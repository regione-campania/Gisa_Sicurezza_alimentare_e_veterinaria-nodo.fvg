...
<script language="JavaScript" type="text/javascript" src="js/sinantropi/addMarini.js"></script>


<form action="sinantropi.AddMarini.us" name="form" method="post" onsubmit="javascript:return checkform(this);">
	
	<input type="hidden" name="interactiveMode" value="<c:out value="${interactiveMode}"/>"/>
	<h4 class="titolopagina">
	   	Registrazione di un nuovo animale marino
	</h4>
		...
		<tr class="even">
	        ...
	        <td colspan="2">
		        <select name="specieSinantropo" onChange="javascript: chooseSpecie(this.value)" style="width:30%;">
    				...
    				<option value="1" >  Mammifero/Cetaceo  </option>
            		<option value="2" >  Rettile/Testuggine </option>
            		<option value="3" >  Selaci Chondrichthyes </option>    
	    		</select>      
	        	<select name="tipologiaSinantropoU" id="selaci" style="display:none;width:50%;">
	        	...
	        	<select name="tipologiaSinantropoM" id="mammiferiCetacei" style="display:none;width:50%;">
					<option value="0">&lt;--- Selezionare Genere e Specie ---&gt;</option>
	        	...
	        	<select name="tipologiaSinantropoRA" id="rettiliTestuggini" style="display:none;width:50%;">
					<option value="0">&lt;--- Selezionare Genere e Specie ---&gt;</option>
