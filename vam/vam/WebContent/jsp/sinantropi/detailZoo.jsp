...
<h4 class="titolopagina">
  Dettaglio Animale dello zoo/circo numero ${s.numeroAutomatico }
</h4>
...
<table class="tabella">
        ...
        <tr class='even'>
        	<td align="center">
        		<c:if test="${interactiveMode != 'Y'}">
		    		<input type="button" value="Modifica Scheda" onclick="attendere(), location.href='sinantropi.ToEditZoo.us?idSinantropo=${s.id}'">
        		</c:if>   
        	</td>
    		<td>    			
	    	</td>
