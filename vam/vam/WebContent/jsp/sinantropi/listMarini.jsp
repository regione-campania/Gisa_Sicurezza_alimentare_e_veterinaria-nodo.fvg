...
<div class="area-contenuti-2">
	<form action="sinantropi.ListMarini.us" method="post">
			...
			<jmesa:htmlTable styleClass="tabella">
				<jmesa:htmlRow>
					...
					<jmesa:htmlColumn sortable="false" filterable="false" 				title="Operazioni">
							<a href="sinantropi.DetailMarini.us?idSinantropo=${s.id}">Dettaglio</a>										
					</jmesa:htmlColumn>
	...
	<script type="text/javascript">
		...
		function onInvokeExportAction(id)
		{
			...
			location.href = 'sinantropi.ListMarini.us?' + parameterString;
		}
	</script>
</div>