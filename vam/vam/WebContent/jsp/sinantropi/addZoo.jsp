...
<form action="sinantropi.AddZoo.us" name="form" method="post" onsubmit="javascript:return checkform(this);">
	...
	<table class="tabella">
        ...
        <div id="div_cattura_1" style="display:none">
        <tr class="even">
    		<td id="div_cattura_2">
    			 Data<font color="red" id="data_asterisco"> *</font>
    		</td>
    		<td id="div_cattura_9">    		
        ...
        <tr class="odd">
	        <td id="div_cattura_3" style="display:none">
	       		 Provincia e Comune<font color="red" id="prov_asterisco" style="display:none"> *</font>
	        </td>
	        <td id="div_cattura_4" style="display:none" colspan="2">
	    	...
	    	<td id="div_cattura_5" style="display:none">
    		</td>   
        </tr>
                        
        
        <tr class="even">
	        <td id="div_cattura_6" style="display:none">
	       		 Luogo<font color="red" id="luogo_asterisco" style="display:none"> *</font>
	        </td>
	        <td id="div_cattura_7" style="display:none">
	        	<input type="text" name="luogoCattura" maxlength="50" size="50"/>		             
	        </td>
	        <td id="div_cattura_8" style="display:none">
	        </td>
        </tr>
        </div>
        <tr class="odd">
