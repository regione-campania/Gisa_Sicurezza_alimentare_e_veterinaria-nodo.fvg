...
<div id="sidebar-left">
	...
	<li><a href="#">Anagrafe</a>
			<ul id="qm1" class="qmmc">
					...
					<li>
						<a onclick="attendere()" href="sinantropi.ToAddMarini.us" accesskey="5"><span>Marini</span></a>
					</li>
					
					<li>
						<a onclick="attendere()" href="sinantropi.ToAddZoo.us" accesskey="5"><span>Provenienti da zoo/circo</span></a>
					</li>
			</ul>
		</li>
	...
	<li>
		...
		<ul id="qm1" class="qmmc">
					...
					<li>
						<a onclick="attendere()" href="sinantropi.ToFindMarini.us" accesskey="5"><span>Marini</span></a>
					</li>
					
					<li>
						<a onclick="attendere()" href="sinantropi.ToFindZoo.us" accesskey="5"><span>Provenienti da zoo/circo</span></a>
					</li>
			</ul>
	...
	<li>
		<a href="#" accesskey="4"><span>Lista</span></a>
		<ul id="qm1" class="qmmc">
					<li>
						<a onclick="attendere()" href="sinantropi.List.us" accesskey="5"><span>Sinantropi/Selvatici</span></a>
					</li>
				
					<li>
						<a onclick="attendere()" href="sinantropi.ListMarini.us" accesskey="5"><span>Marini</span></a>
					</li>
					
					<li>
						<a onclick="attendere()" href="sinantropi.ListZoo.us" accesskey="5"><span>Provenienti da zoo/circo</span></a>
					</li>
			</ul>
