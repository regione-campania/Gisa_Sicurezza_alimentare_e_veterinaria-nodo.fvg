...
<form action="vam.bdr.canina.Ritrovamento.us" method="post">
	...
	<fieldset>
		...
		<table class="tabella">
			...
			<tr>
		        ...
		        <td colspan="2">
		        	<select id="provincia"  name="provincia" onChange="javascript: chooseProvincia(this.value)">
			        	...
			        	<select name="comuneBN" id="comuneBN" style="display:none">
			        	...
			        	<select name="comuneNA" id="comuneNA" style="display:none">
			        	...
			        	<select name="comuneSA" id="comuneSA" style="display:none">
			        	...
			        	<select name="comuneCE" id="comuneCE" style="display:none">
			        	...
			        	<select name="comuneAV" id="comuneAV" style="display:none">
			...
			<tr class="odd" >
				<td>Indirizzo</td>
				<td> <input type="text" size="30" maxlength="120" name="luogoRitrovamento" /> </td>
			</tr>
			<tr class="even" >
				<td>Note</td>
				<td>
