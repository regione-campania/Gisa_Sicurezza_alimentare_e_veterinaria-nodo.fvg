...
<br/><br/>
<input type="button" value="Inserimento Registrazioni Completato" onclick="javascript:if(registrazioneInserita('${accettazione.animale.identificativo}',${accettazione.animale.lookupSpecie.id},${idTipoRegBdr})){attendere(),logoutFromCanina( inserimentoRegistrazioniCompletato );}" />
</br></br>
...
{
	location.href='vam.bdr.canina.RegistrazioniInterattiveInserite.us?idAccettazione=${accettazione.id }&idTipoRegBdr=${idTipoRegBdr}';
}
</script>
