...
%>
<form action="vam.izsm.autopsie.Add.us" name="form" method="post" id="form" class="marginezero" onsubmit="javascript:return checkform(this);">
...
<!--    		</td>-->
<!--    		<td>-->
<!--    			<TEXTAREA NAME="esameEsterno" COLS=40 ROWS=4></TEXTAREA>	    			   					-->
<!--    		</td>-->
<!--    		<td>-->
<!--    		</td>-->
<!--        </tr>-->
...
<!--    		</td>-->
<!--    		<td>-->
<!--    			<TEXTAREA NAME="cavitaAddominale" COLS=40 ROWS=4></TEXTAREA>	    			   					-->
<!--    		</td>-->
<!--    		<td>-->
<!--    		</td>-->
<!--        </tr> -->
...
<!--    		</td>-->
<!--    		<td>-->
<!--    			<TEXTAREA NAME="cavitaToracica" COLS=40 ROWS=4></TEXTAREA>	    			   					-->
<!--    		</td>-->
<!--    		<td>-->
<!--    		</td>-->
<!--        </tr> -->
...
<!--    		</td>-->
<!--    		<td>-->
<!--    			<TEXTAREA NAME="cavitaPelvica" COLS=40 ROWS=4></TEXTAREA>	    			   					-->
<!--    		</td>-->
<!--    		<td>-->
<!--    		</td>-->
<!--        </tr>-->
...
<!--    		</td>-->
<!--    		<td>-->
<!--    			<TEXTAREA NAME="cavitaOrale" COLS=40 ROWS=4></TEXTAREA>	    			   					-->
<!--    		</td>-->
<!--    		<td>-->
<!--    		</td>-->
<!--        </tr>                    -->
