...
<%@ taglib uri="/WEB-INF/jmesa.tld" prefix="jmesa" %>
    ...
    <h4 class="titolopagina">
     		Storico scarico farmaco ${mf.lookupFarmaci.description }
    </h4>
...
<div class="area-contenuti-2">
	<form action="vam.magazzino.farmaci.Storico.us" method="post">
		...
		<jmesa:tableModel items="${listScaricoFarmaci}" id="lsf" var="lsf" filterMatcherMap="it.us.web.util.jmesa.MyFilterMatcherMap" >
			<jmesa:htmlTable styleClass="tabella" >
				<jmesa:htmlRow>	
					
					<jmesa:htmlColumn property="entered" title="Data Scarico" sortable="false" filterable="false">
						<fmt:formatDate value="${lsf.entered}" pattern="dd/MM/yyyy" var="data"/>
					...
					<jmesa:htmlColumn property="mf.lookupTipiFarmaco.unitaMisuraScarico" 	title="Unità di misura per lo scarico" sortable="false" filterable="false" />
