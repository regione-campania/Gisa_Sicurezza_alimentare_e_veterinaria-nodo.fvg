...
function test(){
	mess="";
	TestAutopsie.existNumRifMittente(document.getElementById('numeroAccettazioneSigla').value, 
			{
    ...
    <table class="tabella">
        ...
        <tr class='even'>
    		<td>
    			 ...
    			 <input onclick="popolaNumRifMittente('<%=decimalFormat.format((Integer)request.getAttribute("progressivo"))%>','${utente.clinica.lookupAsl.id}')" type="radio" name="tipoAccettazione" id="idTipoAccettazione1" value="IZSM" <c:if test="${a.tipoAccettazione=='IZSM' || a==null}">checked="checked"</c:if>/>
     ...
     <table class="tabella">     	
       ...
       <td colspan="4">
        ...
        <tr class='odd'>
        	...
        	<td align="center">
        		<input type="submit" value="Salva" onclick="test(); if(mess!=''){ return false;}"
        		/>
        		<!-- input
