...
<script language="JavaScript" type="text/javascript" src="js/vam/cc/diagnosticaImmagini/rx/add.js"></script>
<%-- <script language="JavaScript" type="text/javascript" src="js/azionijavascript.js"></script>--%>

<form action="vam.cc.diagnosticaImmagini.rx.Add.us" name="form" id="form" method="post" class="marginezero">
