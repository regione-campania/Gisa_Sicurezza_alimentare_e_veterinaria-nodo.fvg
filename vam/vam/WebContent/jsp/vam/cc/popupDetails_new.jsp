...
<%if (cc.getCcMorto()) { %>
<input type="checkbox" name="sezione" id="1" value="det" checked="checked" disabled="disabled" onClick="javascript:ctr('1');">Dettaglio Generale<br>
<input type="hidden" name="sezione" id="18" value="anamnesi">
<input type="hidden" name="sezione" id="19" value="esameObiettivoGenerale">
<input type="hidden" name="sezione" id="20" value="esameObiettivoParticolare">
...
<input type="checkbox" name="sezione" id="5"  value="dimismalt" onClick="javascript:ctr(5,'divDimis');">Trasporto spoglie<br>
...
<input type="hidden" name="sezione" id="9" value="lista">
<input type="hidden" name="sezione" id="10" value="listaUrine">
<input type="hidden" name="sezione" id="11" value="listaCoprologico">
<input type="hidden" name="sezione" id="12" value="listaDiagnosticaImmagini">
<input type="hidden" name="sezione" id="13" value="listaEsterni">
<input type="hidden" name="sezione" id="14" value="listaECG">
<input type="hidden" name="sezione" id="15" value="listaEcitologico">
<input type="checkbox" name="sezione" id="16" value="isto" onClick="javascript:ctr(16,'divListIsto');">Esami istopatologici<br>
<input type="checkbox" name="sezione" id="17" value="necro" onClick="javascript:ctr(17,'divListNecro');">Esame necroscopico<br>
<%} else { %>
<input type="checkbox" name="sezione" id="1" value="det" checked="checked" disabled="disabled" onClick="javascript:ctr('1');">Dettaglio Generale<br>
<input type="checkbox" name="sezione" id="18" value="anamnesi" onClick="javascript:ctr(18,'divAnamnesi');">Anamnesi<br>
<input type="checkbox" name="sezione" id="19" value="esameObiettivoGenerale" onClick="javascript:ctr(19,'divEsameObiettivoGenerale');">Esame Obiettivo Generale<br>
<input type="checkbox" name="sezione" id="20" value="esameObiettivoParticolare" onClick="javascript:ctr(20,'divEsameObiettivoParticolare');">Esame Obiettivo Particolare<br>
...
<input type="checkbox" name="sezione" id="5"  value="dimismalt" onClick="javascript:ctr(5,'divDimis');">Dimissioni<br>
...
<input type="checkbox" name="sezione" id="8" value="trasf" onClick="javascript:ctr(8,'divTrasf');">Trasferimenti<br>
<input type="checkbox" name="sezione" id="9" value="lista" onClick="javascript:ctr(9,'divList');">Esami del Sangue<br>
<input type="checkbox" name="sezione" id="10" value="listaUrine" onClick="javascript:ctr(10,'divListUrine');">Esami delle urine<br>
<input type="checkbox" name="sezione" id="11" value="listaCoprologico" onClick="javascript:ctr(11,'divListCoprologico');">Esame coprologico<br>
<input type="checkbox" name="sezione" id="12" value="listaDiagnosticaImmagini" onClick="javascript:ctr(12,'divListDiagnosticaImmagini');">Esame diagnostica per immagini<br>
<input type="checkbox" name="sezione" id="13" value="listaEsterni" onClick="javascript:ctr(13,'divListEsterni');">Esami esterni<br>
<input type="checkbox" name="sezione" id="14" value="listaECG" onClick="javascript:ctr(14,'divListECG');">Esame ECG<br>
<input type="checkbox" name="sezione" id="15" value="listaEcitologico" onClick="javascript:ctr(15,'divListCitologico');">Esame Citologico<br>
<input type="hidden" name="sezione" id="16" value="isto">
<input type="hidden" name="sezione" id="17" value="necro">
<%} %>
...
<%
					while(sl.hasNext())
					{
						...
						{
							alreadyChecked = "NO";
							Iterator<EsameObiettivoEsito> esitiSelezionati = ((ArrayList<EsameObiettivoEsito>)request.getAttribute("superListCheckedPart"+idApparato)).iterator();
							while(esitiSelezionati.hasNext())
							{
   ...
   <div id="divTerap" <c:choose>
   	...
   	<table class="bordo" style="collapse;page-break-inside: avoid">
        ...
        <c:forEach items="${trasferimenti}" var="tr" >
    		...
    		<tr><td><H3>NOTA DI RICONSEGNA</H3></td><td>${tr.notaRiconsegna }</td></tr>
    		<c:set var="i" value='${i+1}'/>
        </c:forEach>  
          <% } %>
   	</table>
...
<div style="page-break-before:always"> &nbsp;</div>
  	...
  	<div id="divListCitologico" <c:choose>
    	...
    	<br/><br/>
    		...
    		<c:forEach items="${cc.esameCitologicos}" var="ecito" >
		      ...
		      <tr><td><h3>DIAGNOSI</h3></td>
		        <td><c:out value="${ecito.diagnosi}"></c:out>	
		        		 		</td></tr>
    		        </c:forEach>
   	</table>
  	</div>
  	...
  	<br/>   	
         ...
         <table class="fondo">
        	...
        	<td> 
        	<fmt:formatDate type="date" value="<%= new java.util.Date() %>" pattern="dd/MM/yyyy"/>
        	</td>
        	<td colspan="2">
        		<h3>FIRMA</h3> 
        	</td>
        	...
        	<tr></tr>
        	<tr><td colspan="2"></td>
        	<td class="underline" colspan="2"></td></table> 
