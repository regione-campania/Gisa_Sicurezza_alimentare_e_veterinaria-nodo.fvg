...
<script language="JavaScript" type="text/javascript" src="js/vam/cc/rickettsiosi/edit.js"></script>


<form action="vam.cc.rickettsiosi.Edit.us" method="post" onsubmit="javascript:return checkform(this);">

	<input type="hidden" name="idRickettsiosi" value="<c:out value="${r.id}"/>"/>
	
	
	
	<jsp:include page="/jsp/vam/cc/menuCC.jsp"/>
	<h4 class="titolopagina">
	   	Modifica Rickettsiosi
	</h4>
	...
	<table class="tabella">
		...
		<tr class="even">
    		<td>
    			 Data Richiesta
    			<fmt:formatDate value="${r.dataRichiesta}" pattern="dd/MM/yyyy" var="dataRichiesta"/>   			 
    		...
    		<td>
    			 Data Esito
    			<fmt:formatDate value="${r.dataEsito}" pattern="dd/MM/yyyy" var="dataEsito"/>   			 
	...
	<tr>
		...
		<td>	
			...
			<input type="button" value="Annulla" onclick="attendere(), location.href='vam.cc.rickettsiosi.List.us'">
		 </td>
	 </tr>
 	</table>
