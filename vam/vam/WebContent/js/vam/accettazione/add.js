function abilitaDisabilitaProntoSoccorso(checkbox)
{
	if(checkbox.checked)
	{
		if(document.getElementById('idAttivitaEsterna').value=="2")
			document.getElementById('idAttivitaEsterna').value="";
		document.getElementById('idAttivitaEsternaValue2').disabled="disabled";
	}
	else
	{
		document.getElementById('idAttivitaEsternaValue2').disabled=false;
	}
}

function abilitaDisabilitaIdentificazioneCarcasse(checkbox)
{
	if(checkbox.checked)
	{
		if(document.getElementById('idAttivitaEsterna').value=="1")
			document.getElementById('idAttivitaEsterna').value="";
		document.getElementById('idAttivitaEsternaValue1').disabled="disabled";
	}
	else
	{
		document.getElementById('idAttivitaEsternaValue1').disabled=false;
	}
}
...
function abilitaDisabilitaAttivitaEsterne(checkbox)
{
	if(checkbox!=null)
	{
		if(checkbox.checked)
		{
			...
			if(document.getElementById('comuneIndirizzoAttEsternaEdit').value=='true')
			{
...
function checkform(idUtente,idAnimale,idClinica,pregresso,modifica)
{
	...
	{
		alert("Non e'' consentito l'inserimento di anagrafiche animali e registrazioni di sterilizzazione relative ad anni precedenti");
		toReturn = false;
		$( "#dialog-modal" ).dialog( "close" );
	}
    }
