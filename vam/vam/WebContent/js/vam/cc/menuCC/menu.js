...
/** jquery.lavalamp.js ****************/
/**
 * LavaLamp - A menuCC plugin for jQuery with cool hover effects.
...
/**
 * Creates a menuCC with an unordered list of menuCC-items. You can either use the CSS that comes with the plugin, or write your own styles 
 * to create a personalized effect
 *
 * The HTML markup used to build the menuCC can be as simple as...
 *
 *       <ul class="lavaLamp">
 *           <li><a href="#">Home</a></li>
 ...
 *
 * Use the following snippet to initialize the menuCC.
 *   $(function() { $(".lavaLamp").lavaLamp({ fx: "backout", speed: 700}) });
 *
 * Thats it. Now you should have a working lavalamp menuCC. 
 *
 ...
 * @desc Creates a menuCC with "backout" easing effect. You need to include the easing plugin for this to work.
 *
 * @option speed - default is 500 ms
 * @example
 * $(".lavaLamp").lavaLamp({ speed: 500 });
 * @desc Creates a menuCC with an animation speed of 500 ms.
 *
 * @option click - no defaults
 * @example
 * $(".lavaLamp").lavaLamp({ click: function(event, menuCCItem) { return false; } });
 * @desc You can supply a callback to be executed when the menuCC item is clicked. 
 * The event object and the menuCC-item that was clicked will be passed in as arguments.
 */
(function($) {
