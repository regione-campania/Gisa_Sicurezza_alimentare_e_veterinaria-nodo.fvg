(function ($) {
    ...
    var filterapi = {
        createDynFilterModify : function(filter, id, property) {
            if (dynFilter) {
                return;
            }
            ...
            cell.html('<div id="dynFilterDiv"><input id="dynFilterInput" maxlength="15" name="filter" style="width:' + (width + 2) + 'px" value="" /></div>');
