...
public class EditMarini extends GenericAction {
	...
	{
		final Logger logger = LoggerFactory.getLogger(EditMarini.class);			
		...
		setMessaggio("Modica Animale Marino avvenuta con successo");
		redirectTo( "sinantropi.DetailMarini.us?idSinantropo="+idSinantropo);	
