...
/*		while(listComuniIterator3.hasNext()) {			
		...
		setMessaggio( "Registrazione Sinantropo effettuata" );		
		
		redirectTo  ( "sinantropi.Detail.us?idSinantropo="+s.getId()+"&&interactiveMode="+stringaFromRequest("interactiveMode"));
