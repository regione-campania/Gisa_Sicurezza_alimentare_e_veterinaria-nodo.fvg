...
public class ListZoo extends GenericAction {
	...
	public void execute() throws Exception
	{
		...
		if (sinantropi.size() == 0) {
			...
			setMessaggio("Nessun animale dello zoo/circo presente in banca dati");				
			...
			gotoPage("sinantropi_default","/jsp/sinantropi/listZoo.jsp");
