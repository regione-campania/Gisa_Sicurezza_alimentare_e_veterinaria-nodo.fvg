...
public class FindZoo extends GenericAction {
	...
	public void execute() throws Exception
	{
		...
		if (sinantropiUfficiali.size() == 0 && sinantropiAutomatici.size() == 0 && sinantropiMc.size()==0 && sinantropiIspra.size()==0) {
			setErrore("Nessun Animale dello zoo/circo presente con il numero " + " " + numeroSinantropo);				
			gotoPage("sinantropi_default","/jsp/sinantropi/findZoo.jsp");	
