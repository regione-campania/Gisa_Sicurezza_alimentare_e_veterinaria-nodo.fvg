...
public class DeleteAssegnazione extends GenericAction 
{
	...
	{		
		...
		setMessaggio("Cancellazione Effettuata con successo");
	...
	{
		return "Cancellazione Assegnazione Terapia Farmacologica";
	}
