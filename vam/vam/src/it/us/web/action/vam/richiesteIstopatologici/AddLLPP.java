...
public class AddLLPP extends GenericAction {
	...
	public void execute() throws Exception
	{
		...
		EsameIstopatologicoDAO dao = new EsameIstopatologicoDAO();
		String progressivo = dao.getProgressivoIstopatologico(utente.getSuperutente().getId(), connection);
		
		esame.setOutsideCC(true);
		esame.setAnimale(a);
		esame.setNumeroAccettazioneSigla(utente.getSuperutente().getSiglaProvincia() + "-" + utente.getSuperutente().getNumIscrizioneAlbo()+"/"+progressivo);
