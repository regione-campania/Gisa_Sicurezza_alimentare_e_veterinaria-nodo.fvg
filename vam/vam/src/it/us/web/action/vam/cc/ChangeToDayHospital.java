...
public class ChangeToDayHospital extends GenericAction implements Specie {
	...
	public void execute() throws Exception
	{
		...
		setConnectionBdu(connection);
			...
			final Logger logger = LoggerFactory.getLogger(ChangeToDayHospital.class);
				
					
			try{
				
				cc.setDayHospital(true);		
