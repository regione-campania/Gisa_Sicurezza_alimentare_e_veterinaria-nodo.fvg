...
public class ToEdit extends GenericAction implements Specie
{
	...
	public void execute() throws Exception
	{
			...
			EsameCoprologico esame = (EsameCoprologico) persistence.find(EsameCoprologico.class, interoFromRequest("idEsame") );
	
			String specieAnimale = null;
			switch ( esame.getCartellaClinica().getAccettazione().getAnimale().getLookupSpecie().getId() )
			{
			case CANE:
