...
public class AnimaleDAONoH extends GenericDAO {
	public static final Logger logger = LoggerFactory.getLogger(AnimaleDAONoH.class);

	public static AnimaleNoH getAnimale(int id, Connection conn) {
	...
	public static Animale getAnimale(String identificativo, Connection conn) {
		...
		try {
			stat = conn.prepareStatement("select id, identificativo, eta, comune_ritrovamento, provincia_ritrovamento, indirizzo_ritrovamento, note_ritrovamento,  clinica_chippatura, tatuaggio, deceduto_non_anagrafe_data_morte_presunta, data_nascita, specie as lookup_specie_id, deceduto_non_anagrafe, deceduto_non_anagrafe_data_morte "
	...
	public static AnimaleNoH getAnimaleNoH(String identificativo, Connection conn) {
		PreparedStatement stat = null;
		ResultSet rs = null;
	...
	public static void delete(String nome_ruolo, BUtente utente, HttpServletRequest req) {
		...
		public static CartellaClinicaNoH getCcRicovero(AnimaleNoH animale, Connection conn) {
			PreparedStatement stat = null;
			ResultSet rs = null;
			...
			try {
				...
				if (rs.next()) 
				{
					...
					cc = CartellaClinicaDAONoH.getCc(conn, rs.getInt(1));
				}
	...
	public static void updateClinicaChippatura(Connection conn, Animale animale) {
		PreparedStatement stat = null;
			try {
