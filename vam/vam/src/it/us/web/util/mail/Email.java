...
public abstract class Email
{
    ...
    public static final String MAIL_LOCAL_HOST = "mail.smtp.localhost";
    ...
    protected Session getMailSession() throws EmailException
    {
        if (this.session == null)
        {
            ...
            properties.setProperty(MAIL_PORT, smtpPort);//OK
            properties.setProperty(MAIL_HOST, hostName);//OK
            
            properties.setProperty(MAIL_LOCAL_HOST, hostName);

            properties.setProperty(MAIL_DEBUG, String.valueOf(this.debug));
            properties.setProperty(MAIL_SMTP_STARTTLS, "true");//OK
            properties.setProperty("mail.smtp.socketFactory.fallback", "true");//OK

            if (this.authenticator != null)
            {
                properties.setProperty(MAIL_SMTP_AUTH, "true");//OK
            }
            ...
            this.session.setPasswordAuthentication(new URLName("smtp", hostName, Integer.parseInt(smtpPort),"INBOX", Application.get("MAIL_USERNAME"), Application.get("MAIL_PASSWORD")), new PasswordAuthentication(Application.get("MAIL_USERNAME"), Application.get("MAIL_PASSWORD")));
        }
        return this.session;
    }
