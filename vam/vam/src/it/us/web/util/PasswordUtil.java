...
public class PasswordUtil {
	...
	{		
		boolean ret = true;
		if( password.matches(".*[a-zA-Zàèéìòù].*") )
		{
			ret = true;
		}
		else
	...
	private static boolean containsOtherChar(String password) 
	{
		...
		boolean ret = true;
		if( password.matches(".*[^0-9a-zA-Zàèéìòù].*") )
		{
			ret = true;
		}
		else
