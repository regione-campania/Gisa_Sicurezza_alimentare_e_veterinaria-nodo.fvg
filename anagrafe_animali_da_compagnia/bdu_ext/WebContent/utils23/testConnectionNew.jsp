...
public static final String ChiamaServizioConJSON(String urlService, JSONObject json) {
		...
		String output = "{}";
		String amb = ApplicationProperties.getProperty("ambiente");
		String abilitazione_chiamata_microservices = ApplicationProperties.getProperty("abilitazione_chiamata_microservices");
