<%@page
	import="org.aspcfs.modules.registrazioniAnimali.base.EventoTrasferimento,org.aspcfs.modules.opu.base.*"%>
...
<%
	EventoTrasferimento eventoF = (EventoTrasferimento) evento;
%>
