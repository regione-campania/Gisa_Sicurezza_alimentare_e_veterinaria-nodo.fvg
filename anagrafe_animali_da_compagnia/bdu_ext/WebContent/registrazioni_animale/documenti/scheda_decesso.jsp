...
<jsp:useBean id="scheda" class="org.aspcfs.modules.registrazioniAnimali.base.SchedaDecesso" scope="request" />	
...
<link type="text/css" href="anagrafe_animali/documenti/screen.css"
rel="stylesheet" />
...
<jsp:useBean id="diagnosiCitologicheList" class="org.aspcfs.utils.web.LookupList" scope="request" />
...
<input type="submit" name="stampa" class="buttonClass"
    ...
    <jsp:param name="idAnimale" value="<%=thisAnimale.getIdAnimale() %>" />
     <jsp:param name="idSpecie" value="<%=thisAnimale.getIdSpecie() %>" />
      <jsp:param name="idTipo" value="PrintCertificatoDecesso" />
...
<div class="title1">SCHEDA DI DECESSO</div>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
...
<div class="dott_long_margin_low" >&nbsp; <%=(sedeOperativa != null) ? sedeOperativa.getVia() : ""%> - <%=(sedeOperativa != null) ? comuniList.getSelectedValue((sedeOperativa.getComune())) : ""%></div>
<div class="clear1"></div>
...
<div class="nodott_margin_low" >Indirizzo:</div>
<div class="dott_long_margin_low" >&nbsp; <%=(sedeOperativa2 != null) ? sedeOperativa2.getVia() : ""%> - <%=(sedeOperativa2 != null) ? comuniList.getSelectedValue((sedeOperativa2.getComune())) : ""%></div>
<div class="clear1"></div>

<div class="nodott_margin_low" >Telefono:</div>
<div class="dott_margin_low" >&nbsp; <%=(detentore.getRappLegale() != null) ? (detentore.getRappLegale().getTelefono1()) : ""%></div>

<div class="nodott_margin_low" >Cellulare/Tel. secondario:</div>
<div class="dott_margin_low" >&nbsp; <%=(detentore.getRappLegale() != null) ? (detentore.getRappLegale().getTelefono2()) : ""%></div>
<div class="clear1"></div>
...
<div class="nodott_margin_low" ><b><u>Informazioni scheda decesso</u></b></div>
<div class="clear1"></div>
<div class="nodott_margin_low" >Data decesso:</div>
<div class="dott_margin_low" >&nbsp;<%=toDateasString(scheda.getDataDecesso())%></div>

<div class="nodott_margin_low" >Causa decesso</div>
<div class="dott_margin_low" >&nbsp;<%=causeDecessoList.getSelectedValue(scheda.getIdCausa())%><%if(scheda.getNoteCausaDecesso()!=null && !scheda.getNoteCausaDecesso().equals("")) {%>&nbsp;&nbsp;&nbsp;&nbsp; Note: <%=scheda.getNoteCausaDecesso() %><%}%></div>

<div class="clear1"></div>
<div class="nodott_margin_low" >Diagnosi di Neoplasia</div>
<div class="dott_margin_low" >&nbsp;<%=neoplasieList.getSelectedValue(scheda.getIdNeoplasia())%><%if(scheda.getNoteNeoplasia()!=null && !scheda.getNoteNeoplasia().equals("")) {%> &nbsp;&nbsp;&nbsp;&nbsp; Note: <%=scheda.getNoteNeoplasia() %><%}%>
</div>
<div class="clear1"></div>
...
%>
		...
		<div class="nodott_margin_low" >Diagnosi citologica</div>
		<div class="dott_margin_low" >&nbsp;<%=diagnosiCitologicheList.getSelectedValue(scheda.getIdDiagnosiCitologica())%>
		</div>
		
<%
	}

	if(scheda.getIdDiagnosiIstologica()>0)
	{
%>

<div class="nodott_margin_low" ><b><u>Diagnosi istologica</u></b></div>
<div class="clear1"></div>

<div class="nodott_margin_low" >Data esito</div>
		<div class="dott_margin_low" >&nbsp;<%=toDateasString(scheda.getDataEsitoIstologico())%>
		</div>
<div class="clear1"></div>
		<div class="nodott_margin_low" >Descrizione morfologica</div>
		<div class="dott_margin_low" >&nbsp;<%=scheda.getDescMorfologicaIstologico() %>
		</div>
		

<div class="clear1"></div>
		<div class="nodott_margin_low" >Tipo diagnosi</div>
		<div class="dott_margin_low" >&nbsp;<%=tipoDiagnosiIstologiche.getSelectedValue(scheda.getIdTipoDiagnosiIstologica()) %> 
		</div>
		
		<div class="nodott_margin_low" >Diagnosi</div>
		<div class="dott_margin_low" >&nbsp;<%=diagnosiIstologicheTumorali.getSelectedValue( scheda.getIdDiagnosiIstologica()) %>
		</div>		
<div class="clear1"></div>		


	<div class="nodott_margin_low" >Note Diagnosi</div>
		<div class="dott_margin_low" >&nbsp;<%if(scheda.getNoteDiagnosiIstologicaTumorali()!=null){
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;<%=User.getUserRecord().getContact().getNameLast() + " " + User.getUserRecord().getContact().getNameFirst() %>, <%= toDateasString(new Timestamp(new Date().getTime())) %>
<br>
