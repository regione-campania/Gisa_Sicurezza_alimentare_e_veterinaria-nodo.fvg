<%@page
	import="org.aspcfs.modules.registrazioniAnimali.base.EventoPresaInCaricoDaAdozioneFuoriAsl,org.aspcfs.modules.opu.base.*"%>
...
<%
EventoPresaInCaricoDaAdozioneFuoriAsl eventoF = (EventoPresaInCaricoDaAdozioneFuoriAsl) evento;
%>
...
<table cellpadding="4" cellspacing="0" border="0" width="100%"
	class="pagedList">
	<th colspan="2">Dettagli della presa in carico</th>

	<tr>
		<td><b><dhv:label name="">Data presa in carico da cessione</dhv:label></b></td>
		<td><%=toDateasString(eventoF.getDataPresaAdozione())%>&nbsp;</td>
	</tr>
	<tr>
