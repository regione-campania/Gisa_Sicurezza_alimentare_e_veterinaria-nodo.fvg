...
//			'>' + currentText + '</button>' : '') + (isRTL ? '' : controls) + '</div>' : '';
		//custom
		var buttonPanel = (showButtonPanel) ? '<div class="ui-datepicker-buttonpane ui-widget-content">' + (isRTL ? controls : '') +
			('<button type="button" class="ui-datepicker-current ui-state-default ui-priority-primary ui-corner-all" data-handler="today" data-event="click"' +
			'>' + currentText + '</button>') + (isRTL ? '' : controls) + '</div>' : '';
...
$.widget("ui.dialog", {
	...
	_create: function() {
		...
		var that = this,
			...
			uiDialogTitlebarClose = $( "<a href='#'></a>" )
				.addClass( "ui-dialog-titlebar-close ui-state-hover" )
				.attr( "role", "button" )
	...
	_makeDraggable: function() {
		...
		this.uiDialog.draggable({
			cancel: ".ui-dialog-content, .ui-dialog-titlebar-close .ui-state-hover",
