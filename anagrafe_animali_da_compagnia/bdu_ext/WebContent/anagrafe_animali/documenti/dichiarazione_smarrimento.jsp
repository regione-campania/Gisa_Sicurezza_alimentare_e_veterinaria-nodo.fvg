  ...
  <jsp:include page="../../gestione_documenti/boxDocumentale.jsp">
    <jsp:param name="idAnimale" value="<%=thisAnimale.getIdAnimale() %>" />
     <jsp:param name="idSpecie" value="<%=thisAnimale.getIdSpecie() %>" />
      <jsp:param name="idTipo" value="PrintDichiarazioneSmarrimento" />
...
<div class="title1">DICHIARAZIONE DI SMARRIMENTO <%=specieList.getSelectedValue(thisAnimale.getIdSpecie()).toUpperCase() %></div>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
...
<div class="nodott" style="margin-top: 0px;">che il <%=thisAnimale.getNomeSpecieAnimale() %> di cui sopra è stato smarrito in data</div>
<div class="dott_solid" style="margin-top: 0px;">&nbsp; <%=toDateasString(dati_smarrimento.getDataSmarrimento())%></div>
<div class="clear1"></div>

<div class="nodott" style="margin-top: 0px;">a</div>
<div class="dott_solid" style="margin-top: 0px;">&nbsp; <%=(dati_smarrimento.getLuogoSmarrimento()!= null) ? dati_smarrimento.getLuogoSmarrimento() : "--"%></div>
</br>
</br>
