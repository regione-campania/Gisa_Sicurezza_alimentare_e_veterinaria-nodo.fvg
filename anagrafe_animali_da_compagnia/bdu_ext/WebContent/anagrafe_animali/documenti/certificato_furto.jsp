...
<input type="submit" name="stampa" class="buttonClass"
    ...
    <jsp:param name="idAnimale" value="<%=thisAnimale.getIdAnimale() %>" />
     <jsp:param name="idSpecie" value="<%=thisAnimale.getIdSpecie() %>" />
      <jsp:param name="idTipo" value="PrintCertificatoFurto" />
...
<div class="title1">CERTIFICATO FURTO ANAGRAFE CANINA REGIONALE</div>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
...
<div class="dott_margin_low" >&nbsp;<%=toDateasString(dati_furto.getDataFurto())%></div>
<div class="nodott_margin_low" >Luogo smarrimento:</div>
<div class="dott_margin_low" >&nbsp;<%=dati_furto.getLuogoFurto()%></div>
<div class="clear1"></div>
