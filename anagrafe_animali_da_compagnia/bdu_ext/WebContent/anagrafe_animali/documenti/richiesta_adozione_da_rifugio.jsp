...
<div class="nodott" style="margin-top: 0px;">alla via</div>
<div class="dott_long" style="margin-top: 0px;">&nbsp;<%=dati_registrazione_adozione.getIndirizzo() %> </div>
<div class="nodott" style="margin-top: 0px;">cap</div>
...
<div class="nodott" style="margin-top: 0px;">chiede l'adozione del cane randagio di proprietà del</div>
<div class="clear1"></div>
...
<div class="dott_long" style="margin-top: 0px;">&nbsp; <%=tagliaList.getSelectedValue(animale.getIdTaglia()) %></div>
...
<div class="dott" style="margin-top: 0px;"><%=provinceList.getSelectedValue(Integer.parseInt(indirizzoOperativoDet.getProvincia()))%> </div>
<div class="clear1"></div>
