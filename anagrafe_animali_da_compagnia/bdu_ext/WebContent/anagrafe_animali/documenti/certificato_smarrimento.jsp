...
<jsp:useBean id="dati_smarrimento" class="org.aspcfs.modules.registrazioniAnimali.base.EventoSmarrimento"
	scope="request" />	
...
<div class="title1">CERTIFICATO SMARRIMENTO ANAGRAFE CANINA REGIONALE</div>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
...
<div class="dott_margin_low" >&nbsp; <%=(linea_proprietario.getTelefono2() != null) ? (linea_proprietario.getTelefono2()) : ""%></div>
<div class="clear1"></div>
...
<div class="clear1"></div>
	...
	<div class="nodott_margin_low" >Telefono:</div>
<div class="dott_margin_low" >&nbsp; <%=(linea_detentore.getTelefono1() != null) ? (linea_detentore.getTelefono1()) : ""%></div>
<div class="nodott_margin_low" >Cellulare/Tel. secondario:</div>
...
<!-- div class="nodott_margin_low" >Data smarrimento:</div>
<div class="dott_margin_low" >&nbsp;<%=toDateasString(dati_smarrimento.getDataSmarrimento())%></div>
<div class="nodott_margin_low" >Luogo smarrimento:</div>
<div class="dott_margin_low" >&nbsp;<%=dati_smarrimento.getLuogoSmarrimento()%></div>
<div class="clear1"></div>
<div class="nodott_margin_low" >Importo ritrovamento:</div>
<div class="dott_margin_low" > &nbsp;<%=(dati_smarrimento.isFlagPresenzaImportoSmarrimento() ) ? "SI -- &#x20ac; "+dati_smarrimento.getImportoSmarrimento() : "NO" %></div>
<div class="clear1"></div-->

<div class="nodott_margin_low" >Tatuaggio:</div>
<div class="dott_margin_low" >&nbsp; <%=thisAnimale.getTatuaggio() %></div>
<div class="clear1"></div>
