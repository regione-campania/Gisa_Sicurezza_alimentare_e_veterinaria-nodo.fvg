...
<div class="title1">CERTIFICATO DECESSO ANAGRAFE CANINA REGIONALE</div>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
...
<div class="nodott_margin_low" >Comune di residenza:</div>
<div class="dott_margin_low" >&nbsp;  <%=(sedeOperativa2 != null) ? comuniList.getSelectedValue((sedeOperativa2.getComune())) : ""%></div>
<div class="clear1"></div>
...
<div class="dott_margin_low" >&nbsp;<%=toDateasString(dati_decesso.getDataDecesso())%></div>
<div class="nodott_margin_low" >Presunta:</div>
<div class="dott_short_margin_low" > &nbsp;<%=(dati_decesso.isFlagDecessoPresunto() ) ? "SI" : "NO" %></div>
<div class="clear1"></div>
