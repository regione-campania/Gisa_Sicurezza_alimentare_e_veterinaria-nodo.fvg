...
<form id="newMessageForm" name="newMessageForm" action="MyCFSInbox.do?command=SendMessage" method="post">
<input onclick="if(sendMessage()){document.newMessageForm.submit();}" type="button" id="send1" value="<dhv:label name="global.button.send">Send</dhv:label>" />
...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="details">
  ...
  <tr>
    ...
    <tr>
       ...
       <td>Email: </td><td><input type="text" name="rispondi_a"
             value="<%= User.getContact().getEmailAddress(1) %>" size="40"
             maxlength="250"/>
             <font color="red">*</font></td>
     </tr>
     </table>
   ...
   <tr>
    ...
    <td valign="middle">
	       <input class="date_picker" type="text" id="problemDate" />
    </td>
  </tr>
  ...
  <tr class="containerBody" id="motivoSegnalazione">
    <td valign="top" class="formLabel">
     	Motivo segnalazione
    </td>
    <td>
...
<br>
<input onclick="if(sendMessage()){document.newMessageForm.submit();}" type="button" id="send2" value="<dhv:label name="global.button.send">Send</dhv:label>" />
