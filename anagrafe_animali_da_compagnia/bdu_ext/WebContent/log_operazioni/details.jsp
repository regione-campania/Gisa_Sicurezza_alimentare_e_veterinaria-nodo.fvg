...
<table class="trails" cellspacing="0">
	<tr>
		...
		<a href="LogOperazioni.do?command=Search&searchusername=<%=searchusername%>&ssearchtimestampdatestart=<%=searchtimestampdatestart%>&searchtimestampdateend=<%=searchtimestampdateend%>">
...
<table class="details" cellpadding="4" cellspacing="0" border="0" width="100%">
	...
	<tr class="row2"><td>USER ID SESSION</td><td><%=UODetails.getUser_id_session()%></td></tr>
</table>
