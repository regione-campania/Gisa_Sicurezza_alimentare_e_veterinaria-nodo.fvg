...
import org.aspcfs.modules.passaporti.base.PassaportoImportValidate;
...
public class PassaportoImport  extends CFSModule {
	  ...
	  public String executeCommandView(ActionContext context) {
	    ...
	    pagedListInfo.setLink("PassaportoImports.do?command=View");
	    ...
	    try {
	      ...
	      thisList.setIdTipologiaImport(Import.TIPOLOGIA_IMPORT_PASSAPORTI);
	  ...
	  public String executeCommandSave(ActionContext context) {
	    ...
	    SystemStatus systemStatus = this.getSystemStatus(context);
	    org.aspcfs.modules.passaporti.base.PassaportoImport thisImport = ( org.aspcfs.modules.passaporti.base.PassaportoImport) context.getFormBean();
	    try {
	      db = getConnection(context);
	      
	     
	      
	      String filePath = this.getPath(context, "passaporti");
	...
	//      thisImport.setSiteId(siteId);
	      thisImport.setTipologiaImport(org.aspcfs.modules.passaporti.base.PassaportoImport.TIPOLOGIA_IMPORT_PASSAPORTI);
	      ...
	      if (contactRecordInserted && fileRecordInserted) {
	        thisImport = new org.aspcfs.modules.passaporti.base.PassaportoImport(db, thisImport.getId());
	  ...
	  public String executeCommandDetails(ActionContext context) {
	    ...
	    try {
	      ...
	      org.aspcfs.modules.passaporti.base.PassaportoImport thisImport = new org.aspcfs.modules.passaporti.base.PassaportoImport(
	  ...
	  public String executeCommandInitValidate(ActionContext context) {
	    ...
	    try {
	      ...
	      PropertyMap thisMap = new PropertyMap(propertyFile, "passaportoImport");
	      ...
	      String filePath = this.getPath(context, "passaporti") + getDatePath(
	          importFile.getModified()) + importFile.getFilename();

	      if (FileUtils.fileExists(filePath)) {
	        //Run the validator(only maps fields to properties in this iteration)
	        PassaportoImportValidate validator = new PassaportoImportValidate();
	  ...
	  public String executeCommandProcess(ActionContext context) {
	    ...
	    try {
	     ...
	     PassaportoImportValidate validator = (PassaportoImportValidate) context.getRequest().getAttribute(
	          "ImportValidator");
	      org.aspcfs.modules.passaporti.base.PassaportoImport thisImport = ( org.aspcfs.modules.passaporti.base.PassaportoImport) context.getRequest().getAttribute(
	              "ImportDetails");
	      if (!isRecordAccessPermitted(context, thisImport)){
	        return ("PermissionError");
	      }
...
//	      
	    ...
	    try {
	      ...
	      if (dependencies.size() == 0) {
	        ...
	        htmlDialog.setDeleteUrl(
	            "javascript:window.location.href='PassaportoImport.do?command=Delete&importId=" + importId + "'");
	      } else {
	        htmlDialog.setHeader(systemStatus.getLabel("confirmdelete.header"));
	        htmlDialog.addButton(
	            systemStatus.getLabel("button.deleteAll"), "javascript:window.location.href='PassaportoImport.do?command=Delete&importId=" + importId + "'");
	        htmlDialog.addButton(
	  ...
	  public String executeCommandDelete(ActionContext context) {
	    ...
	    try {
	      ...
	      if (recordDeleted > 0) {
	        ...
	        importFile.delete(db, this.getPath(context, "passaporti"));
	      }
	    } catch (Exception e) {
	      context.getRequest().setAttribute("Error", e);
	      return ("SystemError");
	    ...
	    context.getRequest().setAttribute(
	        "refreshUrl", "PassaportoImport.do?command=View");
	    ...
	    try {
	      ...
	      if (version == null) {
	        ...
	        if (fileDownload.fileExists()) {
	          ...
	          db = null;
	          System.err.println(
	              "passaportoImports-> Trying to send a file that does not exist");
	          context.getRequest().setAttribute(
	              "actionError", systemStatus.getLabel(
	  ...
	  public String executeCommandViewResults(ActionContext context) {
	    ...
	    pagedListInfo.setLink(
	        "passaportoImports.do?command=ViewResults&importId=" + importId);
	...
	*/
	   ...
	   */
	  private void buildValidateFormElements(Connection db, ActionContext context, org.aspcfs.modules.passaporti.base.PassaportoImport thisImport) throws SQLException {
