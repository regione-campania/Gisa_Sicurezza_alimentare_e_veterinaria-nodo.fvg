...
/**
  ...
  public ResultSet queryListOperatore(Connection db, PreparedStatement pst) throws SQLException {
    ...
    if (pagedListInfo != null) {
      ...
      sqlSelect.append("SELECT ");
    	 ...
    	 sqlSelect.append(
    		        "distinct i.*, i.id as id_indirizzo, r.tipologia_sede,comuni1.cod_provincia,comuni1.codiceistatasl,comuni1.nome as descrizione_comune,lp.description as descrizione_provincia, reg.code as idregione, reg.description as regione " +
    ...
    System.out.println("QUERY DEBUG: "+pst.toString());
    rs = pst.executeQuery();
    if (pagedListInfo != null) {
  ...
  public ResultSet queryListStabilimento(Connection db, PreparedStatement pst) throws SQLException {
	    ...
	    if (pagedListInfo != null) {
	     ...
	     //UTILIZZO CAST PERCHè PER RETROCOMPATIBILITà IL NOME COMUNE IN INDIRIZZO E' ANCORA STRINGA
	    	 sqlSelect.append(
