package org.aspcfs.modules.mcnonstandard.base;
...
String cognome_proprietario,String codice_fiscale,String indirizzo,String comune,String notes,String tipo_esame1,int esito_esame1,java.sql.Date data_esame1)
	{
	...
	/*private void setNote(String notes2) {
		// TODO Auto-generated method stub
	}*/
...
java.sql.PreparedStatement pst= db.prepareStatement(sql);
			...
			logger.severe("[BDU] - EXCEPTION nel metodo insert della classe McNonstandard");
			e.printStackTrace();
		}
	}
