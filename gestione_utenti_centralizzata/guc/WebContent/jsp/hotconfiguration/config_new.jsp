...
<tr>
<td>
<a href="Index.us"><dhv:label name="My Home Page" mainMenuItem="true">Home</dhv:label></a> >
...
<center>
<form name="configForm" action="hotconfiguration.HotConfiguration.us" method="post">
...
caricato: <b><label class="noUpper"><%=it.us.web.db.ApplicationProperties.getFileProperties() %></label></b><br/>
