...
<% if(!ApplicationProperties.getAmbiente().toUpperCase().contains("UFFICIALE")){ %>
	<input type="button" style="margin: 0px 0px 0px 50px;" value="Allinea DELTA Utenti" onclick="window.location.href = 'deltautenti.toDeltaUtenti.us'"/>
<% } %>
</div>
...
<thead>
		...
		<th aria-sort="none" style="-moz-user-select: none;" unselectable="on" aria-controls="table" aria-disabled="false" role="columnheader" scope="col" tabindex="0" data-column="0" data-placeholder="TUTTI" class="first-name filter-select"><div class="tablesorter-header-inner">Ruolo<br/> GISA</div></th>
		<th aria-sort="none" style="-moz-user-select: none;" unselectable="on" aria-controls="table" aria-disabled="false" role="columnheader" scope="col" tabindex="0" data-column="0" data-placeholder="TUTTI" class="first-name filter-select"><div class="tablesorter-header-inner">Ruolo<br/> BDR</div></th>
		<th aria-sort="none" style="-moz-user-select: none;" unselectable="on" aria-controls="table" aria-disabled="false" role="columnheader" scope="col" tabindex="0" data-column="0" data-placeholder="TUTTI" class="first-name filter-select"><div class="tablesorter-header-inner">Ruolo<br/> VAM</div></th>
		<th aria-sort="none" style="-moz-user-select: none;" unselectable="on" aria-controls="table" aria-disabled="false" role="columnheader" scope="col" tabindex="0" data-column="0" data-placeholder="TUTTI" class="first-name filter-select"><div class="tablesorter-header-inner">Ruolo<br/> DIGEMON</div></th>
<!-- 		<th aria-sort="none" style="-moz-user-select: none;" unselectable="on" aria-controls="table" aria-disabled="false" role="columnheader" scope="col" tabindex="0" data-column="0" data-placeholder="TUTTI" class="first-name filter-select"><div class="tablesorter-header-inner">Ruolo<br/> SICUREZZA LAVORO</div></th> -->
...
<%-- <td style="border:1px solid black;"><%=ric.getIdRuoloSicurezzaLavoro()> 0 ? toHtml(ric.getRuoloSicurezzaLavoro()) : "" %></td> --%>
