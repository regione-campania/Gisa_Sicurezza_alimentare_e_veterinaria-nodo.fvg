...
<!-- 	<tr><th colspan="2">SICUREZZA LAVORO</th></tr> -->
...
<tr><th>Id Ambito GESDASIC</th><td><%=dettaglioRichiesta.getIdAmbitoGesdasic() > 0 ? dettaglioRichiesta.getIdAmbitoGesdasic() : "" %></td></tr>
<tr><th>PEC</th><td><%=toHtml(dettaglioRichiesta.getPec()) %></td></tr>
<% if((dettaglioRichiesta.getQualifica() != null && !dettaglioRichiesta.getQualifica().equalsIgnoreCase("")) && (dettaglioRichiesta.getProfiloProfessionale() != null && !dettaglioRichiesta.getProfiloProfessionale().equalsIgnoreCase(""))){ %>
<tr><th>Qualifica</th><td><%= toHtml(dettaglioRichiesta.getQualifica()) %></td></tr>
<tr><th>Profilo Professionale</th><td><%= toHtml(dettaglioRichiesta.getProfiloProfessionale()) %></td></tr>
<% } %>
...
<tr><th>Utente validatore</th><td><%=toHtml(dettaglioRichiesta.getUtenteEsito())%></td></tr>
