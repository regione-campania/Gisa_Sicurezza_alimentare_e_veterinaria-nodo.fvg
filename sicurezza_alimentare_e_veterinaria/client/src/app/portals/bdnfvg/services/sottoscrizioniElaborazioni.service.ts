...
@Injectable()
export class SottoscrizioniElaborazioniService {
  ...
  getSottoscrizioni() {
    ...
    return this.client.getDati('get_elaborazioni');
  }

  getSottoscrizioniElaborazioniFiltered(idSottoscrizione: number) {
    return this.client.getDati('get_elaborazioni', {
      id_sottoscrizione: idSottoscrizione
    });
  }
