...
@Injectable()
export class MonitoraggioAllevamentiService {
  ...
  getMonitoraggioAllevamenti(funcName: string) {
    this.loadingService.openDialog('Caricamento MonitoraggioAllevamenti...');
