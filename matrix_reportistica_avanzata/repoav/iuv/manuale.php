...
$results = pg_query("select  descr, upper(i.alias_indicatore) as alias, motivo from \"Analisi_dev\".config_iuv ci
...
<body>
    <div class="header">
		<h3>Manuale Macroarea IUV</h3>		
    </div> 
    <div style="padding: 3px">
    Di seguito solo riportati i piani/attività rendcontati nella sezione MacroArea IUV della Reportistica Avanzata, e il dettaglio dei loro conteggi.
<br> 
    Si può navigare per Piani/Attivita' DPAT richiesti e selezionando un range di date (default anno correte; data inizio e fine devono essere comprese nello stesso anno).
    </div>
