...
export class DenominazioneProdottoService {
    constructor(
    ...
    insDenominazioneProdotti(params: any = {}) {
        return this.client.updDati('ins_denominazione_prodotti', params);
    }

    delDenominazioneProdotti(params: any = {}) {
        return this.client.updDati('del_denominazione_prodotti', params);
    }
}
