...
<jsp:useBean id="rev" class="java.lang.String" scope="request"/>
...
<form method="post" name="myform" id="myform" action="PrintModulesHTML.do?command=ViewModules">
	...
	<% if(OrgCampione.getTipoModulo().equals("2")) { %>
		...
		<%@ include file="/campioni/moduli_html/rev9/mod2_batter.jsp" %>
	
	<% } if(OrgCampione.getTipoModulo().equals("3")){ %>
	 	
	 	<%@ include file="/campioni/moduli_html/rev9/mod3_chimico.jsp" %>
	 	
	<% }  if(OrgCampione.getTipoModulo().equals("1")){ %>
	
		<%@ include file="/campioni/moduli_html/rev9/mod1_molluschi.jsp" %>
