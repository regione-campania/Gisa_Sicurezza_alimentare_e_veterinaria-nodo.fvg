...
località <label class="layout"><%= fixValore(OrgOperatore.getRagione_sociale())%></label> codice univoco nazionale (CUN) <label class="layout"><%= fixValore(OrgOperatore.getCun())%></label>.<br><br/>
...
si è proceduto con l'ausilio di</span>  <label class="layout"><%= fixValore(Modulo.getListaCampiModulo().get("ausilio").get("ausilio"))%> </label>
...
<!-- 	 	COORDINATE PUNTI DI PRELIEVO <br/> -->
		...
		<% } %>
		<br/><br/>
Ciascuna unità campionaria è costituita da molluschi raccolti <span class="NocheckedItem"> &nbsp;a diversi livelli di profondità </span> <span class="NocheckedItem"> &nbsp;sul fondale. </span> <br>
...
<br/>
<b>temperatura dell'acqua a 10 metri di profondità: </b>
...
<b>di intensità: </b> fine/consistente/abbondante; 
<br/>
<b>salinità dell'acqua: </b>
...
Il campione è inviato all'I.Z.S.M. Sezione di <label class="layout"><%= fixValore(Modulo.getListaCampiModulo().get("sezione").get("sezione"))%></label>
