...
<td style="border:1px solid black;">
<b><%=(Modulo.getTipoModulo()==1) ? "MOD. 1" : (Modulo.getTipoModulo()==2) ? "MOD. 2" : (Modulo.getTipoModulo()==3) ? "MOD. 3" : (Modulo.getTipoModulo()==4) ? "MOD. FISICO" : (Modulo.getTipoModulo()==14) ? "MOD. 14" : "" %></b><br/>
Rev. 9 del <br/>
17/11/21 <br/>
</td>
<td style="border:1px solid black;">
VERBALE<br/>
PRELEVAMENTO<br/>
CAMPIONE <%=(Modulo.getTipoModulo()==1) ? "MOLLUSCHI " : (Modulo.getTipoModulo()==2) ? "MICROBIOLOGICO" : (Modulo.getTipoModulo()==3) ? "CHIMICO/FISICO" : "" %></b><br/>
<br/>
N.<br/>
...
<tr>
<%if((Modulo.getTipoModulo()==1)) { %>
<td colspan="4" style="border:1px solid black;">
<b>CAMPIONE EFFETTUATO PER: </b>
<label class="layout"><%=OrgCampione.getMotivazione_campione()!=null && OrgCampione.getMotivazione_campione().equals("89") ? toHtml(OrgCampione.getPiano().toUpperCase()) : "" %></label>
<label class="layout"><%=OrgCampione.getMotivazione_campione()!=null && !OrgCampione.getMotivazione_campione().equals("89") ? toHtml(OrgCampione.getPiano().toUpperCase()) : "" %></label>
<% } else { %>
<td colspan="4" style="border:1px solid black;">
