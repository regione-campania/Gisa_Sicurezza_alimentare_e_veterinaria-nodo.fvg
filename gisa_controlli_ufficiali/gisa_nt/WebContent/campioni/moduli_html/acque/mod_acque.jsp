...
<TABLE cellpadding="10" style="border-collapse: collapse">
 ...
 <TR>
<Td style="border:1px solid black; font-size: 10px"><b>N</b></Td>
<Td style="border:1px solid black; font-size: 10px"><b>Comune</b></Td>
<Td style="border:1px solid black; font-size: 10px"><b>Ente gestore</b></Td>
<Td style="border:1px solid black; font-size: 10px"><b>Denominazione Punto di Prelievo</b></Td>
<Td style="border:1px solid black; font-size: 10px"><b>Codice Punto di prelievo</b></Td>
<Td style="border:1px solid black; font-size: 10px"><b>Tipologia Controllo</b></Td>
<Td style="border:1px solid black; font-size: 10px"><b>Temp gr.C</b></Td>
<Td style="border:1px solid black; font-size: 10px"><b>Cloro Residuo</b></Td>
<Td style="border:1px solid black; font-size: 10px"><b>Identificativo Bottiglia</b></Td>
 <Td style="border:1px solid black; font-size: 10px"><b>Ora Fine Camp.to</b></Td>
</b></TR>
...
<% for ( int indicepdp = 0 ; indicepdp<PdpList.size() ; indicepdp ++)
	  ...
	  %>
<tr>
<Td style="border:1px solid black; font-size: 10px"> <%=indicepdp+1 %> </Td>
<Td style="border:1px solid black; font-size: 10px"> <%=pdp.getOrgdDetails().getAddressList().getAddress(5).getCity()  %></Td>
<Td style="border:1px solid black; font-size: 10px"> <%=pdp.getOrgdDetails().getEnte_gestore()  %></Td>
<Td style="border:1px solid black; font-size: 10px"><%=pdp.getOrgdDetails().getName() %></Td>
<Td style="border:1px solid black; font-size: 10px"><%=pdp.getOrgdDetails().getAccountNumber() %></Td>
<Td style="border:1px solid black; font-size: 10px">


<%
String nomeProtocollo = "";
int i=0 ;
...
<Td style="border:1px solid black; font-size: 10px"><%=pdp.getTemperatura()%></td>
<Td style="border:1px solid black; font-size: 10px"><%=pdp.getCloro()%></td>
<Td style="border:1px solid black; font-size: 10px"> <input class="editField" type="text" value="<%=valoriScelti.get(z++) %>" size="20" />  </Td>
<Td style="border:1px solid black; font-size: 10px"><%=pdp.getOre()%></td>
