  ...
  <tr class="containerBody">
    ...
    <td>
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
          <td>
            <textarea readonly style="background-color:grey;" name="esito_note_esame" cols="55" rows="8" onkeyup="this.value = this.value.replace(/[`~!@#$%^&*|+\-=?§°ç£<>\{\}\[\]\\\/]/gi, '').replace(/\r?\n/g, '');" onpaste="this.value = this.value.replace(/[`~!@#$%^&*|+\-=?§°ç£<>\{\}\[\]\\\/]/gi, '').replace(/\r?\n/g, '');"><%=TicketDetails.getEsitoNoteEsame() %></textarea>
          </td>
          <td valign="top">
         ...
         <tr class="containerBody">
		    ...
		    <td>
		      <table border="0" cellspacing="0" cellpadding="0" width="100%">
		        <tr>
		          <td>
		            <textarea name="esito_note_esame" cols="55" rows="8" onkeyup="this.value = this.value.replace(/[`~!@#$%^&*|+\-=?§°ç£<>\{\}\[\]\\\/]/gi, '').replace(/\r?\n/g, '');" onpaste="this.value = this.value.replace(/[`~!@#$%^&*|+\-=?§°ç£<>\{\}\[\]\\\/]/gi, '').replace(/\r?\n/g, '');"><%=TicketDetails.getEsitoNoteEsame() %></textarea>
		          </td>
		          <td valign="top">
		            <%= showAttribute(request, "problemError") %>
		          </td>
