...
<form method="post" name="myform" action="CampioniReport.do?command=InsertSchedaSin&type=2&idControllo=<%=SinDetails.getIdControllo()%>&orgId=<%=SinDetails.getOrgId()%>&url=<%=SinDetails.getUrl()%>&tipo=latteA">

<i>Mod. A: Scheda di accompagnamento campioni<br>
(contaminanti ambientali in alimenti di origine animale prodotti nei SIN)</i>
&nbsp;
&nbsp;
&nbsp;
&nbsp;
Scheda N.<input class="layout" type="text" readonly name="a14" id="a14" value="<%=SinDetails.getA14()%>" size="10" maxlength="10"/>
...
<% int i=0;
	...
	<div id="<%=j%>" style="display: none">
  	CF: <input class="layout" type="text" readonly name="a2_1_<%=j%>" id="a2_1_<%=j%>" value="<%=p.trim()%>" size="20" maxlength="16"/><br>
  	</div>
  	<% } if(j == 0){ %> 
  	<div id="<%=1%>" style="display: none">
  	CF: <input class="layout" type="text" readonly name="a2_1_1" id="a2_1_1" value="" size="20" maxlength="16"/><br>
  	</div>
  	<% } %>	
  </td>
  <%--<td>
      <input class="editNoBottom" type="text"  name="a2_1" id="a2_1" value="<%= (SinDetails.getA2_1() != null && !(SinDetails.getA2_1().equals(""))) ? SinDetails.getA2_1() : "" %>" size="20" maxlength="16"/>
  </td>
  --%>
  <td><input class="layout" type="text" readonly  name="a3" id="a3" value="<%=SinDetails.getA3()%>" size="83" maxlength="60"/></td> 
</tr>
<tr class="colorcell">
  <td colspan="2"><b>A4. Luogo di prelievo (S39):</b></td>
</tr>
<tr>
  <td>Codice SIN:<input class="editNoBottom" type="text" readonly="readonly"  name="a4_1" id="a4_1" value="83" size="60" maxlength="60"/></td>
  <td>Denominazione SIN: <input class="editNoBottom"  type="text"  name="a4_2" id="a4_2" readonly="readonly" value="VESUVIANO - PIANURA - ORIENTALE - BAGNOLI" size="60" maxlength="60"/></td>
</tr>
<tr class="colorcell">
...
<tr>
  <td><input class="layout" type="text" readonly  name="a5" id="a5" value="<%=SinDetails.getA5()%>" size="80" maxlength="60"/></td>
  <td><input class="layout" type="text" readonly  name="a6" id="a6" value="<%=SinDetails.getA6()%>" size="83" maxlength="60"/></td>  
</tr>
<tr class="colorcell">
...
<tr>
  <td><input class="layout" type="text" readonly  name="a7" id="a7" value="<%=SinDetails.getA7()%>" size="80" maxlength="60"/></td>
  <td><input class="layout" type="text" readonly  name="a8" id="a8" value="<%=SinDetails.getA8()%>" size="83" maxlength="60"/></td>  
</tr>
<tr class="colorcell">
...
<tr>
  <td><input class="layout" type="text" readonly  name="a9" id="a9" value="<%=SinDetails.getA9() %>" size="80" maxlength="60"/></td>
  <td><input class="layout" type="text" readonly   name="a10" id="a10" value="<%=SinDetails.getA10()%>" size="83" maxlength="60"/></td>  
</tr>
<tr class="colorcell">
  <td colspan="2"><b>A11. Localizzazione geografica del punto di prelievo (GPS - Formato decimale):</b></td>
</tr>
<tr>
  <td>Latitudine: <input class="editNoBottom" type="text"  name="a11_1" id="a11_1" value="<%= (SinDetails.getA11_1() != null && !(SinDetails.getA11_1().equals(""))) ? SinDetails.getA11_1() : "" %>" size="60" maxlength="60"/></td>
  <td>Longitudine: <input class="editNoBottom" type="text"  name="a11_2" id="a11_2" value="<%= (SinDetails.getA11_2() != null && !(SinDetails.getA11_2().equals(""))) ? SinDetails.getA11_2() : "" %>" size="60" maxlength="60"/></td>  
</tr>
<tr class="colorcell">
...
<tr>
  <td><input class="layout" type="text" readonly  name="a12" id="a12" value="<%=SinDetails.getA12()%>" size="80" maxlength="60"/></td>
  <td><input class="editNoBottom" type="text"  name="a13" id="a13" value="<%= (SinDetails.getA13() != null && !(SinDetails.getA13().equals(""))) ? SinDetails.getA13() : "" %>" size="83" maxlength="60" onkeydown="return onKeyNumeric(event);" /></td>  
</tr>
<tr class="colorcell">
...
<tr>
  <td><input class="layout" type="text" readonly  name="a14" id="a14" value="<%=SinDetails.getA14()%>" size="80" maxlength="60"/></td>
  <td><input class="layout" type="text" readonly  name="a15" id="a15" value="<%=SinDetails.getA15()%>" size="83" maxlength="60"/></td>  
</tr>
</table>

<div style="height: 150px;">&nbsp;</div>
<p >Data di elaborazione
  <input class="layout" type="text" readonly  name="data" id="data" value="<%=SinDetails.getData()%>" size="15" maxlength="15"/>
</p>
...
<tr class="colorcell">
  ...
  <table cellspacing="1" cellpadding="5" border="1">
   ...
   <tr>
    ...
    <tr>
      <th><input class="editNoBottom" type="text"  name="b4_1_1" id="b4_1_1" value="<%=SinDetails.getB4_1_1()%>" size="30" maxlength="30"/></th>
      <th><input class="editNoBottom" type="text"  name="b4_1_2" id="b4_1_2" value="<%=SinDetails.getB4_1_2()%>" size="30" maxlength="30"/></th>
      <th><input class="editNoBottom" type="text"  name="b4_1_3" id="b4_1_3" value="<%=SinDetails.getB4_1_3()%>" maxlength="30"/></th>
      <th><input class="editNoBottom" type="text"  name="b4_1_4" id="b4_1_4" value="<%=SinDetails.getB4_1_4()%>" size="30" maxlength="30"/></th>
    ...
    <tr>
      <th><input class="editNoBottom" type="text"  name="b4_2_1" id="b4_2_1" value="<%=SinDetails.getB4_2_1()%>" size="30" maxlength="30"/></th>
      <th><input class="editNoBottom" type="text"  name="b4_2_2" id="b4_2_2" value="<%=SinDetails.getB4_2_2()%>" size="30" maxlength="30"/></th>
      <th><input class="editNoBottom" type="text"  name="b4_2_3" id="b4_2_3" value="<%=SinDetails.getB4_2_3()%>" size="30" maxlength="30"/></th>
      <th><input class="editNoBottom" type="text"  name="b4_2_4" id="b4_2_4" value="<%=SinDetails.getB4_2_4()%>" size="30" maxlength="30"/></th>
    ...
    <tr>
     <th><input class="editNoBottom" type="text"  name="b4_3_1" id="b4_3_1" value="<%=SinDetails.getB4_3_1()%>" size="30" maxlength="30"/></th>
      <th><input class="editNoBottom" type="text"  name="b4_3_2" id="b4_3_2" value="<%=SinDetails.getB4_3_2()%>" size="30" maxlength="30"/></th>
      <th><input class="editNoBottom" type="text"  name="b4_3_3" id="b4_3_3" value="<%=SinDetails.getB4_3_3()%>" size="30" maxlength="30"/></th>
      <th><input class="editNoBottom" type="text"  name="b4_3_4" id="b4_3_4" value="<%=SinDetails.getB4_3_4()%>" size="30" maxlength="30"/></th>
    ...
    <tr>
     <th><input class="editNoBottom" type="text"  name="b4_4_1" id="b4_4_1" value="<%=SinDetails.getB4_4_1()%>" size="30" maxlength="30"/></th>
      <th><input class="editNoBottom" type="text"  name="b4_4_2" id="b4_4_2" value="<%=SinDetails.getB4_4_2()%>" size="30" maxlength="30"/></th>
      <th><input class="editNoBottom" type="text"  name="b4_4_3" id="b4_4_3" value="<%=SinDetails.getB4_4_3()%>" size="30" maxlength="30"/></th>
      <th><input class="editNoBottom" type="text"  name="b4_4_4" id="b4_4_4" value="<%=SinDetails.getB4_4_4()%>" size="30" maxlength="30"/></th>
    ...
    <tr>
      <th><input class="editNoBottom" type="text"  name="b4_5_1" id="b4_5_1" value="<%=SinDetails.getB4_5_1()%>" size="30" maxlength="30"/></th>
      <th><input class="editNoBottom" type="text"  name="b4_5_2" id="b4_5_2" value="<%=SinDetails.getB4_5_2()%>" size="30" maxlength="30"/></th>
      <th><input class="editNoBottom" type="text"  name="b4_5_3" id="b4_5_3" value="<%=SinDetails.getB4_5_3()%>" size="30" maxlength="30"/></th>
      <th><input class="editNoBottom" type="text"  name="b4_5_4" id="b4_5_4" value="<%=SinDetails.getB4_5_4()%>" size="30" maxlength="30"/></th>
    ...
    <tr>
     <th><input class="editNoBottom" type="text"  name="b4_6_1" id="b4_6_1" value="<%=SinDetails.getB4_6_1()%>" size="30" maxlength="30"/></th>
      <th><input class="editNoBottom" type="text"  name="b4_6_2" id="b4_6_2" value="<%=SinDetails.getB4_6_2()%>" size="30" maxlength="30"/></th>
      <th><input class="editNoBottom" type="text"  name="b4_6_3" id="b4_6_3" value="<%=SinDetails.getB4_6_3()%>" size="30" maxlength="30"/></th>
      <th><input class="editNoBottom" type="text"  name="b4_6_4" id="b4_6_4" value="<%=SinDetails.getB4_6_4()%>" size="30" maxlength="30"/></th>
    ...
    <tr>
      <th><input class="editNoBottom" type="text"  name="b4_7_1" id="b4_7_1" value="<%=SinDetails.getB4_7_1()%>" size="30" maxlength="30"/></th>
      <th><input class="editNoBottom" type="text"  name="b4_7_2" id="b4_7_2" value="<%=SinDetails.getB4_7_2()%>" size="30" maxlength="30"/></th>
      <th><input class="editNoBottom" type="text"  name="b4_7_3" id="b4_7_3" value="<%=SinDetails.getB4_7_3()%>" size="30" maxlength="30"/></th>
      <th><input class="editNoBottom" type="text"  name="b4_7_4" id="b4_7_4" value="<%=SinDetails.getB4_7_4()%>" size="30" maxlength="30"/></th>
...
<p style="border-style: solid;border-width:1px;">
  <br>
  Telefono del veterinario prelevatore <input class="editNoBottom" type="text" name="telefono" id="telefono" size="80" value="<%=SinDetails.getTelefono()%>"><br><br>
  Firma del prelevatore <input class="layout" type="text" readonly name="firma" id="firma" size="93" value="" >&nbsp;&nbsp;&nbsp;Timbro<br>
  <br>
  <br>
</p>
