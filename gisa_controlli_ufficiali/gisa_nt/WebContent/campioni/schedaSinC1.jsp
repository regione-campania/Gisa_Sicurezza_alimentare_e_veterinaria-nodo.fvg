...
<form method="post" name="myform" action="CampioniReport.do?command=InsertSchedaSin&type=2&idControllo=<%=SinDetails.getIdControllo()%>&orgId=<%=SinDetails.getOrgId()%>&url=<%=SinDetails.getUrl()%>&tipo=latteC1">

<i>Mod. C1: Scheda di accompagnamento campioni<br>
