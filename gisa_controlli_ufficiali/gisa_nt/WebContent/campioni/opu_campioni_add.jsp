...
<%
int pId = OrgDetails.getIdStabilimento();
String pChiave = "stabIdopu_stabilimento";
if (OrgDetails.getTipologia()== 2000){
pId = OrgDetails.getAltId();
pChiave = "altIdsintesis_stabilimento";
}
%>

 <jsp:include page="../campioni/preaccettazione_list.jsp">
    <jsp:param name="preaccLinea" value="<%=pId+pChiave+CU.getId_imprese_linee_attivita()+OrgDetails.getTipologia() %>" />
 </jsp:include>
 </td>
 </tr>
...
//			Commento tutto il codice dentro questo else perchè se fallisce l'if non deve fare niente: cioè non mostrare la popup 'campi aggiuntivi''
// 			$.ajax({
// 		        type: "GET",
<%-- 		        url: "<%=request.getContextPath() %>/ServletForm?motivazione_piano_campione="+idPiano+"&idControllo="+<%= idCU2%>, --%>
// 		        async: false,
