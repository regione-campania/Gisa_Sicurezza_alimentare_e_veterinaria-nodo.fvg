...
//	}
  ...
  <tr class="containerBody">
    ...
    <td>   
    <input class="date_picker" type="text" id="dataAccettazione" name="dataAccettazione" size="10" 
  ...
  <tr class="containerBody">
    ...
    <td>
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
          <td>
            <textarea readonly style="background-color:grey;" name="esito_note_esame" id="esito_note_esame" cols="55" rows="8" onkeyup="this.value = this.value.replace(/[`~!@#$%^&*|+\-=?§°ç£<>\{\}\[\]\\\/]/gi, '').replace(/\r?\n/g, '')" onpaste="this.value = this.value.replace(/[`~!@#$%^&*|+\-=?§°ç£<>\{\}\[\]\\\/]/gi, '').replace(/\r?\n/g, '');"><%=(TicketDetails.getEsitoNoteEsame()!=null) ? TicketDetails.getEsitoNoteEsame() : "" %></textarea>
          </td>
          <td valign="top">
        ...
        <%} else { %>
		    ...
		    <td>
		      <table border="0" cellspacing="0" cellpadding="0" width="100%">
		        <tr>
		          <td>
		            <textarea name="esito_note_esame" id="esito_note_esame" cols="55" rows="8" onkeyup="this.value = this.value.replace(/[`~!@#$%^&*|+\-=?§°ç£<>\{\}\[\]\\\/]/gi, '').replace(/\r?\n/g, '')" onpaste="this.value = this.value.replace(/[`~!@#$%^&*|+\-=?§°ç£<>\{\}\[\]\\\/]/gi, '').replace(/\r?\n/g, '');"><%=(TicketDetails.getEsitoNoteEsame()!=null) ? TicketDetails.getEsitoNoteEsame() : "" %></textarea>
		          </td>
		          <td valign="top">
		            <%= showAttribute(request, "problemError") %>
		          </td>
  ...
  <!-- NUOVO CAMPO DATA -->
   <tr class="containerBody">
    ...
    <td>   
    <input class="date_picker" type="text" id="dataRisultato" name="dataRisultato" size="10" 
 ...
 { k++;
	 ...
	 <td>
       ...
       <input class="date_picker" type="text" id="esito_data_<%=k %>" name="esito_data_<%=k %>" size="10" value = ""/>
