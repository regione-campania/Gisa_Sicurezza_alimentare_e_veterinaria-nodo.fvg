...
%>
 ...
 <table cellpadding="4" cellspacing="0" width="100%" class="details">
	<tr>
    <th colspan="2">
      <strong><dhv:label name="">Esito Analita</dhv:label></strong>
    </th>
	</tr>
 <tr class="containerBody">
      <td class="formLabel">
...
<% if (!TicketDetails.getProblem().contains("ACQUE DI RETE")) {%>
<tr class="containerBody">
  ...
  <%} else {
  //GESTIONE PER ACQUE DI RETE
  %>
 	  <div style="visibility: hidden">
     <select style="visibility: hidden" name="esito_punteggio">
     <option value="0"  >   0</option>
     </select>
