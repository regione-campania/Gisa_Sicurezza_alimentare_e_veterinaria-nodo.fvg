...
function checkForm()
{
	...
	if(document.addAccount.provvedimentiRestrittivi.value =='-1')
	{
		formtest = false ;
	...
	if(formtest==true){
		var text = document.getElementById('provvedimentiRestrittivi').options[document.getElementById('provvedimentiRestrittivi').selectedIndex].text;
...
<table cellpadding="4" cellspacing="0" border="0" width="100%"class="details" id = "zc">
	...
	<tr id = "classeId">
		...
		<td><%=Classificazione.getHtmlSelect("provvedimentiRestrittivi",OrgDetails.getProvvedimentiRestrittivi()) %><font color="red">*</font>
