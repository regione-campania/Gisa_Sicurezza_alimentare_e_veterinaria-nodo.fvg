...
<body>
 <form name="addticket" action="MolluschiBivalviProvvedimenti.do?command=Insert&auto-populate=true" method="post" onsubmit="return controllaForm(this)">
<%-- Trails --%>
...
<script language="JavaScript" TYPE="text/javascript" SRC="javascript/popMolluschiBivalvi.js"></script>
