...
<body>
 <form name="addticket" action="ImbarcazioniProvvedimenti.do?command=Insert&auto-populate=true" method="post" onsubmit="return controllaForm(document.addticket)">
<%-- Trails --%>
...
<input type="button" value="Annulla" onClick="window.location.href='ImbarcazioniVigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC") %>&orgId=<%=OrgDetails.getOrgId()%>';this.form.dosubmit.value='false';" />
<br>
<dhv:formMessage />
