...
<script language="JavaScript" TYPE="text/javascript" SRC="javascript/controlli_ufficiali_imbarcazioni.js"></script>
...
<form name="details" action="ImbarcazioniVigilanza.do?command=ModifyTicket&auto-populate=true" method="post">
...
<table cellpadding="4" cellspacing="0" width="100%" class="empty">
 ...
 <%@ include file="../controlliufficiali/controlli_ufficiali_sottoattivita.jsp" %>
   ...
   <td>
      ...
      <a href="CheckListImbarcazioni.do?command=View&id=<%= thisAudit.getId()%>&aggiorna=<%=thisAudit.isAggiornaCategoria() %>"><%= toHtml(OrgCategoriaRischioList.getSelectedValue(thisAudit.getTipoChecklist())) %></a>
	</td>
