...
<body>
 <form name="addticket" action="AbusivismiProvvedimenti.do?command=Insert&auto-populate=true" method="post" onsubmit="return controllaForm(document.addticket)">
<%-- Trails --%>
...
<input type="button" value="Annulla" onClick="window.location.href='AbusivismiVigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC") %>&orgId=<%=OrgDetails.getOrgId()%>';this.form.dosubmit.value='false';" />
<br>
<dhv:formMessage />
