...
<body onload="verificaChiusuraNc(<%=request.getAttribute("Chiudi")%>,<%=request.getAttribute("numSottoAttivita")%>,'<%=request.getAttribute("Messaggio2")%>',<%=TicketDetails.getIdControlloUfficiale() %>,'AbusivismiVigilanza')">

<form name="details" action="AbusivismiNonConformita.do?command=ModifyTicket&auto-populate=true" method="post">
<%-- Trails --%>
...
<dhv:container name="abusivisminonconformita" selected="details" object="TicketDetails"
	param="<%= param1 %>"
