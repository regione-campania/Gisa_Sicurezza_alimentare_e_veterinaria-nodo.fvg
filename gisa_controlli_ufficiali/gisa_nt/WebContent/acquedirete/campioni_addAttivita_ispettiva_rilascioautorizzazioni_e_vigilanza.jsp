...
<form name="addticket" action="AcqueReteCampioni.do?command=Insert&auto-populate=true" method="post">
<% request.setAttribute("isAcque Di Rete", "si"); %>
<%-- Trails --%>
...
<input type="button" value="Annulla" onClick="window.location.href='AcqueReteVigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC") %>&orgId=<%=OrgDetails.getOrgId()%>';this.form.dosubmit.value='false';" />
<br>
<dhv:formMessage />
