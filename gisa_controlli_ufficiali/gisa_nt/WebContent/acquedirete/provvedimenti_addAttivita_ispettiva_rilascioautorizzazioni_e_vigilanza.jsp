...
<body>
 <form name="addticket" action="AcqueReteProvvedimenti.do?command=Insert&auto-populate=true" method="post" onsubmit="return controllaForm(this)">
<%-- Trails --%>
<table class="trails" cellspacing="0" >
<tr>
<td>
  <a href="AcqueRete.do?command=SearchForm">Acqua di Rete</a> > 
  <a href="AcqueRete.do?command=Search"><dhv:label name="accounts.SearchResults">Search Results</dhv:label></a> >
  <a href="AcqueRete.do?command=Details&orgId=<%=OrgDetails.getOrgId()%>">Scheda Operatore </a> >
...
<br>
<input type="submit" value="<dhv:label name="button.insert">Insert</dhv:label>" name="Save" class="Save">
<input type="button" value="Annulla" onClick="window.location.href='AccountsVigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC") %>&orgId=<%=OrgDetails.getOrgId()%>';this.form.dosubmit.value='false';" />
</form>
</body>
