...
<form name="addticket" action="AcqueReteNonConformita.do?command=Insert&auto-populate=true" method="post">
<input type = "hidden" id = "dosubmit" name = "dosubmit" value = "0">
<%-- Trails --%>
<table class="trails" cellspacing="0">
<tr>
<td>
<a  href="AcqueRete.do?command=SearchForm"  onclick="return !this.disabled;">AcqueRete</a> > 
<a href="AcqueRete.do?command=Search"  onclick="return !this.disabled;"><dhv:label name="accounts.SearchResults">Search Results</dhv:label></a> >
<a href="AcqueRete.do?command=Details&orgId=<%=OrgDetails.getOrgId()%>"  onclick="return !this.disabled;">Scheda Acque Di Rete</a> >
<a href="AcqueReteVigilanza.do?command=ViewVigilanza&orgId=<%=OrgDetails.getOrgId()%>"  onclick="return !this.disabled;"><dhv:label name="">Controlli Ufficiali</dhv:label></a> >
<a href="AcqueReteVigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC")%>&orgId=<%=OrgDetails.getOrgId()%>"  onclick="return !this.disabled;"><dhv:label name="">Controllo Ufficiale</dhv:label></a> >
...
<table cellpadding="4" cellspacing="0" width="100%" class="details">
 ...
 <input type="hidden" name="idIspezione" value="<%= request.getAttribute("idIspezione")%>">
  ...
  <%if(request.getAttribute("idIspezione")!=null && !request.getAttribute("idIspezione").equals("3")){ %>
            ...
            <input type="hidden" readonly="readonly" name="punteggio" value="" id="totale" title="INUTILE CHE SBAREI : punteggio determinato automaticamente dal sistema">
