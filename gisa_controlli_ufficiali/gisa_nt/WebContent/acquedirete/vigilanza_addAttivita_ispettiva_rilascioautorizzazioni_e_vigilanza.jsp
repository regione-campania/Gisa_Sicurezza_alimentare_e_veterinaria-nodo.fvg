...
<input type="submit" value="Annulla" onClick="javascript:this.form.action='AcqueReteVigilanza.do?command=ViewVigilanza&orgId=<%=OrgDetails.getOrgId()%>'">
<br>
...
<td><font color="red"><b>Si ricorda che per le acque di rete, piano B42, occorre selezionare SOLO uno tra i sottopiani B42_A e B42_B.</b></font></td></tr>
