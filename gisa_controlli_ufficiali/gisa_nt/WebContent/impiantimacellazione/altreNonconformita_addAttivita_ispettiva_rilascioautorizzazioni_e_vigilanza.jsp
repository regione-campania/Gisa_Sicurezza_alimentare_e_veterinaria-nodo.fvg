...
<form name="addticket" action="AccountNonConformita.do?command=Insert&auto-populate=true" method="post">
<%-- Trails --%>
...
<a href="ImpiantiMacellazione.do?command=ViewNonConformita&orgId=<%=OrgDetails.getOrgId() %>"><dhv:label name="nonconformitaa">Non Conformità Rilevate</dhv:label></a> > 
...
<input type="submit" value="Annulla" onClick="javascript:this.form.action='ImpiantiMacellazione.do?command=ViewNonConformita'">
<br>
<dhv:formMessage />
...
function checkImporto(form)
{
  ...
  function updateCategoryList() {
    ...
    var url = 'TroubleTicketsNonConformita.do?command=CategoryJSList&form=addticket&reset=true&orgId='+orgId;
...
<dhv:include name="ticket.catCode" none="false">
  function updateSubList1() {
    ...
    if(orgId != '-1'){
      ...
      var url = "TroubleTicketsNonConformita.do?command=CategoryJSList&form=addticket&catCode=" + escape(value)+'&orgId='+orgId;
      window.frames['server_commands'].location.href=url;
    } else {
      var sel = document.forms['addticket'].elements['catCode'];
...
<dhv:include name="ticket.subCat1" none="true">
  function updateSubList2() {
    ...
    var value = sel.options[sel.selectedIndex].value;
    var url = "TroubleTicketsNonConformita.do?command=CategoryJSList&form=addticket&subCat1=" + escape(value)+'&orgId='+orgId;
    window.frames['server_commands'].location.href=url;
  }
</dhv:include>
<dhv:include name="ticket.subCat2" none="true">
  function updateSubList3() {
    ...
    var value = sel.options[sel.selectedIndex].value;
    var url = "TroubleTicketsNonConformita.do?command=CategoryJSList&form=addticket&subCat2=" + escape(value)+'&orgId='+orgId;
    window.frames['server_commands'].location.href=url;
  }
</dhv:include>
<dhv:include name="ticket.subCat3" none="true">
  function updateSubList4() {
    ...
    var value = sel.options[sel.selectedIndex].value;
    var url = "TroubleTicketsNonConformita.do?command=CategoryJSList&form=addticket&subCat3=" + escape(value)+'&orgId='+orgId;
    window.frames['server_commands'].location.href=url;
  }
</dhv:include>
  ...
  function checkForm(form){
   ...
   // if (form.cause.value == "" && form.NonConformitaAmministrative.value!=-1) {
    ...
    if (form.orgId.value == "-1") {
      message += label("check.nonconformita.richiedente.selezionato","- Controllare che l'osa sia stato selezionato\r\n");
      formTest = false;
    }
    </dhv:include>
...
<dhv:include name="ticket.location" none="true">
  ...
  <tr>
    <td valign="top" class="formLabel">
      <dhv:label name="nonconformita.azioni">Non Conformità formali rilevate</dhv:label>
    </td>
    <td>
      <table border="0" cellspacing="0" cellpadding="0" class="empty">
        <tr>
         ...
         <td>
        <%	Provvedimenti.setJsEvent("onChange=\"javascript:selectCarattere('Provvedimenti1', '1', 2, '1');\"");
        %>
         <%= Provvedimenti.getHtmlSelect("Provvedimenti1",TicketDetails.getProvvedimenti()) %>
        ...
        <td>
          ...
          <td>
            <textarea name="nonConformitaFormali" cols="55" rows="8"><%= toString(TicketDetails.getSolution()) %></textarea>
          </td>
          <td valign="top">
            <%= showAttribute(request, "problemError") %>
          </td>
          <td>
            Punteggio <input type="text" name="puntiFormali" id="puntiFormali" onchange="calcolaTotale()">
          </td>
        </tr>
      </table>
    </td>
  ...
  <tr>
    <td valign="top" class="formLabel">
      <dhv:label name="nonconformita.azioni">Non Conformità significative rilevate</dhv:label>
    </td>
    <td>
      <table border="0" cellspacing="0" cellpadding="0" class="empty">
        <tr>
        <td>
        <%	Provvedimenti.setJsEvent("onChange=\"javascript:selectCarattere('Provvedimenti2', '1', 2, '1');\"");
        %>
         <%= Provvedimenti.getHtmlSelect("Provvedimenti2",TicketDetails.getProvvedimenti()) %>
        ...
        &nbsp;
          ...
          <td>
            <textarea name="nonConformitaSignificative" cols="55" rows="8"><%= toString(TicketDetails.getSolution()) %></textarea>
          </td>
          <td valign="top">
            <%= showAttribute(request, "problemError") %>
          </td>
          <td>
            Punteggio <input type="text" name="puntiSignificativi" id="puntiSignificativi" onchange="calcolaTotale()">
          </td>
        </tr>
      </table>
    </td>
  ...
  <tr>
    <td valign="top" class="formLabel">
      <dhv:label name="nonconformita.azioni">Non Conformita Gravi Rilevate</dhv:label>
    </td>
    <td>
      <table border="0" cellspacing="0" cellpadding="0" class="empty">
        <tr>
        <td>
        <%	Provvedimenti.setJsEvent("onChange=\"javascript:selectCarattere('Provvedimenti3', '1', 2, '1');\"");
        %>
         <%= Provvedimenti.getHtmlSelect("Provvedimenti3",TicketDetails.getProvvedimenti()) %>
        ...
        &nbsp;
          ...
          <td>
            <textarea name="nonConformitaGravi" cols="55" rows="8"><%= toString(TicketDetails.getSolution()) %></textarea>
          </td>
          <td valign="top">
            <%= showAttribute(request, "problemError") %>
          </td>
          <td>
            Punteggio <input type="text" name="puntiGravi" id="puntiGravi" onchange="calcolaTotale()">
          </td>
        </tr>
      </table>
    </td>
  ...
  <tr>
    ...
    <td>
      <table border="0" cellspacing="0" cellpadding="0" class="empty">
        <tr>
          <td>
            <input type="text" name="punteggio" value="" id="totale">
          </td>
