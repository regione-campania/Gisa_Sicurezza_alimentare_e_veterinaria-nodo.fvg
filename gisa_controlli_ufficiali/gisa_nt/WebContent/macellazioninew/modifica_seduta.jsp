<%@page import="org.aspcfs.modules.macellazioninew.base.CategoriaRischio"%>
...
<jsp:useBean id="PartitaPrincipale"				class="org.aspcfs.modules.macellazioninew.base.Partita"			scope="request" />
...
<form name="main" action="MacellazioniNew.do?command=UpdateSeduta" method="post" onsubmit="return controllaForm( false );" >
...
<input type="button" value="Annulla" onclick="location.href='MacellazioniNew.do?command=DetailsSeduta&id=<%=Partita.getId()%>&orgId=<%=OrgDetails.getOrgId()%>';" >
</div><!-- End demo -->
</form>
