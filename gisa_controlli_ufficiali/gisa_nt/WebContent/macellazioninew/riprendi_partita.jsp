	...
	<tr>
		<td>
			...
			<%
					...
					%>
			<a href="MacellazioniNew.do?command=List&orgId=<%=OrgDetails.getOrgId()%>">Macellazioni</a> > Aggiungi Seduta
		</td>
	</tr>
</table>
<%@page import="java.text.SimpleDateFormat"%>
...
<form name="main" action="MacellazioniNew.do?command=RiprendiPartita" method="post" onsubmit="return controllaForm( false );" >
...
%>
	<input id="liberoConsumoButton" type="button" value="Libero Consumo >>" onclick="if(controllaForm( true )){document.main.action='MacellazioniNew.do?command=ToLiberoConsumoSeduta&idPartita=<%=Partita.getId()%>';settaSoloCD('false');document.main.submit();};" />
