...
<jsp:useBean id="Partita"				class="org.aspcfs.modules.macellazioninew.base.PartitaSeduta"			scope="request" />
...
<form name="main" action="MacellazioniNew.do?command=UpdateSedutaEsitoCampioni" method="post" onsubmit="return controllaForm( false );" >
						    ...
						    <td>
						    	<div style="" id="imprese_2">
						        	<a href = "javascript:popLookupSelectorDestinazioneCarni( 'si', 2, 'impresa' );" onclick="selectDestinazione(2);" >[Seleziona Impresa]</a><br/>
						      		...
						      		<a href="javascript:mostraTextareaEsercente('esercenteNoGisa2');" onclick="selectDestinazioneFromLinkTextarea(2);gestisciObbligatorietaVisitaPostMortem();" >[Inserisci Esercente non in G.I.S.A.]</a><br/>
