...
<br>
<form id="main"  name="main" action="MacellazioniNew.do?command=SaveEsitoRichiestaIstopatologico&auto-populate=true<%=addLinkParams(request, "popup|popupType|actionId")%>"
...
<script>
    ...
    function refreshParent() {
        window.opener.location.href='MacellazioniNew.do?command=List&orgId='+<%=richiestaIstopatologico.getCapo().getId_macello()%>+'&tipo=2';
    }  
</script>