...
<%@page import="org.aspcfs.modules.macellazioninew.base.PartitaSeduta"%>
...
<table class="trails" cellspacing="0">
	<tr>
		<td>
			...
			%>
			<a href="MacellazioniNew.do?command=List&orgId=<%=OrgDetails.getOrgId() %>">Macellazioni</a> > Dettaglio Seduta
		</td>
	</tr>
</table>
...
<%
	...
	{
%>
		<%-- 	<a href="MacellazioniDocumentiNew.do?command=EsercentiArt17Sedute&<%=param1 %>&idSeduta=<%=Partita.getId() %>&comboDateMacellazione=<%=toDateasString(Partita.getVpm_data()) %>" style="text-decoration:none"><input type="button" value="Articolo 17"/></a> --%>
...
<dhv:permission name="stabilimenti-stabilimenti-macellazioni-edit">
	...
	onclick="location.href='MacellazioniNew.do?command=ModificaSeduta&id=<%=Partita.getId() %>&orgId=<%=OrgDetails.getOrgId() %>'"
	 />
</dhv:permission>
...
%>
<dhv:permission name="stabilimenti-stabilimenti-macellazioni-edit">
	<input type="button" value="Inserisci Esito Campioni" onclick="location.href='MacellazioniNew.do?command=ModificaSedutaCampioniSenzaEsito&id=<%=Partita.getId() %>&orgId=<%=OrgDetails.getOrgId() %>'" />
</dhv:permission>
<%	
}
