...
function openPopupErrataCorrigeArt17(idCapo, orgId, tipo){
        ...
        if (document.all) {
        	  window.open('MacellazioniDocumentiNew.do?command=ViewModuleErrataCorrigeArt17&orgId='+orgId+'&idCapo='+idCapo+'&tipoMacello='+tipo,'popupSelect',
...
<table class="trails" cellspacing="0">
	<tr>
		<td>
			...
			%>
			<a href="MacellazioniNew.do?command=List&orgId=<%=OrgDetails.getOrgId() %>">Macellazioni</a> > Dettaglio Capo
		</td>
	</tr>
</table>
...
<dhv:permission name="stabilimenti-stabilimenti-macellazioni-edit">
	<input type="button" value="Modifica" onclick="location.href='MacellazioniNew.do?command=ModificaCapo&id=<%=Capo.getId() %>&orgId=<%=OrgDetails.getOrgId() %>'" />
</dhv:permission>

<dhv:permission name="stabilimenti-stabilimenti-macellazioni-delete">
	<input type="button" value="Elimina" onclick="if(confirm('Sicuro di voler eliminare la registrazione?')){location.href='MacellazioniNew.do?command=Delete&id=<%=Capo.getId() %>&orgId=<%=OrgDetails.getOrgId() %>'}" />
</dhv:permission>
<%} else{ 
...
%>
<dhv:permission name="stabilimenti-stabilimenti-macellazioni-edit">
	<input type="button" value="Inserisci Esito Campioni" onclick="location.href='MacellazioniNew.do?command=ModificaCapo&id=<%=Capo.getId() %>&orgId=<%=OrgDetails.getOrgId() %>'" />
</dhv:permission>
<%	
}else
{
