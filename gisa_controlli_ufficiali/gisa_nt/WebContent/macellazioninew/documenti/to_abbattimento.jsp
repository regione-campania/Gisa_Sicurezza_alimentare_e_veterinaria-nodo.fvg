...
<table class="trails" cellspacing="0">
	<tr>
		<td>
			...
			%>
			<a href="MacellazioniNew.do?command=List&orgId=<%=OrgDetails.getOrgId() %>">Macellazioni</a> > Abbattimento
		</td>
	</tr>
</table>
...
<br/><br/>
<form name="main" action="MacellazioniDocumentiNew.do?command=SpeditoriAbbattimento" method="post" >
