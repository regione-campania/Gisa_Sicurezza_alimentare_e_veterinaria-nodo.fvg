...
<jsp:useBean id="Capo"				class="org.aspcfs.modules.macellazioninew.base.Capo"			scope="session" />
...
<form name="main" action="MacellazioniNew.do?command=<%=update ? "Update" : "Save" %>ToLiberoConsumo&id=<%=Capo.getId()%>" method="post" onsubmit="return controllaForm( );">
