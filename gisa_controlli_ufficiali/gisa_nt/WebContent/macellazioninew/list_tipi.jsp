		...
		<tr>
			<td colspan="2">
				...
				<dhv:permission name="stabilimenti-stabilimenti-macellazioni-view">
					<input type="button" name="tipo1" id="tipo1" value="Bovini/Bufalini/Equidi" onclick="location.href='MacellazioniNew.do?command=List&orgId=<%=OrgDetails.getId()%>&tipo=1';" /> <br/>
				</dhv:permission>
				<dhv:permission name="macellazioni-ovicaprini-view">
					<input type="button" name="tipo2"     id="tipo2" value="Ovicaprini"             onclick="location.href='MacellazioniNew.do?command=List&orgId=<%=OrgDetails.getId()%>&tipo=2';" /> <br/>
				</dhv:permission>
...
function checkForm()
{
	...
	{
		location.href='MacellazioniNew.do?command=List&orgId=<%=OrgDetails.getId()%>&tipo='+tipo;	
	}
}
