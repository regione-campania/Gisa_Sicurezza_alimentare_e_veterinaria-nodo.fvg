...
function chgAction( button )
{
    ...
    if( action_name=="old" ) {
        document.getElementById('macellazioniForm').action = 'MacellazioniOpu.do?command=StampeModuli&<%=param1%>';
    }
...
<%--form name="macellazioniForm" action="MacellazioniOpu.do?command=StampeModuli&<%=param1%>" method="post"--%>
...
<dhv:permission name="stabilimenti-stabilimenti-macellazioni-view">
	<a href="MacellazioniDocumentiOpu.do?command=ToRegistroMacellazioni&<%=param1 %>">Registro Macellazioni</a>
</dhv:permission>

<dhv:permission name="stabilimenti-stabilimenti-macellazioni-view">
	<a href="MacellazioniDocumentiOpu.do?command=ToArt17&<%=param1 %>">Articolo 17</a>
</dhv:permission>

<dhv:permission name="stabilimenti-stabilimenti-macellazioni-view">
	<a href="MacellazioniDocumentiOpu.do?command=ToMortiStalla&<%=param1 %>">Anim. morti in stalla/trasporto</a>
</dhv:permission>

<dhv:permission name="stabilimenti-stabilimenti-macellazioni-view">
	<a href="MacellazioniDocumentiOpu.do?command=ToBSE&<%=param1 %>">Modulo BSE</a>
</dhv:permission>\
...
<dhv:permission name="stabilimenti-stabilimenti-macellazioni-view">
	<a href="MacellazioniOpu.do?command=PrintBRCRilevazioneMacelli&file=BRC_rilevazione_macelli.xml&<%=param1 %>">BRC rilevazione macelli</a>
</dhv:permission>

<dhv:permission name="stabilimenti-stabilimenti-macellazioni-view">
	<a href="MacellazioniOpu.do?command=PrintTBCRilevazioneMacelli&file=TBC_rilevazione_macelli.xml&<%=param1 %>">TBC rilevazione macelli</a>
</dhv:permission>
<dhv:permission name="stabilimenti-stabilimenti-macellazioni-view">
	<a href="MacellazioniOpu.do?command=PrintDisinfezioneMezziTrasporto&file=disinfezione_mezzi_di_trasporto.xml&<%=param1 %>">Disinfezione mezzi di trasporto</a>
</dhv:permission>
 --%> 
