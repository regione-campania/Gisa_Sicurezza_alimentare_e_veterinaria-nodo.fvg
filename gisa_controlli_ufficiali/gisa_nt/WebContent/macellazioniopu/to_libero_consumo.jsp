...
<jsp:useBean id="Capo"				class="org.aspcfs.modules.macellazioniopu.base.Capo"			scope="session" />
<jsp:useBean id="Campione"			class="org.aspcfs.modules.macellazioniopu.base.Campione"		scope="request" />
...
<form name="main" action="MacellazioniOpu.do?command=<%=update ? "Update" : "Save" %>ToLiberoConsumo" method="post" onsubmit="return controllaForm( );">
