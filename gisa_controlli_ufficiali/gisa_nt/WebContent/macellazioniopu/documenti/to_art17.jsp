...
<table class="trails" cellspacing="0">
	<tr>
		<td>
			...
			%>
			<a href="MacellazioniOpu.do?command=List&altId=<%=OrgDetails.getAltId() %>">Macellazioni</a> > Articolo 17
		</td>
	</tr>
</table>
...
<br/>
	...
	* Nella combo sono presenti le ultime <%= ApplicationProperties.getProperty("numero_date_macellazione_combo") %> date di macellazione. Per date antecedenti è possibile usare il calendario.
	...
	<form name="main" action="MacellazioniDocumentiOpu.do?command=EsercentiArt17" method="post" >
