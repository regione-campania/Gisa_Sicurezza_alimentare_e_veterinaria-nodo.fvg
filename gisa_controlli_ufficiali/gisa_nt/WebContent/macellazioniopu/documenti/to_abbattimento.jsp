...
<table class="trails" cellspacing="0">
	<tr>
		<td>
			...
			%>
			<a href="MacellazioniOpu.do?command=List&altId=<%=OrgDetails.getAltId() %>">Macellazioni</a> > Abbattimento
		</td>
	</tr>
</table>
...
<br/><br/>
<form name="main" action="MacellazioniDocumentiOpu.do?command=SpeditoriAbbattimento" method="post" >
