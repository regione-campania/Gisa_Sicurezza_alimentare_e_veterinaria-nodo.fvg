...
<table class="trails" cellspacing="0">
	<tr>
		<td>
			...
			%>
			<a href="MacellazioniOpu.do?command=List&altId=<%=OrgDetails.getAltId() %>">Macellazioni</a> > Modulo BSE
		</td>
	</tr>
</table>
...
<br/><br/>
<form name="main" action="MacellazioniDocumentiOpu.do?command=BSE" method="post" >
