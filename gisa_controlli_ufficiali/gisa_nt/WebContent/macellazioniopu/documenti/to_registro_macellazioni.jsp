...
function chgAction( button )
{
    ...
    if( action_name=="old" ) {
        document.getElementById('RegistroMacelliForm').action = 'MacellazioniDocumentiOpu.do?command=RegistroMacellazioni';
        nuoveStampe = false;
    }
...
function openPopupRegistroMacellazioniPdf(altId){
	...
	window.open('MacellazioniDocumentiOpu.do?command=RegistroMacellazioni&altId='+altId+'&notEsitoBSE='+notEsitoBSE+'&ante_macellazione='+ante_macellazione+'&comboDateMacellazione='+date,'popupSelect',
	...
	nuoveStampe = true;
	if (!nuoveStampe){
	window.open('MacellazioniDocumentiOpu.do?command=RegistroMacellazioni&altId='+altId+'&comboDateMacellazione='+date+'&comboSedutaMacellazione='+sedutaMacellazione,'popupSelect',
	'toolbar=no,directories=no,status=no,continued from previous linemenubar=no,scrollbars=no,resizable=no ,modal=yes');}
	else{
		 window.open('GestioneDocumenti.do?command=GeneraPDFMacelli&tipo=Macelli_Registro&altId='+altId+'&comboDateMacellazione='+date+'&comboSedutaMacellazione='+sedutaMacellazione,'popupSelect',
			'toolbar=no,directories=no,status=no,continued from previous linemenubar=no,scrollbars=no,resizable=no ,modal=yes');
...
<table class="trails" cellspacing="0">
	<tr>
		<td>
			...
			%>
			<a href="MacellazioniOpu.do?command=List&altId=<%=OrgDetails.getAltId() %>">Macellazioni</a> > Registro Macellazioni
		</td>
	</tr>
</table>
