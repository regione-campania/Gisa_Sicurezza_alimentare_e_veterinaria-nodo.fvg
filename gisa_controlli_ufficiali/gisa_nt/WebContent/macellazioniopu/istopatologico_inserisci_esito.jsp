...
<br>
<form id="main"  name="main" action="MacellazioniOpu.do?command=SaveEsitoRichiestaIstopatologico&auto-populate=true<%=addLinkParams(request, "popup|popupType|actionId")%>"
...
<%SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");%>
    ...
    function refreshParent() {
        ...
        window.opener.location.href='MacellazioniOpu.do?command=List&sessioneCorrente=<%=dataMacellazione+"-"+richiestaIstopatologico.getCapo().getCd_seduta_macellazione()%>&altId=<%=richiestaIstopatologico.getCapo().getId_macello()%>&tipo=1';
    }  
</script>