...
<!--***************************************************************-->
	...
	<input id="liberoConsumoButton" type="button" value="Libero Consumo >>" onclick="if(controllaForm( true )){document.main.action='MacellazioniOpu.do?command=ToLiberoConsumo';settaSoloCD('false');document.main.submit();};" />
