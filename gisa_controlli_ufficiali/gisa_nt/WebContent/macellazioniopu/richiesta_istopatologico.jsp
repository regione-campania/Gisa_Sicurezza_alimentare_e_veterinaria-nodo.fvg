...
<%@page import="org.aspcfs.modules.macellazioniopu.base.TipoRicerca"%><jsp:useBean
...
<table class="trails" cellspacing="0">
	<tr>
		<td>
			...
			<a href="MacellazioniOpu.do?command=List&altId=<%=OrgDetails.getAltId()%>">Macellazioni Ovicaprini</a> > 
			<a href="MacellazioniOpu.do?command=Details&altId=<%=OrgDetails.getAltId()%>&id=<%=Capo.getId()%>">Dettaglio capo</a>	> Richiesta istopatologico		
		</td>
	</tr>
</table>
<dhv:container
...
<div id="tabs-1">
	...
	<form name="main" action="MacellazioniOpu.do?command=SaveIstopatologico&auto-populate=true<%=addLinkParams(request, "popup|popupType|actionId")%>"
