...
<form name="details" action="<%=TicketDetails.getURlDettaglio() %>AltreNonConformita.do?command=ModifyTicket&auto-populate=true" method="post">
<%-- Trails --%>
...
<%@ include file="../controlliufficiali/opu_header_provvedimenti.jsp"  %>
