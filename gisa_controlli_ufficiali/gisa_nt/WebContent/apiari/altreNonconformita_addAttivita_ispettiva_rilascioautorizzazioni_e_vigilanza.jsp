...
<form name="addticket" action="ApicolturaApiariNonConformita.do?command=Insert&auto-populate=true" method="post">
...
<table cellpadding="4" cellspacing="0" width="100%" class="details">
  ...
  <dhv:evaluate if="<%= SiteIdList.size() <= 1 %>">
	...
	<% if (!"true".equals(request.getParameter("contactSet"))) { %>
        ...
        <input type="hidden" name="id_apiario" value="<%=CU.getIdApiario()%>">
        <input type="hidden" name="idApiario" value="<%=CU.getIdApiario()%>">
