...
<form name="addticket" action="ApicolturaApiariSequestri.do?command=Insert&auto-populate=true" method="post">
<%-- Trails --%>
...
<a href="ApicolturaApiari.do?command=Details&orgId=<%=OrgDetails.getOrgId()%>">Scheda Apiari</a> >
<a href="ApicolturaApiarido?command=ViewVigilanza&orgId=<%=OrgDetails.getOrgId()%>"><dhv:label name="">Controlli Ufficiali</dhv:label></a> >
<a href="ApicolturaApiariVigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC")%>&orgId=<%=OrgDetails.getOrgId()%>"><dhv:label name="">Controllo Ufficiale</dhv:label></a> >
<a href="ApicolturaApiariNonConformita.do?command=TicketDetails&id=<%= request.getAttribute("idNC")%>&orgId=<%=OrgDetails.getOrgId()%>"><dhv:label name="">Non Conformità Rilevata</dhv:label></a> >
...
<input type="button" value="Annulla" onClick="window.location.href='ApicolturaApiariNonConformita.do?command=TicketDetails&id=<%= request.getAttribute("idNC") %>&orgId=<%=OrgDetails.getOrgId()%>';this.form.dosubmit.value='false';" />
<br>
<dhv:formMessage />
...
if(form.tipo_richiesta.value==""){
  ...
  function addNewContact(){
    <dhv:permission name="apicoltura-contacts-add">
      var acctPermission = true;
    </dhv:permission>
    <dhv:permission name="apicoltura-contacts-add" none="true">
