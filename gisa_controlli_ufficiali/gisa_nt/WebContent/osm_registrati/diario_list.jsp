...
<%@ page import="java.util.*,org.aspcfs.modules.osmregistrati.base.*,org.aspcfs.modules.contributo.base.*,org.aspcfs.modules.audit.base.*,org.aspcfs.utils.web.*,org.aspcfs.utils.*" %>
...
<dhv:container name="osm" selected="diario_macellazione" object="OrgDetails" param='<%= "orgId=" + OrgDetails.getOrgId() %>' style="sidetabs" >
	...
	<dhv:evaluate if="<%= !OrgDetails.isTrashed() %>">
		<dhv:permission name="osmregistrati-osmregistrati-diario-add">
