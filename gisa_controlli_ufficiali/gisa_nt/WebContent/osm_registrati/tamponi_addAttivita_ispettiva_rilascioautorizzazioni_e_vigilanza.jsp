...
<body >
<form name="addticket" action="OsmRegistratiTamponi.do?command=Insert&auto-populate=true" method="post">
<%-- Trails --%>
...
<td>
  ...
  <%--a href="OsmRegistrati.do?command=ViewTamponi&orgId=<%=OrgDetails.getOrgId()%>"><dhv:label name="tamponi">Tamponi</dhv:label></a> --%>
...
<input type="submit" value="Annulla" onClick="javascript:this.form.action='OsmRegistratiVigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC")%>&orgId=<%=OrgDetails.getOrgId()%>'">
<br>
<dhv:formMessage />
