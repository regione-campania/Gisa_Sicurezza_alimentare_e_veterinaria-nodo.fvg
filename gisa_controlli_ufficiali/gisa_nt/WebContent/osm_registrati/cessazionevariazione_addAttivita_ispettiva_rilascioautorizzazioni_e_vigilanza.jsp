...
<td>
  ...
  <a href="OsmRegistrati.do?command=ViewCessazionevariazione&orgId=<%=OrgDetails.getOrgId()%>"><dhv:label name="">Cessazioni/Variazioni</dhv:label></a> >
  <dhv:label name="cessazionevariazione.aggiungi">Cessazione</dhv:label>
</td>
</tr>
</table>
<%-- End Trails --%>
<dhv:container name="osm" selected="cessazionevariazione" object="OrgDetails" param='<%= "orgId=" + OrgDetails.getOrgId() %>' appendToUrl='<%= addLinkParams(request, "popup|popupType|actionId") %>'>
...
<dhv:include name="ticket.subCat3" none="true">
  ...
  function checkForm(form){
    ...
    if (form.orgId.value == "-1") {
      message += label("check.campioni.richiedente.selezionato","- Controllare che \"OSM\" sia stato selezionato\r\n");
      formTest = false;
    }
    </dhv:include>
...
<%--</dhv:evaluate>  --%>
  ...
  <tr class="containerBody">
    <td class="formLabel">
      <dhv:label name="sanzioni.richiedente">OSM Richiedente</dhv:label>
    </td>
