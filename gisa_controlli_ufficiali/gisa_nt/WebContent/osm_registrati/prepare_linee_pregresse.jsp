...
<form name="searchAccount" id = "searchAccount" action="OsmRegistrati.do?command=UpdateLineePregresse" method="post">	
...
<% for (int h=1; h<=linee_attivita.size(); h++){ // inizializzo le macroaree   %>
<script>
    document.getElementById("MACROAREA").value=11;
    mostraAttivitaProduttive('attprincipale<%=h%>',2,11, false,-1);
    </script>
<% } %>
