...
<div id="menuServiceContractContainer" class="menu">
  <div id="menuServiceContractContent">
    <table id="menuServiceContractTable" class="pulldown" width="170" cellspacing="0">
      <dhv:permission name="osmregistrati-service-contracts-view">
      ...
      <dhv:permission name="osmregistrati-service-contracts-edit">
      ...
      <dhv:permission name="osmregistrati-service-contracts-delete">
