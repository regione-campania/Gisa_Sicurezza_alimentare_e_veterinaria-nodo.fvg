...
<form name="addticket" action="OsmRegistratiNonConformita.do?command=Insert&auto-populate=true" method="post">
<%-- Trails --%>
...
<a href="OsmRegistrati.do?command=ViewNonConformita&orgId=<%=OrgDetails.getOrgId() %>"><dhv:label name="nonconformita">NonConformita Amministrative</dhv:label></a> > 
...
<input type="submit" value="Annulla" onClick="javascript:this.form.action='OsmRegistrati.do?command=ViewNonConformita'">
<br>
<dhv:formMessage />
...
<dhv:include name="ticket.subCat3" none="true">
  ...
  function addNewContact(){
    <dhv:permission name="osmregistrati-osmregistrati-contacts-add">
      var acctPermission = true;
    </dhv:permission>
    <dhv:permission name="osmregistrati-osmregistrati-contacts-add" none="true">
...
<%--</dhv:evaluate>  --%>
  ...
  <tr>
    <td class="formLabel">
      <dhv:label name="nonconformita.richiedente">OSM</dhv:label>
    </td>
