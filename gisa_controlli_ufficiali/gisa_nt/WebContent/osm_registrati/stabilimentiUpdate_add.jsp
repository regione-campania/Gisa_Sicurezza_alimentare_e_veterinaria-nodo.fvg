...
<td width="100%">
  ...
  <dhv:label name="a">Importa Osm</dhv:label>
</td>
</tr>
</table>
<%-- End Trails --%>
...
<br>
  <a href="OsmRegistrati.do?command=AllImportRecords" > Visualizza Tutti gli Import </a>
  <br><br>
  ...
  <input type="button" value="Annulla" onClick="location.href='OsmRegistrati.do?command=Dashboard'" /><br />
  <dhv:formMessage />
  <br />
</form>
</body>