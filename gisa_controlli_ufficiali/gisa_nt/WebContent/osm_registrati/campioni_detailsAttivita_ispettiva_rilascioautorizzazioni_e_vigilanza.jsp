...
function apriVerbale(idCampione,tipoAnalisi)
{
	...
	document.location.href="OsmRegistratiCampioni.do?command=StampaScheda&tipoAnalisi="+tipoAnalisi+"&idCampione="+idCampione+"&tipoAlimenti="+tipoAlimenti;
...
<form id="details" name="details" action="OsmRegistratiCampioni.do?command=ModifyTicket&auto-populate=true" method="post">
...
<td>
  ...
  <a href="OsmRegistrati.do?command=Details&orgId=<%=TicketDetails.getOrgId()%>">Scheda Osm Registrati</a> >
...
<dhv:container name="osmregistraticampioni" selected="details" object="TicketDetails"
	param="<%= param1 %>"
...
if(request.getAttribute("Messaggio2")!=null)
{
	...
	function doSubmit(idTicket){
		...
		document.details.action="OsmRegistratiCampioni.do?command=Chiudi&id="+idTicket+"&chiudiCu=true'"
