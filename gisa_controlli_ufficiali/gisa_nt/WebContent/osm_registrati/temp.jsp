...
<form name="addticket" action="OsmRegistratiSequestri.do?command=Insert&auto-populate=true" method="post">
<%-- Trails --%>
...
<a href="OsmRegistratiNonConformita.do?command=TicketDetails&id=<%= request.getAttribute("idNC")%>&orgId=<%=OrgDetails.getOrgId()%>"><dhv:label name="">Non Conformità Rilevata</dhv:label></a> >
...
<input type="submit" value="Annulla" onClick="javascript:this.form.action='OsmRegistratiNonConformita.do?command=TicketDetails&id=<%= request.getAttribute("idNC")%>&orgId=<%=OrgDetails.getOrgId()%>'">
<br>
<dhv:formMessage />
