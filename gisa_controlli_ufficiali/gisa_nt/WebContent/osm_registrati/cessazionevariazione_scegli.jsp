...
<td>
  ...
  <a href="OsmRegistrati.do?command=ViewCessazionevariazione&orgId=<%=OrgDetails.getOrgId()%>"><dhv:label name="cessazionevariazione">Tickets</dhv:label></a> >
  <dhv:label name="cessazionevariazione.aggiungi">Aggiungi Cessazione/Variazione Attività</dhv:label>
</td>
</tr>
</table>
<%-- End Trails --%>
...
<table cellpadding="4" cellspacing="0" width="100%" class="details">
	<tr>
    	<th colspan="2">
      		<strong>Cessazione/Variazione</strong>
    	</th>
	</tr>
	...
	<tr> 
    	<td class="formLabel">
   		 ...
   		 <td>
      		<input
      			type="submit"
      			onmouseover="ddrivetip('Variazione')"
      			onmouseout="hideddrivetip()"
      			name="<dhv:label name="richieste.emi">EMI</dhv:label>"
      			value="Variazione"
      			onclick="javascript:this.form.action='OsmCessazionevariazione.do?command=AddTicket&tipo_richiesta=autorizzazione_trasporto_animali_vivi&orgId=<%=OrgDetails.getOrgId()%>'"
      		/>
      		...
      		<input
      			...
      			value="Cessazione"
      			onclick="javascript:this.form.action='OsmCessazionevariazione.do?command=AddTicket&tipo_richiesta=attivita_ispettiva_rilascioautorizzazioni_e_vigilanza&orgId=<%=OrgDetails.getOrgId()%>'"
      		/>
    	</td>
	</tr>
