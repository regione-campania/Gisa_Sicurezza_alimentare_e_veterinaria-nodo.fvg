...
<tr>
<th>GIACENZA REGISTRO CARICO/SCARICO CENTRI DI PRODUZIONE MATERIALE SEMINALE</th>
</tr>
</table>

<table class="detailsSeme" cellpadding="10" cellspacing="10" id ="tblGiacenza" width="100%" style="border-collapse: collapse">
...
<th>TIPO SEME</th>
<th>DOSI PRODOTTE</th>
<th>DOSI ACQUISTATE</th>
<th>DOSI VENDUTE</th>
<th>DOSI DISTRUTTE</th>
<th>GIACENZA</th>
</tr>
...
<!-- <center>  -->
<%-- <input type="button" style="width:250px; height: 50px; font-size: 20px; word-wrap: break-word; display: inline-block;" onclick="exportCSV_7('tblGiacenza', 'GiacenzaSeme_<%=NumRegistrazioneStab %>')" value="Esporta in excel"/> --%>
<!-- </center> -->
