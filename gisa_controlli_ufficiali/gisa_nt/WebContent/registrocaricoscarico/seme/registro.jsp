...
<%@page import="org.aspcfs.modules.registrocaricoscarico.base.seme.*"%>
...
function openPopupExcelRegistro(idRegistro){
	...
	if (dataInizio > dataFine){
	  ...
	  var link = 'GenerazioneExcel.do?command=GetExcel&idRegistro='+idRegistro+'&dataInizio='+dataInizio+'&dataFine='+dataFine+'&tipo_richiesta=registro_seme'; 
...
<table class="detailsSeme" cellpadding="10" cellspacing="10" width="100%">
<tr>
<th>REGISTRO CARICO/SCARICO CENTRI DI PRODUZIONE MATERIALE SEMINALE</th>
</tr>
</table>

<table  class="tablesorter" id = "tablelistaregistriseme">
...
<thead>
		...
		<th data-sorter="false" aria-sort="none" style="-moz-user-select: none;" unselectable="on" aria-controls="table" aria-disabled="false" role="columnheader" scope="col" tabindex="0" data-column="0" data-placeholder="FILTRA" class="filter-match tablesorter-header tablesorter-headerUnSorted"><div class="tablesorter-header-inner">DATA PRODUZIONE/ACQUISTO</div></th>
		...
		<th data-sorter="false" aria-sort="none" style="-moz-user-select: none;" unselectable="on" aria-controls="table" aria-disabled="false" role="columnheader" scope="col" tabindex="0" data-column="0" data-placeholder="FILTRA" class="first-name filter-select"><div class="tablesorter-header-inner">TIPO SEME</div></th>
		<th data-sorter="false" aria-sort="none" style="-moz-user-select: none;" unselectable="on" aria-controls="table" aria-disabled="false" role="columnheader" scope="col" tabindex="0" data-column="0" data-placeholder="FILTRA" class="filter-match tablesorter-header tablesorter-headerUnSorted"><div class="tablesorter-header-inner">DOSI PRODOTTE</div></th>
		<th data-sorter="false" aria-sort="none" style="-moz-user-select: none;" unselectable="on" aria-controls="table" aria-disabled="false" role="columnheader" scope="col" tabindex="0" data-column="0" data-placeholder="FILTRA" class="filter-match tablesorter-header tablesorter-headerUnSorted"><div class="tablesorter-header-inner">DOSI ACQUISTATE</div></th>
		<th data-sorter="false" aria-sort="none" style="-moz-user-select: none;" unselectable="on" aria-controls="table" aria-disabled="false" role="columnheader" scope="col" tabindex="0" data-column="0" data-placeholder="FILTRA" class="filter-match tablesorter-header tablesorter-headerUnSorted"><div class="tablesorter-header-inner">DOCUMENTO TRASPORTO ENTRATA</div></th>
		<th data-sorter="false" aria-sort="none" style="-moz-user-select: none;" unselectable="on" aria-controls="table" aria-disabled="false" role="columnheader" scope="col" tabindex="0" data-column="0" data-placeholder="FILTRA" class="filter-match tablesorter-header tablesorter-headerUnSorted"><div class="tablesorter-header-inner">DATA VENDITA</div></th>
		<th data-sorter="false" aria-sort="none" style="-moz-user-select: none;" unselectable="on" aria-controls="table" aria-disabled="false" role="columnheader" scope="col" tabindex="0" data-column="0" data-placeholder="FILTRA" class="filter-match tablesorter-header tablesorter-headerUnSorted"><div class="tablesorter-header-inner">CODICE DESTINATARIO</div></th>
		<th data-sorter="false" aria-sort="none" style="-moz-user-select: none;" unselectable="on" aria-controls="table" aria-disabled="false" role="columnheader" scope="col" tabindex="0" data-column="0" data-placeholder="FILTRA" class="filter-match tablesorter-header tablesorter-headerUnSorted"><div class="tablesorter-header-inner">DOSI VENDUTE</div></th>
		<th data-sorter="false" aria-sort="none" style="-moz-user-select: none;" unselectable="on" aria-controls="table" aria-disabled="false" role="columnheader" scope="col" tabindex="0" data-column="0" data-placeholder="FILTRA" class="filter-match tablesorter-header tablesorter-headerUnSorted"><div class="tablesorter-header-inner">DOSI DISTRUTTE</div></th>
		<th data-sorter="false" aria-sort="none" style="-moz-user-select: none;" unselectable="on" aria-controls="table" aria-disabled="false" role="columnheader" scope="col" tabindex="0" data-column="0" data-placeholder="FILTRA" class="filter-match tablesorter-header tablesorter-headerUnSorted"><div class="tablesorter-header-inner">DOCUMENTO TRASPORTO USCITA</div></th>
...
<% 
ArrayList<CaricoSeme> listaCarico = Registro.getListaCarico();

for (int i = 0; i< listaCarico.size(); i++){
	CaricoSeme c = (CaricoSeme) listaCarico.get(i); %>

<tr>
<td><%=toHtml(c.getNumRegistrazione()) %> <br/> <b>CARICO</b></td>
<td><%=toDateasStringFromString(c.getDataProduzione()) %></td>
...
<td><%=c.getDosiProdotte()%></td>
<td><%=c.getDosiAcquistate() %></td>
<td><%=toHtml(c.getDocumentoTrasportoEntrata()) %></td>
...
<% if (c.getListaScarico().size() == 0 && c.getTrashedDate() == null){ %>
	<dhv:permission name="registro_carico_scarico_seme-edit">
	...
	<dhv:permission name="registro_carico_scarico_seme-delete">
...
<% if (c.getTrashedDate() == null){ %>
	...
	<dhv:permission name="registro_carico_scarico_seme-add">
...
<% ArrayList<ScaricoSeme> listaScarico = c.getListaScarico();
for (int j = 0; j< listaScarico.size(); j++){
	ScaricoSeme s = (ScaricoSeme) listaScarico.get(j); %>
...
<td><%=toDateasStringFromString(s.getDataVendita()) %></td>
<td><%=toHtml(s.getCodiceDestinatario()) %></td>
<td><%=s.getDosiVendute() %></td>
<td><%=s.getDosiDistrutte() %></td>
<td><%=toHtml(s.getDocumentoTrasportoUscita()) %></td>
...
<br/>
<font color="red"><i>Attenzione. Saranno esportati i record di carico e scarico con Data Produzione/Acquisto e Data Vendita rientranti nell'intervallo selezionato.</i></font>     
