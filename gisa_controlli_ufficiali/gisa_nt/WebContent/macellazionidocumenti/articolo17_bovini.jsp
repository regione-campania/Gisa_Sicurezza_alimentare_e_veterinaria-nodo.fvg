...
<th style="border:1px solid black;text-overflow: ellipsis; overflow: hidden;">Mezz.</th>
<th style="border:1px solid black;text-overflow: ellipsis; overflow: hidden;">Data nascita</th>
