...
<dhv:permission name="gestionepostit_regione-add">
<center>
<a href="MyCFS.do?command=PostItModifica&tipo=2" class="blue">Modifica</a>
</center>
</dhv:permission>
...
Create a CSS3 post-it note without images
-->
<div class="quote-container" id="postit_container">
      <i class="pin"></i>
