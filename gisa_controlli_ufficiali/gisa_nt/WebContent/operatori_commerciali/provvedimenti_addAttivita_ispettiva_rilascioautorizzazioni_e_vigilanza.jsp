...
<body>
 <form name="addticket" action="OperatoriCommercialiProvvedimenti.do?command=Insert&auto-populate=true" method="post" onsubmit="return controllaForm(this)">
<%-- Trails --%>
...
<td>
  ...
  <a href="OperatoriCommerciali.do?command=Details&orgId=<%=OrgDetails.getOrgId()%>">Scheda Operatore </a> >
  ...
  <a href="OperatoriCommercialiOperatoriCommercializa.do?command=TicketDetails&id=<%= request.getAttribute("idC")%>&orgId=<%=OrgDetails.getOrgId()%>"><dhv:label name="">Controllo Ufficiale</dhv:label></a> >
...
<script language="JavaScript" TYPE="text/javascript" SRC="javascript/popOperatoriCommerciali.js"></script>
