...
<form name="addticket" action="OperatoriCommercialiCampioni.do?command=Insert&auto-populate=true" method="post">
<% request.setAttribute("isOperatoreCommerciale", "si"); %>
<%-- Trails --%>
...
<%-- End Trails --%>
<!-- <input type="submit" class="save" id="bottoneInserimentoCampioneSu" value="<dhv:label name="button.insert">Insert</dhv:label>" name="Save" > -->
...
<input type="button" value="Annulla" onClick="window.location.href='OperatoriCommercialiVigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC") %>&orgId=<%=OrgDetails.getOrgId()%>';this.form.dosubmit.value='false';" />
<br>
<dhv:formMessage />
...
<input type = "hidden" name = "macroarea" value = "<%=OrgDetails.getTipologia_operatore() %>">
...
<br>
<!-- <input type="submit" id="bottoneInserimentoCampioneGiu" value="<dhv:label name="button.insert">Insert</dhv:label>" name="Save" class="save"> -->
<!-- <input type="submit" value="<dhv:label name="button.insert">Insert</dhv:label>" name="Save" class="Save"> -->
