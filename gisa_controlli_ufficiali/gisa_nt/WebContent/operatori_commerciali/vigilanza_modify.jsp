...
<tr>
<td>
  <a href="<%=TicketDetails.getURlDettaglio() %>.do"><dhv:label name="">Operatori Commerciali</dhv:label></a> >
...
<%-- End Trails --%>
</dhv:evaluate>  <%--@ include file="accounts_ticket_header_include_vigilanza.jsp" --%>
