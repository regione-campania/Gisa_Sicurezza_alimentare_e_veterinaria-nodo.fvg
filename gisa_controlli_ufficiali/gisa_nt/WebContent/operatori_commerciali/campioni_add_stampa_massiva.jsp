...
<%@page import="java.util.Date"%><jsp:useBean id="OrgDetails" class="org.aspcfs.modules.canili.base.Organization" scope="request"/>
<body onload="controlloLookup();impostaResponsabilita('addticket');">
<form name="addticket" action="CaniliCampioni.do?command=InsertCampioniStampaMassiva&auto-populate=true" method="post">
