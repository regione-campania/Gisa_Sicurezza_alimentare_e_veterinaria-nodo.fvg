...
function openPopupModules(){
	...
	comboDateMacellazione  = document.getElementById("comboDateMacellazione").value ; 
		window.open('PrintModulesHTML.do?command=ViewModello10MacelliSintesis&sessione_macellazione='+sessione_macellazione+'&altId='+altId+'&id_macello='+id_macello+'&url='+url+'&tipo='+tipo+'&comboDateMacellazione='+comboDateMacellazione,'popupSelect',
	...
	<tr>
		<td>
			...
			<%
				...
				{}
			%>
			<a href="MacellazioniSintesis.do?command=List&altId=<%=OrgDetails.getAltId() %>">Macellazioni</a> > Modello 10
		</td>
	</tr>
</table>
...
<br/>
	...
	* Nella combo sono presenti le ultime <%= ApplicationProperties.getProperty("numero_date_macellazione_combo") %> date di macellazione. Per date antecedenti è possibile usare il calendario.
	...
	<input type="hidden" name="url" id="url" value="SintesisStab" />
