	...
	<tr>
		<td>
			...
			<%
				...
				{}
			%>
			<a href="MacellazioniSintesis.do?command=List&altId=<%=OrgDetails.getAltId() %>">Macellazioni</a> > Modulo BSE
		</td>
	</tr>
</table>
...
<br/><br/>
<form name="main" action="MacellazioniDocumentiSintesis.do?command=BSE" method="post" >
