...
<%@page import="org.aspcfs.modules.macellazionisintesis.base.TipoRicerca"%><jsp:useBean
...
<table class="trails" cellspacing="0">
	<tr>
		<td>
			...
			<a href="MacellazioniSintesis.do?command=List&altId=<%=OrgDetails.getAltId()%>">Macellazioni Ovicaprini</a> > 
			<a href="MacellazioniSintesis.do?command=Details&altId=<%=OrgDetails.getAltId()%>&id=<%=Capo.getId()%>">Dettaglio capo</a>	> Richiesta istopatologico		
		</td>
	</tr>
</table>
<dhv:container
...
<div id="tabs-1">
	...
	<form name="main" action="MacellazioniSintesis.do?command=SaveIstopatologico&auto-populate=true<%=addLinkParams(request, "popup|popupType|actionId")%>"
