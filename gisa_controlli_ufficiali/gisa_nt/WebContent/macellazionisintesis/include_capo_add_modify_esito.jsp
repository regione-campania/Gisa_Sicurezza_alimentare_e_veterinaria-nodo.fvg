...
<body onbeforeunload="return gestisciUnload();" onload="gestisciUtenteVeterinario();gestisciRazza();gestisciCategoria();contralla_cd_bse();mostra_tab_test_bse_onload();gestisciBloccoAnimale();displayAbbattimento(); mostraDestinazione();gestisciTabellaNonConformitaVam();">
        ...
        <table class="details" width="100%" border="0" cellpadding="4" cellspacing="0">
           ...
           <%-- <tr class="containerBody">
            	...
            	<td>
            		...
            		<a href="javascript:popLookupSelectorCustomSpeditore('11');"><dhv:label name="">Seleziona Speditore</dhv:label></a>
            		<input type ="hidden" id="cd_id_speditore" name="cd_id_speditore" value="<%=toHtmlValue( Capo.getCd_id_speditore())%>" />
            	</td>
            	<% } %>
...
<!--***************************************************************-->
	...
	<input id="liberoConsumoButton" type="button" value="Libero Consumo >>" onclick="if(controllaForm( true )){document.main.action='MacellazioniSintesis.do?command=ToLiberoConsumo';settaSoloCD('false');document.main.submit();};" />
...
<%--              	<zeroio:dateSelect field="vpm_data" form="main" showTimeZone="false" timestamp="<%=Capo.getVpm_data() %>" />  --%>
			        ...
			        <a href="#" onClick="cal19.select(document.forms[0].vpm_data,'anchor19','dd/MM/yyyy'); return false;" NAME="anchor19" ID="anchor19">
			 		...
			 		<a href="#" style="cursor: pointer;" onclick="svuotaData(document.forms[0].vpm_data);"><img src="images/delete.gif" align="absmiddle"/></a>
              		<input type="hidden" name="cd_seduta_macellazione" id="cd_seduta_macellazione" value="<%=Capo.getCd_seduta_macellazione() %>" />
              </td>
            </tr>
