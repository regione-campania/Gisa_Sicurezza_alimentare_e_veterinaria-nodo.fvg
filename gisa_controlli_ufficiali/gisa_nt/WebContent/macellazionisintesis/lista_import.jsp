...
<jsp:useBean id="listaImport" class="org.aspcfs.modules.macellazionisintesis.base.ImportLogList" scope="request"/>
...
<jsp:useBean id="StabilimentoDettaglio" class="org.aspcfs.modules.sintesis.base.SintesisStabilimento" scope="request"/>
...
<%@page import="org.aspcfs.modules.macellazionisintesis.base.ImportLog"%>
...
<%-- 			<td><a href="#" onClick="openPopup('MacellazioniImportSintesis.do?command=DownloadImport&idImport=<%=log.getId()%>')">Download</a></td>  --%>
		</tr>
		<%} } else {%>
