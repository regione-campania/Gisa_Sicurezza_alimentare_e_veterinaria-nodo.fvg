...
<input type="button" value="allegato 1" onclick="window.open('macellazionidocumenti/all_1_positivi_dubbi_sospeso_tbc.jsp')" />
<input type="button" value="allegato 2" onclick="window.open('macellazionidocumenti/all_2_positivi_all_infetto_tbc.jsp')" />
<input type="button" value="allegato 3" onclick="window.open('macellazionidocumenti/all_3_macellazione_regolare.jsp')" />
<input type="button" value="allegato 4" onclick="window.open('macellazionidocumenti/all_4_macellazione_brc.jsp')" />
<input type="button" value="allegato 5" onclick="window.open('macellazionidocumenti/all_5_macellazione_brc_ao.jsp')" />
<input type="button" value="allegato 6" onclick="window.open('macellazionidocumenti/all_6_macellazione_tbc_ao.jsp')" />
<br>
<br>
