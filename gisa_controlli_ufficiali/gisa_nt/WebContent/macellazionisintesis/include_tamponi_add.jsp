<%@page import="org.aspcfs.modules.macellazionisintesis.base.Capo"%>
<%@page import="org.aspcfs.modules.macellazionisintesis.base.Tampone"%>
...
<table class="details" width="100%" border="0" cellpadding="5" cellspacing="0">
                        <tr>
                                <th colspan="4">Effettuato Tampone <input type = "checkbox" id="checkTampone" <%if(Tampone.getId()>0){%> checked="checked"<%} %> name = "checkTampone" onclick="getCodiceTipoPianoFromCodiceInterno(<%=idPianoMonitoraggioTamponi%>);setTampone(<%=OrgDetails.getAltId() %>,<%=Capo.getCd_seduta_macellazione() %>)" > </th>
                        </tr>
