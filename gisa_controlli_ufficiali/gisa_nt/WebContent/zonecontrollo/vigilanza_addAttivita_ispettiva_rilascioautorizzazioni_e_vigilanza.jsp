...
costruisci_rel_ateco_attivita('<%= OrgDetails.getOrgId() %>', 'id_linea_sottoposta_a_controllo');">
 ...
 <%
    ...
    TipoCampione.setJsEvent("onChange=javascript:reloadAddCU('ZoneControlloVigilanza.do?command=Add&orgId="+OrgDetails.getOrgId()+"&tipoCampione='+this.value)"); 


%>


<form method="post" name="addticket" action="ZoneControlloVigilanza.do?command=Insert&auto-populate=true"  >
<%-- Trails --%>
<table class="trails" cellspacing="0">
<tr>
<td>
  <a href="ZoneControllo.do">Zone di Controllo</a> > 
  <a href="ZoneControllo.do?command=Search"><dhv:label name="">Risultati Ricerca</dhv:label></a> >
  <a href="ZoneControllo.do?command=Details&orgId=<%=OrgDetails.getOrgId()%>">Scheda Zone di Controllo</a> >
...
<input type="submit" value="Annulla" onClick="javascript:this.form.action='ZoneControlloVigilanza.do?command=ViewVigilanza&orgId=<%=OrgDetails.getOrgId()%>'">
<br>
...
<%@ include file="../controlliufficiali/controlli_ufficiali_operatore_zonecontrollo.jsp" %> 
<br><br>
...
<br>
<input type="button" value="<dhv:label name="button.inserta">Inserisci </dhv:label>" name="Save" onClick="<%--javascript:this.form.action='ZoneControlloVigilanza.do?command=InsertContinua&auto-populate=true';--%>return controlloCuSorveglianza()">
<input type="submit" value="Annulla" onClick="javascript:this.form.action='ZoneControlloVigilanza.do?command=ViewVigilanza&orgId=<%=OrgDetails.getOrgId()%>'">
</form>
</body>
