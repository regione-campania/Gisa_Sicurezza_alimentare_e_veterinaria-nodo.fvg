...
<body>
 <form name="addticket" action="ZoneControlloProvvedimenti.do?command=Insert&auto-populate=true" method="post" onsubmit="return controllaForm(this)">
<%-- Trails --%>
...
<td>
  ...
  <a href="ZoneControllo.do?command=Details&orgId=<%=OrgDetails.getOrgId()%>">Scheda Operatore </a> >
...
<script language="JavaScript" TYPE="text/javascript" SRC="javascript/popZoneControllo.js"></script>
