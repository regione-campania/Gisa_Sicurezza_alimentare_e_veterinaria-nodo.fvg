...
<form id="form2" action="GestioneAllegatiUpload.do?command=AllegaLista" method="post" name="form2" enctype="multipart/form-data">
 <table cellpadding="4" cellspacing="0" border="0" width="100%" class="details">
    <tr>
      <th colspan="2">
        <img border="0" src="images/file.gif" align="absmiddle"><b>Carica una nuova lista</b>
      </th>
    </tr>
