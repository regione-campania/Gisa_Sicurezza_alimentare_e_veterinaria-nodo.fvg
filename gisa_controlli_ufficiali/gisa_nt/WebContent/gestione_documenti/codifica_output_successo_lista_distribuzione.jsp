...
function ritornaAllegato (cod, tit){
	window.opener.document.getElementById('allegatoDocumentale').value=cod;
	window.opener.document.getElementById('isAllegato').value='true';
	window.opener.document.getElementById('allegatoDocumentaleNome').innerHTML = tit;
	window.opener.document.getElementById('msg_file').innerHTML = '<font color = "green">File allegato!</font>';
