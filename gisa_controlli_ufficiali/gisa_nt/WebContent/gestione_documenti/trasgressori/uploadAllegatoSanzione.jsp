  <%
	...
	var nome = fileCaricato.value.toLowerCase();
	
	var errorString = '';
	if (fileCaricato.value==''|| !nome.endsWith(".pdf")){
...
<form id="form2" action="GestioneAllegatiTrasgressori.do?command=AllegaFileSanzione" method="post" name="form2" enctype="multipart/form-data">
