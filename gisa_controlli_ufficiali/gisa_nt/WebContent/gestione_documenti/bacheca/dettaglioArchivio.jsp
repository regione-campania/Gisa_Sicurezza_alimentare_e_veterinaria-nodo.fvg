...
<a href="GestioneBacheca.do?command=ListaAllegati&storeId=<%=storeId%>">Contenuto archivio</a> &gt;
...
<a href="GestioneBacheca.do?command=GestisciArchivio&storeId=<%=storeId%>&descrizioneArchivio=<%=split[1] %>&nomeArchivio=<%=split[0] %>&dataInizio=<%=split[2] %>&statoArchivio=<%=split[3] %>&prioritaArchivio=<%=split[9] %>&operazione=modificaArchivio">
Modifica</a>
</dhv:permission>
&nbsp;
