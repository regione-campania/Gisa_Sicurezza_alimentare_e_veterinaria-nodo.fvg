...
function openGestioneDocumenti(orgId, ticketId, tipo, url, idCU){
	var res;
	var result;
		window.open('GestioneDocumenti.do?command=ListaDocumentiByTipo&tipo='+tipo+'&orgId='+orgId+'&ticketId='+ticketId+'&idCU='+idCU+'&url='+url,'popupDocumentale_'+tipo+"_"+orgId+"_"+idCU,
