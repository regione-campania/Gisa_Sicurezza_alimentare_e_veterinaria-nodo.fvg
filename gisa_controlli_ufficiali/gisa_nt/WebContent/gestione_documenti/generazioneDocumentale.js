...
function openRichiestaPDFRicevutaPagoPa(idPagamento, idSanzione, nomeDocumento){
	
	var res;
	var result=
		window.open('GestioneDocumenti.do?command=GeneraPDFRicevutaPagoPa&idPagamento='+idPagamento+'&idSanzione='+idSanzione+'&nomeDocumento='+nomeDocumento,'popupSelectRicevuta'+idPagamento,
		'height=200px,width=842px,left=200px, top=200px,toolbar=no,directories=no,status=no,continued from previous linemenubar=no,scrollbars=yes,resizable=yes ,modal=yes');
		var text = document.createTextNode('GENERAZIONE PDF IN CORSO.');
		span = document.createElement('span');
		span.style.fontSize = "30px";
...
function openRichiestaDownload(codDocumento, nomeDocumento, ignoraCodice){
	
	var res;
	var result=
		window.open('GestioneAllegatiUpload.do?command=DownloadPDF&codDocumento='+codDocumento+'&nomeDocumento='+nomeDocumento+'&ignoraCodice='+ignoraCodice,'popupSelectDownload'+codDocumento,
		'height=200px,width=842px,left=200px, top=200px,toolbar=no,directories=no,status=no,continued from previous linemenubar=no,scrollbars=yes,resizable=yes ,modal=yes');
		var text = document.createTextNode('DOWNLOAD PDF IN CORSO.');
		span = document.createElement('span');
		span.style.fontSize = "30px";
		span.style.fontWeight = "bold";
		span.style.color ="#ff0000";
		span.appendChild(text);
		var br = document.createElement("br");
		var text2 = document.createTextNode('Attendere il download del documento entro qualche secondo...');
		span2 = document.createElement('span');
		span2.style.fontSize = "20px";
		span2.style.fontStyle = "italic";
		span2.style.color ="#000000";
