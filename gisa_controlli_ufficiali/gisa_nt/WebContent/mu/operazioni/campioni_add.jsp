    			...
    			<tr class="containerBody">
    				...
    				<td >
	    				...
	    				%>
	    					...
	    					<input style="width: 50p" type="hidden" name="cmp_note_<%=index %>" value="<%=campione.getNote()  %>" />
	    				<%
	    						break;
	    					case 2:
	    				%>
	    					<%=MolecoleBatteriologico.getHtmlSelect( "cmp_molecole_" + index, campione.getId_molecole() ) %>
	    					<input "width: 50p" type="hidden" name="cmp_note_<%=index %>" value="<%= campione.getNote() %>" />
	    				<%
	    						break;
	    					case 3:
	    				%>
	    					<%=MolecoleParassitologico.getHtmlSelect( "cmp_molecole_" + index, campione.getId_molecole() ) %>
	    					<input type="hidden" name="cmp_note_<%=index %>" value="<%=campione.getNote()  %>" />
	    				<%
	    						break;
	    					case 4:
	    					case 5:
	    				%>
	    					<textarea rows="2" cols="40" name="cmp_note_<%=index %>"><%= campione.getNote() %></textarea>
