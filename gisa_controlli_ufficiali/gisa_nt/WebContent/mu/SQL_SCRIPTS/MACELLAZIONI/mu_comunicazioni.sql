...
GRANT SELECT ON TABLE mu_comunicazioni_non_conformita_rilevate TO report;
GRANT SELECT ON TABLE mu_comunicazioni_non_conformita_rilevate TO usr_ro;

drop table mu_provvedimenti
...
GRANT SELECT ON TABLE mu_comunicazioni_provvedimenti TO report;
...
GRANT SELECT ON TABLE mu_comunicazioni_destinatari TO report;
