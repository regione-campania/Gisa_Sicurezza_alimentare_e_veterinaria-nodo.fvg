...
<%@ page import="java.util.*,java.text.DateFormat,org.aspcfs.modules.stabilimenti.base.*,org.aspcfs.controller.SystemStatus"%>
...
<script language="JavaScript">
  ...
  function checkForm(form) {
    ...
    if(form.partitaIva.value.length<11)
	{
		 message += label("", "- Lunghezza partita IVA errata.\r\n");
	     formTest = false;
	}
...
<body>
<form name="addticket" action="StabilimentiCessazionevariazione.do?command=UpdateTicket&auto-populate=true<%= addLinkParams(request, "popup|popupType|actionId") %>" onSubmit="return checkForm(this);" method="post">
...
<td>
  ...
  <a href="Stabilimenti.do?command=ViewCessazionevariazione&orgId=<%=OrgDetails.getOrgId()%>"><dhv:label name="">Volture</dhv:label></a> >
  <% if (request.getParameter("return") == null) {%>
  <a href="StabilimentiCessazionevariazione.do?command=TicketDetails&id=<%=TicketDetails.getId()%>"><dhv:label name="cessazionevariazionea.dettagli">Scheda Voltura</dhv:label></a> >
  <%}%>
  <dhv:label name="cessazionevariazione.modify">Modifica Voltura</dhv:label>
</td>
</tr>
</table>
<%-- End Trails --%>
...
<dhv:container name="stabilimenti" selected="cessazionevariazione" object="OrgDetails" param='<%= "orgId=" + OrgDetails.getOrgId() %>' appendToUrl='<%= addLinkParams(request, "popup|popupType|actionId") %>'>
    <%--@ include file="accounts_ticket_header_include_cessazionevariazione.jsp" --%>
     <dhv:evaluate if="<%= !TicketDetails.isTrashed() %>" >
      <dhv:evaluate if="<%= TicketDetails.getClosed() != null %>" >
          <dhv:permission name="stabilimenti-stabilimenti-cessazionevariazione-edit">
            <input type="submit" value="<dhv:label name="button.reopen">Reopen</dhv:label>" onClick="javascript:this.form.action='StabilimentiCessazionevariazione.do?command=ReopenTicket&id=<%=TicketDetails.getId()%><%= addLinkParams(request, "popup|popupType|actionId") %>'">
           </dhv:permission>
           <dhv:evaluate if='<%= "list".equals(request.getParameter("return"))%>' >
            <input type="submit" value="Annulla" onClick="javascript:this.form.action='Stabilimenti.do?command=ViewCessazionevariazione&orgId=<%=OrgDetails.getOrgId()%><%= addLinkParams(request, "popup|popupType|actionId") %>'" />
           </dhv:evaluate>
           <dhv:evaluate if='<%= !"list".equals(request.getParameter("return"))%>' >
            <input type="submit" value="Annulla" onClick="javascript:this.form.action='StabilimentiCessazionevariazione.do?command=TicketDetails&id=<%= TicketDetails.getId() %><%= addLinkParams(request, "popup|popupType|actionId") %>'" />
           </dhv:evaluate>
      </dhv:evaluate>
      <dhv:evaluate if="<%= TicketDetails.getClosed() == null %>" >
          <dhv:permission name="stabilimenti-stabilimenti-cessazionevariazione-edit">
 ...
 <tr class="containerBody">
  ...
  <input type="hidden" name="tipo_richiesta" value="attivita_ispettiva_rilascioautorizzazioni_e_vigilanza" />
    ...
    <tr class="containerBody">
      ...
      <td>
              <%= ((OrgDetails.getAccountNumber()!=null)?(toHtmlValue(OrgDetails.getAccountNumber())):(toHtmlValue(OrgDetails.getNumAut()))) %>
      </td>
    </tr>
  </dhv:include>
      <tr class="containerBody">
    ...
    <td>
            <input type="text" size="50" maxlength="80" name="partitaIva" value="<%= toHtmlValue(OrgDetails.getPartitaIva()) %>"><font color="#00FF00"><b>* Inserire la variazione</b></font>
    </td>
  </tr>
  ...
  <dhv:include name="" none="true">
    <tr class="containerBody">
      ...
      <td>
        <input type="text" size="16" name="codiceFiscaleRappresentante" maxlength="300" value="<%= toHtmlValue(TicketDetails.getCodiceFiscaleRappresentante()) %>"><font color="#00FF00"><b>* Inserire la variazione</b></font>
      </td>
    </tr>
  </dhv:include>
    <dhv:include name="" none="true">
    <tr class="containerBody">
      ...
      <td>
        <input type="text" size="50" name="cognomeRappresentante" maxlength="300" value="<%= toHtmlValue(TicketDetails.getCognomeRappresentante()) %>"><font color="#00FF00"><b>* Inserire la variazione</b></font>
      </td>
    </tr>
  </dhv:include>
  ...
  <dhv:include name="" none="true">
    <tr class="containerBody">
      ...
      <td>
        <input type="text" size="50" name="nomeRappresentante" maxlength="300" value="<%= toHtmlValue(TicketDetails.getNomeRappresentante()) %>"><font color="#00FF00"><b>* Inserire la variazione</b></font>
      </td>
    </tr>
  </dhv:include> 
  <tr class="containerBody">
      ...
      <input readonly type="text" id="dataNascitaRappresentante" name="dataNascitaRappresentante" size="10" value="<%= ((TicketDetails.getDataNascitaRappresentante()!=null)?(toHtml(DateUtils.getDateAsString(TicketDetails.getDataNascitaRappresentante(),Locale.ITALY))):("")) %>"/>
  ...
  <tr class="containerBody">
    ...
    <td>
      <input type="text" size="30" maxlength="50" name="luogoNascitaRappresentante" value="<%= toHtmlValue(TicketDetails.getLuogoNascitaRappresentante()) %>"><font color="#00FF00"><b>* Inserire la variazione</b></font>
    </td>
  </tr>
  <dhv:include name="" none="true">
    <tr class="containerBody">
      ...
      <td>
        <input type="text" size="50" name="emailRappresentante" maxlength="300" value="<%= toHtmlValue(TicketDetails.getEmailRappresentante()) %>"><font color="#00FF00"><b>* Inserire la variazione</b></font>
      </td>
    </tr>
  </dhv:include>
  ...
  <dhv:include name="" none="true">
    <tr class="containerBody">
      ...
      <td>
        <input type="text" size="50" name="telefonoRappresentante" maxlength="300" value="<%= ((TicketDetails.getTelefonoRappresentante()!=null)?(TicketDetails.getTelefonoRappresentante()):("")) %>"><font color="#00FF00"><b>* Inserire la variazione</b></font>
      </td>
    </tr>
  </dhv:include>
   <tr class="containerBody">
    ...
    <td>
      <input type="text" size="30" maxlength="50" name="fax" value="<%= TicketDetails.getFax()!=null ? (TicketDetails.getFax()):("") %>"><font color="#00FF00"><b>* Inserire la variazione</b></font>
    </td>
