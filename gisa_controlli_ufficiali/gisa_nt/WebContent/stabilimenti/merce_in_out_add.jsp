...
<table cellpadding="4" cellspacing="0" width="100%" class="details">
  ...
  <tr class="containerBody">
    ...
    <td>
        ...
        [<a href="javascript:popAccountsListSingleNew('id_provenienza','changeaccount_prov', 'showMyCompany=true&filters=all|my|disabled');"><dhv:label name="accountsa.accounts_add.select">Seleziona Stabilimento</dhv:label></a>]
  ...
  <tr class="containerBody">
    ...
    <td>
        ...
        [<a href="javascript:popAccountsListSingleNew('id_destinatario','changeaccount', 'showMyCompany=true&filters=all|my|disabled');"><dhv:label name="accountsa.accounts_add.select">Seleziona Stabilimento</dhv:label></a>]
    </td>
  </tr>
