...
<%@page import="java.sql.Date"%><jsp:useBean id="OrgDetails" class="org.aspcfs.modules.stabilimenti.base.Organization" scope="request"/>
<body onload="controlloLookup();impostaResponsabilita();">
<form name="addticket" action="StabilimentiCampioni.do?command=Insert&auto-populate=true" method="post">
<%-- Trails --%>
<table class="trails" cellspacing="0" >
<tr>
<td>
  <a href="Stabilimenti.do"><dhv:label name="">Stabilimenti</dhv:label></a> > 
  <a href="Stabilimenti.do?command=Search"><dhv:label name="">Risultati Ricerca</dhv:label></a> >
  <a href="Stabilimenti.do?command=Details&orgId=<%=OrgDetails.getOrgId()%>"><dhv:label name="accounts.details">Scheda Allevamento</dhv:label></a> >
...
<input type="button" value="Annulla" onClick="window.location.href='AccountVigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC") %>&orgId=<%=OrgDetails.getOrgId()%>';this.form.dosubmit.value='false';" />
<br>
<dhv:formMessage />
