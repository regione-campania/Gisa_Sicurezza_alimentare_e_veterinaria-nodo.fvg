...
<body >
<form name="addticket" action="StabilimentiTamponi.do?command=Insert&auto-populate=true" method="post">
	...
	<% if (OrgDetails.isOperatoreIttico()) { %>
		<table class="trails" cellspacing="0">
				...
				<td>
					...
					<%--a href="Stabilimenti.do?command=ViewTamponi&orgId=<%=OrgDetails.getOrgId()%>"><dhv:label name="tamponi">Tamponi</dhv:label></a> --%>
...
<input type="submit" value="Annulla" onClick="javascript:this.form.action='StabilimentiVigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC")%>&orgId=<%=OrgDetails.getOrgId()%>'">
<br>
<dhv:formMessage />
...
<script language="JavaScript" TYPE="text/javascript" SRC="javascript/popStabilimenti.js"></script>
