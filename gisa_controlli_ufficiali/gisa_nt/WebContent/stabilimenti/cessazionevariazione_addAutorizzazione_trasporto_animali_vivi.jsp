...
<form name="addticket" action="StabilimentiCessazionevariazione.do?command=InsertTicket&auto-populate=true<%= addLinkParams(request, "popup|popupType|actionId") %>" method="post">
<%-- Trails --%>
...
<input type="submit" value="Invia Richiesta" name="Save" onClick="return checkForm(this.form)">
<input type="submit" value="Annulla" onClick="javascript:this.form.action='Stabilimenti.do?command=ViewCessazionevariazione&orgId=<%=OrgDetails.getOrgId()%>'">
<br>
<dhv:formMessage />
  ...
  <dhv:include name="" none="true">
    <tr class="containerBody">
      ...
      <td>
        ...
        <input type="text" maxlength="16" name="codiceFiscaleRappresentante" maxlength="16"   value="<%= toHtmlValue(OrgDetails.getCodiceFiscaleRappresentante() )%>"><font color="#00FF00"><b>* Inserire la variazione</b></font>
      </td>
    </tr>
  </dhv:include>
    <dhv:include name="" none="true">
    <tr class="containerBody">
      ...
      <td>
        ...
        <input type="text" size="50" name="cognomeRappresentante" maxlength="300" value="<%= toHtml(OrgDetails.getCognomeRappresentante()) %>"><font color="#00FF00"><b>* Inserire la variazione</b></font>
      </td>
    </tr>
  </dhv:include>
  ...
  <dhv:include name="" none="true">
    <tr class="containerBody">
      ...
      <td>
        ...
        <input type="text" size="50" name="nomeRappresentante" maxlength="300" value="<%= toHtml(OrgDetails.getNomeRappresentante()) %>"><font color="#00FF00"><b>* Inserire la variazione</b></font>
      </td>
    </tr>
  </dhv:include> 
  <tr class="containerBody">
      ...
      <input readonly type="text" id="dataNascitaRappresentante" name="dataNascitaRappresentante" size="10" value="<%=toDateString(TicketDetails.getDataNascitaRappresentante()) %>" />
...
%>
  ...
  <br/>
  <input type="hidden" name="statoVoltura" value="0">
