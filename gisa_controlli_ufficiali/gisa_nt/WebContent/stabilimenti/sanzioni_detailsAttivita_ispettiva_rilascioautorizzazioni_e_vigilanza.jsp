...
<a href="StabilimentiNonConformita.do?command=TicketDetails&id=<%= TicketDetails.getId_nonconformita()%>&orgId=<%=TicketDetails.getOrgId()%>"><dhv:label name="">Non Conformità Rilevata</dhv:label></a> >
 <%}
else
{
%>
<a href="StabilimentiAltreNonConformita.do?command=TicketDetails&id=<%= TicketDetails.getId_nonconformita()%>&orgId=<%=TicketDetails.getOrgId()%>"><dhv:label name="">Non Conformità Rilevata</dhv:label></a> >
