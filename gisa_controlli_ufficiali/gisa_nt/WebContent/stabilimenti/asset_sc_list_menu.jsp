...
<div id="menuServiceContractContainer" class="menu">
  <div id="menuServiceContractContent">
    <table id="menuServiceContractTable" class="pulldown" width="170" cellspacing="0">
      <dhv:permission name="stabilimenti-service-contracts-view">
      ...
      <dhv:permission name="stabilimenti-service-contracts-edit">
      ...
      <dhv:permission name="stabilimenti-service-contracts-delete">
