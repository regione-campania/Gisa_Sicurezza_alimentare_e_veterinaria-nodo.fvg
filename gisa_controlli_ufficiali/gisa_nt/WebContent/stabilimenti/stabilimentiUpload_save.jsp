...
<table cellpadding="4" cellspacing="0" border="0" width="50%" class="details">
  <tr>
   ...
   <tr>
      ...
      <td>
        <a href="<%= "logStabilimenti/"+path+"_rpg.txt" %>" ><%= path %></a>
      </td>
    </tr>
    <tr>
      <td nowrap class="formLabel">
      ...
      <td>
        <a href="<%= "logStabilimenti/"+path+"_ok.txt" %>" ><%= path %></a>
      </td>
    </tr>
    <tr>
      <td nowrap class="formLabel">
      ...
      <td>
        <a href="<%= "logStabilimenti/"+path+"_err.txt" %>" ><%= path %></a>
      </td>
    </tr>
 </table>
...
<br>
  ...
  <input type="submit" value="<dhv:label name="global.button.c">Chiudi</dhv:label>" onClick="this.form.action='Stabilimenti.do'" /><br/>
  <dhv:formMessage />
  <br />
</form>
</body>