...
<table class="trails" cellspacing="0">
	<tr>
		<td width="100%"><a href="Stabilimenti.do"><dhv:label
			name="">Stabilimenti</dhv:label></a> > <dhv:label
			name="">Importa Stabilimenti</dhv:label>
		</td>
	</tr>
</table>
<%-- End Trails --%>
...
<table cellpadding="4" cellspacing="0" border="0" width="50%"
	...
	%>
			<tr>
				...
				<td align="right"><a href="<%= "logStabilimenti/"+rImport.get(i).getRiepilogo() %>">Download</a></td>
				<td align="right"><a href="<%= "logStabilimenti/"+rImport.get(i).getErrori() %>">Download</a></td>
				<td align="right"><a href="<%= "logStabilimenti/"+rImport.get(i).getRecordInseriti() %>">Download</a></td>
			</tr>
			<% } %>
		<% } else { %>
