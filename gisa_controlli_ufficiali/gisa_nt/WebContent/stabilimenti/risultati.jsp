    ...
    <td width="50%" valign="top">
      ...
      <table cellpadding="4" cellspacing="0" border="0" width="100%" class="details">
        ...
        <tr>
          ...
          <td class="formLabel">
          	<a href="BlackBerryImportStabilimenti.do?command=Dettaglio&id=<%=bc.getId() %>&idControllo=<%=request.getAttribute("idControllo")%>&idNonConformita=<%=request.getAttribute("idNonConformita") %>&orgId=<%=request.getAttribute("orgId") %>&identificativo=<%=request.getAttribute("identificativo") %>">Scheda</a>
          </td>
        </tr>
        <%
        		}
