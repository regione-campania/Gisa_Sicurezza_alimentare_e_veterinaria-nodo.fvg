...
<tr>
<td>
  <a href="<%=TicketDetails.getURlDettaglio() %>.do"><dhv:label name="">Stabilimenti 853</dhv:label></a> >
  <a href="<%=TicketDetails.getURlDettaglio() %>.do?command=Search"><dhv:label name="accounts.SearchResults">Search Results</dhv:label></a> >
  <a href="<%=TicketDetails.getURlDettaglio() %>.do?command=Details&orgId=<%=OrgDetails.getOrgId()%>"><dhv:label name="">Scheda Stabilimento 853</dhv:label></a> >
