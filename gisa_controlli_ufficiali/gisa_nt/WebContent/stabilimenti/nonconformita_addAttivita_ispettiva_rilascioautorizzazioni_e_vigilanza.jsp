...
<form name="addticket" action="StabilimentiNonConformita.do?command=Insert&auto-populate=true" method="post">
<%-- Trails --%>
...
<a href="Stabilimenti.do?command=ViewNonConformita&orgId=<%=OrgDetails.getOrgId() %>"><dhv:label name="nonconformita">NonConformita Amministrative</dhv:label></a> > 
...
<input type="submit" value="Annulla" onClick="javascript:this.form.action='Stabilimenti.do?command=ViewNonConformita'">
<br>
<dhv:formMessage />
...
<dhv:include name="ticket.subCat3" none="true">
  ...
  function checkForm(form){
   ...
   // if (form.cause.value == "" && form.NonConformitaAmministrative.value!=-1) {
    ...
    if (form.orgId.value == "-1") {
      message += label("check.nonconformita.richiedente.selezionato","- Controllare che lo stabilimento sia stato selezionato\r\n");
      formTest = false;
    }
    </dhv:include>
  ...
  function addNewContact(){
    <dhv:permission name="stabilimenti-stabilimenti-contacts-add">
      var acctPermission = true;
    </dhv:permission>
    <dhv:permission name="stabilimenti-stabilimenti-contacts-add" none="true">
...
<%--</dhv:evaluate>  --%>
  ...
  <tr>
    <td class="formLabel">
      <dhv:label name="nonconformita.richiedente">Stabilimento</dhv:label>
    </td>
