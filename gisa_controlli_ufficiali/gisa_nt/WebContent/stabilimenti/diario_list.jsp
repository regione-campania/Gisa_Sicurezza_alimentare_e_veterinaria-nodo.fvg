...
<%@ page import="java.util.*,org.aspcfs.modules.stabilimenti.base.*,org.aspcfs.modules.contributo.base.*,org.aspcfs.modules.audit.base.*,org.aspcfs.utils.web.*,org.aspcfs.utils.*" %>
...
<dhv:container name="<%=(OrgDetails.isMacelloUngulati()) ? ("stabilimenti_macellazioni_ungulati") : ("stabilimenti") %>" selected="diario_macellazione" object="OrgDetails" param='<%= "orgId=" + OrgDetails.getOrgId() %>' style="sidetabs" >
	
	<dhv:evaluate if="<%= !OrgDetails.isTrashed() %>">
		<dhv:permission name="stabilimenti-stabilimenti-diario-add">
