      ...
      <table cellpadding="4" cellspacing="0" border="0" width="100%" class="details">
        ...
        <tr>
         ...
         <%if(bc.getDataAccettazione()!=null){
          ...
          <td class="formLabel">
          	<a href="BlackBerryImportStabilimenti.do?command=DettaglioCampione&id=<%=bc.getId() %>&idControllo=<%=request.getAttribute("idControllo")%>&orgId=<%=request.getAttribute("orgId") %>&identificativo=<%=request.getAttribute("identificativo") %>">Scheda</a>
          </td>
        </tr>
        <%
        		}
