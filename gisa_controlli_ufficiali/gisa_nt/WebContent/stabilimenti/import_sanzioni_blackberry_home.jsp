...
<form name="searchCameraCommercio" action="BlackBerryImportStabilimenti.do?command=Cerca" method="post">
<%-- Trails --%>
<table class="trails" cellspacing="0">
	<tr>
		<td>
		<a href="Accounts.do"><dhv:label name="accounts.accounts">Non Conformita</dhv:label></a> > 
  
			<dhv:label name="camera_commercio">Sanzioni inserite da Black Berry</dhv:label>> 
			<dhv:label name="camera_commercio.cerca">Cerca</dhv:label>
		</td>
	</tr>
	<% System.out.println("id controllo : "+request.getAttribute("idControllo")); %>
</table>
...
<%
System.out.println("orgid "+request.getAttribute("orgId"));
%>
...
<%System.out.println("identificativo nc : "+request.getAttribute("identificativo") ); %>
