...
<form name="addticket" action="LabHaccpNonConformita.do?command=Insert&auto-populate=true" method="post">
...
<a href="LaboratoriHACCP.do?command=Details&orgId=<%=OrgDetails.getOrgId()%>"  onclick="return !this.disabled;">Scheda Laboratorio Haccp</a> >
 ...
 <a href="LabHaccpVigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC")%>&orgId=<%=OrgDetails.getOrgId()%>"  onclick="return !this.disabled;"><dhv:label name="">Controllo Ufficiale</dhv:label></a> >
