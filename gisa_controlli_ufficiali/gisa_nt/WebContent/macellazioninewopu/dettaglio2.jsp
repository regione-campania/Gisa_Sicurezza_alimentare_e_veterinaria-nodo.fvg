...
function openPopupErrataCorrigeArt17(idPartita, altId, tipo){
        var res;
        var result;
          	  window.open('MacellazioniDocumentiNewOpu.do?command=ViewModuleErrataCorrigeArt17&altId='+altId+'&idPartita='+idPartita+'&tipoMacello='+tipo,'popupSelect',
...
function openPopupListaErrataCorrigeArt17(idPartita, altId, tipo){
        ...
        var result;
        	  ...
        	  window.open('MacellazioniDocumentiNewOpu.do?command=ViewListaModuleErrataCorrigeArt17&altId='+altId+'&idPartita='+idPartita+'&tipoMacello='+tipo,'popupSelect',
              'height=800px,width=1280px,toolbar=no,directories=no,status=no,continued from previous linemenubar=no,scrollbars=yes,resizable=yes ,modal=yes');
 } 
...
function openPopupCancellazionePartita(idPartita){
    var res;
    var result;
   	  window.open('MacellazioniNewOpu.do?command=PrepareCancellazionePartita&idPartita='+idPartita,'popupSelect',
...
<table class="trails" cellspacing="0">
	<tr>
		<td>
			...
			%>
			<a href="MacellazioniNewOpu.do?command=List&altId=<%=OrgDetails.getAltId() %>">Macellazioni</a> > Dettaglio Partita
		</td>
	</tr>
</table>
...
<%
	...
	{
%>
		<%--<a href="MacellazioniDocumentiNewOpu.do?command=EsercentiArt17&<%=param1 %>&id=<%=Partita.getId() %>&comboDateMacellazione=<%=toDateasString(Partita.getVpm_data()) %>" style="text-decoration:none"><input type="button" value="Articolo 17"/></a>--%>
...
<dhv:permission name="stabilimenti-stabilimenti-macellazioni-edit">
	...
	onclick="location.href='MacellazioniNewOpu.do?command=ModificaCapo&id=<%=Partita.getId() %>&altId=<%=OrgDetails.getAltId() %>'"
	 />
</dhv:permission>
...
%>
<dhv:permission name="stabilimenti-stabilimenti-macellazioni-edit">
	<input type="button" value="Inserisci Esito Campioni" onclick="location.href='MacellazioniNewOpu.do?command=ModificaCapo&id=<%=Partita.getId() %>&altId=<%=OrgDetails.getAltId() %>'" />
</dhv:permission>
<%	
}
