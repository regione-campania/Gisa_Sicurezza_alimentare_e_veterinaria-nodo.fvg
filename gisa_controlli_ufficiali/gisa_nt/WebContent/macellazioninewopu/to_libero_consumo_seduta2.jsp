...
<form name="main" action="MacellazioniNewOpu.do?command=<%=update ? "Update" : "Save" %>ToLiberoConsumoSeduta&id=<%=Partita.getId()%>" method="post" onsubmit="return controllaForm( );">
