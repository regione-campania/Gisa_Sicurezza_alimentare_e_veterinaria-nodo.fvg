<%@page import="org.aspcfs.modules.macellazioninewopu.base.Capo"%>
...
<jsp:useBean id="CapoLog"			class="org.aspcfs.modules.macellazioninewopu.base.CapoLog"		scope="request" />
	...
	<tr>
		<td>
			...
			<%
					...
					%>
			<a href="MacellazioniNewOpu.do?command=List&altId=<%=OrgDetails.getAltId()%>">Macellazioni</a> > <%= update ? "Modifica Capo" : "Aggiungi Capo" %>
		</td>
	</tr>
</table>
<%@page import="java.text.SimpleDateFormat"%>
...
<table width="100%" border="0" cellpadding="2" cellspacing="2">
    ...
    <tr>
     ...
     <%--          		<zeroio:dateSelect field="cd_data_nascita" form="main" showTimeZone="false" timestamp="<%=Capo.getCd_data_nascita() %>" /><font color="red" >*</font> --%>
			      	<input readonly type="text" name="cd_data_nascita" size="10" value="<%=DateUtils.timestamp2string(((Capo)Capo).getCd_data_nascita())%>" />&nbsp;
