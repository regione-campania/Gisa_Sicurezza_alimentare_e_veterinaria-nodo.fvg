...
<jsp:useBean id="Capo"				class="org.aspcfs.modules.macellazioninewopu.base.Capo"			scope="session" />
...
<form name="main" action="MacellazioniNewOpu.do?command=<%=update ? "Update" : "Save" %>ToLiberoConsumo&id=<%=Capo.getId()%>" method="post" onsubmit="return controllaForm( );">
