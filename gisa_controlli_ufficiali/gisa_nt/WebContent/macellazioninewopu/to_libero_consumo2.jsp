...
<%@page import="org.aspcfs.modules.contacts.base.Contact"%><jsp:useBean id="OrgDetails"		class="org.aspcfs.modules.opu.base.Stabilimento"	scope="request" />
...
<form name="main" action="MacellazioniNewOpu.do?command=<%=update ? "Update" : "Save" %>ToLiberoConsumo&id=<%=Partita.getId()%>" method="post" onsubmit="return controllaForm( );">
