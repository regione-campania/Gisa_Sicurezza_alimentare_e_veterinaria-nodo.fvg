...
<jsp:useBean id="Partita"				class="org.aspcfs.modules.macellazioninewopu.base.PartitaSeduta"			scope="request" />
	...
	<tr>
		<td>
			...
			<%
					...
					%>
			<a href="MacellazioniNewOpu.do?command=List&altId=<%=OrgDetails.getAltId()%>">Macellazioni</a> > <%= update ? configTipo4.getNomeFunzioneModificaCapo() : configTipo4.getNomeFunzioneAggiungiCapo() %>
		</td>
	</tr>
</table>
...
<form name="main" action="MacellazioniNewOpu.do?command=UpdateSedutaEsitoCampioni" method="post" onsubmit="return controllaForm( false );" >
...
<!--***************************************************************-->
	...
	<input id="liberoConsumoButton" type="button" value="Libero Consumo >>" onclick="if(controllaForm( true )){document.main.action='MacellazioniNewOpu.do?command=ToLiberoConsumo';settaSoloCD('false');document.main.submit();};" />
