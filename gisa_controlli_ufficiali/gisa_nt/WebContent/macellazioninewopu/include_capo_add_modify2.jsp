	...
	<tr>
		<td>
			...
			<%
					...
					%>
			<a href="MacellazioniNewOpu.do?command=List&altId=<%=OrgDetails.getAltId()%>">Macellazioni</a> > <%= update ? "Modifica Partita" : "Aggiungi Partita" %>
		</td>
	</tr>
</table>
<%@page import="java.text.SimpleDateFormat"%>
...
<jsp:useBean id="PartitaLog"			class="org.aspcfs.modules.macellazioninewopu.base.PartitaLog"		scope="request" />
...
<form name="main" action="MacellazioniNewOpu.do?command=<%=(update) ? ("Update") : ("Save") %>" method="post" onsubmit="return controllaForm( false );" >
...
%>
	<input id="liberoConsumoButton" type="button" value="Libero Consumo >>" onclick="if(controllaForm( true )){document.main.action='MacellazioniNewOpu.do?command=ToLiberoConsumo&fromModifica=si';settaSoloCD('false');document.main.submit();};" />
...
<dhv:evaluate if="<%= update==true%>">
<input type="button" value="Annulla" onclick="location.href='MacellazioniNewOpu.do?command=Details&id=<%=Partita.getId()%>&altId=<%=OrgDetails.getAltId()%>';" >
</dhv:evaluate>
