...
<table class="trails" cellspacing="0">
	<tr>
		<td>
			...
			%>
			<a href="MacellazioniNewOpu.do?command=List&altId=<%=OrgDetails.getAltId() %>">Macellazioni</a> > Abbattimento
		</td>
	</tr>
</table>
...
<br/><br/>
	...
	<form name="macellazioniForm" action="MacellazioniDocumentiNewOpu.do">
		<input type="hidden" name="command" value="SpeditoriAbbattimento" />
	 ...
	 <script type="text/javascript">
            ...
            function onInvokeExportAction(id) {
                ...
                location.href = 'MacellazioniDocumentiNewOpu.do?command=SpeditoriAbbattimento&' + parameterString;
            }
    </script>
