...
<dhv:permission name="stabilimenti-stabilimenti-macellazioni-add">
	<a href="MacellazioniNewOpu.do?command=NuovoCapo&<%=param1 %>" style="text-decoration:none"><input type="button" value="Aggiungi partita"/></a>
</dhv:permission>

<dhv:permission name="stabilimenti-stabilimenti-macellazioni-view">
	<a href="MacellazioniDocumentiNewOpu.do?command=ToRegistroMacellazioni&<%=param1 %>" style="text-decoration:none"><input type="button" value="Registro macellazioni"/></a>
</dhv:permission>

<dhv:permission name="stabilimenti-stabilimenti-macellazioni-view">
	<a href="MacellazioniDocumentiNewOpu.do?command=ToArt17&<%=param1 %>" style="text-decoration:none"><input type="button" value="Articolo 17"/></a>
</dhv:permission>

<dhv:permission name="stabilimenti-stabilimenti-macellazioni-view">
	<!-- a href="MacellazioniDocumentiNewOpu.do?command=ToMod10&<%=param1 %>" style="text-decoration:none"><input type="button" value="Modello 10"/></a -->
</dhv:permission>
...
%>
<form name="macellazioniForm" action="MacellazioniNewOpu.do?command=List" method="post">
...
<br/>
	 ...
	 <script type="text/javascript">
            ...
            {
            	window.open('MacellazioniNewOpu.do?command=ToChiudiPartita&id=' + id + '&altId=' + id_mac ,'Chiudi Partita','width=1000, height=500,toolbar=no,directories=no,status=no,continued from previous linemenubar=no,scrollbars=no,resizable=no ,modal=yes');
            }
            function toMostraMotivazioni(id,id_mac)
            {
            	window.open('MacellazioniNewOpu.do?command=ToMostraMotivazioni&id=' + id + '&altId=' + id_mac ,'Motivazioni Chiusura','width=1000, height=500,toolbar=no,directories=no,status=no,continued from previous linemenubar=no,scrollbars=no,resizable=no ,modal=yes');
            }
     </script>
