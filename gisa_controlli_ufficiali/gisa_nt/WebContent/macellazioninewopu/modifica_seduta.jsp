...
<jsp:useBean id="PartitaPrincipale"				class="org.aspcfs.modules.macellazioninewopu.base.Partita"			scope="request" />
	...
	<tr>
		<td>
			...
			<%
					...
					%>
			<a href="MacellazioniNewOpu.do?command=List&altId=<%=OrgDetails.getAltId()%>">Macellazioni</a> > <%= update ? "Modifica Seduta" : "Aggiungi Seduta" %>
		</td>
	</tr>
</table>
<%@page import="java.text.SimpleDateFormat"%>
...
<form name="main" action="MacellazioniNewOpu.do?command=UpdateSeduta" method="post" onsubmit="return controllaForm( false );" >
...
<input type="button" value="Annulla" onclick="location.href='MacellazioniNewOpu.do?command=DetailsSeduta&id=<%=Partita.getId()%>&altId=<%=OrgDetails.getAltId()%>';" >
</div><!-- End demo -->
</form>
