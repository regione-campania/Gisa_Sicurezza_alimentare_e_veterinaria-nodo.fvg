...
function openPopupErrataCorrigeArt17(idCapo, altId, tipo){
        ...
        if (document.all) {
        	  window.open('MacellazioniDocumentiNewOpu.do?command=ViewModuleErrataCorrigeArt17&altId='+altId+'&idCapo='+idCapo+'&tipoMacello='+tipo,'popupSelect',
...
<table class="trails" cellspacing="0">
	<tr>
		<td>
			...
			%>
			<a href="MacellazioniNewOpu.do?command=List&altId=<%=OrgDetails.getAltId() %>">Macellazioni</a> > Dettaglio Capo
		</td>
	</tr>
</table>
...
<dhv:permission name="stabilimenti-stabilimenti-macellazioni-edit">
	<input type="button" value="Modifica" onclick="location.href='MacellazioniNewOpu.do?command=ModificaCapo&id=<%=Capo.getId() %>&altId=<%=OrgDetails.getAltId() %>'" />
</dhv:permission>

<dhv:permission name="stabilimenti-stabilimenti-macellazioni-delete">
	<input type="button" value="Elimina" onclick="if(confirm('Sicuro di voler eliminare la registrazione?')){location.href='MacellazioniNewOpu.do?command=Delete&id=<%=Capo.getId() %>&altId=<%=OrgDetails.getAltId() %>'}" />
</dhv:permission>
<%} else{ 
...
%>
<dhv:permission name="stabilimenti-stabilimenti-macellazioni-edit">
	<input type="button" value="Inserisci Esito Campioni" onclick="location.href='MacellazioniNewOpu.do?command=ModificaCapo&id=<%=Capo.getId() %>&altId=<%=OrgDetails.getAltId() %>'" />
</dhv:permission>
<%	
}else
{
