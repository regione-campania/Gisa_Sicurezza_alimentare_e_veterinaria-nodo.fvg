...
<body>
 <form name="addticket" action="OpnonAltroveProvvedimenti.do?command=Insert&auto-populate=true" method="post" onsubmit="return controllaForm(this)">
<%-- Trails --%>
...
<td>
  ...
  <a href="OpnonAltrove.do?command=Details&orgId=<%=OrgDetails.getOrgId()%>">Scheda Operatore </a> >
...
<input type="button" value="Annulla" onClick="window.location.href='OpnonAltroveVigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC") %>&orgId=<%=OrgDetails.getOrgId()%>';this.form.dosubmit.value='false';" />
<br>
<dhv:formMessage />
...
<script language="JavaScript" TYPE="text/javascript" SRC="javascript/popOpnonAltrove.js"></script>
