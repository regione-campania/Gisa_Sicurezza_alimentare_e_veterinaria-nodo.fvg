...
<form name="addticket" action="CaniliCampioni.do?command=Insert&auto-populate=true" method="post">
<% request.setAttribute("isCanile", "si"); %>
<%-- Trails --%>
...
<input type="button" value="Annulla" onClick="window.location.href='CaniliVigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC") %>&orgId=<%=OrgDetails.getOrgId()%>';this.form.dosubmit.value='false';" />
<br>
<dhv:formMessage />
...
<br>
<!-- <input type="submit" class= "save" id="bottoneInserimentoCampioneGiu" value="<dhv:label name="button.insert">Insert</dhv:label>" name="save" > -->
<!-- <input type="submit" value="<dhv:label name="button.insert">Insert</dhv:label>" name="Save" class="Save"> -->
