...
function apriVerbale(idCampione,tipoAnalisi)
{
	...
	document.location.href="CaniliCampioni.do?command=StampaScheda&tipoAnalisi="+tipoAnalisi+"&idCampione="+idCampione+"&tipoAlimenti="+tipoAlimenti;
		
}
</script>

<%@ include file="../utils23/initPage.jsp" %>
<form id="details" name="details" action="CaniliCampioni.do?command=ModifyTicket&auto-populate=true" method="post">
...
if(TicketDetails.getCodiceInternPiano()!= null && TicketDetails.getCodiceInternPiano().equals(String.valueOf(pianoBenessereAnimale)))
{
	...
	nomeContainer = "canilicampioni" ;
}
else
{
	param1 = "orgId=" + OrgDetails.getOrgId(); 
	nomeContainer = "canili" ;
}
%>
...
if(request.getAttribute("Messaggio2")!=null)
{
	...
	function doSubmit(idTicket){
		...
		document.details.action="CaniliCampioni.do?command=Chiudi&id="+idTicket+"&chiudiCu=true'"
