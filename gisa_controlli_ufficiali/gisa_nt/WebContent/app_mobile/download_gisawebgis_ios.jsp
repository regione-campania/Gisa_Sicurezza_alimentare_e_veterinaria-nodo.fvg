...
<table class="trails" cellspacing="0">
	<tr>
		<td>
			<a href="DownloadAppMobile.do?command=SuiteAppMobile">SUITE APP MOBILE GISA</a> > APP MOBILE IOS GISA WEBGIS
		</td>
	</tr>
</table>
...
<center>
	<h2>Download app iOS GISA WEBGIS</h2>
	Per installare l'app GISA WEBGIS verificare che sul proprio smartphone iOS sia installata l'app iTunes 
	dopodichè basta scansionare il seguente qr-code oppure <br>
	...
	<font color="red">
		...
		&#8226; se l'app è stata già scaricata sullo stesso smartphone, andare in App Store -> Account -> Acquisti e riscaricare l'app GISA WebGIS <br>
		&#8226; rigenerare il qr-code/codice mediante il seguente link:
		<a href="#" 
		   onclick="loadModalWindowCustom('Attendere Prego...'); window.location.href='DownloadAppMobile.do?command=RigeneraAppMobileIosGisaWebGis'"  
