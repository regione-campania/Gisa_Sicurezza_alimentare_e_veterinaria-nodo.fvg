...
<table  class="tablesorter" id ="tablelistanucleo" >
	<thead>
		<tr class="tablesorter-headerRow" role="row">
			...
			<th aria-label="Qualifica ( filter-match ): No sort applied, activate to apply an ascending sort" aria-sort="none" style="-moz-user-select: none;" unselectable="on" aria-controls="table" aria-disabled="false" role="columnheader" scope="col" tabindex="0" data-column="2" data-placeholder="FILTRO PER QUALIFICA" class="filter-match tablesorter-header tablesorter-headerUnSorted"><div class="tablesorter-header-inner">QUALIFICA</th>
			<th aria-label="Profilo ( filter-match ): No sort applied, activate to apply an ascending sort" aria-sort="none" style="-moz-user-select: none;" unselectable="on" aria-controls="table" aria-disabled="false" role="columnheader" scope="col" tabindex="0" data-column="3" data-placeholder="FILTRO PER PROFILO PROFESSIONALE" class="filter-match tablesorter-header tablesorter-headerUnSorted"><div class="tablesorter-header-inner">PROFILO PROFESSIONALE</th>
			<th  role="columnheader" scope="col" tabindex="0" class="filter-false tablesorter-header" data-column="4" ><div class="tablesorter-header-inner">&nbsp;</div></th>
