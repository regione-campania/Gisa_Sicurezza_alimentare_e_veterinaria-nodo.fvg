...
<!-- BOTTONI -->
<%-- <%@ include file="header_cu_bottoni_opu_old.jsp"%> --%>

<%@ include file="header_cu_bottoni_opu.jsp"%>
<!-- BOTTONI -->
...
function checkFormSupervisione()
{
	...
	window.location.href="<%=OrgDetails.getAction() %>Vigilanza.do?command=Supervisiona&idStabilimento=<%=TicketDetails.getIdStabilimento()%>&id=<%= TicketDetails.getId() %>&orgId=<%=TicketDetails.getIdStabilimento()%>&flag_supervisione_efficace="+flag_supervisione_efficace+"&supervisione_note="+supervisione_note;
	<% } else { %>
	window.location.href="<%=OrgDetails.getAction() %>Vigilanza.do?command=Supervisiona&idStabilimento=<%=TicketDetails.getIdApiario()%>&id=<%= TicketDetails.getId() %>&orgId=<%=TicketDetails.getIdApiario()%>&flag_supervisione_efficace="+flag_supervisione_efficace+"&supervisione_note="+supervisione_note;
	<% } %>
