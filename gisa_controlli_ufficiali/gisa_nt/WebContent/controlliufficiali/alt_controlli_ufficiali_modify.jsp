...
<SCRIPT LANGUAGE="JavaScript" ID="js19">
	...
	cal19.showNavigationDropdowns();
        ...
        if (document.details.assignedDate.value == '')
        	...
        	if (document.details.altId!=null)
        ...
        PopolaCombo.controlloInserimentoCuSorveglianzaAlt(altId, isPianomonitoraggio,isSorveglianza,document.details.assignedDate.value,assetId, {callback:viewMessageCallback1,async:false } );
        return formTest;
        }
