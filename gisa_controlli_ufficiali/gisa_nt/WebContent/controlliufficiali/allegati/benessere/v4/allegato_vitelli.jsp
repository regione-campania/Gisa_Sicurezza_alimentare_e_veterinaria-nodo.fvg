...
<center>
<b>PROTEZIONE DEGLI ANIMALI IN ALLEVAMENTO - VITELLI</b><br/>
...
<table cellpadding="10" width="100%">
<tr><td>
Numero totale dei vitelli presenti <input type="number" id="numVitelli" name="numVitelli" style="width: 4em" class="editField" value="<%=(ChecklistIstanza!=null && ChecklistIstanza.getNumVitelli()!=null) ? toHtml(ChecklistIstanza.getNumVitelli()) : ""%>" size="4"/> Numero dei vitelli di eta' < a 8 settimane <input type="number" id="numVitelli8Sett" name="numVitelli8Sett" style="width: 4em" class="editField" value="<%=(ChecklistIstanza!=null && ChecklistIstanza.getNumVitelli8Sett()!=null) ? toHtml(ChecklistIstanza.getNumVitelli8Sett()) : ""%>" size="4"/><br/>
Capacita' massima vitelli <input type="number" id="numVitelliMax" name="numVitelliMax" style="width: 4em" class="editField" value="<%=(ChecklistIstanza!=null && ChecklistIstanza.getNumVitelliMax()!=null) ? toHtml(ChecklistIstanza.getNumVitelliMax()) : ""%>" size="4"/>
</td></tr>
</table>
