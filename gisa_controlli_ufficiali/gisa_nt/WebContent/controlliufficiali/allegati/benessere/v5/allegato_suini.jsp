...
Indirizzo sede legale <label class="layout"><%=(Allevamento.getIndirizzo_legale()!=null && !Allevamento.getIndirizzo_legale().equalsIgnoreCase("null")) ? Allevamento.getIndirizzo_legale() : "___________"%></label><br/>
Responsabile legale <label class="layout"><%=(Allevamento.getProp()!=null && !Allevamento.getProp().equalsIgnoreCase("null")) ? Allevamento.getProp() : "___________"%></label> codice fiscale <label class="layout"><%=Allevamento.getCodice_fiscale()%></label><br/>
