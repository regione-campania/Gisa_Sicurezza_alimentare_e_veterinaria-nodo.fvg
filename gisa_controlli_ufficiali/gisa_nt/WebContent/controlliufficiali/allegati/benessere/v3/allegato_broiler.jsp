...
<jsp:useBean id="ChecklistIstanza" class="org.aspcf.modules.checklist_benessere.base.v3.ChecklistIstanza_Generica" scope="request"/>

<%@page import="org.aspcf.modules.checklist_benessere.base.*"%>

<link rel="stylesheet" type="text/css" media="screen" documentale_url="" href="controlliufficiali/allegati/benessere/v3/css/screen.css" />
<link rel="stylesheet" type="text/css" media="print" documentale_url="" href="controlliufficiali/allegati/benessere/v3/css/print.css" />
...
<center>
<b>PROTEZIONE DEGLI ANIMALI IN ALLEVAMENTO - BROILER</b><br/>
RISULTATI DEI CONTROLLI EFFETTUATI PRESSO LE AZIENDE<br/>
(D.Lgs. 146/2001 - D.Lgs. 267/2003 e succ. modifiche)<br/>
DECISIONE DELLA COMMISSIONE 2006/778/CE del 14 novembre 2006<br/>
</center> 
...
Fase produttiva <input type="radio" id="flagFaseProduttiva_-" name="flagFaseProduttiva" value="" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getFlagFaseProduttiva()).equals("")) ? "checked=\"checked\"" : ""%>/> N.D.  <input type="radio" id="flagFaseProduttiva_D" name="flagFaseProduttiva" value="D" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getFlagFaseProduttiva()).equals("D")) ? "checked=\"checked\"" : ""%>/> Fase deposizione <input type="radio" id="flagFaseProduttiva_P" name="flagFaseProduttiva" value="P" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getFlagFaseProduttiva()).equals("P")) ? "checked=\"checked\"" : ""%>/> Fase pollastra <br/> 
</td></tr>
</table>
...
<tr><td>
Numero capi presenti in BDN (sulla base delle registrazioni effettuate nel sistema): <input type="text" size="5" maxlength="5" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" id="numCapiPresenti" name="numCapiPresenti" style="width: 4em" class="editField" value="<%=(ChecklistIstanza!=null && ChecklistIstanza.getNumCapiPresenti()!=null) ? toHtml(ChecklistIstanza.getNumCapiPresenti()) : ""%>"/><br/>
Capacita massima di allevamento autorizzata dalla ASL competente per il territorio:<br/>
<input type="radio" id="capacitaMassimaAllevamento_33" name="capacitaMassimaAllevamento" value="A" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getCapacitaMassimaAllevamento()).equals("A")) ? "checked=\"checked\"" : ""%>/> 33 kg/mq
<input type="radio" id="capacitaMassimaAllevamento_39" name="capacitaMassimaAllevamento" value="B" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getCapacitaMassimaAllevamento()).equals("B")) ? "checked=\"checked\"" : ""%>/> 39 kg/mq
<input type="radio" id="capacitaMassimaAllevamento_42" name="capacitaMassimaAllevamento" value="C" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getCapacitaMassimaAllevamento()).equals("C")) ? "checked=\"checked\"" : ""%>/> 42 kg/mq
<br/> 
...
<table cellpadding="10" width="100%">
<tr><th colspan="4">Elenco capannoni</th></tr>
<tr>
<td><b>Numero</b></td>
...
<tr>
<td><input type="text" id="cap_<%=c%>_numero" name="cap_<%=c%>_numero" maxlength="15" class="editField" value="<%=(ChecklistIstanza!=null && ChecklistIstanza.getCapannoni().size()>c && ChecklistIstanza.getCapannoni().get(c)!=null) ? toHtml(ChecklistIstanza.getCapannoni().get(c).getNumero()) : ""%>" size="5"/></td>
<td><input type="text" size="5" maxlength="5" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" id="cap_<%=c%>_capacita" name="cap_<%=c%>_capacita" style="width: 4em" class="editField" value="<%=(ChecklistIstanza!=null && ChecklistIstanza.getCapannoni().size()>c && ChecklistIstanza.getCapannoni().get(c)!=null) ? toHtml(ChecklistIstanza.getCapannoni().get(c).getCapacita()) : ""%>"/></td>
<td><input type="text" size="5" maxlength="5" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" id="cap_<%=c%>_animali" name="cap_<%=c%>_animali" style="width: 4em" class="editField" value="<%=(ChecklistIstanza!=null && ChecklistIstanza.getCapannoni().size()>c && ChecklistIstanza.getCapannoni().get(c)!=null) ? toHtml(ChecklistIstanza.getCapannoni().get(c).getAnimali()) : ""%>"/></td>
...
for (int i = 0; i<DomandeList.size(); i++) {
	org.aspcf.modules.checklist_benessere.base.v3.Domanda domanda = (org.aspcf.modules.checklist_benessere.base.v3.Domanda) DomandeList.get(i);
	org.aspcf.modules.checklist_benessere.base.v3.Risposta risposta = (org.aspcf.modules.checklist_benessere.base.v3.Risposta) domanda.getRisposta();
%>
...
<td> <input type="text" size="4" maxlength="4" onChange="filtraInteri(this); aggiornaIrregolarita('<%=domanda.getId()%>')" onKeyUp="filtraInteri(this); aggiornaIrregolarita('<%=domanda.getId()%>')" <%=(ChecklistIstanza!=null && risposta!=null && !toHtml(risposta.getRisposta()).equals("N")) ? "disabled" : "" %> readonly id="dom_<%=domanda.getId() %>_irregolarita" name="dom_<%=domanda.getId() %>_irregolarita" style="width: 4em" class="editField" value="<%=(ChecklistIstanza!=null && risposta!=null) ? toHtml(risposta.getNumIrregolarita()) : "" %>" size="4"/></td>
