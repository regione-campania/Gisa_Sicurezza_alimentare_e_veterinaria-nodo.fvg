...
<jsp:useBean id="ChecklistIstanza" class="org.aspcf.modules.checklist_benessere.base.v6.ChecklistIstanza_Conigli" scope="request"/>
...
function checkForm(form){
	...
	var presenzaQuarantena = form.presenzaQuarantena.value;
	var vuotoSanitario = form.vuotoSanitario.value;
	
	var numTotaleCapannoni = form.numTotaleCapannoni.value;
	var numTotaleCapannoniAttivi = form.numTotaleCapannoniAttivi.value;
	...
	if (presenzaQuarantena == ''){
		msg+="[Presenza di un locale quarantena] Obbligatorio.\n";
		esito = false;
	}
	if (vuotoSanitario == ''){
		msg+="[Viene applicato un vuoto sanitario] Obbligatorio.\n";
		esito = false;
	}
	
	if (numTotaleCapannoni == ''){
		msg+="[N. totale capannoni] Obbligatorio.\n";
		esito = false;
	}
	if (numTotaleCapannoniAttivi == ''){
		msg+="[N. totale capannoni attivi durante l'ispezione] Obbligatorio.\n";
		esito = false;
	}
	
	if (parseInt(numTotaleCapannoniAttivi, 10) > parseInt(numTotaleCapannoni, 10)){
		msg+="[N. totale capannoni attivi] Non puo' essere maggiore di N. totale capannoni.\n";
		esito = false;
	}
...
<center>
<b>PROTEZIONE DEI CONIGLI</b></br>
<b>IN ALLEVAMENTO</b><br/>
<b>(D. Lgs. 146/2001)</b><br/>
...
<tr>
<td>Data di costruzione o inizio attivita'</td>
<td><label class="layout">___________________</label></td>
<td>Data di inizio affidamento attivita' alla responsabilita' del detentore</td>  
<td><label class="layout">___________________</label></td>
</tr>
...
<td> <input type="checkbox" <%="G".equalsIgnoreCase(Allevamento.getCodice_tipo_allevamento()) ? "checked" : ""%> disabled/> In gabbia <input type="checkbox" <%="T".equalsIgnoreCase(Allevamento.getCodice_tipo_allevamento()) ? "checked" : ""%> disabled/> A terra</td>
<td>Uso di gabbie a parchetto:</td>
<td><input type="radio" id="gabbieParchetto_SI" name="gabbieParchetto" value="S" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getGabbieParchetto()).equals("S")) ? "checked=\"checked\"" : ""%>/> SI <input type="radio" id="gabbieParchetto_NO" name="gabbieParchetto" value="N" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getGabbieParchetto()).equals("N")) ? "checked=\"checked\"" : ""%>/> NO <input type="button" name="resetRadioButton" onClick="resetRadio('gabbieParchetto')" value="reset"/></td>
</tr>

<tr>
<td>Presenza di un locale quarantena:</td>
<td><input type="radio" id="presenzaQuarantena_SI" name="presenzaQuarantena" value="S" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getPresenzaQuarantena()).equals("S")) ? "checked=\"checked\"" : ""%>/> SI <input type="radio" id="presenzaQuarantena_NO" name="presenzaQuarantena" value="N" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getPresenzaQuarantena()).equals("N")) ? "checked=\"checked\"" : ""%>/> NO <input type="button" name="resetRadioButton" onClick="resetRadio('presenzaQuarantena')" value="reset"/></td>
<td>Viene applicato un vuoto sanitario:</td>
<td><input type="radio" id="vuotoSanitario_SI" name="vuotoSanitario" value="S" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getVuotoSanitario()).equals("S")) ? "checked=\"checked\"" : ""%>/> SI <input type="radio" id="vuotoSanitario_NO" name="vuotoSanitario" value="N" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getVuotoSanitario()).equals("N")) ? "checked=\"checked\"" : ""%>/> NO <input type="button" name="resetRadioButton" onClick="resetRadio('vuotoSanitario')" value="reset"/></td>
</tr>

<tr>
<td>Presenza di un manuale di buone pratiche:</td>
<td colspan="3"><input type="radio" id="presenzaManuale_SI" name="presenzaManuale" value="S" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getPresenzaManuale()).equals("S")) ? "checked=\"checked\"" : ""%>/> SI <input type="radio" id="presenzaManuale_NO" name="presenzaManuale" value="N" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getPresenzaManuale()).equals("N")) ? "checked=\"checked\"" : ""%>/> NO <input type="button" name="resetRadioButton" onClick="resetRadio('presenzaManuale')" value="reset"/></td>
</tr>

<tr>
<td>Veterinario Aziendale (se presente): Dott./Dott.ssa</td>
...
<tr>
<td>Numero totale di animali > 30 giorni allevati nell'anno precedente:</td>
<td><input type="text" id="numAnimaliAllevati" name="numAnimaliAllevati" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getNumAnimaliAllevati()) : ""%>"/></td>
</tr>

<tr>
<td>Numero di fattrici > 30 giorni morte nell'anno precedente:</td>
<td><input type="text" id="numFattriciMorte" name="numFattriciMorte" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getNumFattriciMorte()) : ""%>"/></td>
</tr>

<tr>
<td>Numero di rimonte > 30 giorni morte nell'anno precedente:</td>
<td><input type="text" id="numRimonteMorte" name="numRimonteMorte" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getNumRimonteMorte()) : ""%>"/></td>
</tr>

<tr>
<td>Numero di conigli da ingrasso > 30 giorni morti nell'anno precedente:</td>
<td><input type="text" id="numIngrassoMorti" name="numIngrassoMorti" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getNumIngrassoMorti()) : ""%>"/></td>
</tr>

<tr><td colspan="2"><b><i>Solo per orientamento produttivo "riproduzione" e "misto": </i></b></td></tr>

<tr>
<td>Numero di fori nido:</td>
<td><input type="text" id="numForiNido" name="numForiNido" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getNumForiNido()) : ""%>"/></td>
</tr>

<tr>
<td>Numero di fori maschio:</td>
<td><input type="text" id="numForiMaschio" name="numForiMaschio" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getNumForiMaschio()) : ""%>"/></td>
</tr>
...
N. totale capannoni attivi durante l'ispezione <input type="text" id="numTotaleCapannoniAttivi" name="numTotaleCapannoniAttivi" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getNumTotaleCapannoniAttivi()) : ""%>"/><br/><br/>

<table cellpadding="10">
<tr>
<td><b>Capannone</b></td>
<td><b>N. fori</b></td>
<td><b>Numero complessivo animali svezzati</b></td>
<td><b>Tipologia struttura</b></td>
<td><b>Tipo gabbia</b></td>
<td><b>Ventilazione</b></td>
</tr>

<% for (int b = 0; b< 6; b++){ %>

<tr>
<td><input type="text" id="capannone_<%=b %>_numero" name="capannone_<%=b %>_numero" maxlength="15" class="editField" value="<%=(ChecklistIstanza!=null && ChecklistIstanza.getCapannoni().size()==6 && ChecklistIstanza.getCapannoni().get(b)!=null) ? toHtml(ChecklistIstanza.getCapannoni().get(b).getNumero()) : ""%>" size="4"/></td>
<td><input type="text" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" id="capannone_<%=b %>_num_fori" name="capannone_<%=b %>_num_fori" style="width: 4em" class="editField" value="<%=(ChecklistIstanza!=null && ChecklistIstanza.getCapannoni().size()==6 && ChecklistIstanza.getCapannoni().get(b)!=null) ? toHtml(ChecklistIstanza.getCapannoni().get(b).getNumFori()) : ""%>" size="4"/></td>
<td><input type="text" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" id="capannone_<%=b %>_num_animali" name="capannone_<%=b %>_num_animali" style="width: 4em" class="editField" value="<%=(ChecklistIstanza!=null && ChecklistIstanza.getCapannoni().size()==6 && ChecklistIstanza.getCapannoni().get(b)!=null) ? toHtml(ChecklistIstanza.getCapannoni().get(b).getNumAnimali()) : ""%>" size="4"/></td>
<td>
<input type="radio" id="capannone_<%=b %>_tipo_struttura_C" name="capannone_<%=b %>_tipo_struttura" class="editField" value="C" <%=(ChecklistIstanza!=null && ChecklistIstanza.getCapannoni().size()==6 && ChecklistIstanza.getCapannoni().get(b)!=null && toHtml(ChecklistIstanza.getCapannoni().get(b).getTipoStruttura()).equals("C")) ? "checked=\"checked\"" : ""%>/> Chiuso in muratura<br/>
<input type="radio" id="capannone_<%=b %>_tipo_struttura_T" name="capannone_<%=b %>_tipo_struttura" class="editField" value="T" <%=(ChecklistIstanza!=null && ChecklistIstanza.getCapannoni().size()==6 && ChecklistIstanza.getCapannoni().get(b)!=null && toHtml(ChecklistIstanza.getCapannoni().get(b).getTipoStruttura()).equals("T")) ? "checked=\"checked\"" : ""%>/> Tunnel<br/>
<input type="radio" id="capannone_<%=b %>_tipo_struttura_P" name="capannone_<%=b %>_tipo_struttura" class="editField" value="P" <%=(ChecklistIstanza!=null && ChecklistIstanza.getCapannoni().size()==6 && ChecklistIstanza.getCapannoni().get(b)!=null && toHtml(ChecklistIstanza.getCapannoni().get(b).getTipoStruttura()).equals("P")) ? "checked=\"checked\"" : ""%>/> Plein air <br/>
<input type="button" name="resetRadioButton" onClick="resetRadio('capannone_<%=b %>_tipo_struttura')" value="reset"/>
</td>
<td>
<input type="radio" id="capannone_<%=b %>_tipo_gabbia_B" name="capannone_<%=b %>_tipo_gabbia" class="editField" value="B" <%=(ChecklistIstanza!=null && ChecklistIstanza.getCapannoni().size()==6 && ChecklistIstanza.getCapannoni().get(b)!=null && toHtml(ChecklistIstanza.getCapannoni().get(b).getTipoGabbia()).equals("B")) ? "checked=\"checked\"" : ""%>/> Bicellulare<br/>
<input type="radio" id="capannone_<%=b %>_tipo_gabbia_D" name="capannone_<%=b %>_tipo_gabbia" class="editField" value="D" <%=(ChecklistIstanza!=null && ChecklistIstanza.getCapannoni().size()==6 && ChecklistIstanza.getCapannoni().get(b)!=null && toHtml(ChecklistIstanza.getCapannoni().get(b).getTipoGabbia()).equals("D")) ? "checked=\"checked\"" : ""%>/> Pratica/Dual<br/>
<input type="radio" id="capannone_<%=b %>_tipo_gabbia_W" name="capannone_<%=b %>_tipo_gabbia" class="editField" value="W" <%=(ChecklistIstanza!=null && ChecklistIstanza.getCapannoni().size()==6 && ChecklistIstanza.getCapannoni().get(b)!=null && toHtml(ChecklistIstanza.getCapannoni().get(b).getTipoGabbia()).equals("W")) ? "checked=\"checked\"" : ""%>/> WRSA<br/>
<input type="radio" id="capannone_<%=b %>_tipo_gabbia_P" name="capannone_<%=b %>_tipo_gabbia" class="editField" value="P" <%=(ChecklistIstanza!=null && ChecklistIstanza.getCapannoni().size()==6 && ChecklistIstanza.getCapannoni().get(b)!=null && toHtml(ChecklistIstanza.getCapannoni().get(b).getTipoGabbia()).equals("P")) ? "checked=\"checked\"" : ""%>/> Park<br/>
<input type="radio" id="capannone_<%=b %>_tipo_gabbia_A" name="capannone_<%=b %>_tipo_gabbia" class="editField" value="A" <%=(ChecklistIstanza!=null && ChecklistIstanza.getCapannoni().size()==6 && ChecklistIstanza.getCapannoni().get(b)!=null && toHtml(ChecklistIstanza.getCapannoni().get(b).getTipoGabbia()).equals("A")) ? "checked=\"checked\"" : ""%>/> Altro <input type="text" id="capannone_<%=b %>_tipo_gabbia_desc" name="capannone_<%=b %>_tipo_gabbia_desc" maxlength="15" class="editField" value="<%=(ChecklistIstanza!=null && ChecklistIstanza.getCapannoni().size()==6 && ChecklistIstanza.getCapannoni().get(b)!=null) ? toHtml(ChecklistIstanza.getCapannoni().get(b).getTipoGabbiaDesc()) : ""%>" size="10"/><br/>
<input type="button" name="resetRadioButton" onClick="resetRadio('capannone_<%=b %>_tipo_gabbia')" value="reset"/>
</td>
<td>
<input type="radio" id="capannone_<%=b %>_ventilazione_N" name="capannone_<%=b %>_ventilazione" class="editField" value="N" <%=(ChecklistIstanza!=null && ChecklistIstanza.getCapannoni().size()==6 && ChecklistIstanza.getCapannoni().get(b)!=null && toHtml(ChecklistIstanza.getCapannoni().get(b).getVentilazione()).equals("N")) ? "checked=\"checked\"" : ""%>/> Naturale<br/>
<input type="radio" id="capannone_<%=b %>_ventilazione_F" name="capannone_<%=b %>_ventilazione" class="editField" value="F" <%=(ChecklistIstanza!=null && ChecklistIstanza.getCapannoni().size()==6 && ChecklistIstanza.getCapannoni().get(b)!=null && toHtml(ChecklistIstanza.getCapannoni().get(b).getVentilazione()).equals("F")) ? "checked=\"checked\"" : ""%>/> Forzata<br/>
<input type="radio" id="capannone_<%=b %>_ventilazione_C" name="capannone_<%=b %>_ventilazione" class="editField" value="C" <%=(ChecklistIstanza!=null && ChecklistIstanza.getCapannoni().size()==6 && ChecklistIstanza.getCapannoni().get(b)!=null && toHtml(ChecklistIstanza.getCapannoni().get(b).getVentilazione()).equals("C")) ? "checked=\"checked\"" : ""%>/> Forzata con cooling<br/>
<input type="button" name="resetRadioButton" onClick="resetRadio('capannone_<%=b %>_ventilazione')" value="reset"/>
</td>
</tr>
...
<jsp:param name="tipo" value="ChecklistConigli" />
