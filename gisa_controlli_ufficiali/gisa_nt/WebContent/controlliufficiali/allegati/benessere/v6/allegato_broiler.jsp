...
<jsp:useBean id="ChecklistIstanza" class="org.aspcf.modules.checklist_benessere.base.v6.ChecklistIstanza_Broiler" scope="request"/>
...
function verificaStatoChecklist(isBozza){
	...
	if(isBozza == 'false'){
		...
		for(var i=0,fLen=f.length;i<fLen;i++){
			...
			else if (f.elements[i].type == 'button' && f.elements[i].name == 'resetRadioButton')
		    { 
		          f.elements[i].disabled = true;
...
function checkForm(form){
	...
	var ibridoRazzaAllevata = form.ibridoRazzaAllevata.value;
	...
	if (esitoControllo == 'A'){ // mancato controllo
		...
		if (ibridoRazzaAllevata == ''){
			msg+="[Ibrido / Razza allevata] Obbligatorio.\n";
			esito = false;
		}
...
<b>ALLEVAMENTO POLLO DA CARNE</b><br/>
<b>(D. Lgs. 146/2001 - D.Lgs. 181/2010)</b><br/>
...
<td colspan="3">  <label class="layout"><%=toHtml(Allevamento.getDet())%></label></td>
</tr>
...
<tr>
<td>Tipo attivita'<br/><i>(AL Allevamento)</i></td>
<td colspan="3">  <label class="layout"><%=Allevamento.getTipologia_struttura()%></label></td>
</tr>

<tr>
<td>Ibrido/Razza allevata</td>
<td colspan="3"> Capacita' massima di allevamento autorizzata dalla ASL competente per il territorio:<br/>
<input type="radio" id="capacitaMassima_A" name="capacitaMassima" value="A" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getCapacitaMassima()).equals("A")) ? "checked=\"checked\"" : ""%>/> 33 Kg/mq <input type="radio" id="capacitaMassima_B" name="capacitaMassima" value="B" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getCapacitaMassima()).equals("B")) ? "checked=\"checked\"" : ""%>/> 39 Kg/mq <input type="radio" id="capacitaMassima_C" name="capacitaMassima" value="C" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getCapacitaMassima()).equals("C")) ? "checked=\"checked\"" : ""%>/> 42 Kg/mq <input type="button" name="resetRadioButton" onClick="resetRadio('capacitaMassima')" value="reset"/></td>
</tr>

<tr>
<td>Orientamento produttivo<br/><i>(Pollame da carne)</i></td>
<td colspan="3">  <label class="layout"><%=Allevamento.getTipologia_att()%></label></td>
</tr>

<tr>
<td>Tipologia produttiva<br/><i>(GL Galletti; CP Capponi; BR Broiler; CL Colorati; AL Altro)</i></td>
...
<td colspan="3"> 
<input type="radio" id="presenzaManuale_SI" name="presenzaManuale" value="S" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getPresenzaManuale()).equals("S")) ? "checked=\"checked\"" : ""%>/> SI <input type="radio" id="presenzaManuale_NO" name="presenzaManuale" value="N" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getPresenzaManuale()).equals("N")) ? "checked=\"checked\"" : ""%>/> NO <input type="button" name="resetRadioButton" onClick="resetRadio('presenzaManuale')" value="reset"/></td>
</tr>

<tr>
<td>Veterinario Aziendale (se presente): Dr.</td>
<td colspan="3"><input type="text" id="veterinarioAziendale" name="veterinarioAziendale" class="editField" size="50" maxlength="50" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getVeterinarioAziendale()) : ""%>"/></td>
</tr>
...
<tr><th>NUMERO CAPI PRESENTI IN BDN <br/>(sulla base delle registrazioni effettuate nel sistema, presenti alla data di stampa della checklist)</th></tr>

<tr>
<td>

n. totale capannoni <input type="text" id="numTotaleCapannoni" name="numTotaleCapannoni" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getNumTotaleCapannoni()) : ""%>"/><br/>
n. totale capannoni attivi all'atto dell'ispezione <input type="text" id="numTotaleCapannoniAttivi" name="numTotaleCapannoniAttivi" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getNumTotaleCapannoniAttivi()) : ""%>"/><br/><br/>

numero capannone <input type="text" id="capannone1num" name="capannone1num" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getCapannone1num()) : ""%>"/> 
capacita' massima <input type="text" id="capannone1capacita" name="capannone1capacita" class="editField" size="5" maxlength="5" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getCapannone1capacita()) : ""%>"/>  
data di accasamento <input type="date" id="capannone1data" name="capannone1data" class="editField" size="50" maxlength="50" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getCapannone1data()) : ""%>"/> 
numero complessivo animali accasati <input type="text" id="capannone1accasati" name="capannone1accasati" class="editField" size="5" maxlength="5" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getCapannone1accasati()) : ""%>"/>  
<br/>
presenti al momento della stampa della check-list (inclusi sfoltimenti e mortalita' ove registrati) <input type="text" id="capannone1presenti" name="capannone1presenti" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getCapannone1presenti()) : ""%>"/>  
ispezionato <input type="radio" id="capannone1ispezionatoS" name="capannone1ispezionato" value="S" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getCapannone1ispezionato()).equals("S")) ? "checked" : "" %>/> SI <input type="radio" id="capannone1ispezionatoN" name="capannone1ispezionato" value="N" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getCapannone1ispezionato()).equals("N")) ? "checked" : "" %>/> NO <input type="button" name="resetRadioButton" onClick="resetRadio('capannone1ispezionato')" value="reset"/><br/><br/>  

numero capannone <input type="text" id="capannone2num" name="capannone2num" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getCapannone2num()) : ""%>"/> 
capacita' massima <input type="text" id="capannone2capacita" name="capannone2capacita" class="editField" size="5" maxlength="5" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getCapannone2capacita()) : ""%>"/>  
data di accasamento <input type="date" id="capannone2data" name="capannone2data" class="editField" size="50" maxlength="50" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getCapannone2data()) : ""%>"/> 
numero complessivo animali accasati <input type="text" id="capannone2accasati" name="capannone2accasati" class="editField" size="5" maxlength="5" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getCapannone2accasati()) : ""%>"/>  
<br/>
presenti al momento della stampa della check-list (inclusi sfoltimenti e mortalita' ove registrati) <input type="text" id="capannone2presenti" name="capannone2presenti" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getCapannone2presenti()) : ""%>"/>  
ispezionato <input type="radio" id="capannone2ispezionatoS" name="capannone2ispezionato" value="S" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getCapannone2ispezionato()).equals("S")) ? "checked" : "" %>/> SI <input type="radio" id="capannone2ispezionatoN" name="capannone2ispezionato" value="N" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getCapannone2ispezionato()).equals("N")) ? "checked" : "" %>/> NO <input type="button" name="resetRadioButton" onClick="resetRadio('capannone2ispezionato')" value="reset"/><br/><br/>  

numero capannone <input type="text" id="capannone3num" name="capannone3num" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getCapannone3num()) : ""%>"/> 
capacita' massima <input type="text" id="capannone3capacita" name="capannone3capacita" class="editField" size="5" maxlength="5" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getCapannone3capacita()) : ""%>"/>  
data di accasamento <input type="date" id="capannone3data" name="capannone3data" class="editField" size="50" maxlength="50" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getCapannone3data()) : ""%>"/> 
numero complessivo animali accasati <input type="text" id="capannone3accasati" name="capannone3accasati" class="editField" size="5" maxlength="5" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getCapannone3accasati()) : ""%>"/>  
<br/>
presenti al momento della stampa della check-list (inclusi sfoltimenti e mortalita' ove registrati) <input type="text" id="capannone3presenti" name="capannone3presenti" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getCapannone3presenti()) : ""%>"/>  
ispezionato <input type="radio" id="capannone3ispezionatoS" name="capannone3ispezionato" value="S" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getCapannone3ispezionato()).equals("S")) ? "checked" : "" %>/> SI <input type="radio" id="capannone3ispezionatoN" name="capannone3ispezionato" value="N" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getCapannone3ispezionato()).equals("N")) ? "checked" : "" %>/> NO <input type="button" name="resetRadioButton" onClick="resetRadio('capannone3ispezionato')" value="reset"/><br/><br/>  
...
<tr>
<td><input type="text" id="capannone4num" name="capannone4num" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getCapannone4num()) : ""%>"/></td>
<td><input type="radio" id="capannone4ispezionatoS" name="capannone4ispezionato" value="S" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getCapannone4ispezionato()).equals("S")) ? "checked" : "" %>/> SI <input type="radio" id="capannone4ispezionatoN" name="capannone4ispezionato" value="N" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getCapannone4ispezionato()).equals("N")) ? "checked" : "" %>/> NO <input type="button" name="resetRadioButton" onClick="resetRadio('capannone4ispezionato')" value="reset"/></td>
</tr>

<tr>
<td><input type="text" id="capannone5num" name="capannone5num" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getCapannone5num()) : ""%>"/></td>
<td><input type="radio" id="capannone5ispezionatoS" name="capannone5ispezionato" value="S" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getCapannone5ispezionato()).equals("S")) ? "checked" : "" %>/> SI <input type="radio" id="capannone5ispezionatoN" name="capannone5ispezionato" value="N" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getCapannone5ispezionato()).equals("N")) ? "checked" : "" %>/> NO <input type="button" name="resetRadioButton" onClick="resetRadio('capannone5ispezionato')" value="reset"/></td>
</tr>
...
<tr><th colspan="4">STIMA DEI DATI AZIENDALI<br/> (da compilare in base alle informazioni fornite dall'allevatore):</th></tr>

<tr>
<td colspan="2">Ibrido/razza allevata</td>
<td colspan="2"> <input type="text" id="ibridoRazzaAllevata" name="ibridoRazzaAllevata" class="editField" size="50" maxlength="50" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getIbridoRazzaAllevata()) : ""%>"/></td>
</tr>
 
<tr>
<td>Capannone numero </td>
<td><input type="text" id="stimaCapannone1num" name="stimaCapannone1num" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getStimaCapannone1num()) : ""%>"/> </td>
<td>n. stimato capi al momento dell'ispezione</td>
<td><input type="text" id="stimaCapannone1numCapi" name="stimaCapannone1numCapi" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getStimaCapannone1numCapi()) : ""%>"/> </td>
</tr>

<tr>
<td>Capannone numero </td>
<td><input type="text" id="stimaCapannone2num" name="stimaCapannone2num" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getStimaCapannone2num()) : ""%>"/> </td>
<td>n. stimato capi al momento dell'ispezione</td>
<td><input type="text" id="stimaCapannone2numCapi" name="stimaCapannone2numCapi" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getStimaCapannone2numCapi()) : ""%>"/> </td>
</tr>

<tr>
<td>Capannone numero </td>
<td><input type="text" id="stimaCapannone3num" name="stimaCapannone3num" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getStimaCapannone3num()) : ""%>"/> </td>
<td>n. stimato capi al momento dell'ispezione</td>
<td><input type="text" id="stimaCapannone3numCapi" name="stimaCapannone3numCapi" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getStimaCapannone3numCapi()) : ""%>"/> </td>
</tr>

<tr>
<td colspan="4">
Questi dati rappresentano una stima fornita dall'allevatore della consistenza delle diverse popolazioni animali presenti in allevamento il giorno dell'ispezione.<br/>
Compilare questa tabella e' un ausilio necessario ai fini della valutazione delle animal-based measures, nonche' della categorizzazione del rischio in ClassyFarm.
</td>
</tr>
...
<jsp:param name="tipo" value="ChecklistBroiler" />
...
function rispondiCaso() {
	 ...
	 var nomi = ["ABC", "DEF", "GHI", "TEST", "PROVA", "XYZ", "LOREM", "IPSUM", "QUANTUM", "CHECK", "EXT", "ESEMPIO", "BNS", "CHECKLIST", "SPECIE", "QWERTY", "DOLOR", "SIT", "AMET", "CONSECTETUR", "ELIT", "DIAM", "QUIS"];
