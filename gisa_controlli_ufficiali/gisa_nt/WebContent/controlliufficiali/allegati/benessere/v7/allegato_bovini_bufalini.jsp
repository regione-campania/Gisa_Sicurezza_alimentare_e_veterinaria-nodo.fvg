...
<jsp:useBean id="ChecklistIstanza" class="org.aspcf.modules.checklist_benessere.base.v7.ChecklistIstanza_BoviniBufalini" scope="request"/>
...
<tr>
<td><b>ASL</b></td>
<td colspan="3"><label class="layout"><%=Allevamento.getAsl()%></label></td>
</tr>
...
Compilare questa tabella è un ausilio necessario ai fini della valutazione delle animal-based measures, nonché della categorizzazione
...
<tr><td>Sistema di identificazione e registrazione animale</td><td><input type="text" id="evidenzeIr" name="evidenzeIr" class="editField" placeholder="evidenze" style="width:100%" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getEvidenzeIr()) : ""%>"/></td></tr>
<tr><td>Sicurezza alimentare e TSE</td><td><input type="text" id="evidenzeTse" name="evidenzeTse" class="editField" placeholder="evidenze" style="width:100%" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getEvidenzeTse()) : ""%>"/></td></tr>
<tr><td>Sostanze vietate</td><td><input type="text" id="evidenzeSv" name="evidenzeSv" class="editField" placeholder="evidenze" style="width:100%" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getEvidenzeSv()) : ""%>"/></td></tr>
...
<tr><td>
<b>Descrizione:</b><input type="text" id="prescrizioniEseguiteDescrizione" name="prescrizioniEseguiteDescrizione" class="editField" size="50" placeholder="descrizione" style="width:100%" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getPrescrizioniEseguiteDescrizione()) : ""%>"/>
</td></tr>
<tr><td>
