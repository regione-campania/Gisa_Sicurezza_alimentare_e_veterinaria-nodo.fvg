...
<jsp:useBean id="ChecklistIstanza" class="org.aspcf.modules.checklist_benessere.base.v7.ChecklistIstanza_Tacchini" scope="request"/>
...
<tr>
<td>Indirizzo dello stabilimento</td>
...
<td colspan="2">Sesso allevato</td>
</tr>
...
<td colspan="2"> 
<input type="radio" id="sessoAllevatoM" name="sessoAllevato" value="M" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getSessoAllevato()).equals("M")) ? "checked=\"checked\"" : ""%>/> M <br/>
<input type="radio" id="sessoAllevatoF" name="sessoAllevato" value="F" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getSessoAllevato()).equals("F")) ? "checked=\"checked\"" : ""%>/> F <br/>
<input type="radio" id="sessoAllevatoE" name="sessoAllevato" value="E" <%=(ChecklistIstanza!=null && toHtml(ChecklistIstanza.getSessoAllevato()).equals("E")) ? "checked=\"checked\"" : ""%>/> Entrambi
</td>
</tr>
...
<tr>
<td colspan="3">n. totale capannoni</td>
<td colspan="3"></td>
</tr>

<tr>
<td colspan="3">n. totale capannoni attivi all'atto dell'ispezione</td>
<td colspan="3"></td>
</tr>
...
<tr><th>Numero capannone</th><th>Capacita' massima</th><th>Data di accasamento</th><th>numero complessivo animali accasati</th><th>presenti al momento della stampa della check-list (inclusi sfoltimenti e mortalita' ove registrati)</th><th>Ispezionato</th></tr>
<%for (int r = 0; r<4; r++){ %>
...
<jsp:param name="tipo" value="ChecklistTacchini" />
