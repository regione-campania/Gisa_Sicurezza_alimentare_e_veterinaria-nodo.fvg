...
<jsp:useBean id="ChecklistIstanza" class="org.aspcf.modules.checklist_benessere.base.v7.ChecklistIstanza_Ovicaprini" scope="request"/>
...
function checkForm(form){
	...
	var kgLatte = form.kgLatte.value;
	var qLatte = form.qLatte.value;
	
	var numOviLattazione = form.numOviLattazione.value;
	var numCapLattazione = form.numCapLattazione.value;
	var numOviAsciutta = form.numOviAsciutta.value;
	var numCapAsciutta = form.numCapAsciutta.value;
	var numArieti = form.numArieti.value;
	var numBecchi = form.numBecchi.value;
	var numOviRimonta = form.numOviRimonta.value;
	var numCapRimonta = form.numCapRimonta.value;
	var numAgnelliRimonta = form.numAgnelliRimonta.value;
	var numCaprettiRimonta = form.numCaprettiRimonta.value;
	var numAgnelli3m = form.numAgnelli3m.value;
	var numCapretti3m = form.numCapretti3m.value;
	...
	if (esitoControllo == 'A'){ // mancato controllo
		...
		if (kgLatte != ''){
			msg+="[KG LATTE] Deve essere vuoto.\n";
			esito = false;
		}
		
		if (qLatte != ''){
			msg+="[QUINTALI LATTE] Deve essere vuoto.\n";
			esito = false;
		}
		
		if (numOviLattazione != ''){
			msg+="[Numero stimato pecore/capre in lattazione OVINI] Deve essere vuoto.\n";
			esito = false;
		}
		if (numCapLattazione != ''){
			msg+="[Numero stimato pecore/capre in lattazione CAPRINI] Deve essere vuoto.\n";
			esito = false;
		}
		if (numOviAsciutta != ''){
			msg+="[Numero stimato pecore/capre in asciutta OVINI] Deve essere vuoto.\n";
			esito = false;
		}
		if (numCapAsciutta != ''){
			msg+="[Numero stimato pecore/capre in asciutta CAPRINI] Deve essere vuoto.\n";
			esito = false;
		}
		if (numArieti != ''){
			msg+="[Numero stimato arieti/becchi OVINI] Deve essere vuoto.\n";
			esito = false;
		}
		if (numBecchi != ''){
			msg+="[Numero stimato arieti/becchi CAPRINI] Deve essere vuoto.\n";
			esito = false;
		}
		if (numOviRimonta != ''){
			msg+="[umero stimato pecore/capre da rimonta OVINI] Deve essere vuoto.\n";
			esito = false;
		}
		if (numCapRimonta != ''){
			msg+="[umero stimato pecore/capre da rimonta CAPRINI] Deve essere vuoto.\n";
			esito = false;
		}
		if (numAgnelliRimonta != ''){
			msg+="[Numero stimato agnelli/capretti da rimonta OVINI] Deve essere vuoto.\n";
			esito = false;
		}
		if (numCaprettiRimonta != ''){
			msg+="[Numero stimato agnelli/capretti da rimonta CAPRINI] Deve essere vuoto.\n";
			esito = false;
		}
		if (numAgnelli3m != ''){
			msg+="[Numero stimato agnelli/capretti < 3 mesi OVINI] Deve essere vuoto.\n";
			esito = false;
		}
		if (numCapretti3m != ''){
			msg+="[Numero stimato agnelli/capretti < 3 mesi CAPRINI] Deve essere vuoto.\n";
			esito = false;
		}			
		...
		if (kgLatte != '' && qLatte!= ''){
			msg+="[KG LATTE/QUINTALI LATTE] Svuotare uno dei due campi.\n";
			esito = false;
		}
		
		if (kgLatte == '' && qLatte== ''){
			msg+="[KG LATTE/QUINTALI LATTE] Valorizzare uno dei due campi.\n";
			esito = false;
		}
		
		if (numOviLattazione == ''){
			msg+="[Numero stimato pecore/capre in lattazione OVINI] Obbligatorio.\n";
			esito = false;
		}
		if (numCapLattazione == ''){
			msg+="[Numero stimato pecore/capre in lattazione CAPRINI] Obbligatorio.\n";
			esito = false;
		}
		if (numOviAsciutta == ''){
			msg+="[Numero stimato pecore/capre in asciutta OVINI] Obbligatorio.\n";
			esito = false;
		}
		if (numCapAsciutta == ''){
			msg+="[Numero stimato pecore/capre in asciutta CAPRINI] Obbligatorio.\n";
			esito = false;
		}
		if (numArieti == ''){
			msg+="[Numero stimato arieti/becchi OVINI] Obbligatorio.\n";
			esito = false;
		}
		if (numBecchi == ''){
			msg+="[Numero stimato arieti/becchi CAPRINI] Obbligatorio.\n";
			esito = false;
		}
		if (numOviRimonta == ''){
			msg+="[umero stimato pecore/capre da rimonta OVINI] Obbligatorio.\n";
			esito = false;
		}
		if (numCapRimonta == ''){
			msg+="[umero stimato pecore/capre da rimonta CAPRINI] Obbligatorio.\n";
			esito = false;
		}
		if (numAgnelliRimonta == ''){
			msg+="[Numero stimato agnelli/capretti da rimonta OVINI] Obbligatorio.\n";
			esito = false;
		}
		if (numCaprettiRimonta == ''){
			msg+="[Numero stimato agnelli/capretti da rimonta CAPRINI] Obbligatorio.\n";
			esito = false;
		}
		if (numAgnelli3m == ''){
			msg+="[Numero stimato agnelli/capretti < 3 mesi OVINI] Obbligatorio.\n";
			esito = false;
		}
		if (numCapretti3m == ''){
			msg+="[Numero stimato agnelli/capretti < 3 mesi CAPRINI] Obbligatorio.\n";
			esito = false;
		}			
...
<tr><th colspan="3">NUMERO CAPI PRESENTI IN BDN (sulla base delle registrazioni effettuate nel sistema, presenti alla data di stampa della checklist)</th></tr>
<tr><th></th><th>Ovini (1)</th><th>Caprini (1)</th></tr>
<tr><td>Capi totali identificati individualmente presenti alla data</td><td></td><td></td></tr>
<tr><td>Pecore/capre femmine identificate individualmente > 12 mesi presenti alla data</td><td></td><td></td></tr>
<tr><td>Arieti/becchi identificati individualmente > 12 mesi presenti alla data</td><td></td><td></td></tr>
<tr><td>Giovani pecore/capre identificate individualmente < 12 mesi (femmine da rimonta) presenti alla data</td><td></td><td></td></tr>
<tr><td>Agnelli/capretti maschi identificati individualmente < 12 mesi (da rimonta) presenti alla data</td><td></td><td></td></tr>
<tr><td>Agnelli/capretti non identificati registrati al censimento (ove disponibile un censimento negli ultimi 12 mesi)(2)</td><td></td><td></td></tr>
<tr><td></td><td></td><td></td></tr>
<tr><td>Numero di animali identificati individualmente, morti in azienda oltre 12 mesi d'eta' (comprese MSU) negli ultimi 12 mesi</td><td></td><td></td></tr>
<tr><td>Numero di capi circolanti* identificati individualmente (> 12 mesi d'eta') negli ultimi 12 mesi</td><td></td><td></td></tr>
<tr><td>Mortalita' animali identificati individualmente > 12 mesi d'eta' (**)</td><td></td><td></td></tr>
<tr><td></td><td></td><td></td></tr>
<tr><td>Numero di animali identificati individualmente, morti in azienda prima dei 12 mesi d'eta' (comprese MSU) negli ultimi 12 mesi</td><td></td><td></td></tr>
<tr><td>Numero di capi circolanti* identificati individualmente (< 12 mesi d'eta') negli ultimi 12 mesi</td><td></td><td></td></tr>
<tr><td>Mortalita' animali identificati individualmente < 12 mesi d'eta' (**):</td><td></td><td></td></tr>
<tr><td></td><td></td><td></td></tr>
<tr><td>Agnelli/Capretti non identificati o identificati in modalita' semplificata morti in azienda (comprese MSU) negli ultimi 12 mesi</td><td></td><td></td></tr>
<tr><td>Numero di agnelli/capretti identificati in modalita' semplificata usciti per partita negli ultimi 12 mesi</td><td></td><td></td></tr>
<tr><td>Mortalita' agnelli/capretti non identificati o identificati in modalita' semplificata (***)</td><td></td><td></td></tr>
<tr><td></td><td></td><td></td></tr>
<tr><td colspan="3"><i>
(*) Capi circolanti identificati: rispettivamente, soggetti con eta' < 12 mesi o >12 mesi presenti almeno 1 giorno in allevamento negli
ultimi 12 mesi.<br/>
(**) Rapporto tra il numero di capi (rispettivamente <12 mesi e >12 mesi d'eta') morti in azienda negli ultimi 12 mesi e il numero di
capi (rispettivamente < 12 mesi e > 12 mesi d'eta') circolanti in allevamento negli ultimi 12 mesi.<br/>
(***) Rapporto tra il numero di agnelli/capretti non identificati o identificati in modalita' semplificata morti in azienda negli ultimi 12
mesi e la somma tra il numero di agnelli/capretti usciti per partita negli ultimi 12 mesi e il numero di agnelli/capretti morti in
azienda.<br/>
1 - Nel caso in cui per un proprietario/operatore esiste un solo allevamento registrato in BDN per una delle due specie, con
presenza di pochi capi appartenenti all'altra, la checklist precompilata riportera' i dati relativi a entrambe le specie, "ovini" e
"caprini" e sara' l'unica a dover essere compilata; nel caso invece in cui per lo stesso proprietario/operatore risulta la presenza di 2
allevamenti registrati in BDN, uno per "ovini" e l'altro per "caprini", la checklist relativa a ciascun allevamento riportera' solo i dati
relativi alla specie corrispondente; pertanto dovra' essere compilata una diversa checklist per ciascuno dei due allevamenti delle
diverse specie.<br/>
2 - Il censimento viene effettuato nel mese di marzo di ogni anno. Poiché non tutti gli allevamenti hanno obbligo di censimento, se
non sussiste un censimento recente, il campo restera' vuoto</i></td></tr>
</table>
...
<tr><th colspan="3">STIMA DEI DATI AZIENDALI (da compilare in base alle informazioni fornite dall'allevatore):</th></tr>
<tr><th></th><th>Ovini (1)</th><th>Caprini (1)</th></tr>
<tr><td>Numero stimato pecore/capre in lattazione</td><td><input type="text" id="numOviLattazione" name="numOviLattazione" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getNumOviLattazione()) : ""%>"/></td><td><input type="text" id="numCapLattazione" name="numCapLattazione" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getNumCapLattazione()) : ""%>"/></td></tr>
<tr><td>Numero stimato pecore/capre in asciutta</td><td><input type="text" id="numOviAsciutta" name="numOviAsciutta" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getNumOviAsciutta()) : ""%>"/></td><td><input type="text" id="numCapAsciutta" name="numCapAsciutta" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getNumCapAsciutta()) : ""%>"/></td></tr>
<tr><td>Numero stimato arieti/becchi</td><td><input type="text" id="numArieti" name="numArieti" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getNumArieti()) : ""%>"/></td><td><input type="text" id="numBecchi" name="numBecchi" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getNumBecchi()) : ""%>"/></td></tr>
<tr><td>Numero stimato pecore/capre da rimonta (>3 mesi fino al 1. parto)</td><td><input type="text" id="numOviRimonta" name="numOviRimonta" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getNumOviRimonta()) : ""%>"/></td><td><input type="text" id="numCapRimonta" name="numCapRimonta" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getNumCapRimonta()) : ""%>"/></td></tr>
<tr><td>Numero stimato agnelli/capretti da rimonta maschi</td><td><input type="text" id="numAgnelliRimonta" name="numAgnelliRimonta" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getNumAgnelliRimonta()) : ""%>"/></td><td><input type="text" id="numCaprettiRimonta" name="numCaprettiRimonta" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getNumCaprettiRimonta()) : ""%>"/></td></tr>
<tr><td>Numero stimato agnelli/capretti < 3 mesi</td><td><input type="text" id="numAgnelli3m" name="numAgnelli3m" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getNumAgnelli3m()) : ""%>"/></td><td><input type="text" id="numCapretti3m" name="numCapretti3m" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getNumCapretti3m()) : ""%>"/></td></tr>
<tr><td colspan="3">Stima della produzione latte:<br/> <input type="text" id="kgLatte" name="kgLatte" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getKgLatte()) : ""%>"/> kg latte/capo/giorno oppure <input type="text" id="qLatte" name="qLatte" class="editField" size="4" maxlength="4" onChange="filtraInteri(this)" onKeyUp="filtraInteri(this)" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getqLatte()) : ""%>"/> quintali latte dell'ultima consegna</td></tr>
<tr><td colspan="3"><br/>Questi dati rappresentano una stima fornita dall'allevatore della consistenza delle diverse popolazioni animali presenti in allevamento il
giorno dell'ispezione.<br/><br/>
Compilare questa tabella e' un ausilio necessario ai fini della valutazione delle animal-based measures, nonche' della categorizzazione
del rischio in ClassyFarm.<br/><br/>
(1) Nel caso in cui per un proprietario/operatore esiste un solo allevamento registrato in BDN per una delle due specie, con presenza di
pochi capi appartenenti all'altra compilare le colonne relative a entrambe le specie, "ovini" e "caprini"; nel caso invece in cui per lo
stesso proprietario/operatore risulta la presenza di 2 allevamenti registrati in BDN, uno per "ovini" e l'altro per "caprini", compilare solo
la colonna relativa alla specie corrispondente; in tal caso dovra' essere compilata una diversa checklist per ciascuno dei due allevamenti
delle diverse specie.<br/><br/></td></tr>
...
<tr><td colspan="2">
SE SI QUALI:<br/>
<input type="text" id="prescrizioniDescrizione" name="prescrizioniDescrizione" class="editField" size="100" maxlength="2000" placeholder="descrizione" style="width:100%" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getPrescrizioniDescrizione()) : ""%>"/></td>
</tr>
...
<tr><td>
<b>Descrizione:</b><input type="text" id="prescrizioniEseguiteDescrizione" name="prescrizioniEseguiteDescrizione" class="editField" size="50" placeholder="descrizione" value="<%=(ChecklistIstanza!=null) ? toHtml(ChecklistIstanza.getPrescrizioniEseguiteDescrizione()) : ""%>"/>
</td></tr>
<tr><td>
...
<jsp:param name="tipo" value="ChecklistOvicaprini" />
