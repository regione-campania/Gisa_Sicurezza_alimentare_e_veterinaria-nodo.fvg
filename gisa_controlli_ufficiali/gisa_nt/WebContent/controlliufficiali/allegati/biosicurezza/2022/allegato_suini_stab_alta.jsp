...
function gestisciCb(cb){
	...
	if (dom_classyfarm_id == '4085' && risposta_classyfarm_id == '11482'){ // SE HO RISPOSTO NA ALLA DOMANDA SELEZIONATA
		
		for(var i=0,fLen=f.length;i<fLen;i++){ // SETTO NA A TUTTE LE DOMANDE COLLEGATE COME DA RICHIESTA REFERENTE

			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4087' && f.elements[i].dataset.risposta_classyfarm_id == '11490')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4088' && f.elements[i].dataset.risposta_classyfarm_id == '11494')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4089' && f.elements[i].dataset.risposta_classyfarm_id == '11498')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4090' && f.elements[i].dataset.risposta_classyfarm_id == '11502')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4091' && f.elements[i].dataset.risposta_classyfarm_id == '11506')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4092' && f.elements[i].dataset.risposta_classyfarm_id == '11510')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4093' && f.elements[i].dataset.risposta_classyfarm_id == '11514')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4094' && f.elements[i].dataset.risposta_classyfarm_id == '11518')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4095' && f.elements[i].dataset.risposta_classyfarm_id == '11522')
		    { 
		          f.elements[i].checked = true;
		    }
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4096' && f.elements[i].dataset.risposta_classyfarm_id == '11526')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4097' && f.elements[i].dataset.risposta_classyfarm_id == '11530')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4098' && f.elements[i].dataset.risposta_classyfarm_id == '11534')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4099' && f.elements[i].dataset.risposta_classyfarm_id == '11538')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4100' && f.elements[i].dataset.risposta_classyfarm_id == '11542')
		    { 
		          f.elements[i].checked = true;
		    } 
	...
	if (dom_classyfarm_id == '4101' && risposta_classyfarm_id == '11546'){ // SE HO RISPOSTO NA ALLA DOMANDA SELEZIONATA
		
		for(var i=0,fLen=f.length;i<fLen;i++){ // SETTO NA A TUTTE LE DOMANDE COLLEGATE COME DA RICHIESTA REFERENTE

			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4102' && f.elements[i].dataset.risposta_classyfarm_id == '11550')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4103' && f.elements[i].dataset.risposta_classyfarm_id == '11554')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4104' && f.elements[i].dataset.risposta_classyfarm_id == '11558')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4105' && f.elements[i].dataset.risposta_classyfarm_id == '11562')
		    { 
		          f.elements[i].checked = true;
		    } 
		}
...
function checkForm(form){
	...
	for(var i=0,fLen=f.length;i<fLen;i++){
	if (f.elements[i].dataset.dom_classyfarm_id=='4032' && f.elements[i].value.trim() == ''){ 
		msg+= "Compilare NOME E COGNOME DEL PROPRIETARIO/DETENTORE/CONDUTTORE PRESENTE ALL'ISPEZIONE.\n";
	    esito = false;
	    } 
	if (f.elements[i].dataset.dom_classyfarm_id=='4031' && (f.elements[i].value.trim() == '' /*|| parseInt(f.elements[i].value.trim())<= 300*/)){ 
...
<center>
<div class="header">
<b>VALUTAZIONE DELLA BIOSICUREZZA: SUINI - ALLEVAMENTI STABULATI AD ALTA CAPACITA <br/>
...
for (int i = 0; i<Checklist.getDomande().size(); i++) {
	...
	<% for (int j = 0; j<domanda.getListaRisposte().size(); j++) {
		...
		<td <%= (j ==  (domanda.getListaRisposte().size() -1)) ? "colspan=\"" + (4 - j) + "\"" : ""%> style="word-wrap: break-word; word-break: break-all; white-space: normal;"> 
...
<jsp:param name="tipo" value="ChecklistBiosicurezzaSuiniStabAlta2022" />
