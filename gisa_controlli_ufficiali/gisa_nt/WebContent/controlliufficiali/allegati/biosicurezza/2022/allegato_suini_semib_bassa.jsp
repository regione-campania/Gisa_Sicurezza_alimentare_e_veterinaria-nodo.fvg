...
function checkForm(form){
	...
	var f = document.forms['myform'];
	for(var i=0,fLen=f.length;i<fLen;i++){
	if (f.elements[i].dataset.dom_classyfarm_id=='5011' && f.elements[i].value.trim() == ''){ 
		msg+= "Compilare NOME E COGNOME DEL PROPRIETARIO/DETENTORE/CONDUTTORE PRESENTE ALL'ISPEZIONE.\n";
	    esito = false;
	    } 
	if (f.elements[i].dataset.dom_classyfarm_id=='5010' && (f.elements[i].value.trim() == '' /*|| parseInt(f.elements[i].value.trim())> 300*/)){ 
...
<center>
<div class="header">
<b>VALUTAZIONE DELLA BIOSICUREZZA: SUINI - ALLEVAMENTI SEMBRADI A BASSA CAPACITA <br/>
...
<jsp:param name="tipo" value="ChecklistBiosicurezzaSuiniSemibBassa2022" />
