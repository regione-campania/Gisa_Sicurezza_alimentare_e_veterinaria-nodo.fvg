...
function gestisciCb(cb){
	...
	if (dom_classyfarm_id == '4889' && risposta_classyfarm_id == '14215'){ // SE HO RISPOSTO NA ALLA DOMANDA SELEZIONATA
		
		for(var i=0,fLen=f.length;i<fLen;i++){ // SETTO NA A TUTTE LE DOMANDE COLLEGATE COME DA RICHIESTA REFERENTE

			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4890' && f.elements[i].dataset.risposta_classyfarm_id == '14219')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4891' && f.elements[i].dataset.risposta_classyfarm_id == '14223')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4892' && f.elements[i].dataset.risposta_classyfarm_id == '14227')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4893' && f.elements[i].dataset.risposta_classyfarm_id == '14231')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4894' && f.elements[i].dataset.risposta_classyfarm_id == '14235')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4895' && f.elements[i].dataset.risposta_classyfarm_id == '14239')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4896' && f.elements[i].dataset.risposta_classyfarm_id == '14243')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4897' && f.elements[i].dataset.risposta_classyfarm_id == '14247')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4898' && f.elements[i].dataset.risposta_classyfarm_id == '14251')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4899' && f.elements[i].dataset.risposta_classyfarm_id == '14255')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4900' && f.elements[i].dataset.risposta_classyfarm_id == '14259')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4901' && f.elements[i].dataset.risposta_classyfarm_id == '14263')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4902' && f.elements[i].dataset.risposta_classyfarm_id == '14267')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4903' && f.elements[i].dataset.risposta_classyfarm_id == '14271')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4904' && f.elements[i].dataset.risposta_classyfarm_id == '14275')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4905' && f.elements[i].dataset.risposta_classyfarm_id == '14279')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4906' && f.elements[i].dataset.risposta_classyfarm_id == '14283')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4907' && f.elements[i].dataset.risposta_classyfarm_id == '14287')
		    { 
		          f.elements[i].checked = true;
		    } 
			if (f.elements[i].type=='checkbox' && f.elements[i].dataset.dom_classyfarm_id == '4908' && f.elements[i].dataset.risposta_classyfarm_id == '14291')
		    { 
		          f.elements[i].checked = true;
		    } 
...
function checkForm(form){
	...
	var f = document.forms['myform'];
	for(var i=0,fLen=f.length;i<fLen;i++){
	if (f.elements[i].dataset.dom_classyfarm_id=='4829' && f.elements[i].value.trim() == ''){ 
		msg+= "Compilare NOME E COGNOME DEL PROPRIETARIO/DETENTORE/CONDUTTORE PRESENTE ALL'ISPEZIONE.\n";
	    esito = false;
	    } 
	if (f.elements[i].dataset.dom_classyfarm_id=='4828' && (f.elements[i].value.trim() == '' /*|| parseInt(f.elements[i].value.trim())<= 300*/)){ 
...
<center>
<div class="header">
<b>VALUTAZIONE DELLA BIOSICUREZZA: SUINI - ALLEVAMENTI SEMBIRADI AD ALTA CAPACITA <br/>
...
<jsp:param name="tipo" value="ChecklistBiosicurezzaSuiniSemibAlta2022" />
