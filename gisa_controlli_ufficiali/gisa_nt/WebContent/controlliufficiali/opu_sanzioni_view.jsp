  ...
  <td nowrap class="formLabel">
   ...
   <td>
      <%= toHtmlValue(TicketDetails.getTipo_richiesta()) %>
		...
		if(TicketDetails.getPagamento()>0){
		
		%>
			<tr class="containerBody">
				<td valign="top" class="formLabel">
					Pagamento in Misura Ridotta(Euro)</td>
				<td><%=String.format(Locale.US, "%.2f", TicketDetails.getPagamento())%> </td>
			</tr>
	<%} %>
...
Applicata riduzione del 30% (euro)
   ...
   <td>
      <%=String.format(Locale.US, "%.2f", TicketDetails.getPagamentoUltraridotto())%>
