                    ...
                    success: function(data) {
                        ...
                        $.each(json, function(i, item) {
                        	 if(item.id>0 )
                        		 ...
                        		 if (item.nominativo.qualifica !== null) {
                            		 newTr += '<td>' + item.nominativo.qualifica + '</td>';
								} else {
    								newTr += '<td></td>'; 
								}

								if (item.nominativo.profilo_professionale !== null) {
	                        		 newTr += '<td>' + item.nominativo.profilo_professionale + '</td>';
								} else {
    								newTr += '<td></td>';
								}
                        ...
                        else
                        	{
                        	 ...
                        	 var newTr ='<tr style="display: table-row;" class="odd" role="row"><td colspan="5">Attenzione non esiste nessun utente associato nel Dpat</tr>';
