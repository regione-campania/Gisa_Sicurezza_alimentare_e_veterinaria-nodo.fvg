...
for(k=0 ; k<arr.length;k++){
	if(arr[k].value=="-1" && arr[k].selected==true){
		...
		PopolaCombo.verificaEsistenzaDiffida( arr[k].value,form.idC.value,form.orgId.value,form.stabId.value,form.idApiario.value, form.altId.value, -1,{callback:verificaEsistenzaDiffidaCallback,async:false});
