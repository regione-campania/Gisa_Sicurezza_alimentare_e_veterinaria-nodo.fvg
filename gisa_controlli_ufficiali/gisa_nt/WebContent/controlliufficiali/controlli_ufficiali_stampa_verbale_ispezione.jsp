...
function openMod5Rev(idControllo, tipoMod, rev){
	var res;
	var result;
	window.open('Modello5.do?command=View&idControllo='+idControllo+'&tipoMod='+tipoMod+'&rev='+rev,'popupSelect',
			'height=800px,width=1280px,toolbar=no,directories=no,status=no,continued from previous linemenubar=no,scrollbars=yes,resizable=yes ,modal=yes');
}
...
Timestamp dataRev9 = Timestamp.valueOf("2023-01-01 00:00:00.00000000");

if (TicketDetails.getAssignedDate().after(dataRev9)) {%>
<a href="javascript:openMod5Rev('<%=TicketDetails.getId()%>', 'A', '9');"><font size="3px" color="#006699"><b>Visualizza Modello 5/A (rev9) automatico e stampabile</font><b></a><br/>
<a href="javascript:openMod5Rev('<%=TicketDetails.getId()%>', 'B', '9');"><font size="3px" color="#006699"><b>Visualizza Modello 5/B (rev9) automatico e stampabile</font><b></a>
<% } else if (TicketDetails.getAssignedDate().after(dataRev8)) {%>
<a href="javascript:openMod5Rev('<%=TicketDetails.getId()%>', 'A', '8');"><font size="3px" color="#006699"><b>Visualizza Modello 5/A (rev8) automatico e stampabile</font><b></a><br/>
<a href="javascript:openMod5Rev('<%=TicketDetails.getId()%>', 'B', '8');"><font size="3px" color="#006699"><b>Visualizza Modello 5/B (rev8) automatico e stampabile</font><b></a>
<% } else { %>
<br/><br/>
