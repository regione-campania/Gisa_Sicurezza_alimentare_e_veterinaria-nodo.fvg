...
<form name="addticket" action="ColonieNonConformita.do?command=Insert&auto-populate=true" method="post">
<input type = "hidden" id = "dosubmit" name = "dosubmit" value = "0">
<%-- Trails --%>
<table class="trails" cellspacing="0">
<tr>
<td>
<a  href="Colonie.do"  onclick="return !this.disabled;">Colonie</a> > 
<a href="Colonie.do?command=Search"  onclick="return !this.disabled;"><dhv:label name="accounts.SearchResults">Search Results</dhv:label></a> >
<a href="Colonie.do?command=Details&orgId=<%=OrgDetails.getOrgId()%>"  onclick="return !this.disabled;">Scheda Colonia</a> >
<a href="Colonie.do?command=ViewVigilanza&orgId=<%=OrgDetails.getOrgId()%>"  onclick="return !this.disabled;"><dhv:label name="">Controlli Ufficiali</dhv:label></a> >
<a href="ColonieVigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC")%>&orgId=<%=OrgDetails.getOrgId()%>"  onclick="return !this.disabled;"><dhv:label name="">Controllo Ufficiale</dhv:label></a> >
