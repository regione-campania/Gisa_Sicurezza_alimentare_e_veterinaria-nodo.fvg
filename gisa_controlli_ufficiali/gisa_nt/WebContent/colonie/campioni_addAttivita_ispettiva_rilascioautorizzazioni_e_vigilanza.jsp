...
<form name="addticket" action="ColonieCampioni.do?command=Insert&auto-populate=true" method="post">
...
<%-- <input type="button" value="Annulla" onClick="window.location.href='ColonieVigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC") %>&orgId=<%=OrgDetails.getOrgId()%>';this.form.dosubmit.value='false';" /> --%>
<br>
<dhv:formMessage />
