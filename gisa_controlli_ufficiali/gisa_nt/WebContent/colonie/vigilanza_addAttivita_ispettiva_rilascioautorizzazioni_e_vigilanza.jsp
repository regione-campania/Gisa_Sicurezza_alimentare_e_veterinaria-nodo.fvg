...
costruisci_rel_ateco_attivita('<%= OrgDetails.getOrgId() %>', 'id_linea_sottoposta_a_controllo');">
 ...
 <%
    ...
    TipoCampione.setJsEvent("onChange=javascript:reloadAddCU('ColonieVigilanza.do?command=Add&orgId="+OrgDetails.getOrgId()+"&tipoCampione='+this.value)"); 
...
<form method="post" name="addticket" action="ColonieVigilanza.do?command=Insert&auto-populate=true"  >
<%-- Trails --%>
...
<input type="submit" value="Annulla" onClick="javascript:this.form.action='Colonie.do?command=ViewVigilanza&orgId=<%=OrgDetails.getOrgId()%>'">
<br>
