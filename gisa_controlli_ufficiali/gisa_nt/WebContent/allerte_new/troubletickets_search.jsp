...
<table cellpadding="4" cellspacing="0" width="100%" class="details">
  ...
  <tr>
   ...
   <tr>
    ...
    <td>
       Dal <input class="date_picker" type="text" id="searchtimestampDataApertura" name="searchtimestampDataApertura" size="10" value="<%= "" %>"/>      
       al  <input class="date_picker" type="text" id="searchtimestampDataApertura2" name="searchtimestampDataApertura2" onclick="checkDataFine('searchtimestampDataApertura','searchtimestampDataApertura2')" size="10" value="<%= ""%>"/> 
    </td>
  </tr>
...
$( document ).ready(function() {
	calenda('searchtimestampDataApertura','','0');
	calenda('searchtimestampDataApertura2','','0');
});
</script>
