...
<%@page import="org.aspcfs.modules.macellazioni.base.Organi"%>
...
<jsp:useBean id="CapoLog"			class="org.aspcfs.modules.macellazioni.base.CapoLog"		scope="request" />
...
<!--<jsp:useBean id="Organo"			class="org.aspcfs.modules.macellazioni.base.Organi"			scope="request" />-->
...
<form name="main" action="Macellazioni.do?command=<%=(update) ? ("Update") : ("Save") %>" method="post" onsubmit="return controllaForm( false );" >
...
<!--***************************************************************-->
	...
	<input id="liberoConsumoButton" type="button" value="Libero Consumo >>" onclick="if(controllaForm( true )){document.main.action='Macellazioni.do?command=ToLiberoConsumo&cdSedutaMacellazione=<%=cdSedutaMacellazione%>&vpmData=<%=vpmData%>&mavamData=<%=mavamData%>';settaSoloCD('false');document.main.submit();};" />
