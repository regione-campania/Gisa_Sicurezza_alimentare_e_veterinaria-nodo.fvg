...
<form method ="post" action = "Macellazioni.do?command=Search">
...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="details">
        ...
        <tr>
         <td class="formLabel">
          ...
          <td>
            <input type="text" size="23" name="matricola" value="<%= request.getAttribute("matricola_cercata") != null ? (String)request.getAttribute("matricola_cercata") : toHtmlValue( Capo.getCd_matricola()) %>">
          	&nbsp;
    ...
    <tr>
        ...
        <table class="details" width="100%" border="0" cellpadding="4" cellspacing="0">
            ...
            <tr class="containerBody">
            	...
            	<td>
            	<a href="Stabilimenti.do?command=Details&orgId=<%=OrgDetails.getOrgId() %>"><%=OrgDetails.getName() %></a>
            	</td>
            </tr>
              <tr class="containerBody">
...
else if( request.getAttribute("matricola_cercata") != null )
{
	String stringa_msg = "";
	if(((String)request.getAttribute("matricola_cercata")).trim().length() == 0 )
	{
		stringa_msg = "<center><div><font size=\"2px\"><b>INSERIRE MATRICOLA DA RICERCARE</b></font></div></center>" ;
	}
	else
	{
		stringa_msg = "<center><div><font size=\"2px\"><b>NESSUN CAPO TROVATO PER LA MATRICOLA ?</b></font></div></center>".replace("?",
				((String)request.getAttribute("matricola_cercata")).toUpperCase() );
		 
	}
	out.println(stringa_msg);
}
