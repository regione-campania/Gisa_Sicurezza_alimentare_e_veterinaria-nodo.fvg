...
<input type="hidden" name="cd_seduta_macellazione" value="<%=Capo.getCd_seduta_macellazione() %>" />
...
<!--***************************************************************-->
	...
	<input id="liberoConsumoButton" type="button" value="Libero Consumo >>" onclick="if(controllaForm( true )){document.main.action='Macellazioni.do?command=ToLiberoConsumo';settaSoloCD('false');document.main.submit();};" />
