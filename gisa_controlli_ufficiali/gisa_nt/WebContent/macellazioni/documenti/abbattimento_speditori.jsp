...
<table class="trails" cellspacing="0">
	<tr>
		<td>
			...
			%>
			<a href="Macellazioni.do?command=List&orgId=<%=OrgDetails.getOrgId() %>">Macellazioni</a> > Abbattimento
		</td>
	</tr>
</table>
...
<br/><br/>
	...
	<form name="macellazioniForm" action="MacellazioniDocumenti.do">
	 ...
	 <script type="text/javascript">
            ...
            function onInvokeExportAction(id) {
                ...
                location.href = 'MacellazioniDocumenti.do?command=SpeditoriAbbattimento&' + parameterString;
            }
    </script>
