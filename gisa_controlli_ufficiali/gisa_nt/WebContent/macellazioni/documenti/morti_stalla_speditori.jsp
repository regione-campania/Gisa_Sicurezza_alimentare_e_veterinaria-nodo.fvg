...
<table class="trails" cellspacing="0">
	<tr>
		<td>
			...
			%>
			<a href="Macellazioni.do?command=List&orgId=<%=OrgDetails.getOrgId() %>">Macellazioni</a> > Anim. morti in stalla/trasporto
		</td>
	</tr>
</table>
	...
	<form name="macellazioniForm" action="MacellazioniDocumenti.do">
	 ...
	 <script type="text/javascript">
            ...
            function onInvokeExportAction(id) {
                ...
                location.href = 'MacellazioniDocumenti.do?command=SpeditoriMortiStalla&' + parameterString;
            }
    </script>
