...
<table class="trails" cellspacing="0">
	<tr>
		<td>
			...
			%>
			<a href="Macellazioni.do?command=List&orgId=<%=OrgDetails.getOrgId() %>">Macellazioni</a> > Modello Idatidosi
		</td>
	</tr>
</table>
...
<br/><br/>
<form name="main" action="Macellazioni.do?command=PrintModelloIdatidosi&file=modello_idatidosi.xml&orgId=<%= param1.substring(6,param1.length()) %>" method="post" >
