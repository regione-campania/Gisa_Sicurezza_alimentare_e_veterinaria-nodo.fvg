<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <jsp:useBean id="ecList" class="java.util.Vector" scope="request"/>
  <%@page import="org.aspcfs.modules.macellazioni.base.Art17ErrataCorrige"%>
...
function openPopupListaErrataCorrigeArt17(idCapo, orgId, idErrataCorrige){
window.location='GestioneDocumenti.do?command=GeneraPDFMacelli&tipo=Macelli_17_ErrataCorrige&orgId='+orgId+'&idCapo='+idCapo+'&idErrataCorrige='+idErrataCorrige;
}
</script>
...
<center><strong><u>Moduli Errata Corrige generati per il capo matricola <%=Capo.getCd_matricola() %></u></strong></center>
<br/><br/>
...
<td> <input type="button" onClick="openPopupListaErrataCorrigeArt17('<%=ec.getIdCapo() %>', '<%=ec.getIdMacello() %>', '<%=ec.getId()%>')" value="RIGENERA PDF"/> </td>
</tr>			
				<% } } %>
