...
<table class="trails" cellspacing="0">
	<tr>
		<td>
			...
			%>
			<a href="Macellazioni.do?command=List&orgId=<%=OrgDetails.getOrgId() %>">Macellazioni</a> > Modulo BSE
		</td>
	</tr>
</table>
...
<br/><br/>
<form name="main" action="MacellazioniDocumenti.do?command=BSE" method="post" >
