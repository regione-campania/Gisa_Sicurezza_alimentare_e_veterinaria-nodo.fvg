...
<tr class="containerBody">
  ...
  <table width="100%">
     ...
     <b> Sanzione</b>
         ...
         <td  valign="top" nowrap>
   			<a href="<%=thisSan.getURlDettaglio()%>Sanzioni.do?command=TicketDetails&stabId=<%= thisSan.getIdStabilimento()%>&id=<%= thisSan.getId() %>&idNodo=<%=request.getAttribute("idNodo") %>&idC=<%=request.getAttribute("idC")%>&idNC=<%=TicketDetails.getId()%>&orgId=<%= thisSan.getOrgId()%><%= addLinkParams(request, "popup|popupType|actionId") %>"><%= thisSan.getIdentificativo() %></a>
   		</td>
        <td valign="top">
     ...
     <tr >
      ...
      <b>Sequestro</b>
         ...
         <td  valign="top" nowrap>
   			<a href="<%=thisSan.getURlDettaglio()%>Sequestri.do?command=TicketDetails&stabId=<%= thisSan.getIdStabilimento()%>&id=<%= thisSan.getId() %>&idNodo=<%=request.getAttribute("idNodo") %>&idC=<%=request.getAttribute("idC")%>&idNC=<%=TicketDetails.getId()%>&orgId=<%= thisSan.getOrgId()%><%= addLinkParams(request, "popup|popupType|actionId") %>"><%= thisSan.getIdentificativo() %></a>
   		</td>
        <td valign="top">
         <% if(!User.getTimeZone().equals(thisSan.getAssignedDate())){%>
         <zeroio:tz timestamp="<%= thisSan.getAssignedDate() %>" timeZone="<%= User.getTimeZone() %>" dateOnly="true" showTimeZone="false" default="&nbsp;"/>
    ...
    <b> Diffida</b>
        ...
        <td  valign="top" nowrap>
  			<a href="<%=thisSan.getURlDettaglio()%>Diffida.do?command=TicketDetails&stabId=<%= thisSan.getIdStabilimento()%>&id=<%= thisSan.getId() %>&idNodo=<%=request.getAttribute("idNodo") %>&idC=<%=request.getAttribute("idC")%>&idNC=<%=TicketDetails.getId()%>&orgId=<%= thisSan.getOrgId()%><%= addLinkParams(request, "popup|popupType|actionId") %>"><%= thisSan.getIdentificativo() %></a>
  		</td>
       <td valign="top">
        <% if(!User.getTimeZone().equals(thisSan.getAssignedDate())){%>
        <zeroio:tz timestamp="<%= thisSan.getAssignedDate() %>" timeZone="<%= User.getTimeZone() %>" dateOnly="true" showTimeZone="false" default="&nbsp;"/>
    ...
    <%}%>
     ...
     <b> Notizia di Reato</b>
         ...
         <td  valign="top" nowrap>
   			<a href="<%=thisSan.getURlDettaglio()%>Reati.do?command=TicketDetails&stabId=<%= thisSan.getIdStabilimento()%>&id=<%= thisSan.getId() %>&idNodo=<%=request.getAttribute("idNodo") %>&idC=<%=request.getAttribute("idC")%>&idNC=<%=TicketDetails.getId()%>&orgId=<%= thisSan.getOrgId()%><%= addLinkParams(request, "popup|popupType|actionId") %>"><%= thisSan.getIdentificativo() %></a>
   		</td>
        <td valign="top">
         <% if(!User.getTimeZone().equals(thisSan.getAssignedDate())){%>
         <zeroio:tz timestamp="<%= thisSan.getAssignedDate() %>" timeZone="<%= User.getTimeZone() %>" dateOnly="true" showTimeZone="false" default="&nbsp;"/>
     ...
     <tr >
      ...
      <b>Followup</b>
         ...
         <td  valign="top" nowrap>
   			<a href="<%=thisSan.getURlDettaglio()%>Followup.do?command=TicketDetails&stabId=<%= thisSan.getIdStabilimento()%>&id=<%= thisSan.getId() %>&idNodo=<%=request.getAttribute("idNodo") %>&idC=<%=request.getAttribute("idC")%>&idNC=<%=TicketDetails.getId()%>&orgId=<%= thisSan.getOrgId()%><%= addLinkParams(request, "popup|popupType|actionId") %>"><%= thisSan.getIdentificativo() %></a>
   		</td>
        <td valign="top">
         <% if(!User.getTimeZone().equals(thisSan.getAssignedDate())){%>
         <zeroio:tz timestamp="<%= thisSan.getAssignedDate() %>" timeZone="<%= User.getTimeZone() %>" dateOnly="true" showTimeZone="false" default="&nbsp;"/>
