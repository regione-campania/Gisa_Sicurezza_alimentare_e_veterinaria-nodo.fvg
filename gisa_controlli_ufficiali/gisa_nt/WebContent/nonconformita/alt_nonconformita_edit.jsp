...
<!-- cambiato nome perche' per qualche motivo cambiando classe si nasconde come ci aspettavamo flusso 304 -->
 <%@ include file="alt_non_conformita_formali_edit.jsp" %>

</div>
<div class="tabbertab">
 <%@ include file="alt_non_conformita_significative_edit.jsp" %>

</div>
 
 <div class="tabbertab">
 <%@ include file="alt_non_conformita_gravi_edit.jsp" %>

 </div>
 </div>

<input type="hidden" name="altId" id="altId" value="<%=CU.getAltId() %>">
