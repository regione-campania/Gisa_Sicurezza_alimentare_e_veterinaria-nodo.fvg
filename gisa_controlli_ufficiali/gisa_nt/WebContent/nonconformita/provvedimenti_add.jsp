...
function openNotePopupSanzioneTerzi(tipologia,impresa,orgId,idC,dataC,tipo_nc){
	...
	var result;
		...
		window.open('SanzioniNC.do?command=Add&idC='+idC+'&dataC='+dataC+'&orgId='+orgId+'&orgIdSanzionata='+impresa+'&tipologiaOp='+tipologia+'&tipoNc='+tipo_nc,null,
		'height=800px,width=680px,toolbar=no,directories=no,status=no,continued from previous linemenubar=no,scrollbars=yes,resizable=no ,modal=yes');
...
<table cellpadding="4" cellspacing="0" width="100%" class="details">
 ...
 <tr>
    ...
    <tr>
    <td align="left">
    <a href="javascript:openRicercaGlobale()">Seleziona da elenco</a>
    </td>
<!--  	<td align="center"> -->
<!--     <a href="javascript:openAggiungiOpFuoriRegione()">Inserisci operatore fuori regione</a> -->
<!--     </td> -->
    </tr>
    </table>
...
<div class="tabbertab">
 ...
 <%@ include file="provvedimenti_gravi.jsp" %>
