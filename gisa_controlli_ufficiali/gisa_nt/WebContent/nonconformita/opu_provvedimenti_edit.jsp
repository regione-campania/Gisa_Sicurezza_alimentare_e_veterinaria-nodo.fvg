...
function openNotePopupFollowup(orgId,idC,dataC,tipo_nc){
	...
	var tipologiaNc = document.getElementById("Provvedimenti"+tipo_nc+"_1").value;
		...
		window.open('FollowupNC.do?command=Add&idC='+idC+'&dataC='+dataC+'&stabId='+orgId+'&tipoNc='+tipo_nc+'&tipologiaNc='+tipologiaNc,null,
...
function openNotePopupDiffida(orgId,idC,dataC,tipo_nc){
	...
	var result;
		...
		window.open('DiffidaNC.do?command=Add&idC='+idC+'&dataC='+dataC+'&stabId='+orgId+'&tipoNc='+tipo_nc,null,
...
function openNotePopupSanzione(stabId,idC,dataC,tipo_nc){
	var res;
	var result;

	
		window.open('SanzioniNC.do?command=Add&idC='+idC+'&dataC='+dataC+'&stabId='+stabId+'&tipoNc='+tipo_nc,null,
		'height=800px,width=680px,toolbar=no,directories=no,status=no,continued from previous linemenubar=no,scrollbars=yes,resizable=no ,modal=yes');
...
function openNotePopupSanzioneTerzi(impresa,stabId,idC,dataC,tipo_nc){
	var res;
	var result;

	
		window.open('SanzioniNC.do?command=Add&idC='+idC+'&dataC='+dataC+'&stabId='+stabId+'&orgIdSanzionata='+impresa+'&tipoNc='+tipo_nc,null,
		'height=800px,width=680px,toolbar=no,directories=no,status=no,continued from previous linemenubar=no,scrollbars=yes,resizable=no ,modal=yes');
...
function openNotePopupSequestro(orgId,idC,dataC,tipo_nc){
	...
	var result;
		...
		window.open('SequestriNC.do?command=Add&idC='+idC+'&dataC='+dataC+'&stabId='+orgId+'&tipoNc='+tipo_nc,null,
		'height=800px,width=680px,toolbar=no,directories=no,status=no,continued from previous linemenubar=no,scrollbars=yes,resizable=no ,modal=yes');
...
function openNotePopupReato(orgId,idC,dataC,tipo_nc){
	...
	var result;
		...
		window.open('ReatiNC.do?command=Add&idC='+idC+'&dataC='+dataC+'&stabId='+orgId+'&tipoNc='+tipo_nc,null,
		'height=800px,width=680px,toolbar=no,directories=no,status=no,continued from previous linemenubar=no,scrollbars=yes,resizable=no ,modal=yes');
...
<div class="tabbertab">
 <%@ include file="opu_non_conformita_formali.jsp" %>

</div>
<div class="tabbertab">
 <%@ include file="opu_non_conformita_significative.jsp" %>

</div>
 </div>
 <div class="tabbertab">
 <%@ include file="opu_provvedimenti_gravi_edit.jsp" %>
