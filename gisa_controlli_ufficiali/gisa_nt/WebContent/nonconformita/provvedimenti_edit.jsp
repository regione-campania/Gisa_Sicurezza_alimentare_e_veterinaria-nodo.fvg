...
<table cellpadding="4" cellspacing="0" width="100%" class="details">
 ...
 <tr>
    ...
    <td>
     ...
     <input type = "hidden" name = "id_impresa_sanzionata" id = "id_impresa_sanzionata" value="<%=(TicketDetails.isFuoriRegioneImpresaSanzionata()) ? "-999" : TicketDetails.getIdImpresaSanzionata()%>">
     <input type = "hidden" name = "id_tipologia_operatore" id = "id_tipologia_operatore" value="<%=(TicketDetails.isFuoriRegioneImpresaSanzionata()) ? "-999" : TicketDetails.getIdTipologiaImpresaSanzionata()%>">
...
<div class="tabbertab">
 ...
 <div class="tabbertab">
 <%@ include file="provvedimenti_gravi_edit.jsp" %>
