  ...
  <table width="100%">
     ...
     <tr >
         <td  valign="top" nowrap>
   			<a href="<%=thisSan.getURlDettaglio()%>Followup.do?command=TicketDetails&container=<%=request.getParameter("container")%>&id=<%= thisSan.getId() %>&idC=<%=request.getAttribute("idC")%>&idNC=<%=TicketDetails.getId()%>&idNodo=<%=request.getAttribute("idNodo") %>&orgId=<%= thisSan.getOrgId()%><%= addLinkParams(request, "popup|popupType|actionId") %>"><%= thisSan.getIdentificativo() %></a>
   		</td>
        <td valign="top">
...
<tr class="containerBody">
    ...
    <td>
      ...
      <textarea cols="55" rows="6" disabled="disabled"> <%=nc.getNote() %></textarea>
          ...
          <td>
      <%
      	out.println("<b>N.C Significative</b> "+ii+"</br>"); 
     	out.print(nc.getDescrizione_nc().toUpperCase()+"<br>");
...
<%
       ...
       if(CU.getTipoCampione()!=5)
       {
    	   ...
    	   if(TicketDetails.getPuntiSignificativi()!=null && !TicketDetails.getPuntiSignificativi().equals("0") && !TicketDetails.getPuntiSignificativi().equals("")){
    	   %>
       <tr  class="containerBody">
...
<tr class="containerBody">
  ...
  <table width="100%">
     ...
     <tr >
         <td  valign="top" nowrap>
   			<a href="<%=thisSan.getURlDettaglio()%>Followup.do?command=TicketDetails&container=<%=request.getParameter("container")%>&id=<%= thisSan.getId() %>&idC=<%=request.getAttribute("idC")%>&idNodo=<%=request.getAttribute("idNodo") %>&idNC=<%=TicketDetails.getId()%>&orgId=<%= thisSan.getOrgId()%><%= addLinkParams(request, "popup|popupType|actionId") %>"><%= thisSan.getIdentificativo() %></a>
   		</td>
        <td valign="top">
         <% if(!User.getTimeZone().equals(thisSan.getAssignedDate())){%>
         <zeroio:tz timestamp="<%= thisSan.getAssignedDate() %>" timeZone="<%= User.getTimeZone() %>" dateOnly="true" showTimeZone="false" default="&nbsp;"/>
...
<%
  ...
  <table width="100%">
     ...
     <b> Sanzione</b>
         ...
         <td  valign="top" nowrap>
   			<a href="<%=thisSan.getURlDettaglio()%>Sanzioni.do?command=TicketDetails&container=<%=request.getParameter("container")%>&id=<%= thisSan.getId() %>&idNodo=<%=request.getAttribute("idNodo") %>&idC=<%=request.getAttribute("idC")%>&idNC=<%=TicketDetails.getId()%>&orgId=<%= thisSan.getOrgId()%><%= addLinkParams(request, "popup|popupType|actionId") %>"><%= thisSan.getIdentificativo() %></a>
   		</td>
        <td valign="top">
         <% if(!User.getTimeZone().equals(thisSan.getAssignedDate())){%>
         <zeroio:tz timestamp="<%= thisSan.getAssignedDate() %>" timeZone="<%= User.getTimeZone() %>" dateOnly="true" showTimeZone="false" default="&nbsp;"/>
     ...
     <tr >
      ...
      <b>Sequestro</b>
         ...
         <td  valign="top" nowrap>
   			<a href="<%=thisSan.getURlDettaglio()%>Sequestri.do?command=TicketDetails&container=<%=request.getParameter("container")%>&id=<%= thisSan.getId() %>&idNodo=<%=request.getAttribute("idNodo") %>&idC=<%=request.getAttribute("idC")%>&idNC=<%=TicketDetails.getId()%>&orgId=<%= thisSan.getOrgId()%><%= addLinkParams(request, "popup|popupType|actionId") %>"><%= thisSan.getIdentificativo() %></a>
   		</td>
        <td valign="top">
         <% if(!User.getTimeZone().equals(thisSan.getAssignedDate())){%>
         <zeroio:tz timestamp="<%= thisSan.getAssignedDate() %>" timeZone="<%= User.getTimeZone() %>" dateOnly="true" showTimeZone="false" default="&nbsp;"/>
    ...
    <b> Diffida</b>
        ...
        <td  valign="top" nowrap>
  			<a href="<%=thisSan.getURlDettaglio()%>Diffida.do?command=TicketDetails&container=<%=request.getParameter("container")%>&id=<%= thisSan.getId() %>&idNodo=<%=request.getAttribute("idNodo") %>&idC=<%=request.getAttribute("idC")%>&idNC=<%=TicketDetails.getId()%>&orgId=<%= thisSan.getOrgId()%><%= addLinkParams(request, "popup|popupType|actionId") %>"><%= thisSan.getIdentificativo() %></a>
  		</td>
       <td valign="top">
        <% if(!User.getTimeZone().equals(thisSan.getAssignedDate())){%>
        <zeroio:tz timestamp="<%= thisSan.getAssignedDate() %>" timeZone="<%= User.getTimeZone() %>" dateOnly="true" showTimeZone="false" default="&nbsp;"/>
    ...
    <%}%>
     ...
     <b> Notizia di Reato</b>
         ...
         <td  valign="top" nowrap>
   			<a href="<%=thisSan.getURlDettaglio()%>Reati.do?command=TicketDetails&container=<%=request.getParameter("container")%>&id=<%= thisSan.getId() %>&idNodo=<%=request.getAttribute("idNodo") %>&idC=<%=request.getAttribute("idC")%>&idNC=<%=TicketDetails.getId()%>&orgId=<%= thisSan.getOrgId()%><%= addLinkParams(request, "popup|popupType|actionId") %>"><%= thisSan.getIdentificativo() %></a>
   		</td>
        <td valign="top">
         <% if(!User.getTimeZone().equals(thisSan.getAssignedDate())){%>
         <zeroio:tz timestamp="<%= thisSan.getAssignedDate() %>" timeZone="<%= User.getTimeZone() %>" dateOnly="true" showTimeZone="false" default="&nbsp;"/>
     ...
     <tr >
      ...
      <b>Followup</b>
         ...
         <td  valign="top" nowrap>
   			<a href="<%=thisSan.getURlDettaglio()%>Followup.do?command=TicketDetails&container=<%=request.getParameter("container")%>&id=<%= thisSan.getId() %>&idNodo=<%=request.getAttribute("idNodo") %>&idC=<%=request.getAttribute("idC")%>&idNC=<%=TicketDetails.getId()%>&orgId=<%= thisSan.getOrgId()%><%= addLinkParams(request, "popup|popupType|actionId") %>"><%= thisSan.getIdentificativo() %></a>
   		</td>
        <td valign="top">
         <% if(!User.getTimeZone().equals(thisSan.getAssignedDate())){%>
         <zeroio:tz timestamp="<%= thisSan.getAssignedDate() %>" timeZone="<%= User.getTimeZone() %>" dateOnly="true" showTimeZone="false" default="&nbsp;"/>
