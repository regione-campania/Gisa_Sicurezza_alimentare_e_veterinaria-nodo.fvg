...
function openNotePopupSanzione(orgId,idC,dataC,tipo_nc){
	...
	var result;
		...
		window.open('SanzioniNC.do?command=Add&idC='+idC+'&dataC='+dataC+'&stabId='+orgId+'&tipoNc='+tipo_nc,null,
		'height=800px,width=680px,toolbar=no,directories=no,status=no,continued from previous linemenubar=no,scrollbars=yes,resizable=no ,modal=yes');
		
		
		} 
		
function openNotePopupSanzioneTerzi(tipologia,impresa,orgId,idC,dataC,tipo_nc){
	var res;
	var result;

	
		window.open('SanzioniNC.do?command=Add&idC='+idC+'&dataC='+dataC+'&stabId='+orgId+'&orgIdSanzionata='+impresa+'&tipologiaOp='+tipologia+'&tipoNc='+tipo_nc,null,
		'height=800px,width=680px,toolbar=no,directories=no,status=no,continued from previous linemenubar=no,scrollbars=yes,resizable=no ,modal=yes');
...
<div class="tabbertab">
 ...
 <%@ include file="opu_provvedimenti_gravi.jsp" %>
