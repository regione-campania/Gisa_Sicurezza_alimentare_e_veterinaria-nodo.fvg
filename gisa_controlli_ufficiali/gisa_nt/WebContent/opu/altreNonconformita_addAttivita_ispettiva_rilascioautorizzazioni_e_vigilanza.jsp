...
<form name="addticket" action="<%=OrgDetails.getAction() %>NonConformita.do?command=Insert&auto-populate=true" method="post">
...
<table cellpadding="4" cellspacing="0" width="100%" class="details">
 ...
 <%@ include  file="../nonconformita/opu_non_conformita_add.jsp" %>
...
<input type="submit" id = "btn_salva2" disabled="disabled" value="Inserisci" name="Save" onClick="tastoInserisci = true; return checkForm(this.form)">
