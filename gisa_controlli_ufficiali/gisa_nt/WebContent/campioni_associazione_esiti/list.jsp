...
%>
    	...
    	<tr class="containerBody">
    		...
    		<td>
	   			<input class="date_picker" type="text" name="cmp_data_ricezione_esito_<%=index%>" id="cmp_data_ricezione_esito_<%=index%>" size="10" value="<%=DateUtils.timestamp2string(campione.getData_ricezione_esito())%>" />&nbsp;  
				<script type="text/javascript">
					calenda('cmp_data_ricezione_esito_<%=index%>','','0');
				</script>
			</td>
    	</tr>
