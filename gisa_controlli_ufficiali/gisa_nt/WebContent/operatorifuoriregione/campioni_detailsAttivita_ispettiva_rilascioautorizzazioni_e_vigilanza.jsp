...
function apriVerbale(idCampione,tipoAnalisi)
{
	...
	document.location.href="OperatoriFuoriRegioneCampioni.do?command=StampaScheda&tipoAnalisi="+tipoAnalisi+"&idCampione="+idCampione+"&tipoAlimenti="+tipoAlimenti;
...
<form id="details" name="details" action="OperatoriFuoriRegioneCampioni.do?command=ModifyTicket&auto-populate=true" method="post">
...
<td>
  ...
  <a href="OperatoriFuoriRegione.do?command=Details&orgId=<%=TicketDetails.getOrgId()%>"><dhv:label name="">Scheda Operatore Altre ASL della Campania</dhv:label></a> >
...
if(request.getAttribute("Messaggio2")!=null)
{
	...
	function doSubmit(idTicket){
		...
		document.details.action="OperatoriFuoriRegioneCampioni.do?command=Chiudi&id="+idTicket+"&chiudiCu=true'"
