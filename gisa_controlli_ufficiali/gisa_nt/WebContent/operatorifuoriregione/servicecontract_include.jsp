      ...
      <tr>
        ...
        <td>
          ...
          <% if(serviceContract.getImpiantoId() == -1) {%>
            ...
            [<a href="javascript:popListaImpianti('assetId','addAsset', 'filters=allassets|allassetsandcomponenti','ubicazioneId','addUbicazione');"><dhv:label name="accounts.accounts_add.select">Select</dhv:label></a>]
