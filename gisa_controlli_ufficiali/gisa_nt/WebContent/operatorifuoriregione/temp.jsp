...
<form name="addticket" action="OperatoriFuoriRegioneSequestri.do?command=Insert&auto-populate=true" method="post">
<%-- Trails --%>
...
<a href="OperatoriFuoriRegioneNonConformita.do?command=TicketDetails&id=<%= request.getAttribute("idNC")%>&orgId=<%=OrgDetails.getOrgId()%>"><dhv:label name="">Non Conformità Rilevata</dhv:label></a> >
...
<input type="submit" value="Annulla" onClick="javascript:this.form.action='OperatoriFuoriRegioneNonConformita.do?command=TicketDetails&id=<%= request.getAttribute("idNC")%>&orgId=<%=OrgDetails.getOrgId()%>'"><br>
<dhv:formMessage />
...
String aslCU=(String)request.getAttribute("aslCU");
int aslcu=Integer.parseInt(aslCU);
...
<br>
<input type="submit" value="<dhv:label name="button.insert">Insert</dhv:label>" name="Save" onClick="return checkForm(this.form)">
<input type="submit" value="Annulla" onClick="javascript:this.form.action='OperatoriFuoriRegioneNonConformita.do?command=TicketDetails&id=<%= request.getAttribute("idNC")%>&orgId=<%=OrgDetails.getOrgId()%>'"></form>
