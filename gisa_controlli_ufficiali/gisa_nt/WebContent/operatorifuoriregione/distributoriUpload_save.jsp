...
<tr>
<td width="100%">
  <a href="Assets.do"><dhv:label name="">Operatori Fuori Regione</dhv:label></a> >
  <dhv:label name="">Importa Distributori</dhv:label>
</td>
</tr>
</table>
<%-- End Trails --%>
...
<%String orgId=(String) request.getAttribute("orgId"); %>
  ...
  <input type="submit" value="<dhv:label name="global.button.c">Chiudi</dhv:label>" onClick="this.form.action='OperatoriFuoriRegione.do?command=Details&orgId=<%=orgId %>'" /><br/>
  <dhv:formMessage />
  <br />
</form>
</body>