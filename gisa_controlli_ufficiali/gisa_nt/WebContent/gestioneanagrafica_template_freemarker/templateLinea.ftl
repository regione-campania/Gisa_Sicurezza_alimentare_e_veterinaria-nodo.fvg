...
<tr>
	<td>
		<#if id_causale == '1'>
			...
			<a href="GestionePraticheAction.do?command=ListaPraticheStabilimenti">
				GESTIONE ATT. FISSE, MOBILI E RICONOSCIMENTO</a> > INSERISCI STABILIMENTO
		<#else>
			<a href="OpuStab.do?command=SearchForm">ANAGRAFICA STABILIMENTI</a> > INSERISCI STABILIMENTO
		</#if>
	</td>
</tr>
</table>
...
<div id="tipo_linee" style="display:none">
	<center >
	<h2>seleziona il tipo di stabilimento che si andra' ad inserire</h2>
	<br>
		
		
		<#if id_causale == '1'>
			<fieldset style="display : inline-block; text-align : left; font-size: 20px;">
			<legend><b>REGISTRATI</b></legend>
				<table cellpadding="20">
					<tr>
						<td>
							<label style="text-align:center; font-size: 20px;">CON SEDE FISSA</label>
						</td>
						<td>
							<input type="radio" id="attivitaConSedeFissa" name="selezioneTipoAttivita" value="1"  
								onClick="document.getElementById('tipo_linee_attivita').value = this.value;
										 document.getElementById('tipo_linee_attivita_flag_registrabili').value = '1';
										 document.getElementById('tipo_linee_attivita_flag_riconosciuti').value = '0';
										 document.getElementById('tipo_linee').style='display: none';
										 document.getElementById('scheda_inserimento_linee_attivita').style='display:';
										 document.getElementById('info_linee_stabilimento').innerHTML =
										 	'<p><b>Stai inserendo uno stabilimento registrato con sede fissa, puoi aggiungere una o più linee di attività cliccando sul bottone \'aggiungi linea di attività\'</b></p>'; 
										 document.getElementById('info_scheda_stabilimento').innerHTML = '<p><b>Stai inserendo uno stabilimento registrato con sede fissa</b></p>'; 
										 "/> 
						</td>
					</tr>
					<tr>
						<td>
							<label style="text-align:center; font-size: 20px;">SENZA SEDE FISSA</label>
						</td>
						<td>
							<input type="radio" id="attivitaSenzaSedeFissa" name="selezioneTipoAttivita" value="2" 
								onClick="document.getElementById('tipo_linee_attivita').value = this.value;
										 document.getElementById('tipo_linee_attivita_flag_registrabili').value = '1';
										 document.getElementById('tipo_linee_attivita_flag_riconosciuti').value = '0';
										 document.getElementById('tipo_linee').style='display: none';
										 document.getElementById('scheda_inserimento_linee_attivita').style='display:';
										 document.getElementById('info_linee_stabilimento').innerHTML =
										 	'<p><b>Stai inserendo uno stabilimento registrato senza sede fissa, puoi aggiungere una linea di attività cliccando sul bottone \'aggiungi linea di attività\'</b></p>';
										 document.getElementById('info_scheda_stabilimento').innerHTML = '<p><b>Stai inserendo uno stabilimento registrato senza sede fissa</b></p>'; 
										 "/> 	
						</td>
					</tr>
				</table>
				<table>
					<tr><td><font color='red' size="2px"><br><br></font></td></tr>
				</table>
			</fieldset>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<fieldset style="display : inline-block; text-align : left; font-size: 20px;">
			<legend><b>RICONOSCIUTI</b></legend>
				<table cellpadding="20">
					<tr>
						<td><label style="text-align:center; font-size: 20px;">CON SEDE FISSA</label></td>
						<td>
						<input type="radio" id="attivitaConSedeFissa" name="selezioneTipoAttivita" value="1" 
							onClick="document.getElementById('tipo_linee_attivita').value = this.value;
									 document.getElementById('tipo_linee_attivita_flag_registrabili').value = '0';
									 document.getElementById('tipo_linee_attivita_flag_riconosciuti').value = '1';
									 document.getElementById('tipo_linee').style='display: none';
									 document.getElementById('scheda_inserimento_linee_attivita').style='display:';
									 document.getElementById('info_linee_stabilimento').innerHTML =
										 	'<p><b>Stai inserendo uno stabilimento riconosciuto con sede fissa, puoi aggiungere una o più linee di attività cliccando sul bottone \'aggiungi linea di attività\'</b></p>';
									 document.getElementById('info_scheda_stabilimento').innerHTML = '<p><b>Stai inserendo uno stabilimento riconosciuto con sede fissa</b></p>'; 
									 "/> 
						</td>
					</tr>
					<tr>
						...
						<input type="radio" id="attivitaSenzaSedeFissa" name="selezioneTipoAttivita" value="2" 
							onClick="document.getElementById('tipo_linee_attivita').value = this.value;
									 ...
									 document.getElementById('scheda_inserimento_linee_attivita').style='display:';
									 document.getElementById('info_linee_stabilimento').innerHTML =
										 	'<p><b>Stai inserendo uno stabilimento riconosciuto senza sede fissa, puoi aggiungere una linea di attività cliccando sul bottone \'aggiungi linea di attività\'</b></p>';
									 document.getElementById('info_scheda_stabilimento').innerHTML = '<p><b>Stai inserendo uno stabilimento riconosciuto senza sede fissa</b></p>'; 
									 "/> 
						</td>
					</tr>
				</table>
					...
					<tr>
						<td>
							<font color='red' size="2px">
								* esclusi: REG CE 853-04, REG CE 1069-09, REG 852-04 <br>riconosciuti 
									i quali vengono inseriti direttamente dalla regione
							</font>
						</td>
					</tr>
				</table>
		...
		<input type="hidden" id="tipo_linee_attivita" />
		...
		<input type="hidden" id="tipo_linee_attivita_flag_registrabili" />
		<input type="hidden" id="tipo_linee_attivita_flag_riconosciuti" />
	...
	<#else>
	<button type="button" class="yellowBigButton" style="width: 250px;" 
		onClick="loadModalWindowCustom('Attendere Prego...'); window.location.href='GestioneAnagraficaAction.do?command=Choose'">ANNULLA</button>
	</#if>
	</center>
</div>

<div id="scheda_inserimento_linee_attivita" style="display: none">
	...
	<center>
	<#-- <div id="div_button_conferma_linee_ok" style="display: none">  -->
	...
	<input type="button" class="yellowBigButton" style="width: 250px;" value="ANNULLA" 
		...
		<#if id_causale == '1'>
			onclick="var link = 'GestioneAnagraficaAction.do?command=Choose&numeroPratica=${numeroPratica}&tipoPratica=${tipoPratica}&dataPratica=${dataPratica}&comunePratica=${comunePratica}&causalePratica=${id_causale}';
		<#else>
...
function validateForm()
{
	...
	for (var i = 0; i < form_elements.elements.length; i++){
		var this_element = form_elements.elements[i];
			if(tipo_impresa ==17 && this_element.id == 'partita_iva_impresa'){
				 this_element.removeAttribute('required');
		}
...
function gestione_aggiunzione_linee(){
	if(document.getElementById('numero_linee_effettivo').value == '0' || document.getElementById('tipo_linee_attivita').value == '1' )
	{	
		...
		alert('Nota: per stabilimenti senza sede fissa è possibile aggiungere solo una linea di attività');
	}
