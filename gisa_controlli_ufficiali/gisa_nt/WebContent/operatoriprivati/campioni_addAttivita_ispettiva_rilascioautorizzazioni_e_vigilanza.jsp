...
<form name="addticket" action="OperatoriprivatiCampioni.do?command=Insert&auto-populate=true" method="post">
<%-- Trails --%>
...
<%-- <input type="button" value="Annulla" onClick="window.location.href='OperatoriprivatiVigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC") %>&altId=<%=OrgDetails.getAltId()%>';this.form.dosubmit.value='false';" /> --%>
<br>
<dhv:formMessage />
