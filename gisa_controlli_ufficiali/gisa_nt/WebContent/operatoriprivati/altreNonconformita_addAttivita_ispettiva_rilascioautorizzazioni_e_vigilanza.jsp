...
<form name="addticket" action="OperatoriprivatiNonConformita.do?command=Insert&auto-populate=true" method="post">
<input type = "hidden" id = "dosubmit" name = "dosubmit" value = "0">
<%-- Trails --%>
<table class="trails" cellspacing="0">
<tr>
<td>
<a  href="Operatoriprivati.do"  onclick="return !this.disabled;">Operatori Privati</a> > 
<a href="Operatoriprivati.do?command=Search"  onclick="return !this.disabled;"><dhv:label name="	s.SearchResults">Search Results</dhv:label></a> >
<a href="Operatoriprivati.do?command=Details&altId=<%=OrgDetails.getAltId()%>"  onclick="return !this.disabled;">Scheda Operatore Privato</a> >
 <a href="Operatoriprivati.do?command=ViewVigilanza&altId=<%=OrgDetails.getAltId()%>"  onclick="return !this.disabled;"><dhv:label name="">Controlli Ufficiali</dhv:label></a> >
 <a href="OperatoriprivatiVigilanza.do?command=TicketDetails&id=<%=request.getAttribute("idC")%>&altId=<%=OrgDetails.getAltId()%>"  onclick="return !this.disabled;"><dhv:label name="">Controllo Ufficiale</dhv:label></a> >
...
<table cellpadding="4" cellspacing="0" width="100%" class="details">
 ...
 <%@ include  file="../nonconformita/alt_non_conformita_add.jsp" %>
