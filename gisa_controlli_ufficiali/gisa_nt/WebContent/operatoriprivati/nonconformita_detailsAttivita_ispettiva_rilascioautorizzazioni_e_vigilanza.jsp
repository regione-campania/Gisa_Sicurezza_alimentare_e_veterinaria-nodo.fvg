...
<form name="details" action="OperatoriprivatiNonConformita.do?command=ModifyTicket&auto-populate=true" method="post">
<%-- Trails --%>
...
<td>
  ...
  <a href="Operatoriprivati.do?command=Details&altId=<%=TicketDetails.getAltId()%>">Scheda Operatore Privato</a> >
...
<dhv:container name="operatoriprivatinonconformita" selected="details" object="TicketDetails"
	param="<%=param1%>"
