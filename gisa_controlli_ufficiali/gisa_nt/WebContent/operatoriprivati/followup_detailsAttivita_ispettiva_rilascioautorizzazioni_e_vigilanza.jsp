...
<form name="details" action="OperatoriprivatiFollowup.do?command=ModifyTicket&auto-populate=true" method="post">
...
<tr>
<td>
<a href="Operatoriprivati.do"><dhv:label name="accounts.accounts">Operatoriprivati</dhv:label></a> > 
<a href="Operatoriprivati.do?command=Search"><dhv:label name="accounts.SearchResults">Search Results</dhv:label></a> >
<a href="Operatoriprivati.do?command=Details&altId=<%=TicketDetails.getAltId()%>"><dhv:label name="accounts.details">Operatoriprivati Details</dhv:label></a> >
...
%>
  <a href="OperatoriprivatiFollowup.do?command=TicketDetails&Id=<%=TicketDetails.getId()%>&altId=<%=OrgDetails.getAltId() %>"><dhv:label name="tickets.defects.viewDefects">View Defects</dhv:label></a> >
  <a href="OperatoriprivatiFollowupDefects.do?command=Details&defectId=<%= defectCheck %>"><dhv:label name="tickets.defects.defectDetails">Defect Details</dhv:label></a> >
<%
  	} else {
  %>
<%
...
%>
  <a href="OperatoriprivatiFollowup.do?command=SearchTicketsForm"><dhv:label name="tickets.searchForm">Search Form</dhv:label></a> >
  <a href="OperatoriprivatiFollowup.do?command=SearchTickets"><dhv:label name="accounts.SearchResults">Search Results</dhv:label></a> >
<%
  	} else {
  %> 
 <%--  <a href="Operatoriprivati.do?command=ViewFollowup&altId=<%=OrgDetails.getAltId()%>"><dhv:label name="followup.visualizza">Visualizza Notizie di Reato</dhv:label></a> > --%>
<%
   	}
   %>
<%
