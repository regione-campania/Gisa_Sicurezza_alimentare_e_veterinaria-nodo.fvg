...
<form name="details" action="OperatoriprivatiReati.do?command=ModifyTicket&auto-populate=true" method="post">
<%-- Trails --%>
...
{
	%>
<a href="OperatoriprivatiNonConformita.do?command=TicketDetails&idC=<%= request.getAttribute("idControllo")%>&id=<%= request.getAttribute("idNC")%>&altId=<%=TicketDetails.getAltId()%>"><dhv:label name="">Non Conformità Rilevata</dhv:label></a> >
	
	<%
}else
{
%>
<a href="OperatoriprivatiAltreNonConformita.do?command=TicketDetails&idC=<%= request.getAttribute("idControllo")%>&id=<%= request.getAttribute("idNC")%>&altId=<%=TicketDetails.getAltId()%>"><dhv:label name="">Non Conformità Rilevata</dhv:label></a> >
...
%>
  <a href="OperatoriprivatiReati.do?command=TicketDetails&Id=<%=TicketDetails.getId()%>&altId=<%=OrgDetails.getAltId() %>"><dhv:label name="tickets.defects.viewDefects">View Defects</dhv:label></a> >
...
%>
  <a href="OperatoriprivatiReati.do?command=SearchTicketsForm"><dhv:label name="tickets.searchForm">Search Form</dhv:label></a> >
  <a href="OperatoriprivatiReati.do?command=SearchTickets"><dhv:label name="accounts.SearchResults">Search Results</dhv:label></a> >
<%
  	} else {
  %> 
