...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="details">
 ...
 <%if (Flusso.getDataAnnullamento()==null) {%>
  <tr><td>Data annullamento</td> <td> <input type="text" readonly id="dataAnnullamento" name="dataAnnullamento" size="10" value=""/>
<a href="#" onClick="cal19.select(document.getElementById('dataAnnullamento'),'anchor19','dd/MM/yyyy'); return false;" NAME="anchor19" ID="anchor19">
<img src="images/icons/stock_form-date-field-16.gif" border="0" align="absmiddle"></a> &nbsp;
</td></tr>
 <tr><td>Note Annullamento</td> <td> <textarea id="noteAnnullamento" name="noteAnnullamento" cols="120" rows="3"></textarea></td></tr>
 <%} %>
 <tr><td colspan="2">
 
 <%if (Flusso.getDataAnnullamento()==null) {%>
 <input type="button" id="bottoneAnnullamento" value="ANNULLAMENTO" onClick="checkFormAnnullamento(this.form,1)"/>
 <%} else { %>
  <input type="button" id="bottoneAnnullamento" value="RIPRISTINA" onClick="checkFormAnnullamento(this.form,0)"/>
