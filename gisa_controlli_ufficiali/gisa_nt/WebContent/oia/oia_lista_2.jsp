...
<%@ include file="../utils23/initPage.jsp"%>
	...
	<%--dhv:permission name="oia-espandi-add">
		<input class= "pulsante" type="button" value="Inserisci Dipartimento di Prevenzione" onClick="javascript:popLookupSelectorNuovoNodoOia('tipologia=1&livello=1&id_padre=-1');">  
	</dhv:permission--%>
	<br><br>
<%	
...
<%	
				for (OiaNodo nodo_L1 : (ArrayList<OiaNodo> ) nodi_livello) {															
					if ( nodo_L1.getLista_nodi().size()>0 ) {		// GESTIONE NODO CON FIGLI (DI LIVELLO 2)				%>
							...
							%>
							 <dhv:permission name="oia-modellazione_level1-view">
							  ...
							  <dhv:permission name="oia-modellazione_level1-edit">
								<input class= "pulsante" type="button" value="Modifica" style="width:200px;" onClick="javascript:popLookupSelectorModificaNodoOia('id=<%= nodo_L1.getId() %>');" />
							...
							<dhv:permission name="oia-modellazione_level3-view">
											<dhv:permission name="oia-modellazione_level3-edit">
															<input class= "pulsante" type="button" value="Modifica" style="width: 200px;" onClick="javascript:popLookupSelectorModificaNodoOia('id=<%= nodo_L1.getId() %>');" />
																...
																<input class= "pulsante" type="button" value="Elimina" style="width: 200px;" onClick="javascript:confermaDelete('Oia.do?command=Cancella&id=<%= nodo_L1.getId() %>')" />
																</dhv:permission>
															</dhv:permission>
							<%} %>
						...
						<tr align="center" id='riga_<%= nodo_L1.getId()  %>' onmouseover="inRow(this)" onmouseout="outRow(<%= nodo_L1.getId() %>,this)" st> 
							...
							%>
							 ...
							 <dhv:permission name="oia-modellazione_level1-add">
								<input class= "pulsante" type="button" value="AGGIUNGI STRUTTURA" style="width:200px;" onClick="javascript:popLookupSelectorNuovoNodoOia('tipologia=3&livello=2&id_padre=<%= nodo_L1.getId() %>');">
								</dhv:permission>
								</dhv:permission>
								<dhv:permission name="dpat-view">
								<br><br>
								
									<input class= "pulsante" type="button" value="dpat" style="width:200px;" onClick="window.location='Dpat.do?&idAsl=<%=nodo_L1.getId_asl()%>&idPadre=<%=nodo_L1.getId()%>&anno=corrente'" /><br><br>
							...
							<dhv:permission name="oia-modellazione_level2-view">
												...
												<dhv:permission name="oia-modellazione_level2-edit">
												<tr><td><input class= "pulsante" type="button" value="Modifica" style="width: 200px"  onClick="javascript:popLookupSelectorModificaNodoOia('id=<%= nodo_L1.getId() %>');" /></td></tr>
												</dhv:permission><br><br>
												<dhv:permission name="oia-modellazione_level2-delete">
												<input class= "pulsante" type="button" value="Elimina" style="width: 200px"  onClick="javascript:nonPossibileDelete()" />
												</dhv:permission>
						...
						<tr align="center"> 
							...
							<dhv:permission name="oia-modellazione_level2-view">
											<dhv:permission name="oia-modellazione_level2-add">
												<input  class= "pulsante" type="button" value="Aggiungi Unita Operativa" style="width: 200px" onClick="javascript:popLookupSelectorNuovoNodoOia('tipologia=<%=(nodo_L1.getTipologia_struttura()==3)? "4" :(nodo_L1.getTipologia_struttura()==2)? "5" : "-1" %>&livello=3&id_padre=<%= nodo_L1.getId() %>');">
												</dhv:permission>
...
<%						
								ArrayList<OiaNodo> nodi_livello_2_per_id_nodo_livello_1 =  nodo_L1.getLista_nodi();
								for (OiaNodo nodo_L2 : (ArrayList<OiaNodo> ) nodi_livello_2_per_id_nodo_livello_1) {
									if ( nodo_L2.getLista_nodi().size()>0 ) {												%>
							...
							%>
											<dhv:permission name="oia-modellazione_level2-view">
												...
												<dhv:permission name="oia-modellazione_level2-edit">
												<input class= "pulsante" type="button" value="Modifica" style="width: 200px"  onClick="javascript:popLookupSelectorModificaNodoOia('id=<%= nodo_L2.getId() %>');" />
												</dhv:permission><br><br>
												<dhv:permission name="oia-modellazione_level2-delete">
												<input class= "pulsante" type="button" value="Elimina" style="width: 200px"  onClick="javascript:nonPossibileDelete()" />
												</dhv:permission>
							...
							else
							{
											...
											<dhv:permission name="oia-modellazione_level3-edit">
																...
																<dhv:permission name="oia-modellazione_level3-delete">
																<input class= "pulsante" type="button" value="Elimina" style="width: 200px;" onClick="javascript:confermaDelete('Oia.do?command=Cancella&id=<%= nodo_L2.getId() %>')" />
																</dhv:permission>
															</dhv:permission>
							<%} %>				
							...
							%>
											<dhv:permission name="oia-modellazione_level2-view">
											<dhv:permission name="oia-modellazione_level2-add">
												<input  class= "pulsante" type="button" value="Aggiungi Struttura Semplice" style="width: 200px" onClick="javascript:popLookupSelectorNuovoNodoOia('tipologia=4&livello=3&id_padre=<%= nodo_L2.getId() %>');">
												</dhv:permission>
...
<% 													ArrayList<OiaNodo> nodi_livello_3_per_id_nodo_livello_2 =  nodo_L2.getLista_nodi();
							...
							<td rowspan="1"><%=lookup_comuni.getSelectedValue(nodo_L3.getComune())+"<br>"+nodo_L3.getIndirizzo() +"<br>"+nodo_L3.getMail() %></td>
															...
															<dhv:permission name="oia-modellazione_level3-view">
																<tr><td><input class= "pulsante" type="button" value="Modifica" style="width: 200px;" onClick="javascript:popLookupSelectorModificaNodoOia('id=<%= nodo_L3.getId() %>');" /></td></tr>
																<tr><td><input class= "pulsante" type="button" value="Elimina" style="width: 200px;" onClick="javascript:confermaDelete('Oia.do?command=Cancella&id=<%= nodo_L3.getId() %>')" /></td></tr>
							...
							%></td>
							 ...
							 <dhv:permission name="oia-modellazione_level1-view">
								...
								<%if (nodo_L1.getN_livello()==2){ %> 	
											<dhv:permission name="oia-modellazione_level2-view">
											<dhv:permission name="oia-modellazione_level2-add">
												<tr><td><input  class= "pulsante" type="button" value="AGGIUNGI STRUTTURA SEMPLICE" style="width: 200px" onClick="javascript:popLookupSelectorNuovoNodoOia('tipologia=4&livello=3&id_padre=<%= nodo_L1.getId() %>');"></td></tr>
												</dhv:permission>
												<dhv:permission name="oia-modellazione_level2-edit">
												<tr><td><input class= "pulsante" type="button" value="Modifica" style="width: 200px"  onClick="javascript:popLookupSelectorModificaNodoOia('id=<%= nodo_L1.getId() %>');" /></td></tr>
												</dhv:permission>
											...
											<dhv:permission name="oia-modellazione_level3-edit">
																...
																<dhv:permission name="oia-modellazione_level3-delete">
																<tr><td><input class= "pulsante" type="button" value="Elimina" style="width: 200px;" onClick="javascript:confermaDelete('Oia.do?command=Cancella&id=<%= nodo_L1.getId() %>')" /></td></tr>
																</dhv:permission>
															</dhv:permission>
											<%}} %>
						...
						<tr align="center"> 
							 ...
							 <td onmouseover="inRow(this)" onmouseout="outRow(<%= nodo_L1.getId() %>,this)" >
								...
								<%if (nodo_L1.getN_livello()==2){ %> 	
											<dhv:permission name="oia-modellazione_level2-view">
											<dhv:permission name="oia-modellazione_level2-add">
												<input  class= "pulsante" type="button" value="AGGIUNGI STRUTTURA SEMPLICE" style="width: 200px" onClick="javascript:popLookupSelectorNuovoNodoOia('tipologia=4&livello=3&id_padre=<%= nodo_L1.getId() %>');">
												</dhv:permission>
