...
<td>
  ...
  <a href="Farmacosorveglianza.do?command=Details&idFarmacia=<%=OrgDetails.getOrgId()%>">Scheda Farmacosorveglianza</a> >
...
<input type="submit" value="Annulla" onClick="javascript:this.form.action='FarmacieVigilanza.do?command=ViewVigilanza&orgId=<%=OrgDetails.getOrgId()%>'">
<br>
