...
<form name="addticket" action="FarmacieNonConformita.do?command=Insert&auto-populate=true" method="post">
...
<a href="Farmacosorveglianza.do?command=SearchFcie"><dhv:label name="accounts.SearchResults">Search Results</dhv:label></a> >
 <a href="Farmacosorveglianza.do?command=DetailsFcie&idFarmacia=<%=OrgDetails.getOrgId()%>">Dettaglio Farmacie</a> >
