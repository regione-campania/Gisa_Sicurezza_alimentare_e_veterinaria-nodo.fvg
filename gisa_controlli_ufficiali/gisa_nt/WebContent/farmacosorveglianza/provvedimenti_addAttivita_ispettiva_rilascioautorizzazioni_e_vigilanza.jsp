...
<body>
 <form name="addticket" action="FarmacosorveglianzaProvvedimenti.do?command=Insert&auto-populate=true" method="post" onsubmit="return controllaForm(this)">
<%-- Trails --%>
...
<td>
  ...
  <a href="Farmacosorveglianza.do?command=Details&orgId=<%=OrgDetails.getOrgId()%>">Scheda Operatore </a> >
...
<input type="button" value="Annulla" onClick="window.location.href='FarmacosorveglianzaVigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC") %>&orgId=<%=OrgDetails.getOrgId()%>';this.form.dosubmit.value='false';" />
<br>
<dhv:formMessage />
...
<script language="JavaScript" TYPE="text/javascript" SRC="javascript/popFarmacosorveglianza.js"></script>
