...
<form name="addticket" action="SoaCessazionevariazione.do?command=InsertTicket&auto-populate=true<%= addLinkParams(request, "popup|popupType|actionId") %>" method="post">
<%-- Trails --%>
...
<input type="submit" value="Annulla" onClick="javascript:this.form.action='Soa.do?command=ViewCessazionevariazione&orgId=<%=OrgDetails.getOrgId()%>'">
<br>
<dhv:formMessage />
...
<%--</dhv:evaluate>  --%>
 ...
 <input readonly type="text" id="assignedDate" name="assignedDate" size="10" value="<%=toDateString(TicketDetails.getAssignedDate()) %>" />
  ...
  <input type="hidden" name="tipo_richiesta" value="attivita_ispettiva_rilascioautorizzazioni_e_vigilanza" />
    ...
    <td>
      <input type="text" size="50" maxlength="80" name="partitaIva" id="partitaIva" value="<%= toHtmlValue(OrgDetails.getPartitaIva()) %>"><font color="#00FF00"><b>* Inserire la variazione</b></font>
    </td>
  </tr>
