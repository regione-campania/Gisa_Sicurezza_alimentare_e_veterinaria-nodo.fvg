...
<form name="addticket" action="SoaMerceInOut.do?command=Insert&auto-populate=true" method="post">
<%-- Trails --%>
...
<a href="SoaMerceInOut.do?command=List&orgId=<%=OrgDetails.getOrgId() %>"><dhv:label name="merce_in_out">Merce in Ingresso/Uscita</dhv:label></a> > 
...
<table cellpadding="4" cellspacing="0" width="100%" class="details">
  ...
  <tr class="containerBody">
    ...
    <td>
        ...
        [<a href="javascript:popAccountsListSingleNew('id_provenienza','changeaccount_prov', 'showMyCompany=true&filters=all|my|disabled');"><dhv:label name="accountsa.accounts_add.select">Seleziona Soa</dhv:label></a>]
  ...
  <tr class="containerBody">
    ...
    <td>
        ...
        [<a href="javascript:popAccountsListSingleNew('id_destinatario','changeaccount', 'showMyCompany=true&filters=all|my|disabled');"><dhv:label name="accountsa.accounts_add.select">Seleziona Soa</dhv:label></a>]
    </td>
  </tr>
