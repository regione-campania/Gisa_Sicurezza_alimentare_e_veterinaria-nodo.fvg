...
<td>
  ...
  <a href="Soa.do?command=ViewCessazionevariazione&orgId=<%=OrgDetails.getOrgId()%>"><dhv:label name="cessazionevariazione">Tickets</dhv:label></a> >
    	...
    	<td class="formLabel">
   		 ...
   		 <td>
      		<input
      			...
      			value="Variazione"
      			onclick="javascript:this.form.action='SoaCessazionevariazione.do?command=AddTicket&tipo_richiesta=autorizzazione_trasporto_animali_vivi&orgId=<%=OrgDetails.getOrgId()%>'"
      		/>
      		...
      		<input
      			...
      			value="Cessazione"
      			onclick="javascript:this.form.action='SoaCessazionevariazione.do?command=AddTicket&tipo_richiesta=attivita_ispettiva_rilascioautorizzazioni_e_vigilanza&orgId=<%=OrgDetails.getOrgId()%>'"
      		/>
    	</td>
	</tr>
