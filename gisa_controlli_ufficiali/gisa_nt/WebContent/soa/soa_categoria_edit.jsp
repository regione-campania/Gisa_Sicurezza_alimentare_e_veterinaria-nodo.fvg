...
function aggiornamento(orgId,id)
{
	...
	opener.document.details.action ="SoaVigilanza.do?command=TicketDetails&orgId="+document.aggiornacategoria.orgId.value+"&id="+document.aggiornacategoria.ticketid.value;
...
<form method="post"  name = "aggiornacategoria" action="SoaVigilanza.do?command=AggiornaSoa">
