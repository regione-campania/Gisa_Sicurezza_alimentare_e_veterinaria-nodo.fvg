...
function checkLenCodiceFiscale(){
	...
	formTest = true;
	if (document.getElementById('codice_fiscale_rappresentante') != null)
		{
...
%>
<script>
document.location.href = 'Soa.do?command=Details&orgId=<%=OrgDetails.getId()%>';
...
<tr>
<td width="100%">
<a href="Soa.do">Soa</a> >Aggiungi Campi Pregressi
</td>
</tr>
</table>
<br/>

<form name = "addAccount" method="post" action="Soa.do?command=UpdatePregresso">
