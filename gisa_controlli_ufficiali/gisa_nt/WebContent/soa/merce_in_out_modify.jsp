...
<form name="addticket" action="SoaMerceInOut.do?command=Update&auto-populate=true" method="post">
<%-- Trails --%>
...
<a href="SoaMerceInOut.do?command=List&orgId=<%=OrgDetails.getOrgId() %>"><dhv:label name="merce_out">Merce in Ingresso/Uscita</dhv:label></a> > 
