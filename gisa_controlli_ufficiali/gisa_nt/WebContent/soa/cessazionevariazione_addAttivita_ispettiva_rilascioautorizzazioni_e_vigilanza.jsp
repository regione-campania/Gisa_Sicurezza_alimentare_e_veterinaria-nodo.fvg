...
<%--</dhv:evaluate>  --%>
  ...
  <tr class="containerBody">
    <td class="formLabel">
      <dhv:label name="">Nuova Ragione Sociale</dhv:label>
    </td>
   
     
      <td>
        <input type="text" size="50" maxlength="80" name="name" value="">
  ...
  <tr class="containerBody">
    <td class="formLabel">
      <dhv:label name="">Nuova Denominazione</dhv:label>
    </td>
