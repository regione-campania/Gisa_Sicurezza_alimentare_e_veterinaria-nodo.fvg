...
function apriVerbale(idCampione,tipoAnalisi)
{
	...
	document.location.href="SoaCampioni.do?command=StampaScheda&tipoAnalisi="+tipoAnalisi+"&idCampione="+idCampione+"&tipoAlimenti="+tipoAlimenti;
...
<form id="details" name="details" action="SoaCampioni.do?command=ModifyTicket&auto-populate=true" method="post">
...
<dhv:container name="soacampioni" selected="details" object="TicketDetails"
	param="<%= param1 %>"
...
if(request.getAttribute("Messaggio2")!=null)
{
	...
	function doSubmit(idTicket){
		...
		document.details.action="SoaCampioni.do?command=Chiudi&id="+idTicket+"&chiudiCu=true'"
