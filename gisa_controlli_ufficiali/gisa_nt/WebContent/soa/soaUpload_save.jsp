...
<body onLoad="">
<form method="post" name="inputForm" action="Soa.do?command=UploadDoc" enctype="multipart/form-data" onSubmit="return checkFileForm(this);">
<dhv:evaluate if="<%= !isPopup(request) %>">
<%-- Trails --%>
<table class="trails" cellspacing="0">
<tr>
<td width="100%">
  <a href="Assets.do"><dhv:label name="">Soa</dhv:label></a> >
  <dhv:label name="">Importa Soa</dhv:label>
</td>
</tr>
</table>
<%-- End Trails --%>
...
<table cellpadding="4" cellspacing="0" border="0" width="50%" class="details">
  <tr>
   ...
   <tr>
      ...
      <td>
        <a href="<%= "logSoa/"+path+"_rpg.txt" %>" ><%= path %></a>
      </td>
    </tr>
    <tr>
      <td nowrap class="formLabel">
      ...
      <td>
        <a href="<%= "logSoa/"+path+"_ok.txt" %>" ><%= path %></a>
      </td>
    </tr>
    <tr>
      <td nowrap class="formLabel">
      ...
      <td>
        <a href="<%= "logSoa/"+path+"_err.txt" %>" ><%= path %></a>
      </td>
    </tr>
 </table>
...
<br>
  ...
  <input type="submit" value="<dhv:label name="global.button.c">Chiudi</dhv:label>" onClick="this.form.action='Soa.do'" /><br/>
  <dhv:formMessage />
  <br />
</form>
</body>