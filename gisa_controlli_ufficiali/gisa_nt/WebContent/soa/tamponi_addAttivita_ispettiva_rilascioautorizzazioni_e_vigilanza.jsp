...
<body >
<form name="addticket" action="SoaTamponi.do?command=Insert&auto-populate=true" method="post">
<%-- Trails --%>
...
<input type="button" value="Annulla" onClick="window.location.href='SoaNonConformita.do?command=TicketDetails&id=<%= request.getAttribute("idC") %>&orgId=<%=OrgDetails.getOrgId()%>';this.form.dosubmit.value='false';" />
<br>
<dhv:formMessage />
