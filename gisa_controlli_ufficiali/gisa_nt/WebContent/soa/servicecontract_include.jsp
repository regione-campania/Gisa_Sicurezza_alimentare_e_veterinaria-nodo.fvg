...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="details">
  ...
  <tr class="containerBody">
    <td class="formLabel">
      <dhv:label name="soa.soa_add.Type">Type</dhv:label>
    </td>
    <td>
      ...
      <tr>
        <td>
          <div id="addAsset">
            ...
            <%} else {%>
              <dhv:label name="soa.soa_add.NoneSelected">None Selected</dhv:label>
            <%}%>
          </div>
        </td>
        <td>
          ...
          <% if(serviceContract.getImpiantoId() == -1) {%>
            ...
            [<a href="javascript:popListaImpianti('assetId','addAsset', 'filters=allassets|allassetsandcomponenti','ubicazioneId','addUbicazione');"><dhv:label name="soa.soa_add.select">Select</dhv:label></a>]
          ...
          <td>
            ...
            %>
             ...
             <%}
                ...
                <option value="-1"><dhv:label name="soa.soa_add.NoneSelected">None Selected</dhv:label></option>
             <%}%>
            </select>
            <input type="hidden" name="previousSelection" value="" />
          </td>
          <td valign="top">
            &nbsp;[<a href="javascript:popProductCatalogSelectMultiple('selectedList','<%=serviceContract.getId()%>');"><dhv:label name="soa.soa_add.select">Select</dhv:label></a>]
          </td>
        </tr>
      </table>
    </td>
     ...
     <table cellspacing="0" cellpadding="0" border="0" class="empty">
      <tr>
        ...
        <td>
          ...
          &nbsp [<a href="javascript:popURL('AccountsServiceContractsSoa.do?command=HoursHistory&id=<%= serviceContract.getId() %>&popup=true&popupType=inline','Details','650','500','yes','yes');"><dhv:label name="accountsassets.history.long_html">History</dhv:label></a>]
          </dhv:evaluate>&nbsp;
        </td>
        </tr>
      </table>
