...
<tr>
<td width="100%">
  <a href="Soa.do"><dhv:label name="a">Soa</dhv:label></a> >
  <dhv:label name="a">Importa Soa</dhv:label>
</td>
</tr>
</table>
<%-- End Trails --%>
...
<br>
  <a href="Soa.do?command=AllImportRecords" > Visualizza Tutti gli Import </a>
  <br><br>
  ...
  <input type="button" value="Annulla" onClick="location.href='Soa.do?command=Dashboard'" /><br />
  <dhv:formMessage />
  <br />
</form>
</body>