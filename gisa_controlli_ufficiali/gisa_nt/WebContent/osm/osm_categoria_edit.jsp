...
function aggiornamento(orgId,id)
{
	...
	opener.document.details.action ="OsmVigilanza.do?command=TicketDetails&orgId="+document.aggiornacategoria.orgId.value+"&id="+document.aggiornacategoria.ticketid.value;
...
<form method="post"  name = "aggiornacategoria" action="OsmVigilanza.do?command=AggiornaOsm">
