...
<form name="addticket" action="OsmNonConformita.do?command=Insert&auto-populate=true" method="post">
<%-- Trails --%>
...
<a href="Osm.do?command=ViewNonConformita&orgId=<%=OrgDetails.getOrgId() %>"><dhv:label name="nonconformita">NonConformita Amministrative</dhv:label></a> > 
...
<input type="submit" value="Annulla" onClick="javascript:this.form.action='Osm.do?command=ViewNonConformita'">
<br>
<dhv:formMessage />
