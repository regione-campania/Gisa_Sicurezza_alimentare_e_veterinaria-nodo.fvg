...
function apriVerbale(idCampione,tipoAnalisi)
{
	...
	document.location.href="OSAnimaliCampioni.do?command=StampaScheda&tipoAnalisi="+tipoAnalisi+"&idCampione="+idCampione+"&tipoAlimenti="+tipoAlimenti;
...
<form id="details" name="details" action="OSAnimaliCampioni.do?command=ModifyTicket&auto-populate=true" method="post">
...
if(request.getAttribute("Messaggio2")!=null)
{
	...
	function doSubmit(idTicket){
		...
		document.details.action="OSAnimaliCampioni.do?command=Chiudi&id="+idTicket+"&chiudiCu=true'"
