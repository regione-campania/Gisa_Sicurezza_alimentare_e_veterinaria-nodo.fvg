...
<body>
 <form name="addticket" action="OSAnimaliProvvedimenti.do?command=Insert&auto-populate=true" method="post" onsubmit="return controllaForm(this)"s>
<%-- Trails --%>
...
<td>
  ...
  <a href="OSAnimali.do?command=Details&orgId=<%=OrgDetails.getOrgId()%>">Scheda Operatore </a> >
...
<script language="JavaScript" TYPE="text/javascript" SRC="javascript/popOSAnimali.js"></script>
