...
%>
<dhv:container name="<%=nomeContainer %>" selected="vigilanza" object="Operatore" param='<%= "altId=" + OrgDetails.getAltId()+"&opId="+OrgDetails.getIdOperatore() %>'>
...
<%@ include file="../checklist/suap_checklist_view.jsp" %>
