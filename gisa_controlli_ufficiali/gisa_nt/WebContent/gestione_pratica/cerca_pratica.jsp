...
<table class="trails" cellspacing="0">
	<tr>
		<td>
			...
			<a href="GestionePraticheAction.do?command=ListaPraticheStabilimenti">GESTIONE ATT. FISSE, MOBILI E RICONOSCIMENTO</a> > RICERCA PRATICA
		</td>
	</tr>
</table>

<form id="ricercaPratica" name="ricercaPratica" class="form-horizontal" role="form" method="post" 
			action="GestionePraticheAction.do?command=SearchPraticheAmministrative" onsubmit="return validateForm();">
