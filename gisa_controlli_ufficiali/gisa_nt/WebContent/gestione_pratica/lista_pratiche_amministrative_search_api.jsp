...
<%-- Trails --%>
	...
	<tr>
		<td>
			...
			<a href="GestionePraticheAction.do?command=SearchFormPraticaApi"> RICERCA PRATICA APICOLTURA</a> > Risultato Ricerca 
		</td>
	</tr>
	</table>
<%-- Trails --%>
...
<br>
	<h3>ELENCO PRATICHE AMMINISTRATIVE APICOLTURA CORRISPONDENTI AI PARAMETRI DI RICERCA</h3>
<br>
...
<br>
<% } else { %>
	<h3>NESSUN RISULTATO TROVATO</h3><br> <a href="GestionePraticheAction.do?command=SearchFormPraticaApi">torna alla ricerca</a>
<%} %>
</center>
...
function pagina_succ(){
	...
	if(pagina < (totpagine + 1)){
		loadModalWindowCustom('Attendere Prego...');
		document.getElementById('ricercaPratica').action = "GestionePraticheAction.do?command=SearchPraticheAmministrativeApi";
