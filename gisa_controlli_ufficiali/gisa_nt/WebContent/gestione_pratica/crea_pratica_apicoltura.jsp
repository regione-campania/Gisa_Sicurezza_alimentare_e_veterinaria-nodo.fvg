...
<table class="trails" cellspacing="0">
	<tr>
		<td>
			...
			<a href="GestionePraticheAction.do?command=ListaPraticheApicoltura">PRATICHE APICOLTURA</a> > NUOVA PRATICA
		</td>
	</tr>
</table>
...
function salva_pratica(scelta_output){
	...
	document.getElementById('inserimentoPratica').action = "GestionePraticheAction.do?command=InserisciPraticaApicoltura";
	if(validateForm()){
