function eliminaCheckList (idAudit,idControllo,orgId)
{
	...
	{
	    document.location = 'CheckListFarmacosorveglianza.do?command=Delete&id='+idAudit+'&idControllo='+idControllo+'&orgId='+orgId;
	}
...
function compilaCheckList(messaggio,orgId,idControllo,idControlloUfficiale,isPrincipale,form)
{
	...
	var ExpYes=AgntUsr.indexOf('msie')!=-1?1:0;
		...
		if(isPrincipale=='1')
		{
			if(confirm(messaggio))
			{
			document.forms[form].action='CheckListFarmacosorveglianza.do?command=Add&orgId='+orgId+'&idC='+idControllo+'&isExpo='+ExpYes+'&isPrincipale=true&idControllo='+idControlloUfficiale
		...
		else
		{
			...
			{
				document.forms[form].action='CheckListFarmacosorveglianza.do?command=Add&orgId='+orgId+'&idC='+idControllo+'&isPrincipale=false&isExpo='+ExpYes+'&idControllo='+idControlloUfficiale
				setTimestampStartRichiesta();
				document.forms[form].submit();
			}
			}
			...
			{
				document.forms[form].action='CheckListFarmacosorveglianza.do?command=Add&orgId='+orgId+'&idC='+idControllo+'&isExpo='+ExpYes+'&isPrincipale=false&idControllo='+idControlloUfficiale
				setTimestampStartRichiesta();
				document.forms[form].submit();
			}
...
function aggiornaCategoria(idControllo,orgId)
{
	...
	{
		document.details.action='CheckListFarmacosorveglianza.do?command=UpdateCategoria&idC='+idControllo+'&orgId='+orgId ;
