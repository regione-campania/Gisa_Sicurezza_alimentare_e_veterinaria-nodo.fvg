...
document.forms[form].action = "GestioneAnagraficaVigilanza.do?command=UploadListaDistribuzione&goto="+gotoPage;
formTest = true;
message = "";
...
document.forms[form].action = "GestioneAnagraficaVigilanza.do?command=DeleteListaDistribuzione&goto="+gotoPage+"&fid="+fid+"&stabId="+orgId+"&folderId="+folderid;
