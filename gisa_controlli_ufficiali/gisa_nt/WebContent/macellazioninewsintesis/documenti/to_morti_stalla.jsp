	...
	<tr>
		<td>
			...
			<%
				...
				{}
			%>
			<a href="MacellazioniNewSintesis.do?command=List&altId=<%=OrgDetails.getAltId() %>">Macellazioni</a> > Anim. morti in stalla/trasporto
		</td>
	</tr>
</table>
...
<br/><br/>
<form name="main" action="MacellazioniDocumentiNewSintesis.do?command=SpeditoriMortiStalla" method="post" >
