	...
	<tr>
		<td>
			...
			<%
				...
				{}
			%>
			<a href="MacellazioniNewSintesis.do?command=List&altId=<%=OrgDetails.getAltId() %>">Macellazioni</a> > Abbattimento
		</td>
	</tr>
</table>
...
<br/>
<font color= "black">  Inserire la data di abbattimento recuperabile nella sezione Evidenza Visita AM </font></br></br>
<font color="red"> <%=toHtmlValue( (String)request.getAttribute( "messaggio" ) ) %> </font>
<br/><br/>
<form name="main" action="MacellazioniDocumentiNewSintesis.do?command=SpeditoriAbbattimento" method="post" >
