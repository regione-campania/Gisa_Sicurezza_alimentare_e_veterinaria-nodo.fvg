...
<form name="main" action="MacellazioniNewSintesis.do?command=<%=update ? "Update" : "Save" %>ToLiberoConsumoSeduta&id=<%=Partita.getId()%>" method="post" onsubmit="return controllaForm( );">
