...
<jsp:useBean id="Capo"				class="org.aspcfs.modules.macellazioninewsintesis.base.Capo"			scope="session" />
...
<form name="main" action="MacellazioniNewSintesis.do?command=<%=update ? "Update" : "Save" %>ToLiberoConsumo&id=<%=Capo.getId()%>" method="post" onsubmit="return controllaForm( );">
<input type="hidden" name="altId" value="<%=OrgDetails.getAltId() %>" />
<input type="hidden" name="cd_matricola" value="<%=Capo.getCd_matricola()%>" />
...
<!--	            </tr>-->
	            ...
	            <tr class="containerBody">
	              ...
	              <td colspan="2"><input type="text" id="progressivo_macellazione" name="progressivo_macellazione" value="<%=toHtmlValue( Capo.getProgressivo_macellazione() ) %>" onblur="checkNumerico(this);"></input></td>
	            </tr>
...
<%--	              		<zeroio:dateSelect timestamp="<%=new Timestamp( System.currentTimeMillis() ) %>" field="vpm_data" form="main" showTimeZone="false" />  --%>
	              		<input readonly type="text" id="vpm_data" name="vpm_data" size="10" value="<%=Capo.getVpm_data() != null ? DateUtils.timestamp2string(Capo.getVpm_data()) : DateUtils.timestamp2string(Capo.getCd_data_arrivo_macello()) %>" />&nbsp;
	            ...
	            <tr class="containerBody">
	            	<td colspan="3">
			            <table>
				            ...
				            <tr class="containerBody" id="vpm_veterinario_toggle" style="display: <%= Capo.getVpm_veterinario_2().equals("") ? "none" : "" %>" >
				                <td>2. <input 
				            ...
				            <tr class="containerBody" id="vpm_veterinario_2_toggle" style="display: <%= Capo.getVpm_veterinario_3().equals("") ? "none" : "" %>" >
				                <td>3. <input 
