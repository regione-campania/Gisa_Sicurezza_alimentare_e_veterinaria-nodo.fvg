...
<%@page import="org.aspcfs.modules.macellazioninewsintesis.base.PartitaSeduta"%>
	...
	<tr>
		<td>
			...
			<%
				...
				{}
			%>
			<a href="MacellazioniNewSintesis.do?command=List&altId=<%=OrgDetails.getAltId() %>">Macellazioni</a> > Dettaglio Seduta
		</td>
	</tr>
</table>
...
<%
	...
	{
%>
		<%-- 	<a href="MacellazioniDocumentiNewSintesis.do?command=EsercentiArt17Sedute&<%=param1 %>&idSeduta=<%=Partita.getId() %>&comboDateMacellazione=<%=toDateasString(Partita.getVpm_data()) %>" style="text-decoration:none"><input type="button" value="Articolo 17"/></a> --%>
...
<dhv:permission name="stabilimenti-stabilimenti-macellazioni-edit">
	...
	onclick="location.href='MacellazioniNewSintesis.do?command=ModificaSeduta&id=<%=Partita.getId() %>&altId=<%=OrgDetails.getAltId() %>'"
	 />
</dhv:permission>
...
%>
<dhv:permission name="stabilimenti-stabilimenti-macellazioni-edit">
	<input type="button" value="Inserisci Esito Campioni" onclick="location.href='MacellazioniNewSintesis.do?command=ModificaSedutaCampioniSenzaEsito&id=<%=Partita.getId() %>&altId=<%=OrgDetails.getAltId() %>'" />
</dhv:permission>
<%	
}
