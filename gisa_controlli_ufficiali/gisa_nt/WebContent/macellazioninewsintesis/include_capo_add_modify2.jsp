...
<%@page import="org.aspcfs.modules.macellazioninewsintesis.utils.ReflectionUtil"%>
...
<%@page import="org.aspcfs.modules.macellazioninewsintesis.base.Esito"%>
...
<%@page import="org.aspcfs.modules.macellazioninewsintesis.base.NonConformita"%>
<%@page import="org.aspcfs.modules.macellazioninewsintesis.base.PatologiaRilevata"%>
<%@page import="org.aspcfs.utils.web.LookupList"%>
<%@page import="org.aspcfs.modules.macellazioninewsintesis.base.Casl_Non_Conformita_Rilevata"%>
<%@page import="org.aspcfs.modules.macellazioninewsintesis.base.ProvvedimentiCASL"%>
<%@page import="org.aspcfs.modules.macellazioninewsintesis.base.Organi"%>
...
<!--<jsp:useBean id="Campione"			class="org.aspcfs.modules.macellazioninewsintesis.base.Campione"		scope="request" />-->
<!--<jsp:useBean id="Organo"			class="org.aspcfs.modules.macellazioninewsintesis.base.Organi"			scope="request" />-->
...
$( document ).ready(function() {
	calenda('cd_data_nascita','','');
	calenda('cd_data_mod4','','');
	calenda('cd_data_arrivo_macello','','');
	calenda('bse_data_prelievo','','');
	calenda('bse_data_ricezione_esito','','');
	calenda('vam_data','','');
	calenda('abb_data','','');
	calenda('vpm_data','','');
	calenda('mavam_data','','');
	...
	calenda('rca_data','','');
	calenda('seqa_data','','');
	calenda('seqa_data_sblocco','','');
});

function gestisciCapi18(sel)
{
	var has18 = false;
	...
	if (has18==false){
		document.getElementById('cd_num_capi_ovini_18').value = '';
		document.getElementById('cd_num_capi_ovini_18').disabled = "disabled";
		document.getElementById('cd_num_capi_caprini_18').value = '';
		document.getElementById('cd_num_capi_caprini_18').disabled = "disabled";
		return false;
	}	
	

	if(document.getElementById('cd_specie').options[1].selected)
	{
		document.getElementById('cd_num_capi_ovini_18').disabled = false;
	}
	else
	{
		document.getElementById('cd_num_capi_ovini_18').value = '';
	...
	if(document.getElementById('cd_specie').options[2].selected)
	{
		document.getElementById('cd_num_capi_caprini_18').disabled = false;
	}
	else
	{
		document.getElementById('cd_num_capi_caprini_18').value = '';
...
//	alert(index);
	...
	if (value_organo == VISCERI){

		//	alert('polmoni_value' + document.getElementById('lesione_polmoni_'+String(index)).value );
		
		if( document.getElementById('lesione_visceri_'+String(index)).value == 6 )	{
			document.getElementById( "stadio_" + index ).style.display = "table-row";
		}else{
			document.getElementById( "stadio_" + index ).style.display = "none";
		}
...
try {
	...
	if (value_organo == MILZA)  {
		...
		//document.getElementById('lesione_polmoni_'+String(indice_riga)).value = value_patologia;
			...
			|| (value_organo == 19) || (value_organo == 26) || (value_organo == 20) || (value_organo == 21) || (value_organo == 22) || (value_organo == 23) || (value_organo == 24) || (value_organo == 25)) {
...
function isIntPositivo2(Expression,nomeCampo,campo)
{
    Expression = Expression.toLowerCase();
    RefString = "0123456789";
...
function controllaForm( toLiberoConsumo )
{
	...
	try{
		...
		if(document.getElementById('vpm_data')!=null)
		...
		{
			message += label("","- [Controllo documentale] : \"Commerciante/Proprietario degli animali\" obbligatorio\r\n" );
			ret = false;
		}
		
		if( form.cd_partita.value == '' )
		{
			message += label("","- [Controllo documentale] : \"Partita\" obbligatoria\r\n" );
			ret = false;
		}
		
		
		
		if( document.getElementById('cd_specie').selectedIndex < 0 || document.getElementById('cd_specie').value < 0)
		{
			message += label("","- [Controllo documentale] : \"Specie\" obbligatorio\r\n" );
			ret = false;
		}
		
		if( form.cd_num_capi_ovini.value == '' && document.getElementById('cd_specie').options[1].selected )
		{
			message += label("","- [Controllo documentale] : \"Numero Capi "+specie1+"\" obbligatorio\r\n" );
			ret = false;
		}
		
		if( form.cd_num_capi_caprini.value == '' && document.getElementById('cd_specie').options[2].selected  )
		{
			message += label("","- [Controllo documentale] : \"Numero Capi "+specie2+"\" obbligatorio\r\n" );
			ret = false;
		}
		
		if( form.cd_num_capi_ovini_da_testare.value == '' && document.getElementById('cd_bse').checked  && document.getElementById('cd_specie').options[1].selected  )
		{
			message += label("","- [Controllo documentale] : \"Numero Capi "+specie1+" da testare\" obbligatorio\r\n" );
			ret = false;
		}
		
		if( form.cd_num_capi_caprini_da_testare.value == '' && document.getElementById('cd_bse').checked  && document.getElementById('cd_specie').options[2].selected  )
		{
			message += label("","- [Controllo documentale] : \"Numero Capi "+specie2+" da testare\" obbligatorio\r\n" );
			ret = false;
		}
		
		if( parseInt(form.cd_num_capi_ovini.value) < parseInt(form.cd_num_capi_ovini_da_testare.value) )
		{
			message += label("","- [Controllo documentale] : \"Numero Capi "+specie1+" da testare\" non può essere superiore al numero di capi "+specie1+" della partita\r\n" );
			ret = false;
		}
		
		if( parseInt(form.cd_num_capi_caprini.value) < parseInt(form.cd_num_capi_caprini_da_testare.value))
		{
			message += label("","- [Controllo documentale] : \"Numero Capi "+specie2+" da testare\" non può essere superiore al numero di capi "+specie2+" della partita\r\n" );
			ret = false;
		}
		
		if( parseInt(form.cd_num_capi_ovini.value) < parseInt(form.cd_num_capi_ovini_18.value) )
		{
			message += label("","- [Controllo documentale] : \"Numero Capi "+specie1+" con età > 18 mesi\" non può essere superiore al numero di capi "+specie1+" della partita\r\n" );
			ret = false;
		}
		
		if( parseInt(form.cd_num_capi_caprini.value) < parseInt(form.cd_num_capi_caprini_18.value))
		{
			message += label("","- [Controllo documentale] : \"Numero Capi "+specie2+" con età > 18 mesi\" non può essere superiore al numero di capi "+specie2+" della partita\r\n" );
			ret = false;
		}
		...
		if(form.casl_num_capi_ovini!=null && form.casl_num_capi_ovini.value!="")
			casl_num_capi_ovini = parseInt(form.casl_num_capi_ovini.value);
		if(form.vam_num_capi_ovini!=null && form.vam_num_capi_ovini.value!="")
			vam_num_capi_ovini = parseInt(form.vam_num_capi_ovini.value);
		if(form.mavam_num_capi_ovini!=null && form.mavam_num_capi_ovini.value!="")
			mavam_num_capi_ovini = parseInt(form.mavam_num_capi_ovini.value);
		if(form.numCapiOviniSedute.value!="")
			numCapiOviniSedute = parseInt(form.numCapiOviniSedute.value);
		if(form.casl_num_capi_caprini!=null && form.casl_num_capi_caprini.value!="")
			casl_num_capi_caprini = parseInt(form.casl_num_capi_caprini.value);
		if(form.vam_num_capi_caprini!=null && form.vam_num_capi_caprini.value!="")
			vam_num_capi_caprini = parseInt(form.vam_num_capi_caprini.value);
		if(form.mavam_num_capi_caprini!=null && form.mavam_num_capi_caprini.value!="")
			mavam_num_capi_caprini = parseInt(form.mavam_num_capi_caprini.value);
		if(form.numCapiCapriniSedute.value!="")
			numCapiCapriniSedute = parseInt(form.numCapiCapriniSedute.value);
		
		if( parseInt(form.cd_num_capi_ovini.value) < casl_num_capi_ovini + mavam_num_capi_ovini + numCapiOviniSedute)
		{
			message += label("","- [Controllo documentale] : \"Numero Capi "+specie1+"\" non può essere inferiore alla somma dei capi "+specie1+" specificati nelle sezioni successive\r\n" );
			ret = false;
		}
		
		if( parseInt(form.cd_num_capi_caprini.value) < casl_num_capi_caprini + mavam_num_capi_caprini + numCapiCapriniSedute)
		{
			message += label("","- [Controllo documentale] : \"Numero Capi "+specie2+"\" non può essere inferiore alla somma dei capi "+specie2+" specificati nelle sezioni successive\r\n" );
			ret = false;
		}
		
		if(document.getElementById('casl_NC_rilevate')!=null && form.casl_num_capi_ovini!=null && document.getElementById('cd_specie').options[1].selected )
		{
			var tipoNCComunicazioniEsterne = document.getElementById('casl_NC_rilevate').selectedIndex > 0;
			if(tipoNCComunicazioniEsterne && form.casl_num_capi_ovini.value == '')
			{
				message += label("","- [Comunicazioni esterne] : \"Numero Capi "+specie1+"\" obbligatorio\r\n" );
				ret = false;
			}
		}
		
		if(document.getElementById('casl_NC_rilevate')!=null && form.casl_num_capi_caprini!=null && document.getElementById('cd_specie').options[2].selected )
		{
			var tipoNCComunicazioniEsterne = document.getElementById('casl_NC_rilevate').selectedIndex > 0;
			if(tipoNCComunicazioniEsterne && form.casl_num_capi_caprini.value == '')
			{
				message += label("","- [Comunicazioni esterne] : \"Numero Capi "+specie2+"\" obbligatorio\r\n" );
				ret = false;
			}
		}
		
		if(document.getElementById('mavam_luogo')!=null && form.mavam_num_capi_ovini!=null && document.getElementById('cd_specie').options[1].selected )
		{
			var luogoMorteAnteMacellazione = document.getElementById('mavam_luogo').selectedIndex > 0;
			if(luogoMorteAnteMacellazione && form.mavam_num_capi_ovini.value == '')
			{
		...
		if(document.getElementById('mavam_luogo')!=null && form.mavam_num_capi_caprini!=null && document.getElementById('cd_specie').options[2].selected )
		{
			var luogoMorteAnteMacellazione = document.getElementById('mavam_luogo').selectedIndex > 0;
			if(luogoMorteAnteMacellazione && form.mavam_num_capi_caprini.value == '')
			{
				message += label("","- [Morte ant.Macellazione] : \"Numero Capi "+specie2+"\" obbligatorio\r\n" );
				ret = false;
			}
		}
		
		if(document.getElementById('vam_data')!=null && document.getElementById('vam_provvedimenti')!=null && form.vam_num_capi_ovini
				&& document.getElementById('cd_specie').options[1].selected  && document.forms[0].vam_esito!=null )
		{
			if((document.getElementById('vam_data').value != '' || document.getElementById('vam_provvedimenti').selectedIndex > 0) && 
					form.vam_num_capi_ovini.value == '' && (document.forms[0].vam_esito[0].checked || document.forms[0].vam_esito[1].checked || document.forms[0].vam_esito[2].checked ))
			{
				message += label("","- [Evidenza Visita AM] : \"Numero Capi "+specie1+"\" obbligatorio\r\n" );
				ret = false;	
			}
		}
		
		if(document.getElementById('vam_data')!=null && document.getElementById('vam_provvedimenti')!=null && form.vam_num_capi_caprini
				&& document.getElementById('cd_specie').options[2].selected  && document.forms[0].vam_esito!=null )
		{
			if((document.getElementById('vam_data').value != '' || document.getElementById('vam_provvedimenti').selectedIndex > 0) && 
					form.vam_num_capi_caprini.value == '' && (document.forms[0].vam_esito[0].checked || document.forms[0].vam_esito[1].checked || document.forms[0].vam_esito[2].checked ))
			{
				message += label("","- [Evidenza Visita AM] : \"Numero Capi "+specie2+"\" obbligatorio\r\n" );
				ret = false;	
			}
		}
		...
		if( form.partita_esistente.value == 'si' )
		{
			message += label("","- Partita già esistente\r\n" );
			ret = false;
		}
		...
		if ( form.bse_data_ricezione_esito.value != '' )
		{
			if ( confrontoAnni( form.bse_data_prelievo.value, form.bse_data_ricezione_esito.value ) == 1 ) { 
				message += label("","- [Controllo documentale] : Inserire \"Data Ricezione Esito Test TSE\" maggiore o uguale alla \"Data Prelievo Test TSE\" del capo" + " (" +  form.bse_data_prelievo.value + ")\r\n" );
				ret = false;
			}
		}
		...
		*/
		...
		var numCapiOviniControlloDocumentale = parseInt('0');
		if(form.cd_num_capi_ovini!=null && form.cd_num_capi_ovini.value!="")
			numCapiOviniControlloDocumentale += parseInt(form.cd_num_capi_ovini.value);
		var numCapiCapriniControlloDocumentale = parseInt('0');
		if(form.cd_num_capi_caprini!=null && form.cd_num_capi_caprini.value!="")
			numCapiCapriniControlloDocumentale += parseInt(form.cd_num_capi_caprini.value);
		...
		var numCapiCapriniDestTotale = calcolaNumCapiCapriniDestCorrente() + mavam_num_capi_ovini + parseInt(numCapiCapriniDestPartita_AltreSedute)+ parseInt(numCapiCapriniMavamPartita_AltreSedute);
		...
		{
				message += label("","- [Evidenza Visita AM] : \"Numero Capi "+specie1+"\" specificati nella Visita AM e Morte Ant.macellazione non può essere superiore al numero capi "+specie1+" specificato nel controllo documentale\r\n" );
				ret = false;
		}
		
		if(numCapiCapriniDestTotale>numCapiCapriniControlloDocumentale)
		{
				message += label("","- [Evidenza Visita AM] : \"Numero Capi "+specie2+"\" specificati nella Visita AM e Morte Ant.macellazione non può essere superiore al numero capi "+specie2+" specificato nel controllo documentale\r\n" );
				ret = false;
		}
		...
		if(calcolaNumCapiOviniDestCorrente()+num_capi_ovini_esito_2_val!=vam_num_capi_ovini && document.getElementById('cd_specie').options[1].selected)
		{
		...
		if(calcolaNumCapiCapriniDestCorrente()+num_capi_caprini_esito_2_val!=vam_num_capi_caprini && document.getElementById('cd_specie').options[1].selected)
		{
		...
		if(!toLiberoConsumo){
			...
			for (var i=0; i<options.length; i++) 
			{
				if(options[i].index>=2)
				{
					...
					if(selected && document.getElementById('num_capi_caprini_esito_'+id).value=="" && document.getElementById('num_capi_ovini_esito_'+id).value=="")
					{
		...
		if ( form.vpm_data!=null && form.vpm_data.value != '' )
		{
		...
		*/
		if ( form.vpm_data!=null && form.vam_provvedimenti.value == '4' && form.abb_data.value == ''  )
		{
		...
		*/
		...
		//if( form.cd_bse.checked && form.cd_data_nascita.value!='' && !sonoPassatiQuattroAnni( form.cd_data_nascita.value)){
		...
		//{
			//if(document.getElementById('cd_bse').checked==false){
				/*
				...
				document.getElementById('cd_bse').checked = true;
		...
		/*
		if(document.getElementById('cd_bse').checked==false && document.getElementById('mavam_luogo').value != '-1' && ( (id_specie_selezionata == BOVINI || id_specie_selezionata == BUFALINI)  ) ){
		...
		*/
		...
		if( ret && form.cd_bse.checked && form.cd_bse.value != '-1' && form.bse_data_prelievo.value == '' ) 
		{
...
function contralla_cd_bse(){
	if ( document.getElementById('cd_bse').checked ) {
...
{
	document.getElementById('sezioneTESTBSE').style.display = "none";
	document.main.cd_bse.checked = false;
		...
		for (var i=0; i<options.length; i++) 
		{
			if(options[i].index>=2)
			{
				...
				if(selected)
				{
					if(document.getElementById('cd_specie').options[1].selected)
					{
						document.getElementById('num_capi_ovini_esito_'+id).disabled="";
						document.getElementById('num_capi_ovini_esito_asterisco_'+id).style.display="";
					}
					else
					{
						document.getElementById('num_capi_ovini_esito_'+id).disabled="disabled";
						document.getElementById('num_capi_ovini_esito_asterisco_'+id).style.display="none";
					}
					if(document.getElementById('cd_specie').options[2].selected)
					{
						document.getElementById('num_capi_caprini_esito_'+id).disabled="";
						document.getElementById('num_capi_caprini_esito_asterisco_'+id).style.display="";
					}
					else
					{
						document.getElementById('num_capi_caprini_esito_'+id).disabled="disabled";
						document.getElementById('num_capi_caprini_esito_asterisco_'+id).style.display="none";
					}
...
function displayLCSO()
{
	...
	{
		if(document.getElementById("lcso")!=null)
...
function gestisciObbligatorietaCd()
{
	if(document.getElementById('cd_specie').options[1].selected)
	{
		document.getElementById('cd_num_capi_ovini_asterisco').style.display = '';
		document.getElementById('cd_num_capi_ovini').disabled = false;
		var i=1;
		/*while(i<=1)
		{
			if(document.getElementById('num_capi_ovini_'+i)!=null)
			{
				document.getElementById('num_capi_ovini_'+i).disabled = false;
			}
			i++;
		}*/
		if(document.getElementById('vam_num_capi_ovini')!=null)
		{
			document.getElementById('vam_num_capi_ovini').disabled = false;
			document.getElementById('vam_num_capi_ovini_asterisco').style.display = "";
		}
		if(document.getElementById('casl_num_capi_ovini')!=null)
		{
			document.getElementById('casl_num_capi_ovini').disabled = false;
			//document.getElementById('casl_num_capi_ovini_asterisco').style.display = "";
		}
		if(document.getElementById('mavam_num_capi_ovini')!=null)
		{
			document.getElementById('mavam_num_capi_ovini').disabled = false;
			//document.getElementById('mavam_num_capi_ovini_asterisco').style.display = "";
		}
	}
	else
	{
		document.getElementById('cd_num_capi_ovini_asterisco').style.display = 'none';
		document.getElementById('cd_num_capi_ovini').value = '';
		document.getElementById('cd_num_capi_ovini').disabled = "disabled";
		var i=1;
		/*while(i<=1)
		{
			if(document.getElementById('num_capi_ovini_'+i)!=null)
			{
				document.getElementById('num_capi_ovini_'+i).disabled = "disabled";
			}
			i++;
		}*/
		if(document.getElementById('vam_num_capi_ovini')!=null)
		{
			document.getElementById('vam_num_capi_ovini').disabled = "disabled";
			document.getElementById('vam_num_capi_ovini_asterisco').style.display = "none";
		}
		if(document.getElementById('casl_num_capi_ovini')!=null)
		{
			document.getElementById('casl_num_capi_ovini').disabled = "disabled";
			//document.getElementById('casl_num_capi_ovini_asterisco').style.display = "none";
		}
		if(document.getElementById('mavam_num_capi_ovini')!=null)
		{
			document.getElementById('mavam_num_capi_ovini').disabled = "disabled";
	...
	if(document.getElementById('cd_bse').checked)
	{
		if(document.getElementById('cd_specie').options[1].selected)
		{
			document.getElementById('cd_num_capi_ovini_da_testare_asterisco').style.display = '';
			document.getElementById('cd_num_capi_ovini_da_testare').disabled = false;
		}
		if(document.getElementById('cd_specie').options[2].selected)
		{
			document.getElementById('cd_num_capi_caprini_da_testare_asterisco').style.display = '';
			document.getElementById('cd_num_capi_caprini_da_testare').disabled = false;
		}
		if(!document.getElementById('cd_specie').options[1].selected)
		{
			document.getElementById('cd_num_capi_ovini_da_testare_asterisco').style.display = 'none';
			document.getElementById('cd_num_capi_ovini_da_testare').value = '';
			document.getElementById('cd_num_capi_ovini_da_testare').disabled = "disabled";
		}
		if(!document.getElementById('cd_specie').options[2].selected)
		{
			document.getElementById('cd_num_capi_caprini_da_testare_asterisco').style.display = 'none';
			document.getElementById('cd_num_capi_caprini_da_testare').value = '';
			document.getElementById('cd_num_capi_caprini_da_testare').disabled = "disabled";
		}
	}
	else
	{
	...
	if(document.getElementById('cd_specie').options[2].selected)
	{
		document.getElementById('cd_num_capi_caprini_asterisco').style.display = '';
		document.getElementById('cd_num_capi_caprini').disabled = false;
		var i=1;
		/*while(i<=1)
		{
			if(document.getElementById('num_capi_caprini_'+i)!=null)
			{
				document.getElementById('num_capi_caprini_'+i).disabled = false;
			}
			i++;
		}*/
		...
		if(document.getElementById('vam_num_capi_caprini')!=null)
		{
			document.getElementById('vam_num_capi_caprini').disabled = false;
			document.getElementById('vam_num_capi_caprini_asterisco').style.display = "";
		}
		if(document.getElementById('casl_num_capi_caprini')!=null)
		{
			document.getElementById('casl_num_capi_caprini').disabled = false;
			//document.getElementById('casl_num_capi_caprini_asterisco').style.display = "";
		}
		if(document.getElementById('mavam_num_capi_caprini')!=null)
		{
			document.getElementById('mavam_num_capi_caprini').disabled = false;
			//document.getElementById('mavam_num_capi_caprini_asterisco').style.display = "";
		}
	}
	else
	{
		document.getElementById('cd_num_capi_caprini_asterisco').style.display = 'none';
		document.getElementById('cd_num_capi_caprini').value = '';
		document.getElementById('cd_num_capi_caprini').disabled = "disabled";
		var i=1;
		while(i<=1)
		{
			if(document.getElementById('num_capi_caprini_'+i)!=null)
			{
				document.getElementById('num_capi_caprini_'+i).disabled = "disabled";
			}
			i++;
		}
		if(document.getElementById('vam_num_capi_caprini')!=null)
		{
			document.getElementById('vam_num_capi_caprini').disabled = "disabled";
			document.getElementById('vam_num_capi_caprini_asterisco').style.display = "none";
		}
		if(document.getElementById('casl_num_capi_caprini')!=null)
		{
			document.getElementById('casl_num_capi_caprini').disabled = "disabled";
			//document.getElementById('casl_num_capi_caprini_asterisco').style.display = "none";
		}
		if(document.getElementById('mavam_num_capi_caprini')!=null)
		{
			document.getElementById('mavam_num_capi_caprini').disabled = "disabled";
...
function gestisciObbligatorietaComunicazioniEsterne(){
	...
	if(comunicazioniEsterneA || dataComunicazioniEsterne || tipoNCComunicazioniEsterne || provvedimentiComunicazioniEsterne){
		...
		if(tipoNCComunicazioniEsterne)
			document.getElementById('casl_num_capi_asterisco').style.display = '';
	}
	else{
		...
		if(tipoNCComunicazioniEsterne)
			document.getElementById('casl_num_capi_asterisco').style.display = 'none';
	}
...
function gestisciObbligatorietaMorteAnteMacellazione(){
	...
	var dataVisitaPostMortem = document.getElementById('vpm_data').value;
	var destinatarioVisitaPostMortem = trim(document.getElementById('destinatario_1_nome').value) ;
...
function gestisciObbligatorietaVisitaAnteMortem(){
	...
	if(dataVisitaAnteMortem || dataVisitaAnteMortem || provvedimentoVisitaAnteMortem || numCapiOvini!='' || numCapiCaprini!=''){
		...
		if(document.forms[0].vam_esito[0].checked || document.forms[0].vam_esito[1].checked || document.forms[0].vam_esito[2].checked )
		{
...
<body onload="displayVPMpatologie(),displayLCSO(),displayNumCapiEsito();<%if(update){out.println("gestisciObbligatorietaCd();gestisciObbligatorietaComunicazioniEsterne();gestisciObbligatorietaMorteAnteMacellazione();gestisciObbligatorietaVisitaAnteMortem();gestisciObbligatorietaVisitaPostMortem();");}%>gestisciUtenteVeterinario();contralla_cd_bse();gestisciBloccoAnimale();displayAbbattimento(); mostraDestinazione();gestisciTabellaNonConformitaVam();">
	...
	<tr>
		<td>
			...
			<%
					...
					%>
			<a href="MacellazioniNewSintesis.do?command=List&altId=<%=OrgDetails.getAltId()%>">Macellazioni</a> > <%= update ? "Modifica Partita" : "Aggiungi Partita" %>
		</td>
	</tr>
</table>
<%@page import="java.text.SimpleDateFormat"%>
...
<jsp:useBean id="PartitaLog"			class="org.aspcfs.modules.macellazioninewsintesis.base.PartitaLog"		scope="request" />
...
<form name="main" action="MacellazioniNewSintesis.do?command=<%=(update) ? ("Update") : ("Save") %>" method="post" onsubmit="if( controllaForm( false )){loadModalWindow();this.submit();}" >
...
<input type="hidden" name="partita_esistente" value="no" />
...
<input type="hidden" id="numCapiOviniSedute" name="numCapiOviniSedute" value="<%=(String)request.getAttribute("numCapiOviniSedute")%>" />
<input type="hidden" id="numCapiCapriniSedute" name="numCapiCapriniSedute" value="<%=(String)request.getAttribute("numCapiCapriniSedute")%>" />
            ...
            <tr class="containerBody">
            	<td class="formLabel">Codice Azienda di provenienza</td>
            	 <td>
					...
					<input type="text" onchange="return false; searchBdn(this.value,2)" name="cd_codice_azienda_provenienza" value="<%=toHtmlValue( Partita.getCd_codice_azienda_provenienza() ) %>" /><font color="red" >*</font>
<br>			
			<textarea style="display:none" rows="5" cols="33"  name = "cd_info_azienda_provenienza" id = "infoAzienda" ><%=toHtml2( Partita.getCd_info_azienda_provenienza())%></textarea>
					<input type = "hidden" name = "rag_soc_azienda_provenienza" id = "rag_soc_azienda_provenienza" value ="<%=toHtml2( Partita.getRag_soc_azienda_prov())%>"/>
					<input type = "hidden" name = "denominazione_asl_azienda_prov" id = "denominazione_asl_azienda_prov" value ="<%=toHtml2( Partita.getDenominazione_asl_azienda_prov())%>"/>
					<input type = "hidden" name = "id_asl_azienda_prov" id = "id_codice_asl_azienda_prov" value ="<%=toHtml2( Partita.getId_asl_azienda_prov())%>"/>
					<input type = "hidden" name = "cod_asl_azienda_prov" id = "cod_asl_azienda_prov" value ="<%=toHtml2( Partita.getCod_asl_azienda_prov())%>"/>
            ...
            <tr>
                ...
                <td style="background-color:yellow;">
               	<input type="text"   id="cd_partita" name="cd_partita" value="<%=toHtmlValue( ((Partita)Partita).getCd_partita() ) %>" /><font color="red" >*</font>
               	<input type="button" id="genera_partita" name="genera_partita" value="Numero automatico" onclick="javascript:generaPartita();" />
                </td>
            </tr>
            ...
            <tr class="containerBody">
            	<td class="formLabel">Commerciante/Proprietario degli animali</td>
            	 <td>
					<input type="text" name="proprietario" value="<%=toHtmlValue( Partita.getProprietario() ) %>" /><font color="red" >*</font>
				</td>
            </tr>
            ...
            <tr class="containerBody">
                ...
                <td>
                	<input type="text" name="cd_codice_azienda" value="<%=toHtmlValue( Partita.getCd_codice_azienda() ) %>" />
				</td>
            </tr>

  <tr class="containerBody" id="categoriaPartitaRow">
                <td class="formLabel" nowrap="nowrap">Categoria partita<br></td>
                <input type="hidden" id="Specie1" name="Specie1" value="Ovini"/>
                <input type="hidden" id="Specie2" name="Specie2" value="Caprini"/>
                <td><input type="radio" id="categoriaPartitaOvicaprini" name="categoriaPartita" value="1" <%= (!Partita.isSpecie_suina() ? "checked" : "") %> onClick="gestisciLabelPartite(this.value)"/>Ovicaprini 
                <input type="radio" id="categoriaPartitaSuini" name="categoriaPartita" value="2" <%= (Partita.isSpecie_suina() ? "checked" : "") %> onClick="gestisciLabelPartite(this.value)"/>Suini
            ...
            <tr class="containerBody" >
                ...
                <td>
<% 
					   Specie.setJsEvent("onChange=\"javascript:contralla_cd_bse();gestisciObbligatorietaCd();gestisciObbligatorietaVisitaAnteMortem();displayNumCapiEsito();\"");  
                	   Specie.setMultiple(true); 
                	   Specie.setSelectSize(3);
                	   LookupList specieSel = new LookupList();
                	   if(((Partita)Partita).getCd_num_capi_ovini()>0)
   					   		specieSel.addItem( 27, "" );
                	   if(((Partita)Partita).getCd_num_capi_caprini()>0)
  					   		specieSel.addItem( 28, "" );
%>
              		<%=Specie.getHtmlSelect("cd_specie", specieSel)%>
              		<font color="red" >*</font>
              	<br/>	
              	<label>Numero Capi <label class="specie1">Ovini</label>    </label>
<%              	
              	String num_capi_ovini = "";
				if(((Partita)Partita).getCd_num_capi_ovini()>0)
					num_capi_ovini = ((Partita)Partita).getCd_num_capi_ovini()+"";
%>
                <input type="text" disabled="disabled" id="cd_num_capi_ovini" name="cd_num_capi_ovini" onchange="isIntPositivo2(this.value,'Numero Capi Ovini',this);" value="<%=toHtmlValue(num_capi_ovini) %>" />
                <font id="cd_num_capi_ovini_asterisco" style="display: none;" color="red" >*</font>
                
                <br/>
                <label>Numero Capi <label class="specie2">Caprini</label> </label>
<%              	
              	String num_capi_caprini = "";
				if(((Partita)Partita).getCd_num_capi_caprini()>0)
					num_capi_caprini = ((Partita)Partita).getCd_num_capi_caprini()+"";
%>
                <input type="text" disabled="disabled" id="cd_num_capi_caprini" name="cd_num_capi_caprini" onchange="isIntPositivo2(this.value,'Numero Capi Caprini',this);" value="<%=toHtmlValue(num_capi_caprini) %>" />
                <font id="cd_num_capi_caprini_asterisco" style="display: none;" color="red" >*</font>
                ...
                <td>
					...
					<tr><td>
                	0 <input type = "radio" id = "cd_categoria_rischio_0" name = "cd_categoria_rischio" value = "0" <%if(Partita.getCd_categoria_rischio()==0 || Partita.getCd_categoria_rischio()<=0  ){%>checked="checked"<%} %> />	[default]
                	</td></tr>
                	<tr><td>
                	1 <input type = "radio" id = "cd_categoria_rischio_1" name = "cd_categoria_rischio" value = "1" <%if(Partita.getCd_categoria_rischio()==1   ){%>checked="checked"<%} %> />	[presenza animali di et&agrave; &gt; 18 mesi]
                	</td></tr>
                	<tr><td>
                	2 <input type = "radio" id = "cd_categoria_rischio_2" name = "cd_categoria_rischio" value = "2" <%if(Partita.getCd_categoria_rischio()==2  ){%>checked="checked"<%} %> /> 	[MAC. DIFFERITA IN CASO DI BRUC.] <br> 
                	</td></tr> 	
                	</table-->
                	...
                	<table class="noborder">
                		<tr>
                			<td>
                				<select name="categorie_selezionate" id="categorie_selezionate" multiple="multiple" size="3" onChange="gestisciCapi18(this)">
                					<option value="0" selected="selected">
                						0 [Default]
                					</option>
                					
                					<option value="1" <%if(update && CategorieId.contains(1)){out.println("selected=\"selected\""); }%>>
                						1 [Presenza animali di et&agrave; &gt; 18 mesi]
                					</option>
                					
                					<option value="2" <%if(update && CategorieId.contains(2)){out.println("selected=\"selected\""); }%>>
                						2 [MAC. DIFFERITA IN CASO DI BRUC.]
                					</option>
                				</select>
                	...
                	<label>Numero Capi <label class="specie1">Ovini</label> > 18 mesi   </label>
<%              	
              	String num_capi_ovini_18 = "";
				if(((Partita)Partita).getCd_num_capi_ovini_18()>0)
					num_capi_ovini_18 = ((Partita)Partita).getCd_num_capi_ovini_18()+"";
%>
                <input type="text" disabled="disabled" id="cd_num_capi_ovini_18" name="cd_num_capi_ovini_18" onchange="isIntPositivo2(this.value,'Numero Capi Ovini',this);" value="<%=toHtmlValue(num_capi_ovini_18) %>" />
                
                <br/>
                <label>Numero Capi <label class="specie2">Caprini</label> 18 mesi </label>
<%              	
              	String num_capi_caprini_18 = "";
				if(((Partita)Partita).getCd_num_capi_caprini_18()>0)
					num_capi_caprini_18 = ((Partita)Partita).getCd_num_capi_caprini_18()+"";
%>
                <input type="text" disabled="disabled" id="cd_num_capi_caprini_18" name="cd_num_capi_caprini_18" onchange="isIntPositivo2(this.value,'Numero Capi Caprini',this);" value="<%=toHtmlValue(num_capi_caprini_18) %>" />
            ...
            <tr class="containerBody">
              ...
              <td valign="middle">
              	<input type="checkbox" name="cd_vincolo_sanitario" <%=(Partita.isCd_vincolo_sanitario()) ? ("checked=\"checked\"") : ("") %> />
                Motivo
                <textarea rows="2" cols="40" name="cd_vincolo_sanitario_motivo"><%=toHtmlValue( Partita.getCd_vincolo_sanitario_motivo() ) %></textarea>
              </td>
            </tr>
            ...
            <tr class="containerBody">
                ...
                <td>
                	<input type="text" name="cd_mod4" value="<%=toHtmlValue( Partita.getCd_mod4() ) %>" />
				</td>
            </tr>
			...
			<tr class="containerBody">
              ...
              <td>
<%--              		<zeroio:dateSelect field="cd_data_mod4" form="main" showTimeZone="false" timestamp="<%=Partita.getCd_data_mod4() %>" /> --%>
              		<input type="text" name="cd_data_mod4" id="cd_data_mod4" class="date_picker" size="10" value="<%=DateUtils.timestamp2string(Partita.getCd_data_mod4())%>" />&nbsp;  
			        <a href="#" style="cursor: pointer;" onclick="svuotaData(document.forms[0].cd_data_mod4);"><img src="images/delete.gif" align="absmiddle"/></a>
              </td>
            </tr>
            ...
            <tr class="containerBody">
              ...
              %>
              	<%=PianiRisanamento.getHtmlSelect( "cd_macellazione_differita", Partita.getCd_macellazione_differita() ) %>
              </td>
            </tr>
            
            <tr class="containerBody">
              <td class="formLabel" nowrap="nowrap" id="test_bse_etichetta">Partita sottoposta a test TSE</td>
              <td id="test_bse_valore">
              	<input id="cd_bse" onchange="gestisciObbligatorietaCd();" name="cd_bse" type="checkbox" <%=(((Partita)Partita).getCd_bse()) ? ("checked=\"checked\"") : ("") %> />
				<br/>
				<label>Numero Capi da testare</label>
<%              	
              	num_capi_ovini = "";
				if(((Partita)Partita).getCd_num_capi_ovini_da_testare()>0)
					num_capi_ovini = ((Partita)Partita).getCd_num_capi_ovini_da_testare()+"";
				num_capi_caprini = "";
				if(((Partita)Partita).getCd_num_capi_caprini_da_testare()>0)
					num_capi_caprini = ((Partita)Partita).getCd_num_capi_caprini_da_testare()+"";
%>
				<br/>
				<label class="specie1">Ovini</label> 
                <input type="text" disabled="disabled" id="cd_num_capi_ovini_da_testare" name="cd_num_capi_ovini_da_testare" onchange="isIntPositivo(this.value,'Numero Capi Ovini da testare',this);" value="<%=toHtmlValue(num_capi_ovini) %>" />
                <font id="cd_num_capi_ovini_da_testare_asterisco" style="display: none;" color="red" >*</font>
                <br/>
               <label class="specie2">Caprini</label> 
                <input type="text" disabled="disabled" id="cd_num_capi_caprini_da_testare" name="cd_num_capi_caprini_da_testare" onchange="isIntPositivo(this.value,'Numero Capi Caprini da testare',this);" value="<%=toHtmlValue(num_capi_caprini) %>" />
                <font id="cd_num_capi_caprini_da_testare_asterisco" style="display: none;" color="red" >*</font>
              </td>
            </tr>
            ...
            <tr class="containerBody">
              ...
              <td>
              	<input type="checkbox" name="cd_info_catena_alimentare" <%=(update && !Partita.isCd_info_catena_alimentare()) ? ("") : ("checked=\"checked\"") %> />
              </td>
            </tr>
            ...
            <tr class="containerBody">
            	...
            	<td>
<%--              	<zeroio:dateSelect field="cd_data_arrivo_macello" form="main" showTimeZone="false" timestamp="<%=Partita.getCd_data_arrivo_macello() %>" /> --%>
					<input onfocus="gestisciDataCorrente();" type="text" class="date_picker" id="cd_data_arrivo_macello" name="cd_data_arrivo_macello" size="10" value="<%=DateUtils.timestamp2string(Partita.getCd_data_arrivo_macello())%>" />  
			        <font color="red" >*</font>
			        <a href="#" style="cursor: pointer;" onclick="svuotaData(document.forms[0].cd_data_arrivo_macello);"><img src="images/delete.gif" align="absmiddle"/></a>
              		<input type="checkbox" name="cd_data_arrivo_macello_flag_dichiarata" <%=(update && !Partita.isCd_data_arrivo_macello_flag_dichiarata()) ? ("") : ("checked=\"checked\"") %>/>
              		Data dichiarata dal gestore
              	</td>
            </tr>
             <tr>
             ...
             <tr class="containerBody">
                ...
                <td>
                	<input type="text" name="cd_tipo_mezzo_trasporto" value="<%=toHtmlValue( Partita.getCd_tipo_mezzo_trasporto() ) %>" />
				</td>
            </tr>
            ...
            <tr class="containerBody">
                ...
                <td>
                	<input type="text" name="cd_targa_mezzo_trasporto" value="<%=toHtmlValue( Partita.getCd_targa_mezzo_trasporto() ) %>" />
				</td>
            </tr>
            ...
            <tr class="containerBody">
              ...
              <td>
              	<input type="checkbox" name="cd_trasporto_superiore8ore" <%=(Partita.isCd_trasporto_superiore8ore()) ? ("checked=\"checked\"") : ("") %> />
              </td>
            </tr>
...
<tbody id="sezioneTESTBSE">
				<tr>
				  ...
				  <th colspan="2"><strong>Dettagli Test TSE</strong></th>
				</tr>
...
<%--						<zeroio:dateSelect 
 ...
 --%>							
						<input type="text" name="bse_data_prelievo" id="bse_data_prelievo" class="date_picker" size="10" value="<%=DateUtils.timestamp2string(Partita.getBse_data_prelievo())%>" />&nbsp;  
			        	<a href="#" style="cursor: pointer;" onclick="svuotaData(document.forms[0].bse_data_prelievo);"><img src="images/delete.gif" align="absmiddle"/></a>
					</td>
				</tr>
...
<%--						<zeroio:dateSelect 
 ...
 --%>
						<input type="text" name="bse_data_ricezione_esito" id="bse_data_ricezione_esito" class="date_picker" size="10" value="<%=DateUtils.timestamp2string(Partita.getBse_data_ricezione_esito())%>" />&nbsp;  
			        	<a href="#" style="cursor: pointer;" onclick="svuotaData(document.forms[0].bse_data_ricezione_esito);"><img src="images/delete.gif" align="absmiddle"/></a> 
					</td>
				</tr>
					...
					<td>
						<select name="bse_esito" id="bse_esito" onchange="javascript:controlla_esito_testBSE()" >
							...
							<option 
								...
								<%=( "POSITIVO AL TEST".equals( toHtmlValue( Partita.getBse_esito() ) ) ) ? ("selected=\"selected\"") : ("") %> 
								>POSITIVO AL TEST</option>
							<option 
								value="NEGATIVO AL TEST" 
								<%=( "NEGATIVO AL TEST".equals( toHtmlValue( Partita.getBse_esito() ) ) ) ? ("selected=\"selected\"") : ("") %> 
...
<!--***************************************************************-->
            	...
            	<td colspan="2">
		            <table>
		            	<tr class="containerBody" style="display: block;">
		                	<td>
		                		1. <input 
		                				value="<%=toHtmlValue( Partita.getCd_veterinario_1() ) %>" 
			            ...
			            <tr 
			            	...
			            	<%=( toHtmlValue( Partita.getCd_veterinario_1() ).length() == 0 ) ? ("style=\"display: none\"") : ("") %> >
			                <td>
				                2. <input 
		                				value="<%=toHtmlValue( Partita.getCd_veterinario_2() ) %>" 
			            ...
			            <tr 
			            	...
			            	<%=( toHtmlValue( Partita.getCd_veterinario_2() ).length() == 0 ) ? ("style=\"display: none\"") : ("") %> >
			                <td>
				                3. <input 
		                				value="<%=toHtmlValue( Partita.getCd_veterinario_3() ) %>" 
				                		size="35" 
				                		id="cd_veterinario_3"  
            ...
            <tr class="containerBody">
               <td class="formLabel">Note</td>
               <td>
               		<textarea name="cd_note" rows="3" cols="70"><%=toHtmlValue( Partita.getCd_note() ) %></textarea>
               </td>
            </tr>        
      </tbody></table>        
      </td>
...
%>
	<input id="liberoConsumoButton" type="button" value="Libero Consumo >>" onclick="if(controllaForm( true )){document.main.action='MacellazioniNewSintesis.do?command=ToLiberoConsumo&fromModifica=si';settaSoloCD('false');document.main.submit();};" />

	<%if (update) { %> 
		<script type="text/javascript">nascondi_liberoConsumoButton(true)</script>
	 <% } else { %>
...
<!--	<div style="text-align: center; margin-top: 20px;">-->
	<input type="button" value="Altre operazioni" onclick="checkControlloDocumentale();gestisciObbligatorietaCd();gestisciObbligatorietaVisitaAnteMortem();" />
<!--	</div>-->
	<%} %>
          ...
          <tbody>
           ...
           <tr>
            ...
            <tr>
                <td style="background-color:yellow;text-align: right" nowrap="nowrap">Partita</td>
                <td style="background-color:yellow;">
                	<%=toHtmlValue( ((Partita)Partita).getCd_partita() ) %>
                </td>
            </tr>
...
<%--               	<zeroio:dateSelect field="vam_data" form="main" showTimeZone="false" timestamp="<%=Partita.getVam_data() %>" /> --%>
					<input type="text" id="vam_data" name="vam_data" class="date_picker" onfocus="riportaDataArrivoMacello(this);gestisciObbligatorietaVisitaAnteMortem();" size="10" value="<%=DateUtils.timestamp2string(Partita.getVam_data())%>" />&nbsp;  
            ...
            <tr class="containerBody">
                ...
                <td>
						<input 
							...
							name="vam_esito" 
							value="Favorevole" 
							<%=(update && !Partita.getVam_esito().equalsIgnoreCase("Favorevole")) ? ("") : ("checked=\"checked\"") %> >Favorevole<br/>
						<input 
							type=radio 
							onclick="if(this.checked==true) document.getElementById('vam_tabella_non_conformita').style.display='none';gestisciObbligatorietaVisitaAnteMortem();"
							id= "vam_esito" 
							...
							<%=(update && Partita.getVam_esito().equalsIgnoreCase("Favorevole con riserva") ) ? ("checked=\"checked\"") : ("") %> >Favorevole con riserva<br/>
						<input 
							type=radio 
							...
							<%=(update && Partita.getVam_esito().equalsIgnoreCase("Non favorevole") ) ? ("checked=\"checked\"") : ("") %> >Non favorevole 
...
try{
				num_capi_ovini = "";
				if(Partita!=null && ((Partita)Partita).getVam_num_capi_ovini()>0) 
					num_capi_ovini = ((Partita)Partita).getVam_num_capi_ovini()+"";
}
catch(Exception e)
{
}
%>
                	<input type="text" disabled="disabled" id="vam_num_capi_ovini" name="vam_num_capi_ovini" onblur="gestisciObbligatorietaVisitaAnteMortem()" onchange="isIntPositivo(this.value,'Numero Capi Ovini',this);" value="<%=toHtmlValue(num_capi_ovini) %>" />
...
try{
				num_capi_caprini = "";
				if(Partita!=null && ((Partita)Partita).getVam_num_capi_caprini()>0) 
					num_capi_caprini = ((Partita)Partita).getVam_num_capi_caprini()+"";
}
catch(Exception e)
{
}
%>
                	<input type="text" disabled="disabled" id="vam_num_capi_caprini" name="vam_num_capi_caprini" onblur="gestisciObbligatorietaVisitaAnteMortem()" onchange="isIntPositivo(this.value,'Numero Capi Caprini',this);" value="<%=toHtmlValue(num_capi_caprini) %>" />
                	<font id="vam_num_capi_caprini_asterisco" align="center" style="display: none;" color="red" >*</font>
                </td>
            </tr>
            ...
            <tr class="containerBody">
                ...
                <td>
					...
					%>                               
	               	...
	               	<%=ProvvedimentiVAM.getHtmlSelect( "vam_provvedimenti", Partita.getVam_provvedimenti() ) %>
            ...
            <tr class="containerBody">
            	...
            	<td>
            		<input 
            			...
            			<%=(Partita.isVam_to_asl_origine()) ? ("checked=\"checked\"") : ("") %> 
            			/> ASL origine <br/>
            		<input 
            			type="checkbox" 
            			id="vam_to_proprietario_animale"
            			name="vam_to_proprietario_animale" 
            			<%=(Partita.isVam_to_proprietario_animale()) ? ("checked=\"checked\"") : ("") %> 
            			/> Proprietario animale <br/>
            		<input 
            			type="checkbox" 
            			id="vam_to_azienda_origine"
            			name="vam_to_azienda_origine" 
            			<%=(Partita.isVam_to_azienda_origine()) ? ("checked=\"checked\"") : ("") %>
            			/> Azienda di origine <br/>
            		<input 
            			type="checkbox" 
            			id="vam_to_proprietario_macello"
            			name="vam_to_proprietario_macello" 
            			<%=(Partita.isVam_to_proprietario_macello()) ? ("checked=\"checked\"") : ("") %>
            			/> Proprietario macello <br/>
            		<input 
            			type="checkbox" 
            			id="vam_to_pif"
            			name="vam_to_pif" 
            			<%=(Partita.isVam_to_pif()) ? ("checked=\"checked\"") : ("") %>
            			/> P.I.F. <br/>	
            		<input 
            			type="checkbox" 
            			id="vam_to_uvac"
            			name="vam_to_uvac" 
            			<%=(Partita.isVam_to_uvac()) ? ("checked=\"checked\"") : ("") %>
            			/> U.V.A.C. <br/>	
            		<input 
            			type="checkbox" 
            			id="vam_to_regione"
            			name="vam_to_regione" 
            			<%=(Partita.isVam_to_regione()) ? ("checked=\"checked\"") : ("") %>
            			/> Regione <br/>
            		<input 
            			type="checkbox"
            			id="vam_to_altro" 
            			...
            			<%=(Partita.isVam_to_altro()) ? ("checked=\"checked\"") : ("") %>
            			/> Altro <br/>
              ...
              <tr class="containerBody">
		 		<td class="formLabel">Note</td>
		 		<td><textarea rows="2" cols="40" name="vam_provvedimenti_note"><%=toHtmlValue( Partita.getVam_provvedimenti_note() ) %></textarea></td>
			  </tr>
...
<%--			<zeroio:dateSelect field="abb_data" form="main" showTimeZone="false" timestamp="<%=Partita.getAbb_data() %>"/>  --%>              
              	<input type="text" id="abb_data" name="abb_data" class="date_picker" size="10" value="<%=DateUtils.timestamp2string(Partita.getAbb_data())%>" />&nbsp;  
                ...
                <td>
                	<textarea rows="2" cols="40" name="abb_motivo"><%=toHtmlValue( Partita.getAbb_motivo() ) %></textarea>
                </td>
                </tr>
            ...
            <tr class="containerBody">
            	<td colspan="2">
		            <table>
		            	<tr class="containerBody">
		                	<td>1. <input 
		                			value="<%=toHtmlValue( Partita.getAbb_veterinario() ) %>"
			            ...
			            <tr 
			            	...
			            	<%=( toHtmlValue( Partita.getAbb_veterinario() ).length() == 0 ) ? ("style=\"display: none\"") : ("") %> >
			                <td>2. <input 
		                			value="<%=toHtmlValue( Partita.getAbb_veterinario_2() ) %>"
			            ...
			            <tr 
			            	...
			            	<%=( toHtmlValue( Partita.getAbb_veterinario_2() ).length() == 0 ) ? ("style=\"display: none\"") : ("") %> >
			                <td>3. <input 
		                			value="<%=toHtmlValue( Partita.getAbb_veterinario_3() ) %>"
			                		size="25" 
...
<!--            </tr>-->
            ...
            <tr class="containerBody">
              ...
              %>
              <%=TipiMacellazione.getHtmlSelect( "mac_tipo", Partita.getMac_tipo() ) %></td>
            </tr>
          </tbody>
        </table>
         </td>
...
<%--              	<zeroio:dateSelect field="vpm_data" form="main" showTimeZone="false" timestamp="<%=Partita.getVpm_data() %>" />  --%>
					<input type="text" id="vpm_data" name="vpm_data" class="date_picker" onfocus="riportaDataArrivoMacello(this);gestisciObbligatorietaVisitaPostMortem();" size="10" value="<%=DateUtils.timestamp2string(Partita.getVpm_data())%>" />&nbsp;  
            ...
            <tr class="containerBody">
                ...
                %>                               
                <%=EsitiVpm.getHtmlSelect( "vpm_esito", esiti ) %>
                </td>
            </tr>
...
%>
            <tr class="containerBody" style="display:none;" id="trNumCapiOviniEsito<%=thisElement.getId()%>">
                ...
                <td>
               		 <input type="text" id="num_capi_ovini_esito_<%=thisElement.getId()%>" name="num_capi_ovini_esito_<%=thisElement.getId()%>" onchange="isIntPositivo(this.value,'Numero Capi Ovini',this);" value="<%=num_capi_ovini_esito%>" />
                	 <font id="num_capi_ovini_esito_asterisco_<%=thisElement.getId()%>" color="red" >*</font>
                </td>
            </tr>
             ...
             <tr class="containerBody" style="display:none;" id="trNumCapiCapriniEsito<%=thisElement.getId()%>">
                ...
                <td>
               		 <input type="text" id="num_capi_caprini_esito_<%=thisElement.getId()%>" name="num_capi_caprini_esito_<%=thisElement.getId()%>" onchange="isIntPositivo(this.value,'Numero Capi Caprini',this);" value="<%=num_capi_caprini_esito%>" />
                	 <font id="num_capi_caprini_esito_asterisco_<%=thisElement.getId()%>" color="red" >*</font>
                </td>
            </tr>
<%
				}
...
<!--            </tr>              -->
			...
			<tr class="containerBody">
              <td class="formLabel" >Data Ricezione Esito</td>
              <td>
              	<zeroio:dateSelect field="vpm_data_esito" form="main" showTimeZone="false" timestamp="<%=Partita.getVpm_data_esito() %>" />
              </td>
            </tr>
            <% } %>
            ...
            <tr class="containerBody" 
            	...
            	<%=(update && ( EsitiId.contains(2) ||  EsitiId.contains(4) )) ? ("") : ("style=\"display: none\"") %> >
             ...
             <tr class="containerBody">
                ...
                <td><input type="text" name="vpm_causa_patologia" value="<%=toHtmlValue( Partita.getVpm_causa_patologia() ) %>" /></td>
             </tr>

             <tr class="containerBody">
                <td class="formLabel">Note</td>
                <td><textarea name="vpm_note" rows="2" cols="25"><%=toHtmlValue( Partita.getVpm_note() ) %></textarea></td>
            ...
            <tr class="containerBody">
            	<td colspan="2">
		            <table>
		            	<tr class="containerBody" style="display: block;">
		                	<td>1. <input 
		                			value="<%=toHtmlValue( Partita.getVpm_veterinario() ) %>"
							...
							<select id="veterinari_vpm" name="veterinari_vpm" onchange="set_vet( this, 'vpm_veterinario')">
									...
									<%for (String gruppo : listaVeterinari.keySet()){ %>
										<optgroup label="<%=gruppo %>"></optgroup>
										<%for(Contact vet : listaVeterinari.get(gruppo)){ %>
											<option <%if (Partita.getVpm_veterinario() != null && Partita.getVpm_veterinario().trim().equals(vet.getNameLast().trim()) ){%>selected="selected" <%} %> value = "<%=vet.getUserId()%>" ><%=vet.getNameLast() %></option>
										<%} %>
									<%} %>
							</select>
			            ...
			            <tr 
			            	...
			            	<%=( toHtmlValue( Partita.getVpm_veterinario() ).length() == 0 ) ? ("style=\"display: none\"") : ("") %> >
			                <td>2. <input 
		                			value="<%=toHtmlValue( Partita.getVpm_veterinario_2() ) %>"
			                ...
			                <select id="veterinari_vpm2" name="veterinari_vpm2" onchange="set_vet( this, 'vpm_veterinario_2')">
									...
									<%for (String gruppo : listaVeterinari.keySet()){ %>
										<optgroup label="<%=gruppo %>"></optgroup>
										<%for(Contact vet : listaVeterinari.get(gruppo)){ %>
											<option <%if (Partita.getVpm_veterinario_2() != null && Partita.getVpm_veterinario_2().trim().equals(vet.getNameLast().trim()) ){%>selected="selected" <%} %> value = "<%=vet.getUserId()%>" ><%=vet.getNameLast() %></option>
										<%} %>
									<%} %>
							</select>
			                </td>
			            ...
			            <tr 
			                ...
			                <td>3. <input 
		                			value="<%=toHtmlValue( Partita.getVpm_veterinario_3() ) %>"
			                		size="35" 
			                ...
			                <select id="veterinari_vpm3" name="veterinari_vpm3" onchange="set_vet( this, 'vpm_veterinario_3')">
									...
									<%for (String gruppo : listaVeterinari.keySet()){ %>
										<optgroup label="<%=gruppo %>"></optgroup>
										<%for(Contact vet : listaVeterinari.get(gruppo)){ %>
											<option <%if (Partita.getVpm_veterinario_3() != null && Partita.getVpm_veterinario_3().trim().equals(vet.getNameLast().trim()) ){%>selected="selected" <%} %> value = "<%=vet.getUserId()%>" ><%=vet.getNameLast() %></option>
										<%} %>
									<%} %>
							</select>
	...
	<% } %>
            ...
            <tr>
                <th colspan="2"><strong>Destinatari/Esercenti</strong> <input onclick="javascript:gestioneAddDest();" type="button" name="addDest" id="addDest" value="Aggiungi" />             </th>
            </tr>
            <tr>
            	<td colspan="2">
            	...
            	<td colspan="2">
		            <table width="100%" border="0" cellpadding="2" cellspacing="0" align="left">
					    ...
					    <tr class="containerBody">
					        ...
					        <td>
						        <div 
						        	...
						        	<textarea style="display: none;" rows="3" cols="36" id="esercenteNoGisa1" name="esercenteNoGisa1" onchange="valorizzaDestinatario(this,'destinatario_1');" ><%=toHtmlValue( Partita.getDestinatario_1_nome() ) %></textarea>
						        </div>
						        <div  
						        	style="<%=(update && !Partita.isDestinatario_1_in_regione()) ? ("") : ("display:none") %>" 
						        	id="esercenti_1">
						       		<a href="javascript:mostraTextareaEsercente('esercenteFuoriRegione1');" onclick="selectDestinazioneFromLinkTextarea(1);gestisciObbligatorietaVisitaPostMortem();gestisciObbligatorietaVisitaPostMortem();gestioneObbligNumCapiDestCarni(1,0);" >[Inserisci Esercente fuori Regione]</a>
						       		<textarea style="display: none;" rows="3" cols="36" id="esercenteFuoriRegione1" name="esercenteFuoriRegione1" onchange="valorizzaDestinatario(this,'destinatario_1');" ><%=toHtmlValue( Partita.getDestinatario_1_nome() ) %></textarea>
						        </div>
						        <br/>
						        <div id ="destinatario_label_1" align="center">
						        	<%=(Partita.getDestinatario_1_id() != -1) ? (toHtmlValue( Partita.getDestinatario_1_nome() )) : ("-- Seleziona Destinatario --") %>
						        </div>
					        	<input 
					        		type="hidden" 
					        		name="destinatario_1_id" 
					        		id="destinatario_1_id" 
					        		value="<%=(Partita.getDestinatario_1_id() != -1) ? (Partita.getDestinatario_1_id()) : ("-1") %>" />
					        	<input 
					        		type="hidden" 
					        		name="destinatario_1_nome" 
					        		id="destinatario_1_nome" 
					        		onchange="gestisciObbligatorietaVisitaPostMortem();"
					        		value="<%=toHtmlValue( Partita.getDestinatario_1_nome() ) %>" />
						    ...
						    <td>
						    	<div style="" id="imprese_2">
						        	<a href = "javascript:popLookupSelectorDestinazioneCarni( 'si', 2, 'impresa' );" onclick="selectDestinazione(2);gestioneObbligNumCapiDestCarni(2,1);" >[Seleziona Impresa]</a><br/>
						      		<a href = "javascript:popLookupSelectorDestinazioneCarni( 'si', 4, 'stab');" onclick="selectDestinazione(2);gestioneObbligNumCapiDestCarni(2,1);" >[Seleziona Stabilimento]</a><br/>
						      		<a href="javascript:mostraTextareaEsercente('esercenteNoGisa2');" onclick="selectDestinazioneFromLinkTextarea(2);gestioneObbligNumCapiDestCarni(2,2);" >[Inserisci Esercente non in G.I.S.A.]</a><br/>
						      		...
						      		<textarea style="display: none;" rows="3" cols="36" id="esercenteNoGisa2" name="esercenteNoGisa2" onchange="valorizzaDestinatario(this,'destinatario_2');" ><%=toHtmlValue( Partita.getDestinatario_2_nome() ) %></textarea>
						        ...
						        <div  style="display:none" id="esercenti_2">
						       		...
						       		<textarea style="display: none;" rows="3" cols="36" id="esercenteFuoriRegione2" name="esercenteFuoriRegione2" onchange="valorizzaDestinatario(this,'destinatario_2');" ><%=toHtmlValue( Partita.getDestinatario_2_nome() ) %></textarea>
						        </div>
						        <br/>
					        	<div id ="destinatario_label_2" align="center">
						        	<%=(Partita.getDestinatario_2_id() != -1) ? (toHtmlValue( Partita.getDestinatario_2_nome() )) : ("-- Seleziona Destinatario --") %>	
						        </div>
					        	<input 
					        		type="hidden" 
					        		name="destinatario_2_id" 
					        		id="destinatario_2_id" 
					        		value="<%=(Partita.getDestinatario_2_id() != -1) ? (Partita.getDestinatario_2_id()) : ("-1") %>" />
					        	<input 
					        		type="hidden" 
					        		name="destinatario_2_nome" 
					        		id="destinatario_2_nome" 
					        		onchange="gestisciObbligatorietaVisitaPostMortem();"
					        		value="<%=toHtmlValue( Partita.getDestinatario_2_nome() ) %>" />
						...
						<tr class="containerBody">
			            	<td  class="formLabel">Numero Capi <label class="specie1">Ovini</label> </td>
					        <td> 
						        <input disabled="disabled" type="text" name="destinatario_1_num_capi_ovini" onchange="isIntPositivo(this.value,'Numero Capi Destinatari',this);" value="<%=((Partita.getDestinatario_1_num_capi_ovini()>0)?(Partita.getDestinatario_1_num_capi_ovini()):("")) %>" id="num_capi_ovini_1" /> 
					        	<font style="display:none;" id="num_capi_ovini_asterisco_1" color="red" >*</font>
					        </td>
					        <td> 
						        <input disabled="disabled" type="text" name="destinatario_2_num_capi_ovini" onchange="isIntPositivo(this.value,'Numero Capi Destinatari',this);" value="<%=((Partita.getDestinatario_2_num_capi_ovini()>0)?(Partita.getDestinatario_2_num_capi_ovini()):("")) %>" id="num_capi_ovini_2" /> 
					    ...
					    <tr class="containerBody">
			            	<td  class="formLabel">Numero Capi <label class="specie2">Caprini</label> </td>
					        <td> 
						        <input disabled="disabled" type="text" name="destinatario_1_num_capi_caprini" onchange="isIntPositivo(this.value,'Numero Capi Destinatari',this);" value="<%=((Partita.getDestinatario_1_num_capi_caprini()>0)?(Partita.getDestinatario_1_num_capi_caprini()):("")) %>" id="num_capi_caprini_1" /> 
					        	<font style="display:none;" id="num_capi_caprini_asterisco_1" color="red" >*</font>
					        </td>
					        <td> 
						        <input disabled="disabled" type="text" name="destinatario_2_num_capi_caprini" onchange="isIntPositivo(this.value,'Numero Capi Destinatari',this);" value="<%=((Partita.getDestinatario_2_num_capi_caprini()>0)?(Partita.getDestinatario_2_num_capi_caprini()):("")) %>" id="num_capi_caprini_2" /> 
            	...
            	<td colspan="2">
		            <table width="100%" border="0" cellpadding="2" cellspacing="0" align="left">
					    ...
					    <tr class="containerBody">
					        ...
					        <td>
						        <div 
						        	...
						        	<textarea style="display: none;" rows="3" cols="36" id="esercenteNoGisa3" name="esercenteNoGisa3" onchange="valorizzaDestinatario(this,'destinatario_3');" ><%=toHtmlValue( Partita.getDestinatario_3_nome() ) %></textarea>
						        </div>
						        <div  
						        	style="<%=(update && !Partita.isDestinatario_3_in_regione()) ? ("") : ("display:none") %>" 
						        	id="esercenti_3">
						       		...
						       		<textarea style="display: none;" rows="3" cols="36" id="esercenteFuoriRegione3" name="esercenteFuoriRegione3" onchange="valorizzaDestinatario(this,'destinatario_3');" ><%=toHtmlValue( Partita.getDestinatario_3_nome() ) %></textarea>
						        </div>
						        <br/>
						        <div id ="destinatario_label_3" align="center">
						        	<%=(Partita.getDestinatario_3_id() != -1) ? (toHtmlValue( Partita.getDestinatario_3_nome() )) : ("-- Seleziona Destinatario --") %>
						        </div>
					        	<input 
					        		type="hidden" 
					        		name="destinatario_3_id" 
					        		id="destinatario_3_id" 
					        		value="<%=(Partita.getDestinatario_3_id() != -1) ? (Partita.getDestinatario_3_id()) : ("-1") %>" />
					        	<input 
					        		type="hidden" 
					        		name="destinatario_3_nome" 
					        		id="destinatario_3_nome" 
					        		onchange="gestisciObbligatorietaVisitaPostMortem();"
					        		value="<%=toHtmlValue( Partita.getDestinatario_3_nome() ) %>" />
						    ...
						    <td>
						    	<div style="" id="imprese_4">
						        	<a href = "javascript:popLookupSelectorDestinazioneCarni( 'si', 6, 'impresa' );" onclick="selectDestinazione(4);gestioneObbligNumCapiDestCarni(4,1);" >[Seleziona Impresa]</a><br/>
						      		...
						      		<textarea style="display: none;" rows="3" cols="36" id="esercenteNoGisa4" name="esercenteNoGisa4" onchange="valorizzaDestinatario(this,'destinatario_4');" ><%=toHtmlValue( Partita.getDestinatario_4_nome() ) %></textarea>
						        ...
						        <div  style="display:none" id="esercenti_4">
						       		...
						       		<textarea style="display: none;" rows="3" cols="36" id="esercenteFuoriRegione4" name="esercenteFuoriRegione4" onchange="valorizzaDestinatario(this,'destinatario_4');" ><%=toHtmlValue( Partita.getDestinatario_4_nome() ) %></textarea>
						        </div>
						        <br/>
					        	<div id ="destinatario_label_4" align="center">
						        	<%=(Partita.getDestinatario_4_id() != -1) ? (toHtmlValue( Partita.getDestinatario_4_nome() )) : ("-- Seleziona Destinatario --") %>	
						        </div>
					        	<input 
					        		type="hidden" 
					        		name="destinatario_4_id" 
					        		id="destinatario_4_id" 
					        		value="<%=(Partita.getDestinatario_4_id() != -1) ? (Partita.getDestinatario_4_id()) : ("-1") %>" />
					        	<input 
					        		type="hidden" 
					        		name="destinatario_4_nome" 
					        		id="destinatario_4_nome" 
					        		onchange="gestisciObbligatorietaVisitaPostMortem();"
					        		value="<%=toHtmlValue( Partita.getDestinatario_4_nome() ) %>" />
						...
						<tr class="containerBody">
			            	<td  class="formLabel">Numero Capi <label class="specie1">Ovini</label> </td>
					        <td> 
						        <input disabled="disabled" type="text" name="destinatario_3_num_capi_ovini" onchange="isIntPositivo(this.value,'Numero Capi Destinatari',this);" value="<%=((Partita.getDestinatario_3_num_capi_ovini()>0)?(Partita.getDestinatario_3_num_capi_ovini()):("")) %>" id="num_capi_ovini_3" /> 
					        	<font style="display:none;" id="num_capi_ovini_asterisco_3" color="red" >*</font>
					        </td>
					        <td> 
						        <input disabled="disabled" type="text" name="destinatario_4_num_capi_ovini" onchange="isIntPositivo(this.value,'Numero Capi Destinatari',this);" value="<%=((Partita.getDestinatario_4_num_capi_ovini()>0)?(Partita.getDestinatario_4_num_capi_ovini()):("")) %>" id="num_capi_ovini_4" /> 
					    ...
					    <tr class="containerBody">
			            	<td  class="formLabel">Numero Capi <label class="specie2">Caprini</label> </td>
					        <td> 
						        <input disabled="disabled" type="text" name="destinatario_3_num_capi_caprini" onchange="isIntPositivo(this.value,'Numero Capi Destinatari',this);" value="<%=((Partita.getDestinatario_3_num_capi_caprini()>0)?(Partita.getDestinatario_3_num_capi_caprini()):("")) %>" id="num_capi_caprini_3" /> 
					        	<font style="display:none;" id="num_capi_caprini_asterisco_3" color="red" >*</font>
					        </td>
					        <td> 
						        <input disabled="disabled" type="text" name="destinatario_4_num_capi_caprini" onchange="isIntPositivo(this.value,'Numero Capi Destinatari',this);" value="<%=((Partita.getDestinatario_4_num_capi_caprini()>0)?(Partita.getDestinatario_4_num_capi_caprini()):("")) %>" id="num_capi_caprini_4" /> 
...
<%
						...
						{
							int j=i+1;
							Boolean isDestinatarioInRegione = false;
				        	Boolean isDestinatarioInRegione2 = false;
				        	String destinatarioNome  = "";
				        	String destinatarioNome2 = "";
				        	Integer destinatarioId  = -1;
				        	Integer destinatarioId2 = -1;
				        	String destinatarioNumCapiOvini  = "0";
				        	String destinatarioNumCapiOvini2 = "0";
				        	String destinatarioNumCapiCaprini  = "0";
				        	String destinatarioNumCapiCaprini2 = "0";
				        	
				        	if(update)
					        {
					        	isDestinatarioInRegione = (Boolean)ReflectionUtil.invocaMetodo(Partita, "isDestinatario_"+i+"_in_regione", null, null);
					        	isDestinatarioInRegione2 = (Boolean)ReflectionUtil.invocaMetodo(Partita, "isDestinatario_"+j+"_in_regione", null, null);
					        	destinatarioNome  = (String)ReflectionUtil.invocaMetodo(Partita, "getDestinatario_"+i+"_nome", null, null);
					        	destinatarioNome2 = (String)ReflectionUtil.invocaMetodo(Partita, "getDestinatario_"+j+"_nome", null, null);
					        	destinatarioId  = (Integer)ReflectionUtil.invocaMetodo(Partita, "getDestinatario_"+i+"_id", null, null);
					        	destinatarioId2 = (Integer)ReflectionUtil.invocaMetodo(Partita, "getDestinatario_"+j+"_id", null, null);
					        	destinatarioNumCapiOvini  = ((Integer)ReflectionUtil.invocaMetodo(Partita, "getDestinatario_"+i+"_num_capi_ovini", null, null))+"";
					        	destinatarioNumCapiOvini2  = ((Integer)ReflectionUtil.invocaMetodo(Partita, "getDestinatario_"+j+"_num_capi_ovini", null, null))+"";
					        	destinatarioNumCapiCaprini  = ((Integer)ReflectionUtil.invocaMetodo(Partita, "getDestinatario_"+i+"_num_capi_caprini", null, null))+"";
					        	destinatarioNumCapiCaprini2  = ((Integer)ReflectionUtil.invocaMetodo(Partita, "getDestinatario_"+j+"_num_capi_caprini", null, null))+"";
					        }
...
%>						
				<tr>
            	<td id="rigaDest<%=(i+1)/2 %>" colspan="2" style="display:none;">
		            <table width="100%" border="0" cellpadding="2" cellspacing="0" align="left">
			            <tr class="containerBody">
			            	<td  class="formLabel">In Regione </td>
					        <td> 
					    ...
					    <tr class="containerBody">
					        ...
					        <td>
						        ...
						        <div id ="destinatario_label_<%=i%>" align="center">
						        	<%=( destinatarioId != -1) ? (toHtmlValue( destinatarioNome )) : ("-- Seleziona Destinatario --") %>
						        </div>
					        	<input 
					        		type="hidden" 
						    ...
						    <td>
					        	...
					        	<div id ="destinatario_label_<%=j%>" align="center">
						        	<%=(destinatarioId2 != -1) ? (toHtmlValue( destinatarioNome2 )) : ("-- Seleziona Destinatario --") %>	
						        </div>
					        	<input 
					        		type="hidden" 
						...
						<tr class="containerBody">
			            	<td class="formLabel">Numero Capi <label class="specie1">Ovini</label> </td>
					        <td> 
						        <input disabled="disabled" type="text" name="destinatario_<%=i%>_num_capi_ovini" onchange="isIntPositivo(this.value,'Numero Capi Destinatari',this);" value="<%=destinatarioNumCapiOvini%>" id="num_capi_ovini_<%=i%>" /> 
					        	<font style="display:none;" id="num_capi_ovini_asterisco_<%=i%>" color="red" >*</font>
					        </td>
					        <td> 
						        <input disabled="disabled" type="text" name="destinatario_<%=j%>_num_capi_ovini" onchange="isIntPositivo(this.value,'Numero Capi Destinatari',this);" value="<%=destinatarioNumCapiOvini2%>" id="num_capi_ovini_<%=j%>" /> 
					    ...
					    <tr class="containerBody">
			            	<td class="formLabel">Numero Capi <label class="specie2">Caprini</label> </td>
					        <td> 
						        <input disabled="disabled" type="text" name="destinatario_<%=i%>_num_capi_caprini" onchange="isIntPositivo(this.value,'Numero Capi Destinatari',this);" value="<%=destinatarioNumCapiCaprini%>" id="num_capi_caprini_<%=i%>" /> 
					        	<font style="display:none;" id="num_capi_caprini_asterisco_<%=i%>" color="red" >*</font>
					        </td>
					        <td> 
						        <input disabled="disabled" type="text" name="destinatario_<%=j%>_num_capi_caprini" onchange="isIntPositivo(this.value,'Numero Capi Destinatari',this);" value="<%=destinatarioNumCapiCaprini2%>" id="num_capi_caprini_<%=j%>" /> 
...
%>
    ...
    <tr 
    	id="lcso" 
    	style="<%=(  EsitiId.contains(3) ||  EsitiId.contains(4)) ? ( "" ) : ( "display:none" ) %>" >
    	<td>
    		<table class="details" width="100%" border="0" cellpadding="4" cellspacing="0">
    		<tr>
     ...
     %>
            ...
            <tr id="patologie" class="containerBody">
              ...
              %>
	              ...
	              <%=lookup_lesione_generici.getHtmlSelect("lesione_generici_" + index, (organo.getLcso_organo() >= 13 && organo.getLcso_organo() != 26)? multipleSelect : multipleSelectDefault)%>
...
<tr id="lcpr" <%=( EsitiId.contains(4)) ? ("") : ("style=\"display: none\"") %> >
    	<td>
    		<table class="details" width="100%" border="0" cellpadding="4" cellspacing="0">
            ...
            <tr class="containerBody">
              ...
              <td>
              	<zeroio:dateSelect 
              		...
              		form="main" 
              		showTimeZone="false" 
              		timestamp="<%=Partita.getLcpr_data_prevista_liber() %>" />
              </td>
            </tr>     
            ...
            <tr class="containerBody">
              ...
              <td>
              	<zeroio:dateSelect 
              		...
              		form="main" 
              		showTimeZone="false" 
              		timestamp="<%=Partita.getLcpr_data_effettiva_liber() %>" />
              </td>
            </tr>
   </table>
   </td>
...
<tr><td> <%@include file="include_tamponi_add.jsp" %>  </td></tr>
</table>
...
<%--              	<zeroio:dateSelect field="mavam_data" showTimeZone="false" form="main" timestamp="<%=Partita.getMavam_data() %>" />   --%>
              		<input type="text" id="mavam_data" name="mavam_data" class="date_picker" onfocus="riportaDataArrivoMacello(this);gestisciObbligatorietaMorteAnteMacellazione();" size="10" value="<%=DateUtils.timestamp2string(Partita.getMavam_data())%>" />&nbsp;  
             ...
             <tr class="containerBody">
                ...
                <td>
                	...
                	%>                               
                	<%=LuoghiVerifica.getHtmlSelect( "mavam_luogo", Partita.getMavam_luogo() ) %>
                	...
                	<input 
                		...
                		value="<%=toHtmlValue( Partita.getMavam_descrizione_luogo_verifica() ) %>"
                		<%=( Partita.getMavam_luogo() == 3 ) ? ("") : ("style=\"display: none\"") %> />
...
%>
                	<input type="text" id="mavam_num_capi_ovini" name="mavam_num_capi_ovini" onchange="isIntPositivo(this.value,'Numero Capi Ovini',this);" value="<%=toHtmlValue(num_capi_ovini) %>" />
                	<font id="mavam_num_capi_ovini_asterisco" align="center" style="display: none;" color="red" >*</font>
                </td>
            </tr>
...
%>
                	<input type="text" id="mavam_num_capi_caprini" name="mavam_num_capi_caprini" onchange="isIntPositivo(this.value,'Numero Capi Caprini',this);" value="<%=toHtmlValue(num_capi_caprini) %>" />
                	<font id="mavam_num_capi_caprini_asterisco" align="center" style="display: none;" color="red" >*</font>
                </td>
            </tr>
            ...
            <tr class="containerBody">
                ...
                <td>
                	<textarea rows="2" cols="40" id="mavam_motivo" name="mavam_motivo" onchange="gestisciObbligatorietaMorteAnteMacellazione();"><%=toHtmlValue( Partita.getMavam_motivo() ) %></textarea>
           ...
           <tr class="containerBody">
                ...
                <td>
                	<textarea 
                		...
                		><%=toHtmlValue( Partita.getMavam_impianto_termodistruzione() ) %></textarea>
                </td>
           </tr>
             ...
             <tr class="containerBody">
                ...
                <td>
                	<textarea 
                		...
                		><%=toHtmlValue( Partita.getMvam_destinazione_carcassa() ) %></textarea>
                </td>
           </tr>
           ...
           <tr class="containerBody">
            	...
            	<td>
            		<input 
            			...
            			<%=(Partita.isMavam_to_asl_origine()) ? ("checked=\"checked\"") : ("") %> 
            			/> ASL origine <br/>
            		<input 
            			type="checkbox" 
            			id="mavam_to_proprietario_animale"
            			name="mavam_to_proprietario_animale" 
            			<%=(Partita.isMavam_to_proprietario_animale()) ? ("checked=\"checked\"") : ("") %> 
            			/> Proprietario animale <br/>
            		<input 
            			type="checkbox" 
            			id="mavam_to_azienda_origine"
            			name="mavam_to_azienda_origine" 
            			<%=(Partita.isMavam_to_azienda_origine()) ? ("checked=\"checked\"") : ("") %>
            			/> Azienda di origine <br/>
            		<input 
            			type="checkbox" 
            			id="mavam_to_proprietario_macello"
            			name="mavam_to_proprietario_macello" 
            			<%=(Partita.isMavam_to_proprietario_macello()) ? ("checked=\"checked\"") : ("") %>
            			/> Proprietario macello <br/>
            		<input 
            			type="checkbox" 
            			id="mavam_to_pif"
            			name="mavam_to_pif" 
            			<%=(Partita.isMavam_to_pif()) ? ("checked=\"checked\"") : ("") %>
            			/> P.I.F. <br/>	
            		<input 
            			type="checkbox" 
            			id="mavam_to_uvac"
            			name="mavam_to_uvac" 
            			<%=(Partita.isMavam_to_uvac()) ? ("checked=\"checked\"") : ("") %>
            			/> U.V.A.C. <br/>	
            		<input 
            			type="checkbox" 
            			id="mavam_to_regione"
            			name="mavam_to_regione" 
            			<%=(Partita.isMavam_to_regione()) ? ("checked=\"checked\"") : ("") %>
            			/> Regione <br/>
            		<input 
            			type="checkbox"
            			id="mavam_to_altro" 
            			...
            			<%=(Partita.isMavam_to_altro()) ? ("checked=\"checked\"") : ("") %>
            			/> Altro <br/>
            		<textarea id="mavam_to_altro_testo" name="mavam_to_altro_testo" rows="2" cols="40" style="display: <%=(Partita.isMavam_to_altro()) ? "''" : "none" %>;" ><%=toHtmlValue( Partita.getMavam_to_altro_testo() ) %></textarea>
           ...
           <tr class="containerBody">
                <td class="formLabel">Note</td>
                <td>
                	<textarea rows="2" cols="40" id="mavam_note" name="mavam_note"><%=toHtmlValue( Partita.getMavam_note() ) %></textarea>
                </td>
        ...
        <table class="details" width="100%" border="0" cellpadding="4" cellspacing="0">
          <tbody>
            ...
            <tr class="containerBody">
            	...
            	<td>
            		...
            		<input 
            			...
            			<%=(Partita.isCasl_to_asl_origine()) ? ("checked=\"checked\"") : ("") %> 
            			/> ASL origine <br/>
            		<input 
            			type="checkbox" 
            			...
            			onclick="gestisciObbligatorietaComunicazioniEsterne();"
            			<%=(Partita.isCasl_to_proprietario_animale()) ? ("checked=\"checked\"") : ("") %> 
            			/> Proprietario animale <br/>
            		<input 
            			type="checkbox" 
            			...
            			onclick="gestisciObbligatorietaComunicazioniEsterne();"
            			<%=(Partita.isCasl_to_azienda_origine()) ? ("checked=\"checked\"") : ("") %>
            			/> Azienda di origine <br/>
            		<input 
            			type="checkbox" 
            			...
            			onclick="gestisciObbligatorietaComunicazioniEsterne();"
            			<%=(Partita.isCasl_to_proprietario_macello()) ? ("checked=\"checked\"") : ("") %>
            			/> Proprietario macello <br/>
            		<input 
            			type="checkbox" 
            			id="casl_to_pif"
            			name="casl_to_pif" 
            			onclick="gestisciObbligatorietaComunicazioniEsterne();"
            			<%=(Partita.isCasl_to_pif()) ? ("checked=\"checked\"") : ("") %>
            			/> P.I.F. <br/>	
            		<input 
            			type="checkbox" 
            			id="casl_to_uvac"
            			name="casl_to_uvac" 
            			onclick="gestisciObbligatorietaComunicazioniEsterne();"
            			<%=(Partita.isCasl_to_uvac()) ? ("checked=\"checked\"") : ("") %>
            			/> U.V.A.C. <br/>	
            		<input 
            			type="checkbox" 
            			id="casl_to_regione"
            			...
            			onclick="gestisciObbligatorietaComunicazioniEsterne();"
            			<%=(Partita.isCasl_to_regione()) ? ("checked=\"checked\"") : ("") %>
            			/> Regione <br/>
            		<input 
            			type="checkbox"
            			id="casl_to_altro" 
            			...
            			<%=(Partita.isCasl_to_altro()) ? ("checked=\"checked\"") : ("") %>
            			/> Altro <br/>
            		<textarea id="casl_to_altro_testo" name="casl_to_altro_testo" rows="2" cols="40" style="display: <%=(Partita.isCasl_to_altro()) ? "''" : "none" %>;" ><%=toHtmlValue( Partita.getCasl_to_altro_testo() ) %></textarea>
            ...
            <tr class="containerBody">
              <td class="formLabel" >Data</td>
              <td>
<%--            	<zeroio:dateSelect field="casl_data" form="main" showTimeZone="false" timestamp="<%=Partita.getCasl_data() %>" />  --%>
              		<input type="text" id="casl_data" name="casl_data" class="date_picker" onfocus="riportaDataArrivoMacello(this);gestisciObbligatorietaComunicazioniEsterne();" size="10" value="<%=DateUtils.timestamp2string(Partita.getCasl_data())%>" />&nbsp;
              		<font color="red" id="dataComunicazioneA" style="display: none;">*</font>
			        <a href="#" style="cursor: pointer;" onclick="svuotaData(document.forms[0].casl_data);"><img src="images/delete.gif" align="absmiddle"/></a>
              </td>
            </tr>
...
<%--      	MODIFICATO DA ALBERTO CAMPANILE
             <tr class="containerBody">
                ...
                <td>
    					<%=MotiviASL.getHtmlSelect( "casl_motivo", Partita.getCasl_motivo() )%>
    			</td>       
            </tr>
--%>
			<td class="formLabel">Tipo di non conformità</td>
...
%>
                	<input type="text" id="casl_num_capi_ovini" name="casl_num_capi_ovini" onchange="isIntPositivo(this.value,'Numero Capi Ovini',this);" value="<%=toHtmlValue(num_capi_ovini) %>" />
                	<font id="casl_num_capi_ovini_asterisco" style="display: none;" color="red" >*</font>
                </td>
            </tr>
...
%>
                	<input type="text" id="casl_num_capi_caprini" name="casl_num_capi_caprini" onchange="isIntPositivo(this.value,'Numero Capi Caprini',this);" value="<%=toHtmlValue(num_capi_caprini) %>" />
                	<font id="casl_num_capi_caprini_asterisco" style="display: none;" color="red" >*</font>
                </td>
            </tr>
           <tr class="containerBody">
	           <td class="formLabel">Descrizione non conformità</td>
	           <td><textarea rows="2" cols="40" name="casl_info_richiesta"><%=toHtmlValue( Partita.getCasl_info_richiesta() ) %></textarea></td>
           </tr>
           ...
           <tr class="containerBody">
	           	...
	           	<td> 
	           		<input 
		           		...
		           		<%=(update && Partita.getSeqa_data() != null) ? ("checked=\"checked\"") : ("") %> />
		       </td>
           </tr>
--%>
		   ...
		   <tr class="containerBody" id="note_prevvedimento" >
	           <td class="formLabel">Note</td>
	           <td><textarea rows="2" cols="40" name="casl_note_prevvedimento"><%=toHtmlValue( Partita.getCasl_note_prevvedimento() ) %></textarea></td>
           </tr>
          ...
          <tbody>
            <tr>
             ...
             <tr class="containerBody">
                <td class="formLabel">Data</td>
                <td>
<%--                <zeroio:dateSelect field="rca_data" form="main" showTimeZone="false" timestamp="<%=Partita.getRca_data() %>" /> --%>
                	<input type="text" id="rca_data" name="rca_data" class="date_picker" onfocus="riportaDataArrivoMacello(this);" size="10" value="<%=DateUtils.timestamp2string(Partita.getRca_data())%>" />&nbsp;  
			        <a href="#" style="cursor: pointer;" onclick="svuotaData(document.forms[0].rca_data);"><img src="images/delete.gif" align="absmiddle"/></a>
                </td>
             </tr>
             
             <tr class="containerBody">
                <td class="formLabel">Note</td>
                <td><textarea rows="2" cols="40" name="rca_note"><%=toHtmlValue( Partita.getRca_note() ) %></textarea></td>
             </tr>
          </tbody>
         </table>
        </td>
      ...
      <tr>
        <td valign="top" width="100%">
	        <div 
	        	<%=(update && Partita.getSeqa_data() != null) ? ("") : ("style=\"display: none;\"") %> 
	          ...
	          <tbody>
	            ...
	            <tr class="containerBody">
	              ...
	              <td>
	   <%-- 	 		<zeroio:dateSelect field="seqa_data" form="main" showTimeZone="false" timestamp="<%=Partita.getSeqa_data() %>"/>	--%>          
	              		<input type="text" name="seqa_data" id="seqa_data" class="date_picker" size="10" value="<%=DateUtils.timestamp2string(Partita.getSeqa_data())%>" />&nbsp;
				        <a href="#" style="cursor: pointer;" onclick="svuotaData(document.forms[0].seqa_data);"><img src="images/delete.gif" align="absmiddle"/></a>
	            ...
	            <tr class="containerBody">
	              ...
	              <td>
<%-- 	              		<zeroio:dateSelect field="seqa_data_sblocco" form="main" showTimeZone="false" timestamp="<%=Partita.getSeqa_data_sblocco() %>"/> 	--%>
		              	<input type="text" name="seqa_data_sblocco" id="seqa_data_sblocco" class="date_picker" size="10" value="<%=DateUtils.timestamp2string(Partita.getSeqa_data_sblocco())%>" />&nbsp;
				        <a href="#" style="cursor: pointer;" onclick="svuotaData(document.forms[0].seqa_data_sblocco);"><img src="images/delete.gif" align="absmiddle"/></a>
	              </td>
	            </tr>
	             ...
	             <tr class="containerBody">
	                ...
	                <td>
	                	<%=ProvvedimentiVAM.getHtmlSelect("seqa_destinazione_allo_sblocco", Partita.getSeqa_destinazione_allo_sblocco()) %>
	    			</td>                
	            </tr>
	              </tbody>
	           </table>
...
<input type="submit" value="Completa Macellazione" onclick="document.main.clona.value=''" >
<dhv:evaluate if="<%= update != true %>">
<input type="submit" value="Completa Macellazione e Clona" onclick="document.main.clona.value='si'" >
</dhv:evaluate>
<dhv:evaluate if="<%= update==true%>">
<input type="button" value="Annulla" onclick="location.href='MacellazioniNewSintesis.do?command=Details&id=<%=Partita.getId()%>&altId=<%=OrgDetails.getAltId()%>';" >
</dhv:evaluate>
...
function gestioneObbligNumCapiDestCarni(indice,tipoSelezione)
{
	if(tipoSelezione>2 || tipoSelezione==0)
	{
		if(document.getElementById( 'cd_num_capi_ovini').value!="" && document.getElementById( 'cd_num_capi_ovini').value!="0")
		{
			if(document.getElementById( 'num_capi_ovini_' + indice )!=null)
		...
		if(document.getElementById( 'cd_num_capi_caprini').value!="" && document.getElementById( 'cd_num_capi_caprini').value!="0")
		{
			if(document.getElementById( 'num_capi_caprini_' + indice )!=null)
...
function gestioneObbligNumCapiDestCarniPostSelezione( indiceDestinatario, altId, ragioneSociale, tipo, hasNumCapi)
{
	...
	function gestioneAddDest()
	{
		...
		{
			righeDest++;
			document.getElementById('rigaDest'+righeDest).style.display="";
		}
	}
	...
	function generaPartita()
	{
		...
		document.getElementById('cd_partita').value= asl + codiceUnivoco + anno;		
	}
...
<%
	if(Partita.getDestinatario_4_id()>0 || Partita.getDestinatario_4_id()==-999)
	{
%>
	gestioneObbligNumCapiDestCarni(4,4);
<%
	}
if(Partita.getDestinatario_5_id()>0 || Partita.getDestinatario_5_id()==-999)
{
%>
gestioneObbligNumCapiDestCarni(5,4);
<%
}
if(Partita.getDestinatario_6_id()>0 || Partita.getDestinatario_6_id()==-999)
{
%>
gestioneObbligNumCapiDestCarni(6,4);
<%
}
if(Partita.getDestinatario_7_id()>0 || Partita.getDestinatario_7_id()==-999)
{
%>
gestioneObbligNumCapiDestCarni(7,4);
<%
}
if(Partita.getDestinatario_8_id()>0 || Partita.getDestinatario_8_id()==-999)
{
%>
gestioneObbligNumCapiDestCarni(8,4);
<%
}
if(Partita.getDestinatario_9_id()>0 || Partita.getDestinatario_9_id()==-999)
{
%>
gestioneObbligNumCapiDestCarni(9,4);
<%
}
if(Partita.getDestinatario_10_id()>0 || Partita.getDestinatario_10_id()==-999)
{
%>
gestioneObbligNumCapiDestCarni(10,4);
<%
}
if(Partita.getDestinatario_11_id()>0 || Partita.getDestinatario_11_id()==-999)
{
%>
gestioneObbligNumCapiDestCarni(11,4);
<%
}
if(Partita.getDestinatario_12_id()>0 || Partita.getDestinatario_12_id()==-999)
{
%>
gestioneObbligNumCapiDestCarni(12,4);
<%
}
if(Partita.getDestinatario_13_id()>0 || Partita.getDestinatario_13_id()==-999)
{
%>
gestioneObbligNumCapiDestCarni(13,4);
<%
}
if(Partita.getDestinatario_14_id()>0 || Partita.getDestinatario_14_id()==-999)
{
%>
gestioneObbligNumCapiDestCarni(14,4);
<%
}
if(Partita.getDestinatario_15_id()>0 || Partita.getDestinatario_15_id()==-999)
{
%>
gestioneObbligNumCapiDestCarni(15,4);
<%
}
if(Partita.getDestinatario_16_id()>0 || Partita.getDestinatario_16_id()==-999)
{
%>
gestioneObbligNumCapiDestCarni(16,4);
<%
}
if(Partita.getDestinatario_17_id()>0 || Partita.getDestinatario_17_id()==-999)
{
%>
gestioneObbligNumCapiDestCarni(17,4);
<%
}
if(Partita.getDestinatario_18_id()>0 || Partita.getDestinatario_18_id()==-999)
{
%>
gestioneObbligNumCapiDestCarni(18,4);
<%
}
if(Partita.getDestinatario_19_id()>0 || Partita.getDestinatario_19_id()==-999)
{
%>
gestioneObbligNumCapiDestCarni(19,4);
<%
}
if(Partita.getDestinatario_20_id()>0 || Partita.getDestinatario_20_id()==-999)
{
%>
gestioneObbligNumCapiDestCarni(20,4);
<%
}
if(Partita.getDestinatario_1_id()>0 || Partita.getDestinatario_1_id()==-999)
{
%>
gestioneObbligNumCapiDestCarni(1,4);
<%
}
if(Partita.getDestinatario_2_id()>0 || Partita.getDestinatario_2_id()==-999)
{
%>
gestioneObbligNumCapiDestCarni(2,4);
<%
}
if(Partita.getDestinatario_3_id()>0 || Partita.getDestinatario_3_id()==-999)
{
%>
gestioneObbligNumCapiDestCarni(3,4);
<%
}
if(Partita.getDestinatario_4_id()==-999)
{
%>
mostraTextareaEsercente('esercenteFuoriRegione4');
<%
}
if(Partita.getDestinatario_5_id()==-999)
{
%>
mostraTextareaEsercente('esercenteFuoriRegione5');
<%
}
if(Partita.getDestinatario_6_id()==-999)
{
%>
mostraTextareaEsercente('esercenteFuoriRegione6');
<%
}
if(Partita.getDestinatario_7_id()==-999)
{
%>
mostraTextareaEsercente('esercenteFuoriRegione7');
<%
}
if(Partita.getDestinatario_8_id()==-999)
{
%>
mostraTextareaEsercente('esercenteFuoriRegione8');
<%
}
if(Partita.getDestinatario_9_id()==-999)
{
%>
mostraTextareaEsercente('esercenteFuoriRegione9');
<%
}
if(Partita.getDestinatario_10_id()==-999)
{
%>
mostraTextareaEsercente('esercenteFuoriRegione10');
<%
}
if(Partita.getDestinatario_11_id()==-999)
{
%>
mostraTextareaEsercente('esercenteFuoriRegione11');
<%
}
if(Partita.getDestinatario_12_id()==-999)
{
%>
mostraTextareaEsercente('esercenteFuoriRegione12');
<%
}
if(Partita.getDestinatario_13_id()==-999)
{
%>
mostraTextareaEsercente('esercenteFuoriRegione13');
<%
}
if(Partita.getDestinatario_14_id()==-999)
{
%>
mostraTextareaEsercente('esercenteFuoriRegione14');
<%
}
if(Partita.getDestinatario_15_id()==-999)
{
%>
mostraTextareaEsercente('esercenteFuoriRegione15');
<%
}
if(Partita.getDestinatario_16_id()==-999)
{
%>
mostraTextareaEsercente('esercenteFuoriRegione16');
<%
}
if(Partita.getDestinatario_17_id()==-999)
{
%>
mostraTextareaEsercente('esercenteFuoriRegione17');
<%
}
if(Partita.getDestinatario_18_id()==-999)
{
%>
mostraTextareaEsercente('esercenteFuoriRegione18');
<%
}
if(Partita.getDestinatario_19_id()==-999)
{
%>
mostraTextareaEsercente('esercenteFuoriRegione19');
<%
}
if(Partita.getDestinatario_20_id()==-999)
{
%>
mostraTextareaEsercente('esercenteFuoriRegione20');
<%
}
if(Partita.getDestinatario_1_id()==-999)
{
%>
mostraTextareaEsercente('esercenteFuoriRegione1');
<%
}
if(Partita.getDestinatario_2_id()==-999)
{
%>
mostraTextareaEsercente('esercenteFuoriRegione2');
<%
}
if(Partita.getDestinatario_3_id()==-999)
{
%>
mostraTextareaEsercente('esercenteFuoriRegione3');
<%
}
%>
</script>
...
<% if (update){%>
<script>
document.getElementById("categoriaPartitaRow").style.display='none';
</script>
<%} %>
