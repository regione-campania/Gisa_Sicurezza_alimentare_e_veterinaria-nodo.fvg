	...
	<tr>
		<td>
			...
			<%
					...
					%>
			<a href="MacellazioniNewSintesis.do?command=List&altId=<%=OrgDetails.getAltId()%>">Macellazioni</a> > Aggiungi Seduta
		</td>
	</tr>
</table>
<%@page import="java.text.SimpleDateFormat"%>
...
<form name="main" action="MacellazioniNewSintesis.do?command=RiprendiPartita" method="post" onsubmit="return controllaForm( false );" >
...
%>
	<input id="liberoConsumoButton" type="button" value="Libero Consumo >>" onclick="if(controllaForm( true )){document.main.action='MacellazioniNewSintesis.do?command=ToLiberoConsumoSeduta&idPartita=<%=Partita.getId()%>';settaSoloCD('false');document.main.submit();};" />
