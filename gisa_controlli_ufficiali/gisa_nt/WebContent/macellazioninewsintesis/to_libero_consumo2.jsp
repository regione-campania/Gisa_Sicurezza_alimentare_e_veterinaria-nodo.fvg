...
<%@page import="org.aspcfs.modules.contacts.base.Contact"%><jsp:useBean id="OrgDetails"		class="org.aspcfs.modules.sintesis.base.SintesisStabilimento"	scope="request" />
<jsp:useBean id="Campioni"			class="java.util.ArrayList"									scope="request" />
<jsp:useBean id="Partita"				class="org.aspcfs.modules.macellazioninewsintesis.base.Partita"			scope="session" />
...
function controllaForm( )
{
	...
	try {
		...
		{
				message += label("","- [Evidenza Visita AM] : \"Numero Capi "+specie1+"\" specificati nella Visita AM e Morte Ant.macellazione non può essere superiore alla somma dei capi ovini specificati nel controllo documentale\r\n" );
				ret = false;
		}
		
		if(numCapiCapriniDestTotale>numCapiCapriniControlloDocumentale)
		{
				message += label("","- [Evidenza Visita AM] : \"Numero Capi "+specie2+"\"  specificati nella Visita AM e Morte Ant.macellazione non può essere superiore alla somma dei capi caprini specificati nel controllo documentale\r\n" );
				ret = false;
		}
...
// 		}	
		...
		if(document.getElementById('vam_data')!=null && document.getElementById('vam_provvedimenti')!=null && form.vam_num_capi_ovini
				&& (document.getElementById('cd_num_capi_ovini').value!="" && document.getElementById('cd_num_capi_ovini').value!="0"))
		{
			if((document.getElementById('vam_data').value != '' || document.getElementById('vam_provvedimenti').selectedIndex > 0) && 
					form.vam_num_capi_ovini.value == '')
			{
		...
		if(document.getElementById('vam_data')!=null && document.getElementById('vam_provvedimenti')!=null && form.vam_num_capi_caprini
				&& (document.getElementById('cd_num_capi_caprini').value!="" && document.getElementById('cd_num_capi_caprini').value!="0"))
		{
			if((document.getElementById('vam_data').value != '' || document.getElementById('vam_provvedimenti').selectedIndex > 0) && 
					form.vam_num_capi_caprini.value == '')
			{
		...
		if ( form.vpm_data.value != '' )
		{
			if ( confrontoAnni( form.vam_data.value, form.vpm_data.value ) == 1 ) { 
				message += label("", "- [Evidenza Visita PM] : Inserire \"Data Visita Post Mortem\" maggiore o uguale alla \"Data Visita Ante Mortem\" del partita" + " (" +  form.vam_data.value + ")\r\n" );
				ret = false;
			}
		}
...
function gestisciUnload(){
	...
	if(document.getElementById('submitOK').value == 'no'){
		if(confirm('Stai uscendo dalla scheda "<%= update ? "Modifica" : "Aggiungi"%> Partita". Stai uscendo dalla scheda Cliccare su OK per salvare i dati, altrimenti le informazioni inserite verranno perse.')){
...
<form name="main" action="MacellazioniNewSintesis.do?command=<%=update ? "Update" : "Save" %>ToLiberoConsumo&id=<%=Partita.getId()%>" method="post" onsubmit="if( controllaForm(  )){loadModalWindow();return true;}else{return false;}">
...
%>
                	<input <% if(Partita.getCd_num_capi_ovini()<=0){out.println("disabled=\"disabled\"");} %> type="text" id="vam_num_capi_ovini" name="vam_num_capi_ovini" onchange="isIntPositivo(this.value,'Numero Capi Ovini',this);" value="<%=toHtmlValue(num_capi_ovini) %>" />
                	<font <% if(Partita.getCd_num_capi_ovini()<=0){out.println("style=\"display:none;\"");} %> id="vam_num_capi_ovini_asterisco" align="center" color="red" >*</font>
                </td>
            </tr>
...
%>
                	<input <% if(Partita.getCd_num_capi_caprini()<=0){out.println("disabled=\"disabled\"");} %> type="text" id="vam_num_capi_caprini" name="vam_num_capi_caprini" onchange="isIntPositivo(this.value,'Numero Capi Caprini',this);" value="<%=toHtmlValue(num_capi_caprini) %>" />
                	<font <% if(Partita.getCd_num_capi_caprini()<=0){out.println("style=\"display:none;\"");} %> id="vam_num_capi_caprini_asterisco" align="center" color="red" >*</font>
                </td>
            </tr>
...
<%--	              		<zeroio:dateSelect timestamp="<%=new Timestamp( System.currentTimeMillis() ) %>" field="vpm_data" form="main" showTimeZone="false" />  --%>
	            ...
	            <tr class="containerBody">
					    ...
					    <tr class="containerBody">
					        ...
					        <td >
					        	...
					        	<input 
					        		...
					        		<p id="destinatarioCarni1" style="display:none;" align="center"><font color="red" >*</font></p>
							</td>
						    <td>
					        	...
					        	<input 
					        		...
					        		<p id="destinatarioCarni2" style="display:none;" align="center"><font color="red" >*</font></p>
						    </td>
						</tr>
						<tr class="containerBody">
			            	<td  class="formLabel">Numero Capi <label class="specie1">Ovini</label> </td>
					        <td> 
						        <input disabled="disabled" onchange="isIntPositivo(this.value,'Numero Capi',this);" type="text" name="destinatario_1_num_capi_ovini" value="<%=((Partita.getDestinatario_1_num_capi_ovini()>0)?(Partita.getDestinatario_1_num_capi_ovini()):("")) %>" id="num_capi_ovini_1" /> 
					        	<font style="display:none;" id="num_capi_ovini_asterisco_1" color="red" >*</font>
					        </td>
					        <td> 
						        <input disabled="disabled" onchange="isIntPositivo(this.value,'Numero Capi',this);" type="text" name="destinatario_2_num_capi_ovini" value="<%=((Partita.getDestinatario_2_num_capi_ovini()>0)?(Partita.getDestinatario_2_num_capi_ovini()):("")) %>" id="num_capi_ovini_2" /> 
					    ...
					    <tr class="containerBody">
			            	<td  class="formLabel">Numero Capi <label class="specie2">Caprini</label> </td>
					        <td> 
						        <input disabled="disabled" onchange="isIntPositivo(this.value,'Numero Capi',this);" type="text" name="destinatario_1_num_capi_caprini" value="<%=((Partita.getDestinatario_1_num_capi_caprini()>0)?(Partita.getDestinatario_1_num_capi_caprini()):("")) %>" id="num_capi_caprini_1" /> 
					        	<font style="display:none;" id="num_capi_caprini_asterisco_1" color="red" >*</font>
					        </td>
					        <td> 
						        <input disabled="disabled" onchange="isIntPositivo(this.value,'Numero Capi',this);" type="text" name="destinatario_2_num_capi_caprini" value="<%=((Partita.getDestinatario_2_num_capi_caprini()>0)?(Partita.getDestinatario_2_num_capi_caprini()):("")) %>" id="num_capi_caprini_2" /> 
						...
						<tr class="containerBody">
			            	<td  class="formLabel">Numero Capi <label class="specie1">Ovini</label> </td>
					        <td> 
						        <input disabled="disabled" onchange="isIntPositivo(this.value,'Numero Capi',this);" type="text" name="destinatario_3_num_capi_ovini" value="<%=((Partita.getDestinatario_3_num_capi_ovini()>0)?(Partita.getDestinatario_3_num_capi_ovini()):("")) %>" id="num_capi_ovini_3" /> 
					        	<font style="display:none;" id="num_capi_ovini_asterisco_3" color="red" >*</font>
					        </td>
					        <td> 
						        <input disabled="disabled" onchange="isIntPositivo(this.value,'Numero Capi',this);" type="text" name="destinatario_4_num_capi_ovini" value="<%=((Partita.getDestinatario_4_num_capi_ovini()>0)?(Partita.getDestinatario_4_num_capi_ovini()):("")) %>" id="num_capi_ovini_4" /> 
					    ...
					    <tr class="containerBody">
			            	<td  class="formLabel">Numero Capi <label class="specie2">Caprini</label> </td>
					        <td> 
						        <input disabled="disabled" onchange="isIntPositivo(this.value,'Numero Capi',this);" type="text" name="destinatario_3_num_capi_caprini" value="<%=((Partita.getDestinatario_3_num_capi_caprini()>0)?(Partita.getDestinatario_3_num_capi_caprini()):("")) %>" id="num_capi_caprini_3" /> 
					        	<font style="display:none;" id="num_capi_caprini_asterisco_3" color="red" >*</font>
					        </td>
					        <td> 
						        <input disabled="disabled" onchange="isIntPositivo(this.value,'Numero Capi',this);" type="text" name="destinatario_4_num_capi_caprini" value="<%=((Partita.getDestinatario_4_num_capi_caprini()>0)?(Partita.getDestinatario_4_num_capi_caprini()):("")) %>" id="num_capi_caprini_4" /> 
...
%>						
				<tr>
					    ...
					    <tr class="containerBody">
			            	<td  style="display:none;" id="rigaDestTd4<%=(i+1)/2 %>" class="formLabel">Destinatario/Esercente</td>
...
String fileToInclude3 = "include_tamponi_add" + configTipo3.getIdTipo() + ".jsp";
%>
...
<input type="button" value="Completa Macellazione e Prosegui" onclick="document.main.clone.value='ok';if(controllaForm()){loadModalWindow();document.main.submit();}" />
