...
function openPopupErrataCorrigeArt17(idCapo, altId, tipo){
        ...
        if (document.all) {
        	  window.open('MacellazioniDocumentiNewSintesis.do?command=ViewModuleErrataCorrigeArt17&altId='+altId+'&idCapo='+idCapo+'&tipoMacello='+tipo,'popupSelect',
	...
	<tr>
		<td>
			...
			<%
				...
				{}
			%>
			<a href="MacellazioniNewSintesis.do?command=List&altId=<%=OrgDetails.getAltId() %>">Macellazioni</a> > Dettaglio Capo
		</td>
	</tr>
</table>
...
<dhv:permission name="stabilimenti-stabilimenti-macellazioni-edit">
	<input type="button" value="Modifica" onclick="location.href='MacellazioniNewSintesis.do?command=ModificaCapo&id=<%=Capo.getId() %>&altId=<%=OrgDetails.getAltId() %>'" />
</dhv:permission>

<dhv:permission name="stabilimenti-stabilimenti-macellazioni-delete">
	<input type="button" value="Elimina" onclick="if(confirm('Sicuro di voler eliminare la registrazione?')){location.href='MacellazioniNewSintesis.do?command=Delete&id=<%=Capo.getId() %>&altId=<%=OrgDetails.getAltId() %>'}" />
</dhv:permission>
<%} else{ 
...
%>
<dhv:permission name="stabilimenti-stabilimenti-macellazioni-edit">
	<input type="button" value="Inserisci Esito Campioni" onclick="location.href='MacellazioniNewSintesis.do?command=ModificaCapo&id=<%=Capo.getId() %>&altId=<%=OrgDetails.getAltId() %>'" />
</dhv:permission>
<%	
}else
{
...
--%>            
			...
			<tr class="containerBody">
              ...
              <td>
              		<dhv:tz timestamp="<%=Capo.getCd_data_mod4() %>" dateOnly="true"/>&nbsp;
              </td>
            </tr>
			...
			<tr class="containerBody">
                ...
                <td><zeroio:tz timestamp="<%=Capo.getCd_data_arrivo_macello() %>" showTimeZone="false" dateOnly="true" /> </td>
            </tr>
		...
		<tbody>
            <tr>
             ...
             <tr class="containerBody">
                ...
                <td><zeroio:tz timestamp="<%=Capo.getBse_data_prelievo() %>" showTimeZone="false" dateOnly="true" /> </td>
            </tr>
        ...
        <td valign="top" width="100%"><table class="details" width="100%" border="0" cellpadding="4" cellspacing="0">
          <tbody>
            ...
            <tr class="containerBody">
              ...
              <td><%=toDateasString(Capo.getVpm_data()) %>&nbsp; </td>
            </tr>
...
<!--            <%} %>        -->
            ...
            <tr class="containerBody">
             ...
             <tr class="containerBody">
                ...
                <td><%=Capo.getVpm_causa_patologia() %>&nbsp; </td>
             </tr>
				<tr class="containerBody">
                <td class="formLabel">Note</td>
                <td><%=Capo.getVpm_note() %>&nbsp;</td>

            </tr> 
             
              <tr class="containerBody">
                <td class="formLabel" rowspan="3">Veterinari addetti al controllo</td>
                <td>&nbsp;1. <%=Capo.getVpm_veterinario() %></td>
            </tr>
            
            <tr class="containerBody">
                <td>&nbsp;2. <%=Capo.getVpm_veterinario_2() %></td>
            </tr>
            <tr class="containerBody">
                <td>&nbsp;3. <%=Capo.getVpm_veterinario_3() %></td>
            </tr> 
            <tr>
            ...
            <tr class="containerBody">
            	<td  class="formLabel">Destinatari 1 e 2 </td>
		        <td>
    	...
    	<td>
    		<table class="details" width="100%" border="0" cellpadding="4" cellspacing="0">
    			...
    			<tr>
    				...
    				<td><dhv:tz  dateOnly="true" timestamp="<%=temp.getData_ricezione_esito() %>"/>&nbsp; </td>
    			</tr>
    ...
    <tbody><tr>
        ...
        <td valign="top" width="100%"><table class="details" width="100%" border="0" cellpadding="4" cellspacing="0">
          ...
          <tr>
            ...
            <tr class="containerBody">
              <td class="formLabel" >Data</td>
              <td><dhv:tz  dateOnly="true" timestamp="<%=Capo.getMavam_data() %>"/>&nbsp; </td>
            </tr>
             ...
             <tr class="containerBody">
                ...
                <td>
                	...
                	<%=Capo.getMavam_descrizione_luogo_verifica() %>
                </td>
            ...
            <tr class="containerBody">
                ...
                <td>
                	<%=Capo.getMavam_impianto_termodistruzione() %>&nbsp;
    ...
    <tbody><tr>
        <td valign="top" width="100%"><table class="details" width="100%" border="0" cellpadding="4" cellspacing="0">
          ...
          <tr>
            ...
            <tr class="containerBody">
              <td class="formLabel" >Data</td>
              <td><dhv:tz dateOnly="true" timestamp="<%=Capo.getCasl_data() %>"/>&nbsp; </td>
            </tr>
...
--%>
            ...
            <tr class="containerBody">
                ...
                <td><%=Capo.getCasl_info_richiesta() %>&nbsp;</td>
            </tr>
			...
			<tr class="containerBody">
                <td class="formLabel">Note</td>
                <td><%=Capo.getCasl_note_prevvedimento() %>&nbsp;</td>
            </tr>
    ...
    <tbody><tr>
        <td valign="top" width="100%"><table class="details" width="100%" border="0" cellpadding="4" cellspacing="0">
          <tbody>
            <tr>
             ...
             <tr class="containerBody">
                <td class="formLabel">Data</td>
                <td><dhv:tz dateOnly="true" timestamp="<%=Capo.getRca_data() %>"/>&nbsp; </td>
             </tr>
             
             <tr class="containerBody">
                <td class="formLabel">Note</td>
                <td><%=Capo.getRca_note() %>&nbsp; </td>
             </tr>
        ...
        <table class="details" width="100%" border="0" cellpadding="4" cellspacing="0">
          <tbody>
            ...
            <tr class="containerBody">
              <td class="formLabel" >Data</td>
              <td><dhv:tz dateOnly="true" timestamp="<%=Capo.getSeqa_data() %>"/>&nbsp; </td>
            </tr>
            
            <tr class="containerBody">
              <td class="formLabel" >Sbloccato il</td>
              <td><dhv:tz dateOnly="true" timestamp="<%=Capo.getSeqa_data_sblocco() %>"/>&nbsp; </td>
            </tr>
        ...
        <td valign="top" width="100%"><table class="details" width="100%" border="0" cellpadding="4" cellspacing="0">
          <tbody>
            <tr>
             ...
             <tr class="containerBody">
                <td class="formLabel">Data Ricezione Esito</td>
                <td><zeroio:tz timestamp="<%=Capo.getBse_data_ricezione_esito() %>" showTimeZone="false" dateOnly="true" /></td>
            </tr>
