...
<form name="main" action="MacellazioniNewSintesis.do?command=UpdateEsitoCampioni" method="post" onsubmit="return controllaForm( false );" >
     ...
     %>
            ...
            <tr id="patologie" class="containerBody">
              ...
              %>
	              ...
	              <%=lookup_lesione_polmoni.getHtmlSelect("lesione_visceri_" + index, organo.getLcso_organo() == 26 ? multipleSelect : multipleSelectDefault)%>
