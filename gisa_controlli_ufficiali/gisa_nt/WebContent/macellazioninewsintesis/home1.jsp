...
if(listaDateMacellazione.size() > 0){
%>
<form name="macellazioniForm" action="MacellazioniNewSintesis.do?command=AddSedutaMacellazione" onsubmit="return(confirm('Cliccando su OK verrà chiusa definitivamente la corrente seduta di Macellazione e aperta la nuova per la giornata selezionata'))" method="post">
<input type="hidden" name="altId" value="<%=OrgDetails.getAltId() %>" />
