...
<jsp:useBean id="Capo" class="org.aspcfs.modules.macellazioninewsintesis.base.Partita"
	scope="request" />
...
<table class="trails" cellspacing="0">
	<tr>
		<td>
			...
			<a href="MacellazioniNewSintesis.do?command=List&altId=<%=OrgDetails.getAltId()%>">Macellazioni Ovicaprini</a> > 
			<a href="MacellazioniNewSintesis.do?command=Details&altId=<%=OrgDetails.getAltId()%>&id=<%=Capo.getId()%>">Dettaglio partita</a>			
		</td>
	</tr>
</table>
...
<form name="main" action="MacellazioniNewSintesis.do?command=SaveIstopatologico&auto-populate=true<%=addLinkParams(request, "popup|popupType|actionId")%>"
