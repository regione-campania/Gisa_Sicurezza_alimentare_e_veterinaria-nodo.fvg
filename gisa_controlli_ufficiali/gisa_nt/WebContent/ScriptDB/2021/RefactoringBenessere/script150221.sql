...
ALTER FUNCTION public.get_info_chk_bns_istanza(integer, integer)
  OWNER TO postgres;
	...
	update organization_address set city =null where trasheddate is null and city = 'null';
  	...
  	update rel_indicatore_chk_bns set id_lookup_chk_bns  = 29 where codice_raggruppamento = 5605;
  	
update chk_bns_domande_v5 set quesito = replace(quesito, 'È', 'E''');
update chk_bns_domande_v5 set quesito = replace(quesito, 'à', 'a''');
update chk_bns_domande_v5 set quesito = replace(quesito, 'è', 'e''');
update chk_bns_domande_v5 set quesito = replace(quesito, 'ì', 'i''');
update chk_bns_domande_v5 set quesito = replace(quesito, 'ò', 'u''');
update chk_bns_domande_v5 set quesito = replace(quesito, 'ù', 'u''');
update chk_bns_domande_v5 set quesito = replace(sottotitolo, '•', '-');
update chk_bns_domande_v5 set sottotitolo = replace(sottotitolo, '•', '-');
