...
select * from ricerche_anagrafiche_old_materializzata  where tipologia_operatore in (10)


update scheda_operatore_metadati set enabled = false where tipo_operatore = 8;insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','INFORMAZIONE PRIMARIA','capitolo','','','','A','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','CODICE FISCALE','','codice_fiscale_rappresentante as codice_fiscale_titolare ','organization ','org_id = #orgid#','AAAAA','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','STATO CANILE','','case when data_chiusura_canile is not null then ''canile non autorizzato'' else '''' end 
|| case when abusivo then '' / abusivo'' else '''' end as stato_canile ','organization ','org_id = #orgid#
','ab','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','CATEGORIA DI RISCHIO','','categoria_rischio as cat_rischio ','organization ','org_id = #orgid#','b','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','CONTROLLI UFFICIALI APERTI','','count(*)','ticket',' org_id = #orgid# and tipologia = 3 and closed is null and trashed_date is null','BB','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','CONTROLLI UFFICIALI CHIUSI','','count(*)','ticket ',' org_id = #orgid# and tipologia = 3 and closed is not null and trashed_date is null','BBB','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','AUTORIZZAZIONE','','autorizzazione ','organization ','org_id = #orgid#','c','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','NUMERO TELEFONO LEGALE','','p.number','organization o left join organization_phone p on o.org_id = p.org_id','o.org_id = #orgid# and p.phone_type =1','CC','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','NUMERO TELEFONO OPERATIVO','','p.number','organization o left join organization_phone p on o.org_id = p.org_id','o.org_id = #orgid# and p.phone_type =2','CCC','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','INDIRIZZI','capitolo','','','','M','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','SEDE OPERATIVA','','case when upper(oaope.addrline1) is not null then upper(oaope.addrline1) else  '' '' end || ''  ''|| case when upper(oaope.city) is not null  then upper(oaope.city) else  '' '' end || '' ''|| case when oaope.postalcode is not null  then oaope.postalcode else  '' '' end || '' ''|| case when oaope.state is not null  then oaope.state else  '' '' end as ind_sede_operativa ','organization o left join organization_address oaope on (o.org_id = oaope.org_id and oaope.address_type = 5) ','o.org_id = #orgid#','N','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','ASL DI RIFERIMENTO','asl','asl.description as descr_asl ','lookup_site_id asl left join organization o on o.site_id = asl.code ','o.org_id = #orgid#','AA','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','NOME CANILE','','name as ragione_sociale ','organization ','org_id = #orgid#','AAA','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','PARTITA IVA','','partita_iva ','organization ','org_id = #orgid#','AAAA','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','PROSSIMO CONTROLLO CON LA TECNICA DELLA SORVEGLIANZA','','case when prossimo_controllo is null then to_char(current_timestamp, ''dd/mm/yy'') else to_char(prossimo_controllo, ''dd/mm/yy'') end as prossimo_controllo ','organization ','org_id  = #orgid#','bA','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','EMAIL','','email','organization o left join organization_emailaddress oaope on (o.org_id = oaope.org_id and oaope.emailaddress_type =1) ','o.org_id = #orgid#','cccc','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','SEDE LEGALE','','case when upper(oaleg.addrline1) is not null then upper(oaleg.addrline1) else  '' '' end || ''  ''|| case when upper(oaleg.addrline2) is not null  then upper(oaleg.addrline2) else  '' '' end || '' ''|| case  when upper(oaleg.city) is not null  then upper(oaleg.city) else  '' '' end || ''  ''||  case when oaleg.postalcode is not null  then oaleg.postalcode else  '' '' end || ''  ''|| case  when upper(oaleg.state) is not null  then upper(oaleg.state) else '' ''  end as ind_sede_legale ','organization o left join organization_address oaleg on (o.org_id = oaleg.org_id and oaleg.address_type = 1) ','o.org_id = #orgid#','NN','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','LISTA LINEE PRODUTTIVE','capitolo','','','','P','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','ATTIVITA','','norma ||''<br/>''||attivita','ricerche_anagrafiche_old_materializzata','riferimento_id = #orgid# and riferimento_id_nome_col = ''org_id''','PP','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','DESCRIZIONE STORICA DELLE LINEE DI ATTIVITA'' (MASTER LIST , ATECO, ECC.)','','''IGIENE URBANA VETERINARIA->ALLEVAMENTI/CONCENTRAZIONI ANIMALI NON DESTINATI ALLA PRODUZIONE DI ALIMENTI PER USO UMANO->CANILE/PENSIONE''','organization ','org_id = #orgid#','PPP','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','DETTAGLI ADDIZIONALI','capitolo','','','','T','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','NOTE','','notes ','organization ','org_id = #orgid#','TT','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','INSERITO DA','','c.namefirst || '' '' || c.namelast ||  '' '' || to_char(o.entered, ''dd/MM/yyyy'')','organization o left join access_ a on a.user_id = o.enteredby left join contact_ c on c.contact_id = a.contact_id','o.org_id = #orgid#','TTT','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','MODIFICATO DA','','c.namefirst || '' '' || c.namelast ||  '' '' || to_char(o.modified, ''dd/MM/yyyy'')','organization o left join access_ a on a.user_id = o.modifiedby left join contact_ c on c.contact_id = a.contact_id','o.org_id = #orgid#','TTTT','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('8','STATO','','case when date2 is not null then ''CESSATO IL '' ||  to_char(date2, ''dd/mm/yy'') else ''ATTIVO'' end','organization ','org_id = #orgid#','AAA0','');