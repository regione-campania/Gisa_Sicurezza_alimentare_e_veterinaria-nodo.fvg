 update opu_lookup_norme_master_list_rel_tipologia_organzation set codice_univoco_ml = null,  macroarea_temp = 'IGIENE URBANA VETERINARIA' where tipologia_organization = 20;
...
select * from ricerche_anagrafiche_old_materializzata  where tipologia_operatore in (20)


update scheda_operatore_metadati set enabled = false where tipo_operatore = 10;insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','LUOGO DI NASCITA TITOLARE','','luogo_nascita_rappresentante as luogo_nascita_titolare ','organization ','org_id = #orgid#','FFFFFF','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','NOTE','','notes ','organization ','org_id = #orgid#','PP','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','LISTA LINEE PRODUTTIVE','capitolo','','','','O','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','ATTIVITA','','norma ||''<br/>''||attivita','ricerche_anagrafiche_old_materializzata','riferimento_id = #orgid# and riferimento_id_nome_col = ''org_id''','OO','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','NOME TITOLARE','','nome_rappresentante as nome_titolare ','organization ','org_id = #orgid#','FFF','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','INFORMAZIONE PRIMARIA','capitolo','','','','a','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','INDIRIZZI','capitolo','','','','M','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','CATEGORIA DI RISCHIO','','case when categoria_rischio is not null then categoria_rischio else 3 end','organization ','org_id = #orgid#','b','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','CONTROLLI UFFICIALI APERTI','','count(*)','ticket',' org_id = #orgid# and tipologia = 3 and closed is null and trashed_date is null','bb','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','CONTROLLI UFFICIALI CHIUSI','','count(*)','ticket ',' org_id = #orgid# and tipologia = 3 and closed is not null and trashed_date is null','BBB','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','STATO','','case when coalesce(data_chiusura_canile, data_chiusura_commerciale) is not null then ''CESSATO IL '' || to_char(coalesce(data_chiusura_canile, data_chiusura_commerciale) , ''dd/MM/yy'') else ''ATTIVO'' end','organization ','org_id = #orgid#','C','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','TITOLARE O LEGALE RAPPRESENTANTE','capitolo','','','','F','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','CODICE FISCALE TITOLARE','','codice_fiscale_rappresentante as codice_fiscale_titolare ','organization ','org_id = #orgid#','FF','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','COGNOME TITOLARE','','cognome_rappresentante as cognome_titolare ','organization ','org_id = #orgid#','FFFF','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','DETTAGLI ADDIZIONALI','capitolo','','','','P','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','IMPRESA','','name as ragione_sociale ','organization ','org_id = #orgid#','aaaa','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','PARTITA IVA','','partita_iva ','organization ','org_id = #orgid#','aaaaa','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','DATA DI NASCITA TITOLARE','','to_char(data_nascita_rappresentante, ''dd/mm/yy'') as data_nascita_titolare ','organization ','org_id = #orgid#','FFFFF','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','ASL','asl','asl.description as descr_asl ','lookup_site_id asl left join organization o on o.site_id = asl.code ','o.org_id = #orgid#','aa','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','AUTORIZZAZIONE','','autorizzazione ','organization ','org_id = #orgid#','BBBB','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','INDIRIZZO LEGALE','','case when upper(oaleg.addrline1) is not null then upper(oaleg.addrline1) else  '' '' end || ''  ''|| case when upper(oaleg.addrline2) is not null  then upper(oaleg.addrline2) else  '' '' end || '' ''|| case  when upper(oaleg.city) is not null  then upper(oaleg.city) else  '' '' end || ''  ''||  case when oaleg.postalcode is not null  then oaleg.postalcode else  '' '' end || ''  ''|| case  when upper(oaleg.state) is not null  then upper(oaleg.state) else '' ''  end as ind_sede_legale ','organization o left join organization_address oaleg on (o.org_id = oaleg.org_id and oaleg.address_type = 1) ','o.org_id = #orgid#','MM','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','INDIRIZZO AUSILIARIO','','case when upper(oaope.addrline1) is not null then upper(oaope.addrline1) else  '' '' end || ''  ''|| case when upper(oaope.city) is not null  then upper(oaope.city) else  '' '' end || '' ''|| case when oaope.postalcode is not null  then oaope.postalcode else  '' '' end || '' ''|| case when oaope.state is not null  then oaope.state else  '' '' end as ind_sede_operativa ','organization o left join organization_address oaope on (o.org_id = oaope.org_id and oaope.address_type = 2) ','o.org_id = #orgid#','MMM','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','DESCRIZIONE STORICA DELLE LINEE DI ATTIVITA'' (MASTER LIST , ATECO, ECC.)','','''IGIENE URBANA VETERINARIA->ALLEVAMENTI/CONCENTRAZIONI ANIMALI NON DESTINATI ALLA PRODUZIONE DI ALIMENTI PER USO UMANO->OPERATORE COMMERCIALE''','organization ','org_id = #orgid#','OOO','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','INSERITO DA','','c.namefirst || '' '' || c.namelast ||  '' '' || to_char(o.entered, ''dd/MM/yyyy'')','organization o left join access_ a on a.user_id = o.enteredby left join contact_ c on c.contact_id = a.contact_id','o.org_id = #orgid#','PPP','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','MODIFICATO DA','','c.namefirst || '' '' || c.namelast ||  '' '' || to_char(o.modified, ''dd/MM/yyyy'')','organization o left join access_ a on a.user_id = o.modifiedby left join contact_ c on c.contact_id = a.contact_id','o.org_id = #orgid#','PPPP','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','SPECIE ANIMALI','','description ','tipo_operatore_commerciale join lookup_tipo_operatore_commerciale on id_lookup_tipo_operatore_commerciale = code ','id_operatore = #orgid#','AAA','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','CODICE FISCALE','','codice_fiscale as codice_fiscale ','organization ','org_id = #orgid#','aaaaaA','');insert into scheda_operatore_metadati(tipo_operatore, label, attributo, sql_campo, sql_origine, sql_condizione, ordine, destinazione) values ('10','PROSSIMO CONTROLLO CON LA TECNICA DELLA SORVEGLIANZA','','case when prossimo_controllo is null then to_char(current_timestamp, ''dd/mm/yy'') else to_char(prossimo_controllo, ''dd/mm/yy'') end as prossimo_controllo ','organization ','org_id  = #orgid#','BBA','');