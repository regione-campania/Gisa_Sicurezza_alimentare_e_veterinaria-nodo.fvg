...
-- Query di verifica: deve essere zero
...
-- Vista 852 esclusicamente fissi
...
(
 ...
 SELECT DISTINCT o.org_id AS riferimento_id,
    ...
    COALESCE(tsa.id, el.id, o.org_id) AS id_linea,
  ...
  OR o.trashed_date = '1970-01-01 00:00:00'::timestamp without time zone) AND ((o.tipologia = ANY (ARRAY[1, 151, 802, 152, 10, 20, 2, 800, 801])) OR o.tipologia = 3 AND o.direct_bill = false)
...
select distinct o.org_id as org_id, 'update organization set trashed_date = ''1970-01-01'', note_hd =''852 ARCHIVIATO COME DA ACCORDI CON ORSA PER ATECO 00.00.00'' where org_id='||o.org_id||';'
--cod.description,
--i.id as id_la
from organization o
left join la_imprese_linee_attivita i on i.org_id = o.org_id
...
select distinct o.org_id as org_id, 'update organization set trashed_date = ''1970-01-01'', note_hd =''852 ARCHIVIATO COME DA ACCORDI CON ORSA PER ATECO ASSOCIATI AD ALLEVAMENTI'' where org_id='||o.org_id||';'
--cod.description,
--i.id as id_la
from organization o
left join la_imprese_linee_attivita i on i.org_id = o.org_id
...
select distinct o.org_id as org_id, 'update organization set trashed_date = now(), note_hd =''852 ARCHIVIATO COME DA ACCORDI CON ORSA PER ATECO ASSOCIATI A STABILIMENTI NON MAPPATI, SENZA CU'' where org_id='||o.org_id||';'
--cod.description,
--i.id as id_la
from organization o
left join la_imprese_linee_attivita i on i.org_id = o.org_id
...
----- Messaggio originale -----
Da: "Mele" <r.mele@u-s.it>
A: "Bartolo Sansone" <b.sansone@u-s.it>
Inviato: Lunedì, 25 giugno 2018 14:48:54
Oggetto: Aggiungere gli script per 852 - ateco da archviare
