...
CREATE OR REPLACE FUNCTION digemon.dbi_get_anagrafica_mangimi_dedicati(
	...
	ELSE
		RETURN QUERY select * 
				...
				WHERE 
					...
					r."codice macroarea"='MG' and r."codice aggregazione"='OSMM'; 
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION digemon.dbi_get_anagrafica_mangimi_dedicati(text,text, text)
  OWNER TO postgres;

select * from digemon.dbi_get_anagrafica_mangimi_dedicati('2020-01-01','2021-01-31')
select * from digemon.dbi_get_anagrafica_mangimi_dedicati()