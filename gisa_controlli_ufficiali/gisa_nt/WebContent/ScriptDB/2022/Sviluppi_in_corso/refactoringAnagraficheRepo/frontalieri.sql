...
CREATE OR REPLACE FUNCTION digemon.dbi_get_anagrafica_posti_controllo_frontalieri(
	...
	ELSE
		RETURN QUERY select * 
				...
				WHERE 
					...
					r."codice macroarea"='PCF' and r."codice aggregazione"='PCF' and r."codice attivita"='PCF'; 
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION digemon.dbi_get_anagrafica_posti_controllo_frontalieri(text,text, text)
  OWNER TO postgres;

select * from digemon.dbi_get_anagrafica_posti_controllo_frontalieri('2020-01-01','2021-01-31')
select * from digemon.dbi_get_anagrafica_posti_controllo_frontalieri()