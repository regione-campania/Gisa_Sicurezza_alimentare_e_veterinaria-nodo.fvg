...
--DROP FUNCTION digemon.dbi_get_anagrafica_noscia_new(timestamp without time zone, timestamp without time zone,boolean);
CREATE OR REPLACE FUNCTION digemon.dbi_get_anagrafica_noscia_new(
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION digemon.dbi_get_anagrafica_noscia_new(text, text, text)
  OWNER TO postgres;

select * from digemon.dbi_get_anagrafica_noscia_new()
select * from digemon.dbi_get_anagrafica_noscia_new('2020-01-01','2021-04-30') where "codice macroarea"='GIAR'