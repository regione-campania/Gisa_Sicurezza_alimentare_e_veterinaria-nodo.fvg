...
CREATE OR REPLACE FUNCTION digemon.dbi_get_farmacie_norma_362(
	...
	ELSE
		RETURN QUERY select * 
				...
				WHERE 
					...
					r."norma" ilike '%L. 362-91 FARMACIE%';
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION digemon.dbi_get_farmacie_norma_362(text,text, text)
  OWNER TO postgres;

select * from digemon.dbi_get_farmacie_norma_362('2020-01-01','2021-01-31')
select * from digemon.dbi_get_farmacie_norma_362()
