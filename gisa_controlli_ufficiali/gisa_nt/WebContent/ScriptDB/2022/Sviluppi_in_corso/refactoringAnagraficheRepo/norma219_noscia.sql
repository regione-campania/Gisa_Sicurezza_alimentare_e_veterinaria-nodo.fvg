...
CREATE OR REPLACE FUNCTION digemon.dbi_get_anagrafica_no_scia_norma_219(
	...
	ELSE
		RETURN QUERY select * 
				...
				WHERE 
					...
					r."codice macroarea"='FARMDEP' and r."codice aggregazione"='DF' and r."codice attivita"='DF';
	END IF;	
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION digemon.dbi_get_anagrafica_no_scia_norma_219(text,text, text)
  OWNER TO postgres;

select * from digemon.dbi_get_anagrafica_no_scia_norma_219('2020-01-01','2021-01-31')
select * from digemon.dbi_get_anagrafica_no_scia_norma_219()
