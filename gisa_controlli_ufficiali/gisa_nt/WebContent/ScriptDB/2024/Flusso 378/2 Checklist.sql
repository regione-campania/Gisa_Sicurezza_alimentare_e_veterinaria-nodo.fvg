...
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  0),1,5701,'Ndeg totale animali (capienza)');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  0),2,5791,'Ndeg animali presenti');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  0),3,5700,'Tipologia di suini presenti');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  0),4,5705,'Veterinario Ufficiale ispettore');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  0),5,5703,'Lallevamento e posto in un territorio dove si applicano le misure di biosicurezza di cui allallegato II del regolamento UE 2023/594?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  0),6,5704,'E presente un piano di biosicurezza approvato dal Servizio veterinario che tenga conto del profilo dello stabilimento, che comprenda almeno i relativi punti del comma i) da I a IX dellallegato III Regolamento (UE) 2023/594?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),7,5706,'1. Lazienda e dotata di unarea apposita, posta prima della barriera di entrata per la sosta dei veicoli del personale dellallevamento e/o visitatori? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),8,5707,'2. Sono presenti e ben visibili allingresso cartelli di divieto di accesso per le persone non autorizzate? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),9,5708,'3. Lazienda dispone di cancelli o sbarre idonee ad evitare lingresso diretto e non controllato di automezzi e/o persone? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),10,5710,'4. Lazienda dispone di una zona filtro, con accesso obbligatorio, per il personale addetto al governo degli animali e dei visitatori?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),11,5711,'5. Nella zona filtro, esiste una netta separazione tra la zona sporca e la zona pulita?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),12,5712,'6. Il personale/visitatori utilizza vestiario o tute e calzari  monouso che viene utilizzato esclusivamente in azienda? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),13,5713,'7. E vietato al personale/visitatori portare in azienda alimenti per uso personale? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),14,5714,'8. E presente una planimetria, con capannoni e box numerati univocamente, mediante la quale sia possibile verificare il flusso unidirezionale degli spostamenti degli animali nellazienda e identificare i gruppi di animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),15,5715,'9. I locali e gli edifici degli stabilimenti  sono costruiti in modo che nessun altro animale possa entrare in contatto con i suini detenuti o con il loro mangime e materiale da lettiera?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),16,5716,'10. I locali in cui sono detenuti i suini e gli edifici in cui sono tenuti mangime e lettiere sono delimitati da una recinzione a prova di bestiame?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),17,5717,'11. I locali di stabulazione hanno pareti, pavimenti e serramenti a tenuta e in buono stato di manutenzione, senza soluzioni di continuita, pulibili e disinfettabili in modo efficace?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),18,5718,'12. Esiste una prassi di pulizia, lavaggio e disinfezione dei ricoveri, degli ambienti e delle attrezzature dellazienda e ove necessario, dopo la fine di ogni ciclo produttivo (anche per settori)?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),19,5719,'13. Larea tutta intorno ai ricoveri degli animali e mantenuta pulita, coperta da ghiaia o con erba sfalciata, libera da ingombri, oggetti, attrezzature, macchinari, veicoli, ecc. estranei alla funzionalita e gestione dellallevamento?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),20,5720,'14. Lallevamento dispone di punti di cambio o disinfezione delle calzature tra i diversi capannoni?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),21,5721,'15. Lallevamento dispone di punti di disinfezione e lavaggio delle mani tra i diversi capannoni?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),22,5998,'16. E previsto e documentato un piano di derattizzazione?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),23,5999,'17. La derattizzazione viene effettuata ad opera di una ditta specializzata esterna?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),24,5724,'18. E previsto e documentato un piano di disinfestazione?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),25,5725,'19. La disinfestazione viene effettuata ad opera di una ditta specializzata esterna?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),26,5726,'20. Esiste documentazione relativa a corsi di formazione esterna o interna sulla biosicurezza e sui rischi di introduzione di malattie infettive e diffusive degli animali soggette a denuncia?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),27,5727,'21. Esiste un piano di profilassi vaccinale documentato?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),28,5728,'22. Esiste una prassi igienica e sanitaria di gestione delle attrezzature utilizzate per la profilassi vaccinale e i trattamenti terapeutici individuali o di gruppo?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),29,5729,'23. Sono presenti eventuali risultati delle analisi, ufficiali o effettuate in autocontrollo, su campioni prelevati da animali o da altre matrici che abbiano rilevanza per la salute umana e animale?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),30,5730,'24. Esiste un sistema di registrazione dei dati aziendali sanitari, di allevamento, di riproduzione e produzione?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),31,5731,'25. Il personale addetto al governo degli animali ha contatti con altre aziende suinicole?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),32,5732,'26. E presente un registro dei visitatori con indicato almeno data, nome e cognome del visitatore, motivo della visita e targa dellautomezzo?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),33,5733,'27. E presente una documentazione attestante lavvenuta disinfezione degli automezzi?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),34,5734,'28. Lallevamento dispone di una piazzola per la pulizia e la disinfezione degli automezzi localizzata in prossimita dellaccesso allallevamento o, in ogni caso, separata dallarea aziendale destinata alla stabulazione e al governo animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),35,5735,'29. Sono presenti apparecchiature fisse a pressione per la pulizia, il lavaggio e la disinfezione degli automezzi in entrata?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),36,5736,'30. Sono disponibili e utilizzati per la disinfezione dei veicoli prodotti di provata efficacia nei confronti delle malattie vescicolari del suino e PSA?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),37,5737,'31. Il carico/scarico dei suini vivi avviene allesterno dellarea di stabulazione e di governo degli animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),38,5738,'32. Esiste una rampa/corridoio di carico/scarico degli animali vivi, fissa o mobile?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),39,5739,'33. Il carico/scarico dei suini vivi avviene con monocarico?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),40,5740,'34. Il carico degli scarti avviene allesterno larea di stabulazione e di governo degli animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),41,5741,'35. Il carico degli scarti avviene con monocarico?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),42,5742,'36. Le carcasse degli animali morti sono rimosse dai locali di allevamento entro 24 ore dal decesso, conservate in un contenitore coibentato o in una cella frigorifera a tenuta, idonei e funzionanti, posti allesterno dellarea di governo degli animali, per leliminazione delle stesse conformemente alle disposizioni sanitarie? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),43,5743,'37. Il carico dei suini morti avviene allesterno dellarea di stabulazione e governo degli animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),44,5744,'38. Il contenitore/cella frigorifera dove vengono conservati i morti ha un accesso e un percorso differenziato da quello dellarea di stabulazione e governo degli animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),45,5745,'39. Larea sottostante il contenitore/cella frigorifera dei morti, e idonea sia alla raccolta di eventuali materiali o liquidi percolanti sia alla pulizia e disinfezione?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),46,5746,'40. Qualora le carcasse dei suinetti siano temporaneamente immagazzinate nei locali di allevamento, in attesa del loro allontanamento, i contenitori utilizzati sono adeguatamente sigillati ed idonei alla conservazione?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),47,5747,'41. Lo scarico del mangime avviene in modo da non permetterne il contatto con altri animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),48,5748,'42. I locali, edifici o  le aree di stoccaggio dei mangimi e/o delle lettiere, sono coperti da griglie o sigillati per impedire lingresso di altri animali, ratti e insetti nocivi?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),49,5749,'43. Le aree sottostanti i silos dei mangimi consentono una efficace pulizia e il deflusso delle acque di lavaggio?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),50,5750,'44. Sono utilizzati per lalimentazione degli animali dei prodotti derivati dal latte? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),51,5751,'45. Se sono utilizzati per lalimentazione degli animali dei prodotti derivati dal latte e presente il nulla-osta al loro utilizzo ed e garantita la loro tracciabilita?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),52,5752,'46. Il punto di pesa e di esclusivo utilizzo dellallevamento?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),53,5753,'47. E vietata la somministrazione di rifiuti di ristorazione, mensa o avanzi casalinghi agli animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),54,5754,'48. Esistono ingressi per le operazioni di trasporto dei liquami differenziati da quelli dellarea di stabulazione e governo degli animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),55,5755,'49. I terreni attigui allazienda sono utilizzati per lo spandimento di liquami provenienti da altre aziende?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),56,5756,'50. Gli animali domestici/da compagnia non possono avere accesso ai locali dove sono stabulati i suini?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),57,5757,'51. Sono presenti delle reti antipassero o e comunque garantita limpossibilita di ingresso degli uccelli negli stabili?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),58,5758,'52. Il personale che accudisce e/o puo venire a contatto con i suini non pratica attivita venatoria o altre attivita dove puo avere contatto con suidi selvatici nelle 48 precedenti lingresso in azienda?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),59,5759,'53. E presente una autodichiarazione da parte dei lavoratori dipendenti degli allevamenti suini intensivi di non detenzione di suini o cinghiali allevati a carattere rurale?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),60,5760,'54. Divieto di introduzione in allevamento di alimenti a base di carne di suini o cinghiali provenienti dalla filiera rurale');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  1),61,5761,'55. Divieto di somministrazione ai suini di alimenti a base di carne di suini o cinghiali provenienti dalla filiera rurale');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  2),62,5762,'56. La rimonta viene effettuata ad opera di riproduttori esterni?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  2),63,5763,'57. Lallevamento dispone di locali separati fisicamente e funzionalmente per la quarantena dei riproduttori di nuova introduzione? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  2),64,5764,'58. Viene praticato il tutto pieno/tutto vuoto e un idoneo periodo di vuoto sanitario?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  2),65,5765,'59. Il personale non accudisce altri animali oltre a quelli della quarantena, diversamente e presente una zona filtro specifica per la quarantena?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  2),66,5766,'60. I locali di quarantena dispongono di fossa/e separata/e?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  2),67,5767,'61. I locali di quarantena dispongono di ingresso/i separato/i?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  2),68,5768,'62. Sono disponibili attrezzature destinate esclusivamente alla quarantena?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  2),69,5769,'63. Sono disponibili indumenti per il personale o monouso (tute e calzari) destinati esclusivamente alla quarantena?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  2),70,5770,'64. E prevista lesecuzione pianificata di accertamenti diagnostici negli animali in quarantena? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  2),71,5771,'65. E richiesta e disponibile alle aziende di provenienza una documentazione che attesti lo stato sanitario degli animali di nuova introduzione?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  2),72,5772,'66. La rimonta dei riproduttori viene effettuata con cadenza superiore a 3 mesi?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  2),73,5773,'67. Lesame ecografico viene effettuato da operatori esterni?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  2),74,5774,'68. Nel caso in cui si pratichi la fecondazione artificiale il materiale seminale questo proviene da centri di raccolta seme autorizzati?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  2),75,5775,'69. Nel caso in cui si pratichi la monta naturale i verri sono stati sottoposti agli accertamenti diagnostici previsti per i riproduttori maschi della specie suina?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  2),76,5776,'70. I suinetti in sala parto sono destinati a piu di due allevamenti?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  3),77,5777,'71. I suini provengono da piu di un allevamento?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  3),78,5778,'72. In allevamento viene applicato il sistema tutto pieno/tutto vuoto per allevamento?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  3),79,5779,'73. In allevamento viene applicato il sistema tutto pieno/tutto vuoto per capannone? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  3),80,5780,'74. In allevamento viene applicato il sistema tutto pieno/tutto vuoto per stanza? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  3),81,5940,'75. I capannoni sono suddivisi in settori da pareti?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  3),82,5781,'76. I suini a fine ciclo sono destinati a piu di 1  allevamento?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  4),83,5782,'77. I suini provengono da piu di un allevamento?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  4),84,5783,'78. In allevamento viene applicato il sistema tutto pieno/tutto vuoto per allevamento?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  4),85,5784,'79. In allevamento viene applicato il sistema tutto pieno/tutto vuoto per capannone? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  4),86,5785,'80. In allevamento viene applicato il sistema tutto pieno/tutto vuoto per stanza? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  4),87,5941,'81. I capannoni sono suddivisi in settori da pareti?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  4),88,5786,'82. I suini a fine ciclo sono destinati a solo macelli industriali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  5),89,5788,'ESITO DEL CONTROLLO');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  5),90,5789,'Sono state assegnate delle prescrizioni?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  5),91,5790,'Sono state applicate delle sanzioni?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '0122' and m.versione = 2023 and s.ordine =  5),92,5702,'NOME E COGNOME DEL PROPRIETARIO/DETENTORE/CONDUTTORE PRESENTE ALLISPEZIONE :');

-- bonifico domande. OPERAZIONI AD HOC
/*update biosicurezza_domande set ordine = 1 where id_classyfarm = 5701 and id_sezione in (select id from biosicurezza_sezioni where id_lookup_chk_classyfarm_mod = 11);
update biosicurezza_domande set ordine = 2 where id_classyfarm = 5791 and id_sezione in (select id from biosicurezza_sezioni where id_lookup_chk_classyfarm_mod = 11);
update biosicurezza_domande set ordine = 3 where id_classyfarm = 5705 and id_sezione in (select id from biosicurezza_sezioni where id_lookup_chk_classyfarm_mod = 11);
update biosicurezza_domande set ordine = 4 where id_classyfarm = 5700 and id_sezione in (select id from biosicurezza_sezioni where id_lookup_chk_classyfarm_mod = 11);
update biosicurezza_domande set ordine = 5 where id_classyfarm = 5703 and id_sezione in (select id from biosicurezza_sezioni where id_lookup_chk_classyfarm_mod = 11);
update biosicurezza_domande set ordine = 6 where id_classyfarm = 5704 and id_sezione in (select id from biosicurezza_sezioni where id_lookup_chk_classyfarm_mod = 11);
...
-- Modifico unico campo numerico nel tipo number (*0 record*)
...
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 0),1,5793, 'Ndeg totale animali (capienza)');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 0),2,5791, 'Ndeg animali presenti');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 0),3,5792, 'Tipologia di suini presenti');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 0),4,5797, 'Veterinario Ufficiale ispettore');
...
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),7,5798, '1. Sono presenti e ben visibili allingresso cartelli di divieto di accesso per le persone non autorizzate? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),8,5799, '2. Lazienda dispone di cancelli o sbarre idonee ad evitare lingresso diretto e non controllato di automezzi e/o persone? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),9,5801, '3. Lazienda dispone di una zona filtro, con accesso obbligatorio, per il personale addetto al governo degli animali e dei visitatori?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),10,5802, '4. Nella zona filtro, esiste una netta separazione tra la zona sporca e la zona pulita?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),11,5803, '5. Il personale/visitatori utilizza vestiario o tute e calzari  monouso che viene utilizzato esclusivamente in azienda? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),12,5804, '6. E vietato al personale/visitatori portare in azienda alimenti per uso personale? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),13,5805, '7. E presente una planimetria, con capannoni e box numerati univocamente, mediante la quale sia possibile verificare il flusso unidirezionale degli spostamenti degli animali nellazienda e identificare i gruppi di animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),14,5806, '8. I locali e gli edifici degli stabilimenti  sono costruiti in modo che nessun altro animale possa entrare in contatto con i suini detenuti o con il loro mangime e materiale da lettiera?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),15,5807, '9. I locali in cui sono detenuti i suini e gli edifici in cui sono tenuti mangime e lettiere sono delimitati da una recinzione a prova di bestiame?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),16,5808, '10. I locali di stabulazione hanno pareti, pavimenti e serramenti a tenuta e in buono stato di manutenzione, senza soluzioni di continuita, pulibili e disinfettabili in modo efficace?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),17,5809, '11. Esiste una prassi di pulizia, lavaggio e disinfezione dei ricoveri, degli ambienti e delle attrezzature dellazienda e ove necessario, dopo la fine di ogni ciclo produttivo (anche per settori)?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),18,5810, '12. Lallevamento dispone di punti di cambio o disinfezione delle calzature tra i diversi capannoni?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),19,5811, '13. Lallevamento dispone di punti di disinfezione e lavaggio delle mani tra i diversi capannoni?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),20,5939, '14. E previsto e documentato un piano di derattizzazione? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),21,5723, '15. La derattizzazione viene effettuata ad opera di una ditta specializzata esterna?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),22,5722, '16. E previsto e documentato un piano di disinfestazione?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),23,5870, '17. La disinfestazione viene effettuata ad opera di una ditta specializzata esterna?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),24,5812, '18. Esiste documentazione relativa a corsi di formazione esterna o interna sulla biosicurezza e sui rischi di introduzione di malattie infettive e diffusive degli animali soggette a denuncia?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),25,5813, '19. Il personale addetto al governo degli animali ha contatti con altre aziende suinicole?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),26,5814, '20. E presente un registro dei visitatori con indicato almeno data, nome e cognome del visitatore, motivo della visita e targa dellautomezzo?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),27,5815, '21. Sono disponibili e utilizzati per la disinfezione dei veicoli prodotti di provata efficacia nei confronti delle malattie vescicolari del suino e PSA?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),28,5816, '22. Il carico/scarico dei suini vivi avviene allesterno dellarea di stabulazione e di governo degli animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),29,5817, '23. Il carico/scarico dei suini vivi avviene con monocarico?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),30,5818, '24. Il carico degli scarti avviene allesterno larea di stabulazione e di governo degli animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),31,5819, '25. Le carcasse degli animali morti sono rimosse dai locali di allevamento entro 24 ore dal decesso, conservate in un contenitore coibentato o in una cella frigorifera a tenuta, idonei e funzionanti, posti allesterno dellarea di governo degli animali, per');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),32,5820, '26. Il carico dei suini morti avviene allesterno dellarea di stabulazione e governo degli animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),33,5821, '27. Il contenitore/cella frigorifera dove vengono conservati i morti ha un accesso e un percorso differenziato da quello dellarea di stabulazione e governo degli animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),34,5822, '28. Larea sottostante il contenitore/cella frigorifera dei morti, e idonea sia alla raccolta di eventuali materiali o liquidi percolanti sia alla pulizia e disinfezione?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),35,5823, '29. Lo scarico del mangime avviene in modo da non permetterne il contatto con altri animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),36,5824, '30. I locali, edifici o  le aree di stoccaggio dei mangimi e/o delle lettiere, sono coperti da griglie o sigillati per impedire lingresso di altri animali, ratti e insetti nocivi?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),37,5825, '31. Il punto di pesa e di esclusivo utilizzo dellallevamento?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),38,5826, '32. E vietata la somministrazione di rifiuti di ristorazione, mensa o avanzi casalinghi agli animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),39,5827, '33. Esistono ingressi per le operazioni di trasporto dei liquami differenziati da quelli dellarea di stabulazione e governo degli animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),40,5828, '34. Gli animali domestici/da compagnia non possono avere accesso ai locali dove sono stabulati i suini?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),41,5829, '35. Sono presenti delle reti antipassero o e comunque garantita limpossibilita di ingresso degli uccelli negli stabili?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),42,5830, '36. Il personale che accudisce e/o puo venire a contatto con i suini non pratica attivita venatoria o altre attivita dove puo avere contatto con suidi selvatici nelle 48 precedenti lingresso in azienda?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),43,5831, '37. E presente una autodichiarazione da parte dei lavoratori dipendenti degli allevamenti suini intensivi di non detenzione di suini o cinghiali allevati a carattere rurale?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),44,5832, '38. Divieto di introduzione in allevamento di alimenti a base di carne di suini o cinghiali provenienti dalla filiera rurale');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 1),45,5833, '39. Divieto di somministrazione ai suini di alimenti a base di carne di suini o cinghiali provenienti dalla filiera rurale');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 2),46,5834, '40. Lallevamento dispone di locali separati fisicamente e funzionalmente per la quarantena dei riproduttori di nuova introduzione? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 2),47,5835, '41. Il personale non accudisce altri animali oltre a quelli della quarantena, diversamente e presente una zona filtro specifica per la quarantena?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 2),48,5836, '42. I locali di quarantena dispongono di ingresso/i separato/i?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 2),49,5837, '43. Sono disponibili attrezzature destinate esclusivamente alla quarantena?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 2),50,5838, '44. Sono disponibili indumenti per il personale o monouso (tute e calzari) destinati esclusivamente alla quarantena?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 3),51,5839, '45. In allevamento viene applicato il sistema tutto pieno/tutto vuoto per allevamento?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 3),52,5840, '46. In allevamento viene applicato il sistema tutto pieno/tutto vuoto per capannone? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 3),53,5946, '47. In allevamento viene applicato il sistema tutto pieno/tutto vuoto per stanza?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 3),54,5947, '48. I capannoni sono suddivisi in settori da pareti?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 4),55,5841, '49. In allevamento viene applicato il sistema tutto pieno/tutto vuoto per allevamento?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 4),56,5842, '50. In allevamento viene applicato il sistema tutto pieno/tutto vuoto per capannone? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 4),57,5948, '51. In allevamento viene applicato il sistema tutto pieno/tutto vuoto per stanza?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 4),58,5949, '52. I capannoni sono suddivisi in settori da pareti?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 5),59,5844, 'ESITO DEL CONTROLLO');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 5),60,5845, 'Sono state assegnate delle prescrizioni?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 5),61,5846, 'Sono state applicate delle sanzioni?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01222' and m.versione =2023 and s.ordine = 5),62,5794, 'NOME E COGNOME DEL PROPRIETARIO/DETENTORE/CONDUTTORE PRESENTE ALLISPEZIONE :');
...
-- creo le domande
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 0),1,5848, 'Ndeg totale animali (capienza)');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 0),2,5938, 'Ndeg totale animali presenti');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 0),3,5847, 'Tipologia di suini presenti');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 0),4,5852, 'Veterinario Ufficiale ispettore');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 0),5,5850, 'Lallevamento e posto in un territorio dove si applicano le misure di biosicurezza di cui allallegato II del regolamento UE 2023/594?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 0),6,5851, 'E presente un piano di biosicurezza approvato dal Servizio veterinario che tenga conto del profilo dello stabilimento, che comprenda almeno i relativi punti del comma i) da I a IX dellallegato III Regolamento (UE) 2023/594?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),7,5853, '1. Lazienda e dotata di unarea apposita, posta prima della barriera di entrata per la sosta dei veicoli del personale dellallevamento e/o visitatori? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),8,5854, '2. Sono presenti e ben visibili allingresso cartelli di divieto di accesso per le persone non autorizzate? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),9,5855, '3. Lazienda dispone di cancelli o sbarre idonee ad evitare lingresso diretto e non controllato di automezzi e/o persone? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),10,5857, '4. Lazienda dispone di una zona filtro, con accesso obbligatorio, per il personale addetto al governo degli animali e dei visitatori?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),11,5858, '5. Nella zona filtro, esiste una netta separazione tra la zona sporca e la zona pulita?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),12,5859, '6. Il personale/visitatori utilizza vestiario o tute e calzari  monouso che viene utilizzato esclusivamente in azienda? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),13,5860, '7. E vietato al personale/visitatori portare in azienda alimenti per uso personale? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),14,5861, '8. E presente una planimetria, con capannoni e box numerati univocamente, mediante la quale sia possibile verificare il flusso unidirezionale degli spostamenti degli animali nellazienda e identificare i gruppi di animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),15,5862, '9. I locali e gli edifici degli stabilimenti  sono costruiti in modo che nessun altro animale possa entrare in contatto con i suini detenuti o con il loro mangime e materiale da lettiera?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),16,5863, '10. I locali in cui sono detenuti i suini e gli edifici in cui sono tenuti mangime e lettiere sono delimitati da una recinzione a prova di bestiame?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),17,5864, '11. I locali di stabulazione hanno pareti, pavimenti e serramenti a tenuta e in buono stato di manutenzione, senza soluzioni di continuita, pulibili e disinfettabili in modo efficace?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),18,5865, '12. Esiste una prassi di pulizia, lavaggio e disinfezione dei ricoveri, degli ambienti e delle attrezzature dellazienda e ove necessario, dopo la fine di ogni ciclo produttivo (anche per settori)?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),19,5866, '13. Larea tutta intorno ai ricoveri degli animali e mantenuta pulita, coperta da ghiaia o con erba sfalciata, libera da ingombri, oggetti, attrezzature, macchinari, veicoli, ecc. estranei alla funzionalita e gestione dellallevamento?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),20,5867, '14. Lallevamento dispone di punti di cambio o disinfezione delle calzature tra i diversi capannoni?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),21,5868, '15. Lallevamento dispone di punti di disinfezione e lavaggio delle mani tra i diversi capannoni?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),22,5869, '16. E previsto e documentato un piano di derattizzazione?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),23,6000, '17. La derattizzazione viene effettuata ad opera di una ditta specializzata esterna?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),24,5871, '18. E previsto e documentato un piano di disinfestazione?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),25,5872, '19. La disinfestazione viene effettuata ad opera di una ditta specializzata esterna?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),26,5873, '20. Esiste documentazione relativa a corsi di formazione esterna o interna sulla biosicurezza e sui rischi di introduzione di malattie infettive e diffusive degli animali soggette a denuncia?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),27,5874, '21. Esiste un piano di profilassi vaccinale documentato?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),28,5875, '22. Esiste una prassi igienica e sanitaria di gestione delle attrezzature utilizzate per la profilassi vaccinale e i trattamenti terapeutici individuali o di gruppo?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),29,5876, '23. Sono presenti eventuali risultati delle analisi, ufficiali o effettuate in autocontrollo, su campioni prelevati da animali o da altre matrici che abbiano rilevanza per la salute umana e animale?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),30,5877, '24. Esiste un sistema di registrazione dei dati aziendali sanitari, di allevamento, di riproduzione e produzione?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),31,5878, '25. Il personale addetto al governo degli animali ha contatti con altre aziende suinicole?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),32,5879, '26. E presente un registro dei visitatori con indicato almeno data, nome e cognome del visitatore, motivo della visita e targa dellautomezzo?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),33,5880, '27. E presente una documentazione attestante lavvenuta disinfezione degli automezzi?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),34,5881, '28. Lallevamento dispone di una piazzola per la pulizia e la disinfezione degli automezzi localizzata in prossimita dellaccesso allallevamento o, in ogni caso, separata dallarea aziendale destinata alla stabulazione e al governo animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),35,5882, '29. Sono presenti apparecchiature fisse a pressione per la pulizia, il lavaggio e la disinfezione degli automezzi in entrata?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),36,5883, '30. Sono disponibili e utilizzati per la disinfezione dei veicoli prodotti di provata efficacia nei confronti delle malattie vescicolari del suino e PSA?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),37,5884, '31. Il carico/scarico dei suini vivi avviene allesterno dellarea di stabulazione e di governo degli animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),38,5885, '32. Esiste una rampa/corridoio di carico/scarico degli animali vivi, fissa o mobile?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),39,5886, '33. Il carico/scarico dei suini vivi avviene con monocarico?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),40,5887, '34. Il carico degli scarti avviene allesterno larea di stabulazione e di governo degli animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),41,5888, '35. Il carico degli scarti avviene con monocarico?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),42,5889, '36. Le carcasse degli animali morti sono rimosse dai locali di allevamento entro 24 ore dal decesso, conservate in un contenitore coibentato o in una cella frigorifera a tenuta, idonei e funzionanti, posti allesterno dellarea di governo degli animali, per');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),43,5890, '37. Il carico dei suini morti avviene allesterno dellarea di stabulazione e governo degli animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),44,5891, '38.Il contenitore/cella frigorifera dove vengono conservati i morti ha un accesso e un percorso differenziato da quello dellarea di stabulazione e governo degli animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),45,5892, '39. Larea sottostante il contenitore/cella frigorifera dei morti, e idonea sia alla raccolta di eventuali materiali o liquidi percolanti sia alla pulizia e disinfezione?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),46,5893, '40. Qualora le carcasse dei suinetti siano temporaneamente immagazzinate nei locali di allevamento, in attesa del loro allontanamento, i contenitori utilizzati sono adeguatamente sigillati ed idonei alla conservazione?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),47,5894, '41. Lo scarico del mangime avviene in modo da non permetterne il contatto con altri animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),48,5895, '42. I locali, edifici o  le aree di stoccaggio dei mangimi e/o delle lettiere, sono coperti da griglie o sigillati per impedire lingresso di altri animali, ratti e insetti nocivi?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),49,5896, '43. Le aree sottostanti i silos dei mangimi consentono una efficace pulizia e il deflusso delle acque di lavaggio?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),50,5897, '44. Sono utilizzati per lalimentazione degli animali dei prodotti derivati dal latte? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),51,5898, '45. Se sono utilizzati per lalimentazione degli animali dei prodotti derivati dal latte e presente il nulla-osta al loro utilizzo ed e garantita la loro tracciabilita?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),52,5899, '46. Il punto di pesa e di esclusivo utilizzo dellallevamento?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),53,5900, '47. E vietata la somministrazione di rifiuti di ristorazione, mensa o avanzi casalinghi agli animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),54,5901, '48. Esistono ingressi per le operazioni di trasporto dei liquami differenziati da quelli dellarea di stabulazione e governo degli animali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),55,5902, '49. I terreni attigui allazienda sono utilizzati per lo spandimento di liquami provenienti da altre aziende?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),56,5903, '50. Gli animali domestici/da compagnia non possono avere accesso ai locali dove sono stabulati i suini?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),57,5905, '51. Il personale che accudisce e/o puo venire a contatto con i suini non pratica attivita venatoria o altre attivita dove puo avere contatto con suidi selvatici nelle 48 precedenti lingresso in azienda?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),58,5906, '52. E presente una autodichiarazione da parte dei lavoratori dipendenti degli allevamenti suini intensivi di non detenzione di suini o cinghiali allevati a carattere rurale?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),59,5907, '53. Divieto di introduzione in allevamento di alimenti a base di carne di suini o cinghiali provenienti dalla filiera rurale');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 1),60,5908, '54. Divieto di somministrazione ai suini di alimenti a base di carne di suini o cinghiali provenienti dalla filiera rurale');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 2),61,5909, '55. La rimonta viene effettuata ad opera di riproduttori esterni?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 2),62,5910, '56. Lallevamento dispone di locali separati fisicamente e funzionalmente per la quarantena dei riproduttori di nuova introduzione? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 2),63,5911, '57. Viene praticato il tutto pieno/tutto vuoto e un idoneo periodo di vuoto sanitario?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 2),64,5912, '58. Il personale non accudisce altri animali oltre a quelli della quarantena, diversamente e presente una zona filtro specifica per la quarantena?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 2),65,5913, '59. I locali di quarantena dispongono di fossa/e separata/e?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 2),66,5914, '60. I locali di quarantena dispongono di ingresso/i separato/i?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 2),67,5915, '61. Sono disponibili attrezzature destinate esclusivamente alla quarantena?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 2),68,5916, '62. Sono disponibili indumenti per il personale o monouso (tute e calzari) destinati esclusivamente alla quarantena?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 2),69,5917, '63. E prevista lesecuzione pianificata di accertamenti diagnostici negli animali in quarantena? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 2),70,5918, '64. E richiesta e disponibile alle aziende di provenienza una documentazione che attesti lo stato sanitario degli animali di nuova introduzione?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 2),71,5919, '65. La rimonta dei riproduttori viene effettuata con cadenza superiore a 3 mesi?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 2),72,5920, '66.  Lesame ecografico viene effettuato da operatori esterni?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 2),73,5921, '67. Nel caso in cui si pratichi la fecondazione artificiale il materiale seminale questo proviene da centri di raccolta seme autorizzati?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 2),74,5922, '68. Nel caso in cui si pratichi la monta naturale i verri sono stati sottoposti agli accertamenti diagnostici previsti per i riproduttori maschi della specie suina?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 2),75,5923, '69. I suinetti in sala parto sono destinati a piu di due allevamenti?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 3),76,5924, '70. I suini provengono da piu di un allevamento?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 3),77,5925, '71. In allevamento viene applicato il sistema tutto pieno/tutto vuoto per allevamento?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 3),78,5926, '72. In allevamento viene applicato il sistema tutto pieno/tutto vuoto per capannone? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 3),79,5927, '73. In allevamento viene applicato il sistema tutto pieno/tutto vuoto per stanza? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 3),80,5944, '74. I capannoni sono suddivisi in settori da pareti?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 3),81,5928, '75. I suini a fine ciclo sono destinati a piu di 1  allevamento?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 4),82,5929, '76. I suini provengono da piu di un allevamento?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 4),83,5930, '77. In allevamento viene applicato il sistema tutto pieno/tutto vuoto per allevamento?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 4),84,5931, '78. In allevamento viene applicato il sistema tutto pieno/tutto vuoto per capannone? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 4),85,5932, '79. In allevamento viene applicato il sistema tutto pieno/tutto vuoto per stanza? ');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 4),86,5945, '80. I capannoni sono suddivisi in settori da pareti?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 4),87,5933, '81. I suini a fine ciclo sono destinati a solo macelli industriali?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 5),88,5935, 'ESITO DEL CONTROLLO');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 5),89,5936, 'Sono state assegnate delle prescrizioni?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 5),90,5937, 'Sono state applicate delle sanzioni?');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01221' and m.versione =2023 and s.ordine = 5),91,5849, 'NOME E COGNOME DEL PROPRIETARIO/DETENTORE/CONDUTTORE PRESENTE ALLISPEZIONE :');
...
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01223' and m.versione =2023 and s.ordine = 0),3,5950, 'Tipologia di suini presenti');
insert into biosicurezza_domande (id_sezione, ordine, id_classyfarm, domanda) values ((select s.id from biosicurezza_sezioni s join lookup_chk_classyfarm_mod m on m.code = s.id_lookup_chk_classyfarm_mod where m.cod_specie = '01223' and m.versione =2023 and s.ordine = 0),4,5954, 'Veterinario Ufficiale ispettore');
...
update biosicurezza_risposte set ordine = 4 where risposta ilike '%entro quale data%' and ordine is null;
update biosicurezza_risposte set ordine = 3 where risposta ilike '%Se si quali%' and ordine is null;
update biosicurezza_risposte set ordine = 4 where lista ilike '%Nessuna - 0; Blocco Movimentazioni - 1; Abbattimento capi - 2; Amministrativa/pecuniaria - 3; Sequestro Capi - 4; Informativa in procura - 5; Altro (specificare) - 6%' and ordine is null;
update biosicurezza_risposte set ordine = 4 where id_classyfarm=16405;
update biosicurezza_risposte set ordine = 4 where id_classyfarm=16882;
update biosicurezza_risposte set ordine = 4 where id_classyfarm=16716;
update biosicurezza_risposte set ordine = 4 where id_classyfarm=17233;
update biosicurezza_risposte set ordine = 4 where risposta ilike '%Motivo%' and ordine is null;
update biosicurezza_risposte set ordine = 4 where risposta ilike '%Motivi%' and ordine is null;
