...
update chk_bns_domande_v6 set quesito = replace(quesito, 'È', 'E''');
update chk_bns_domande_v6 set quesito = replace(quesito, 'à', 'a''');
update chk_bns_domande_v6 set quesito = replace(quesito, 'è', 'e''');
update chk_bns_domande_v6 set quesito = replace(quesito, 'ì', 'i''');
update chk_bns_domande_v6 set quesito = replace(quesito, 'ò', 'u''');
update chk_bns_domande_v6 set quesito = replace(quesito, 'ù', 'u''');
