alter table registro_trasgressori_values add column ae_pagati boolean default false;
alter table registro_trasgressori_values_storico_record add column ae_pagati boolean default false;
