...
<jsp:useBean id="OrgList" class="org.aspcfs.modules.riproduzioneanimale.base.OrganizationList" scope="request"/>
...
<td>
  ...
  <a href="<%=TicketDetails.getURlDettaglio(OrgDetails.getTipologia(),"") %>.do?command=Details&orgId=<%=OrgDetails.getOrgId()%>">Scheda Operatore</a> >
  <a href="<%=TicketDetails.getURlDettaglio(OrgDetails.getTipologia(),"") %>.do?command=ViewVigilanza&orgId=<%=OrgDetails.getOrgId()%>"><dhv:label name="">Controlli Ufficiali</dhv:label></a> >
  <a href="<%=TicketDetails.getURlDettaglio(OrgDetails.getTipologia(),"") %>Vigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC")%>&orgId=<%=OrgDetails.getOrgId()%>"><dhv:label name="">Controllo Ufficiale</dhv:label></a> >
