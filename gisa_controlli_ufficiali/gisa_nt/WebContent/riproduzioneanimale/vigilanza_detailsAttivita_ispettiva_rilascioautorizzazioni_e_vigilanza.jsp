...
<jsp:useBean id="OrgListOp" class="org.aspcfs.modules.riproduzioneanimale.base.OrganizationList" scope="request"/>
  ...
  <%@ include file="../controlliufficiali/controlli_ufficiali_sottoattivita.jsp" %>
   ...
   <tr class="row<%=rowid%>">
	 ...
	 <td>
	   ...
	   <a href="CheckListRiproduzioneAnimale.do?command=View&id=<%= thisAudit.getId()%>&aggiorna=<%=thisAudit.isAggiornaCategoria() %>"><%= toHtml(OrgCategoriaRischioList2.getSelectedValue(thisAudit.getTipoChecklist())) %></a>
	</td>
