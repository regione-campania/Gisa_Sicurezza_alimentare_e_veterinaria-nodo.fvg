...
<tr style="background-color: red;height: 40px;" >
	<th colspan="8">ORGANIGRAMMA E STRUMENTI DI CALCOLO</th>
</tr>
...
for (int i = 0 ; i < listStrutture.size(); i++)
{
	...
	%>
		...
		%>
					...
					<td style="font-weight:bold;" align="center">
					<%= toHtml2(nominativo.getNominativo().getQualifica()) %>
					</td>
					
					<td style="font-weight:bold;" align="center">
					<%= toHtml2(nominativo.getNominativo().getProfilo_professionale()) %>
					</td>
...
<table  class="tablesorter">
	<thead>
		<tr class="tablesorter-headerRow" role="row">
			...
			<!-- Flusso 342 -->
			<th aria-label="QUALIFICA: No sort applied, activate to apply an ascending sort" aria-sort="none" style="-moz-user-select: none;" unselectable="on" aria-controls="table" aria-disabled="false" role="columnheader" scope="col" tabindex="0" class="tablesorter-header" data-column="3" data-placeholder="FILTRO PER QUALIFICA"><div class="tablesorter-header-inner">QUALIFICA</div></th>
			<th aria-label="PROFILO PROFESSIONALE: No sort applied, activate to apply an ascending sort" aria-sort="none" style="-moz-user-select: none;" unselectable="on" aria-controls="table" aria-disabled="false" role="columnheader" scope="col" tabindex="0" class="tablesorter-header" data-column="3" data-placeholder="FILTRO PER PROFILO PROFESSIONALE"><div class="tablesorter-header-inner">PROFILO PROFESSIONALE</div></th>
			<!--  -->
	...
	%>
		...
		<td><%=toHtml2(utente.getSiteIdName())%></td>
			...
			<!-- Flusso 342 -->
			<td><%=toHtml2(utente.getQualifica()) %> </td>
			<td><%=toHtml2(utente.getProfilo_professionale()) %> </td>
			<!--  -->
