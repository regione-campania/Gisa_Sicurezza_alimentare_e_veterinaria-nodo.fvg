...
<body>
 <form name="addticket" action="AziendeAgricoleProvvedimenti.do?command=Insert&auto-populate=true" method="post" onsubmit="return controllaForm(this)">
<%-- Trails --%>
...
<td>
  ...
  <a href="AziendeAgricole.do?command=Details&orgId=<%=OrgDetails.getOrgId()%>">Scheda Operatore </a> >
...
<script language="JavaScript" TYPE="text/javascript" SRC="javascript/popAziendeAgricole.js"></script>
