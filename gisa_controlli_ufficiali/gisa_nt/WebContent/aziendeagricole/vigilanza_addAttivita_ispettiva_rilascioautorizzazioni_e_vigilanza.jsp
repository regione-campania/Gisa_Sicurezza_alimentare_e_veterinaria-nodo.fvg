...
<form method="post" name="addticket" action="AziendeAgricoleVigilanza.do?command=Insert&auto-populate=true"  >
<%-- Trails --%>
...
<input type="submit" value="Annulla" onClick="javascript:this.form.action='AziendeAgricoleVigilanza.do?command=ViewVigilanza&orgId=<%=OrgDetails.getOrgId()%>'">
<br>
...
<br>
<input type="button" value="<dhv:label name="button.inserta">Inserisci </dhv:label>" name="Save" onClick="<%--javascript:this.form.action='AziendeAgricoleVigilanza.do?command=InsertContinua&auto-populate=true';--%>return controlloCuSorveglianza()">
