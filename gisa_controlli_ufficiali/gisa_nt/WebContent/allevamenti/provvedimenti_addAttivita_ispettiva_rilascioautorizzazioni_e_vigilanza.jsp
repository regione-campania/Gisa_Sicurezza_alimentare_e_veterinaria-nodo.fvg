...
<body>
 <form name="addticket" action="AllevamentiProvvedimenti.do?command=Insert&auto-populate=true" method="post" onsubmit="return controllaForm(this)">
<%-- Trails --%>
...
<td>
  ...
  <a href="Allevamenti.do?command=Details&orgId=<%=OrgDetails.getOrgId()%>">Scheda Operatore </a> >
...
<script language="JavaScript" TYPE="text/javascript" SRC="javascript/popAllevamenti.js"></script>
