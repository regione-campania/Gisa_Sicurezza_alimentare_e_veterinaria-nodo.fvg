...
<body onload = "provaFunzione('addticket'); gestioneVisibilitaCodiceAteco('addticket'); onloadAllerta('addticket'); 
...
<input type="submit" value="Annulla" onClick="javascript:this.form.action='Allevamenti.do?command=ViewVigilanza&orgId=<%=OrgDetails.getOrgId()%>'">
<br>
<dhv:formMessage />
...
<script type="text/javascript" src="dwr/util.js"></script>
 ...
 //gestioneVisibilitaCodiceAteco('addticket')
    ...
    TipoCampione.setJsEvent("onChange=javascript:reloadAddCU('AllevamentiVigilanza.do?command=Add&orgId="+OrgDetails.getOrgId()+"&tipoCampione='+this.value)"); 
