...
function apriVerbale(idCampione,tipoAnalisi)
{
	...
	document.location.href="AllevamentiCampioni.do?command=StampaScheda&tipoAnalisi="+tipoAnalisi+"&idCampione="+idCampione+"&tipoAlimenti="+tipoAlimenti;
...
<form id="details" name="details" action="AllevamentiCampioni.do?command=ModifyTicket&auto-populate=true" method="post">
...
<dhv:container name="allevamenticampioni" selected="details" object="TicketDetails"
	param="<%= param1 %>"
...
%>
<%
String msg3 = (String)request.getAttribute("Messaggio3");
if(request.getAttribute("Messaggio3")!=null)
{
	%>
	<script>
...
if(request.getAttribute("Messaggio2")!=null)
{
	...
	function doSubmit(idTicket){
		...
		document.details.action="AllevamentiCampioni.do?command=Chiudi&id="+idTicket+"&chiudiCu=true'"
