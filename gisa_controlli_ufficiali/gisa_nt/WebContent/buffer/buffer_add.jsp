...
<input type="submit" value="Annulla" onClick="javascript:this.form.action='Buffer.do?command=SearchForm'">
<br>
...
<table cellpadding="4" cellspacing="0" width="100%" class="details">
 ...
 <tr>
    ...
    <td>
       <input class="date_picker" type="text" name="dataEvento" id ="dataEvento" size="10" value="" />
...
<br>
<input type="submit" value="<dhv:label name="button.insert">Insert</dhv:label>" name="Save" onClick="return checkForm(this.form)">
<input type="submit" value="Annulla" onClick="javascript:this.form.action='Bufffer.do?command=SearchForm'">
</form>
</body>