...
<form name="addticket" action="GestioneAnagraficaCampioni.do?command=Insert&auto-populate=true" method="post">
<%-- Trails --%>
...
<%--   <a href="GestioneAnagraficaAction.do?command=Search"><dhv:label name="accounts.SearchResults">Search Results</dhv:label></a> > --%>
  ...
  <%--a href="Accounts.do?command=ViewCampioni&altId=<%=OrgDetails.getAltId()%>"><dhv:label name="campioni">Tickets</dhv:label></a> --%>
...
<!-- <input type="button" value="<dhv:label name="button.insert">Insert</dhv:label>" id="Save" name="Save" class="Save" onClick="if (controllaDate()==true) { javascript:controllaAnaliti(); } " />
<input type="button" value="Annulla" onClick="window.location.href='GestioneAnagraficaVigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC") %>&altId=<%=OrgDetails.getAltId()%>';this.form.dosubmit.value='false';" /> -->
<br>
<dhv:formMessage />
...
<table cellpadding="4" cellspacing="0" width="100%" class="details">
    ...
    <th colspan="2">
     ...
     <%@ include file="/campioni/alt_campioni_add.jsp" %>
