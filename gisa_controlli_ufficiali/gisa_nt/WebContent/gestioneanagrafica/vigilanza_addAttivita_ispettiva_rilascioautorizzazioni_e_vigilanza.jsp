...
<input type="button" value="Annulla" onClick="loadModalWindow(); window.location.href='GestioneAnagraficaAction.do?command=ViewVigilanza&altId=<%=OrgDetails.getAltId()%>'">
<br>
<dhv:formMessage />
