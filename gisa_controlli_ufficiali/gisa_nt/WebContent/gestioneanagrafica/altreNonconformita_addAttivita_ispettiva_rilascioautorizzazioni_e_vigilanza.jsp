...
<tr>
<td>
<a  href="GestioneAnagraficaAction.do"  onclick="return !this.disabled;">Gestione Anagrafica </a> > 
<%-- <a href="GestioneAnagraficaAction.do?command=Search"  onclick="return !this.disabled;"><dhv:label name="	s.SearchResults">Search Results</dhv:label></a> > --%>
<a href="GestioneAnagraficaAction.do?command=Details&altId=<%=OrgDetails.getAltId()%>"  onclick="return !this.disabled;">Scheda Gestione Anagrafica</a> >
 <a href="GestioneAnagraficaAction.do?command=ViewVigilanza&altId=<%=OrgDetails.getAltId()%>"  onclick="return !this.disabled;"><dhv:label name="">Controlli Ufficiali</dhv:label></a> >
 <a href="GestioneAnagraficaVigilanza.do?command=TicketDetails&id=<%=request.getAttribute("idC")%>&altId=<%=OrgDetails.getAltId()%>"  onclick="return !this.disabled;"><dhv:label name="">Controllo Ufficiale</dhv:label></a> >
