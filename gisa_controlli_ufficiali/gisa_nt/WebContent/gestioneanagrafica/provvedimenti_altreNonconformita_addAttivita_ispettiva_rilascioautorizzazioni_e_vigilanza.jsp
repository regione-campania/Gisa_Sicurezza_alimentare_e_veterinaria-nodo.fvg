...
<form name="addticket" action="GestioneAnagraficaAltreNonConformita.do?command=Insert&auto-populate=true" method="post">
<input type = "hidden" id = "dosubmit" name = "dosubmit" value = "0">
<%-- Trails --%>
<table class="trails" cellspacing="0">
<tr>
<td>
  <a href="<%=TicketDetails.getURlDettaglio(OrgDetails.getTipologia(),"") %>.do">Operatori</a> > 
<%--   <a href="<%=TicketDetails.getURlDettaglio(OrgDetails.getTipologia(),"") %>.do?command=Search"><dhv:label name="accounts.SearchResults">Search Results</dhv:label></a> > --%>
  <a href="<%=TicketDetails.getURlDettaglio(OrgDetails.getTipologia(),"") %>.do?command=Details&altId=<%=OrgDetails.getAltId()%>">Scheda Operatore</a> >
  <a href="<%=TicketDetails.getURlDettaglio(OrgDetails.getTipologia(),"") %>.do?command=ViewVigilanza&altId=<%=OrgDetails.getAltId()%>"><dhv:label name="">Controlli Ufficiali</dhv:label></a> >
  <a href="<%=TicketDetails.getURlDettaglio(OrgDetails.getTipologia(),"") %>Vigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC")%>&altId=<%=OrgDetails.getAltId()%>"><dhv:label name="">Controllo Ufficiale</dhv:label></a> >
...
<table cellpadding="4" cellspacing="0" width="100%" class="details">
  ...
  <tr>
    <td class="formLabel">
      ...
      <td>
        ...
        <input type="hidden" name="idStabilimento" value="<%=OrgDetails.getAltId()-20000000%>">
 ...
 <%@ include  file="../nonconformita/provvedimenti_add.jsp" %>
