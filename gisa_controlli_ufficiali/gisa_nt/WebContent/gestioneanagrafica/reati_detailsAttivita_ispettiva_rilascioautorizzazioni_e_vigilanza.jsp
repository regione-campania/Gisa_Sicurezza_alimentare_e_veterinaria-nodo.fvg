...
{
	%>
<a href="GestioneAnagraficaNonConformita.do?command=TicketDetails&idC=<%= request.getAttribute("idControllo")%>&id=<%= request.getAttribute("idNC")%>&altId=<%=TicketDetails.getAltId()%>"><dhv:label name="">Non Conformità Rilevata</dhv:label></a> >
	
	<%
}else
{
%>
<a href="GestioneAnagraficaAltreNonConformita.do?command=TicketDetails&idC=<%= request.getAttribute("idControllo")%>&id=<%= request.getAttribute("idNC")%>&altId=<%=TicketDetails.getAltId()%>"><dhv:label name="">Non Conformità Rilevata</dhv:label></a> >
