...
<table class="trails" cellspacing="0">
	<tr>
		<td width="100%"><a href="TrasportoAnimali.do"><dhv:label
			name="">Trasporto Animali</dhv:label></a> > <dhv:label
			name="">Importa Sedi Operative Autoveicoli</dhv:label>
		</td>
	</tr>
</table>
<%-- End Trails --%>
...
<table cellpadding="4" cellspacing="0" border="0" width="50%"
	...
	%>
			<tr>
				...
				<td align="right"><a href="<%= "logtrasporto/"+rImport.get(i).getRiepilogo() %>">Download</a></td>
				<td align="right"><a href="<%= "logtrasporto/"+rImport.get(i).getErrori() %>">Download</a></td>
				<td align="right"><a href="<%= "logtrasporto/"+rImport.get(i).getRecordInseriti() %>">Download</a></td>
			</tr>
			<% } %>
		<% } else { %>
