	...
	<tr>
		<td>
			<input
      			...
      			onclick="javascript:this.form.action='GisaNoScia.do?command=Choose&codice_univoco_ml=TAV-TAV-PR'"/><!-- il seguente codice_univoco-ml è fittizio -->
      		...
      		<input
      			...
      			onclick="javascript:this.form.action='GisaNoScia.do?command=Choose&codice_univoco_ml=TAV-TAV-EQ'"/>  <!-- il seguente codice_univoco-ml è fittizio -->
