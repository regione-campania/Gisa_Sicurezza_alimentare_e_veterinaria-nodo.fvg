...
<%@ page import="java.util.*,org.aspcfs.modules.trasportoanimali.base.*, org.aspcfs.modules.base.*" %>
<%@ page import="java.util.*,org.aspcfs.modules.trasportoanimali.base.*,org.aspcfs.modules.contacts.base.*,org.aspcfs.utils.web.*,org.aspcfs.modules.assets.base.*,org.aspcfs.modules.servicecontracts.base.*,java.text.DateFormat" %>
...
<body onLoad="">
<form method="post" name="inputForm" action="TrasportoAnimali.do?command=UploadDoc" enctype="multipart/form-data" onSubmit="return checkFileForm(this);">
...
<td width="100%">
  ...
  <dhv:label name="">Importa Autoveicoli</dhv:label>
</td>
</tr>
</table>
<%-- End Trails --%>
...
<table cellpadding="4" cellspacing="0" border="0" width="50%" class="details">
  <tr>
   ...
   <tr>
      ...
      <td>
        <a href="<%= "logtrasporto/"+path+"_rpg.txt" %>" ><%= path %></a>
      </td>
    </tr>
    <tr>
      <td nowrap class="formLabel">
      ...
      <td>
        <a href="<%= "logtrasporto/"+path+"_ok.txt" %>" ><%= path %></a>
      </td>
    </tr>
    <tr>
      <td nowrap class="formLabel">
      ...
      <td>
        <a href="<%= "logtrasporto/"+path+"_err.txt" %>" ><%= path %></a>
      </td>
    </tr>
 </table>
 ...
 <font color="red"><%=request.getAttribute("isError") %></font>
...
<%String orgId=(String) request.getAttribute("orgId"); %>
  ...
  <input type="submit" value="<dhv:label name="global.button.c">Chiudi</dhv:label>" onClick="this.form.action='TrasportoAnimali.do?command=Details&orgId=<%=orgId %>'" /><br/>
  <dhv:formMessage />
  <br />
</form>
</body>