...
<form method="post" name="inputForm" action="TrasportoAnimali.do?command=UploadDoc&carica=personale" enctype="multipart/form-data" onSubmit="return checkFileForm(this);">
...
<td width="100%">
  ...
  <dhv:label name="a">Importa Personale</dhv:label>
</td>
</tr>
</table>
<%-- End Trails --%>
  ...
  <%
  String orgID=(String)session.getAttribute("orgIdPersonale");
  %>
