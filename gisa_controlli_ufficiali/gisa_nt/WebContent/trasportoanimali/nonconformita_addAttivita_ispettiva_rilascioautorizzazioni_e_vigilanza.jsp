...
<form name="addticket" action="TrasportiNonConformita.do?command=Insert&auto-populate=true" method="post">
<%-- Trails --%>
...
<a href="TrasportoAnimali.do?command=ViewNonConformita&orgId=<%=OrgDetails.getOrgId() %>"><dhv:label name="nonconformita">NonConformita Amministrative</dhv:label></a> > 
...
<input type="submit" value="Annulla" onClick="javascript:this.form.action='Accounts.do?command=ViewNonConformita'">
<br>
<dhv:formMessage />
...
<br>
<input type="submit" value="<dhv:label name="button.insert">Insert</dhv:label>" name="Save" onClick="return checkForm(this.form)">
<input type="submit" value="Annulla" onClick="javascript:this.form.action='TrasportoAnimali.do?command=ViewNonConformita'">
</form>
