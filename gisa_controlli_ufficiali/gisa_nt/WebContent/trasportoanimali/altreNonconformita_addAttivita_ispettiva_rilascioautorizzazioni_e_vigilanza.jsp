...
<tr>
<td>
<a  href="TrasportoAnimali.do"  onclick="return !this.disabled;"><dhv:label name="">Trasporto Animali</dhv:label></a> > 
<a href="TrasportoAnimali.do?command=Search"  onclick="return !this.disabled;"><dhv:label name="">Risultati Ricerca</dhv:label></a> >
<a href="TrasportoAnimali.do?command=Details&orgId=<%=OrgDetails.getOrgId()%>"  onclick="return !this.disabled;"><dhv:label name="">Dettaglio Trasporto</dhv:label></a> >
 <a href="TrasportoAnimali.do?command=ViewVigilanza&orgId=<%=OrgDetails.getOrgId()%>"  onclick="return !this.disabled;"><dhv:label name="">Controlli Ufficiali</dhv:label></a> >
 <a href="TrasportiVigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC")%>&orgId=<%=OrgDetails.getOrgId()%>"  onclick="return !this.disabled;"><dhv:label name="">Controllo Ufficiale</dhv:label></a> >
