...
{
	%>
	<a href="TrasportiNonConformita.do?command=TicketDetails&id=<%=TicketDetails.getIdTicketNonConformita()%>&orgId=<%=TicketDetails.getOrgId()%>"><dhv:label name="">Non Conformità Rilevata</dhv:label></a> >
	
	<%
}else
{
%>
<a href="TrasportiAltreNonConformita.do?command=TicketDetails&id=<%=TicketDetails.getIdTicketNonConformita()%>&orgId=<%=TicketDetails.getOrgId()%>"><dhv:label name="">Non Conformità Rilevata</dhv:label></a> >
