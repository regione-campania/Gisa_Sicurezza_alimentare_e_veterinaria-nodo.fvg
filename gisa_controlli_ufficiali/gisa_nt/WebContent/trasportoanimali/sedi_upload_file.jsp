...
<form method="post" name="inputForm" action="TrasportoAnimali.do?command=UploadDoc&carica=sedi" enctype="multipart/form-data" onSubmit="return checkFileForm(this);">
...
<td width="100%">
  ...
  <dhv:label name="a">Importa Sedi Operative Autoveicoli</dhv:label>
</td>
</tr>
</table>
<%-- End Trails --%>
  ...
  <%
  String orgID=(String)session.getAttribute("orgIdSedi");
  %>
