...
<body>
 <form name="addticket" action="ParafarmacieProvvedimenti.do?command=Insert&auto-populate=true" method="post" onsubmit="return controllaForm(this)">
<%-- Trails --%>
<table class="trails" cellspacing="0" >
<tr>
<td>
  <a href="Parafarmacie.do">Operatori</a> > 
  <a href="Parafarmacie.do?command=Search"><dhv:label name="parafarmacie.SearchResults">Search Results</dhv:label></a> >
  <a href="Parafarmacie.do?command=Details&orgId=<%=OrgDetails.getOrgId()%>">Scheda Operatore </a> >
...
<input type="button" value="Annulla" onClick="window.location.href='ParafarmacieVigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC") %>&orgId=<%=OrgDetails.getOrgId()%>';this.form.dosubmit.value='false';" />
<br>
<dhv:formMessage />
...
<script language="JavaScript" TYPE="text/javascript" SRC="javascript/popParafarmacie.js"></script>
