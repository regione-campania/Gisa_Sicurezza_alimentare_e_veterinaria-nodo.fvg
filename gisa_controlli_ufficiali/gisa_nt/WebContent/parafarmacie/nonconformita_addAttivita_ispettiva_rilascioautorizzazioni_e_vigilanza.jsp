...
<tr>
<td>
<a href="Parafarmacie.do"><dhv:label name="accounts.accounts">Accounts</dhv:label></a> > 
<a href="Parafarmacie.do?command=SearchFcie"><dhv:label name="accounts.SearchResults">Search Results</dhv:label></a> >
<a href="Parafarmacie.do?command=Details&orgId=<%=OrgDetails.getOrgId()%>"><dhv:label name="accounts.details">Account Details</dhv:label></a> >

<a href="Parafarmacie.do?command=ViewNonConformita&orgId=<%=OrgDetails.getOrgId() %>"><dhv:label name="nonconformita">NonConformita Amministrative</dhv:label></a> > 
...
<input type="submit" value="Annulla" onClick="javascript:this.form.action='Parafarmacie.do?command=ViewNonConformita'">
<br>
<dhv:formMessage />
...
<dhv:include name="ticket.subCat3" none="true">
 ...
 function setField(formField,thisValue,thisForm) {
  ...
  <dhv:include name="ticket.subCat2" none="true">
    ...
    var url = 'KnowledgeBaseManager.do?command=SearchFcie&popup=true&searchcodeSiteId='+siteId+'&searchcodeCatCode='+catCodeValue;
...
<%--</dhv:evaluate>  --%>
  ...
  <tr>
    <td class="formLabel">
      ...
      <td>
        <%= toHtml(OrgDetails.getRagioneSociale()) %>
