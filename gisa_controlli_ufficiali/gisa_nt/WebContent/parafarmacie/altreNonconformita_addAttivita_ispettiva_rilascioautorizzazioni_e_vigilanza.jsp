...
<form name="addticket" action="ParafarmacieNonConformita.do?command=Insert&auto-populate=true" method="post">
...
<%-- %>a href="Parafarmacie.do?command=ViewNonConformita&orgId=<%=OrgDetails.getOrgId() %>"><dhv:label name="nonconformitaa"> Non Conformità Rilevate</dhv:label></a> --%> 
