...
<form name="addticket" action="<%=TicketDetails.getURlDettaglio(802,"") %>AltreNonConformita.do?command=Insert&auto-populate=true" method="post">
<input type = "hidden" id = "dosubmit" name = "dosubmit" value = "0">
<%-- Trails --%>
<table class="trails" cellspacing="0">
<tr>
<td>
  <a href="<%=TicketDetails.getURlDettaglio(802,"") %>.do">Operatori</a> > 
  <a href="<%=TicketDetails.getURlDettaglio(802,"") %>.do?command=Search"><dhv:label name="accounts.SearchResults">Search Results</dhv:label></a> >
  <a href="<%=TicketDetails.getURlDettaglio(802,"") %>.do?command=Details&orgId=<%=OrgDetails.getOrgId()%>">Scheda Operatore</a> >
  <a href="<%=TicketDetails.getURlDettaglio(802,"") %>.do?command=ViewVigilanza&orgId=<%=OrgDetails.getOrgId()%>"><dhv:label name="">Controlli Ufficiali</dhv:label></a> >
  <a href="<%=TicketDetails.getURlDettaglio(802,"") %>Vigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC")%>&orgId=<%=OrgDetails.getOrgId()%>"><dhv:label name="">Controllo Ufficiale</dhv:label></a> >
