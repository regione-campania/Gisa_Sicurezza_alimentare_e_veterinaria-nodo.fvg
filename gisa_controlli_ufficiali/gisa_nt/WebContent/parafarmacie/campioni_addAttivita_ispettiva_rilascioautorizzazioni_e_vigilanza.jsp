...
<form name="addticket" action="ParafarmacieCampioni.do?command=Insert&auto-populate=true" method="post">
<%-- Trails --%>
...
<a href="Parafarmacie.do?command=SearchFcie"><dhv:label name="accounts.SearchResults">Search Results</dhv:label></a> >
 <a href="Parafarmacie.do?command=DetailsFcie&idFarmacia=<%=OrgDetails.getOrgId()%>">Dettaglio Farmacie / Grossisti / Parafarmacie</a> >
 ...
 <a href="ParafarmacieVigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC")%>&orgId=<%=OrgDetails.getOrgId()%>"><dhv:label name="">Controllo Ufficiale</dhv:label></a> >
  ...
  <%--a href="Parafarmacie.do?command=ViewCampioni&orgId=<%=OrgDetails.getOrgId()%>"><dhv:label name="campioni">Tickets</dhv:label></a> --%>
