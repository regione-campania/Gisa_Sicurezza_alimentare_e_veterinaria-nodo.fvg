...
<form name="addticket" action="CaniPadronaliCampioni.do?command=Insert&auto-populate=true" method="post">
<%-- Trails --%>
...
<input type = "hidden" name = "macroarea" value = "<%=OrgDetails.getTipologia() %>">
