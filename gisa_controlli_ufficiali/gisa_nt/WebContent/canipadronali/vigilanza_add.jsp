...
<body onload = "provaFunzione('addticket'); resetElementiNucleoIspettivo('<%=TicketDetails.getNucleoasList().size() %>'); ">
...
<form method="post" name="addticket" action="CaniPadronaliVigilanza.do?command=Insert&auto-populate=true" onsubmit="return controlloCuSorveglianza()" >
<%-- Trails --%>
...
<input type="submit" value="<dhv:label name="button.inserta">Inserisci</dhv:label>" name="Save">
<input type="submit" value="Annulla" onClick="javascript:this.form.action='CaniPadronali.do?command=SearchForm'">
<br>
...
<table cellpadding="4" cellspacing="0" width="100%" class="details">
	...
	<tr>
		...
		<td>
		<input type ="text" required="required" name = "cap_proprietario" ><font color="red">*</font> 
		</td> 
	</tr>
</table>
<br>
...
<table cellpadding="4" cellspacing="0" width="100%" class="details">
	...
	<tr>
		...
		<td>
		<input type ="text" name = "cap_conducente" >
		</td> 
	</tr>
</table>
