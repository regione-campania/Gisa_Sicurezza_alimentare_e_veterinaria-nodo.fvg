...
<SCRIPT LANGUAGE="JavaScript" ID="js19">
 ...
 -->
        ...
        $( document ).ready(function (){
        	calenda('data_nascita_proprietario','','0');
        	calenda('data_nascita_conducente','','0');
        	calenda('data_nascita_cane_1','','0');
        });
...
function addCane(){
	...
	if(clone.getElementsByTagName('A')[0] != null){
...
function controllaCF()
{
  ...
  var CodiceFiscale = document.getElementById("cf_proprietario");
...
<input type="button" value="Annulla" onClick="location.href='CaniPadronali.do?command=SearchForm'">
<br>
...
<table cellpadding="4" cellspacing="0" width="100%" class="details">
	...
	<tr>
		...
		<td><input type = "text" name = "cf_proprietario" id= "cf_proprietario"  size="30" pattern="^[a-zA-Z]{6}[0-9]{2}[a-zA-Z][0-9]{2}[a-zA-Z][0-9]{3}[a-zA-Z]$" maxlength="16" onblur='javascript:controllaCF();'><font color="red">*</font> 
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			<input type="text" id="data_nascita_proprietario" name="data_nascita_proprietario" size="10" class="date_picker"/>
		</td>
	</tr>
	<tr>
...
<table cellpadding="4" cellspacing="0" width="100%" class="details">
	...
	<tr>
		...
		<td>
		<input type ="text" required="required" id = "cap_proprietario" name = "cap_proprietario" maxlength="5"><font color="red">*</font> 
		</td> 
	</tr>
</table>
<br>
<table cellpadding="4" cellspacing="0" width="100%" class="details">
	...
	<tr>
		...
		<td><input type = "text" name = "cognome_conducente"  size="30" pattern=".{0,16}" maxlength="16">
		</td>
	</tr>
	<tr>
		<td nowrap class="formLabel">Comune di nascita
	...
	<tr>
		...
		<td>
			<input type="text" id="data_nascita_conducente" name="data_nascita_conducente" size="10" class="date_picker"/>
		</td>
	</tr>
...
<table cellpadding="4" cellspacing="0" width="100%" class="details">
	...
	<tr>
		...
		<td>
		<input type ="text" id = "cap_conducente" name = "cap_conducente"  maxlength="5">
		</td> 
	</tr>
</table>
...
<br/><br/>
<font color="red"><b>Inserire almeno una informazione per ogni cane controllato</b></font>

<table id="canicontrollatitrCaniPadronali" cellpadding="4" cellspacing="0" width="100%" class="details">
	...
	<td><b>1</b></td>
		...
		<td><input type = "text" required="required" id = "data_nascita_cane_1" name = "data_nascita_cane_1" value="" class="date_picker"><font color="red">*</font> 
