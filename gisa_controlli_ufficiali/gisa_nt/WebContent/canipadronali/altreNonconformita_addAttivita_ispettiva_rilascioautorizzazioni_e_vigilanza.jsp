...
<form name="addticket" action="CaniPadronaliNonConformita.do?command=Insert&auto-populate=true" method="post">
    ...
    <tr>
      ...
      <%if (OrgDetails.getSiteId()>0 && OrgDetails.getTipologia()!=255){ %>
		...
		else
		{
			...
			<input type="hidden" name="siteId" id = "siteId" value="<%=CU.getSiteId()%>">
			<%
			}
		}
		%>
