...
<%
%>
<form name="details" action="CaniPadronaliSanzioni.do?command=ModifyTicket&auto-populate=true" method="post">
...
<tr>
<td>
<a href="CaniPadronali.do"><dhv:label name="canipadronali.canipadronali">CaniPadronali</dhv:label></a> > 
<a href="CaniPadronali.do?command=Search"><dhv:label name="canipadronali.SearchResults">Search Results</dhv:label></a> >
<a href="CaniPadronali.do?command=Details&orgId=<%=TicketDetails.getOrgId()%>"><dhv:label name="canipadronali.details">Dettaglio CaniPadronali </dhv:label></a> >
...
<%--a href="CaniPadronali.do?command=ViewSanzioni&orgId=<%=TicketDetails.getOrgId() %>"><dhv:label name="">Sanzioni Amministrative</dhv:label></a> --%>
<%
	if (defectCheck != null && !"".equals(defectCheck.trim())) {
%>
  <a href="CaniPadronaliSanzioni.do?command=TicketDetails&Id=<%=TicketDetails.getId()%>&orgId=<%=OrgDetails.getOrgId() %>"><dhv:label name="tickets.defects.viewDefects">View Defects</dhv:label></a> >
  <a href="CaniPadronaliSanzioniDefects.do?command=Details&defectId=<%= defectCheck %>"><dhv:label name="tickets.defects.defectDetails">Defect Details</dhv:label></a> >
<%
  	} else {
  %>
<%
...
%>
  <a href="CaniPadronaliSanzioni.do?command=SearchTicketsForm"><dhv:label name="tickets.searchForm">Search Form</dhv:label></a> >
  <a href="CaniPadronaliSanzioni.do?command=SearchTickets"><dhv:label name="canipadronali.SearchResults">Search Results</dhv:label></a> >
<%
  	} else {
  %> 
 <%--  <a href="CaniPadronali.do?command=ViewSanzioni&orgId=<%=OrgDetails.getOrgId()%>"><dhv:label name="sanzioni.visualizza">Visualizza Sanzioni Amministrative</dhv:label></a> > --%>
<%
   	}
   %>
<%
