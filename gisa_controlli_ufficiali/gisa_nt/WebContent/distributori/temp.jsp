...
<input type="submit" value="Annulla" onClick="javascript:this.form.action='DistributoriNonConformita.do?command=TicketDetails&idMacchinetta=<%=idMacchinetta %>&id=<%= request.getAttribute("idNC")%>&orgId=<%=OrgDetails.getOrgId()%>'"><br>
<dhv:formMessage />
