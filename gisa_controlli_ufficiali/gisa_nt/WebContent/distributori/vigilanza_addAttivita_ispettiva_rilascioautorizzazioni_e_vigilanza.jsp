...
<form name="addticket" action="DistributoriVigilanza.do?command=Insert&auto-populate=true" method="post">
<%-- Trails --%>
...
<input type="submit" value="Annulla" onClick="javascript:this.form.action='Distributori.do?command=ViewVigilanza&orgId=<%=OrgDetails.getOrgId()%>'">
<br>
<dhv:formMessage />
