...
<body onload = "gestioneVisibilitaCodiceAteco('addticket'); resetElementiNucleoIspettivo('<%=TicketDetails.getNucleoasList().size() %>'); ">
...
<form method="post" name="addticket" action="DistributoriVigilanza.do?command=Insert&auto-populate=true">
<%-- Trails --%>
