...
<form name="addticket" action="DistributoriCampioni.do?command=Insert&auto-populate=true" method="post">
<%-- Trails --%>
...
<a href="Distributori.do?command=List"><dhv:label name="">Distributori</dhv:label></a> > 
  ...
  <a href="Distributori.do?command=Details&orgId=<%=request.getAttribute("orgId")%>&id=<%=idMacchinetta %>"><dhv:label name="">Scheda Distributore Automatico</dhv:label></a> >
  <a href="Distributori.do?command=ViewVigilanza&orgId=<%=request.getAttribute("orgId")%>&id=<%=idMacchinetta %>"><dhv:label name="">Controlli Ufficiali</dhv:label></a> >
...
<input type="button" value="Annulla" onClick="window.location.href='DistributoriVigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC") %>&orgId=<%=OrgDetails.getOrgId()%>';this.form.dosubmit.value='false';" />
<br>
<dhv:formMessage />
