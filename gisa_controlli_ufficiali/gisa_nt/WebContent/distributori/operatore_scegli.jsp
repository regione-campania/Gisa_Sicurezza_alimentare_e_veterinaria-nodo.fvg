...
<table cellpadding="4" cellspacing="0" width="100%" class="empty">
	...
	<tr> 
   		 <td>
      		<input
      			type="submit"
      			onmouseover="ddrivetip('<dhv:label name="distributor">In costruzione</dhv:label>')"
      		...
      		<input
      			...
      			onclick="javascript:this.form.action='Distributori.do?command=SearchForm'"
      		/>
