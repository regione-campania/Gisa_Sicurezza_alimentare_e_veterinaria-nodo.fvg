...
function load_linee_attivita_per_alt_id_sintesis_callback(returnValue) {
  ...
  function costruisci_rel_ateco_attivita( org_id, campo_combo_da_costruire ) {
	  ...
	  PopolaCombo.load_linee_attivita_per_alt_id_sintesis(org_id , campo_combo_da_costruire, null, load_linee_attivita_per_alt_id_sintesis_callback)
  }
...
<body onload = "gestioneVisibilitaCodiceAteco('addticket'); resetElementiNucleoIspettivo('<%=TicketDetails.getNucleoasList().size() %>'); costruisci_rel_ateco_attivita('<%= OrgDetails.getAltId() %>', 'id_linea_sottoposta_a_controllo'); ">
...
<input type = "hidden" name="idstabilimentoopu" id = "idstabilimentoopu" value="<%=OrgDetails.getIdStabilimento()%>"/>
	
<%@ include file="../controlliufficiali/controlli_ufficiali_add_opu_tipo2.jsp" %>
