...
<input type="submit" value="Annulla" onClick="javascript:this.form.action='Accounts.do?command=ViewCessazionevariazione&orgId=<%=OrgDetails.getOrgId()%>'">
<br>
<dhv:formMessage />
...
<%--</dhv:evaluate>  --%>
  ...
  <tr class="containerBody">
    <td class="formLabel">
      <dhv:label name="">Nuova Impresa</dhv:label>
    </td>
