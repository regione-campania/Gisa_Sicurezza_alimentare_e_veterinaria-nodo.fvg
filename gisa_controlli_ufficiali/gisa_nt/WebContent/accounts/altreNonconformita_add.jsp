...
<tr>
<td>
<a  href="Accounts.do"  onclick="return !this.disabled;"><dhv:label name="">Stabilimenti 852</dhv:label></a> > 
<a href="Accounts.do?command=Search"  onclick="return !this.disabled;"><dhv:label name="accounts.SearchResults">Search Results</dhv:label></a> >
<a href="Accounts.do?command=Details&orgId=<%=OrgDetails.getOrgId()%>"  onclick="return !this.disabled;"><dhv:label name="">Scheda Stabilimento 852</dhv:label></a> >
 <a href="Accounts.do?command=ViewVigilanza&orgId=<%=OrgDetails.getOrgId()%>"  onclick="return !this.disabled;"><dhv:label name="">Controlli Ufficiali</dhv:label></a> >
 <a href="AccountVigilanza.do?command=TicketDetails&id=<%= request.getAttribute("idC")%>&orgId=<%=OrgDetails.getOrgId()%>"  onclick="return !this.disabled;"><dhv:label name="">Controllo Ufficiale</dhv:label></a> >
...
<table cellpadding="4" cellspacing="0" width="100%" class="details">
  ...
  <tr>
    <td class="formLabel">
      <dhv:label name="nonconformita.richiedente">Impresa O.S.A.</dhv:label>
    </td>
...
function openNotePopupFollowup(orgId,idC,dataC,tipo_nc){
	...
	var result;
		...
		window.open('FollowupNC.do?command=Add&idC='+idC+'&dataC='+dataC+'&orgId='+orgId+'&tipoNc='+tipo_nc,null,
...
<% } %>
<div class="tabbertab">
 <%@ include file="non_conformita_formali.jsp" %>

</div>
<div class="tabbertab">
 <%@ include file="non_conformita_significative.jsp" %>
...
<% } %>
 ...
 <div class="tabbertab">
 <%@ include file="non_conformita_gravi.jsp" %>
