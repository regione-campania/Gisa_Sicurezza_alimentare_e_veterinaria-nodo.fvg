...
<form name="addAccountAudit"  method="post" action="CheckListImprese.do?command=Save&auto-populate=true&return<%= request.getParameter("return") %>" onSubmit="return checkForm()" >
