...
<body onload = "gestioneVisibilitaCodiceAteco('addticket'); resetElementiNucleoIspettivo('<%=TicketDetails.getNucleoasList().size() %>'); costruisci_rel_ateco_attivita('<%= OrgDetails.getOrgId() %>', 'id_linea_sottoposta_a_controllo'); ">
...
%>
<td>
  <a href="Accounts.do"><dhv:label name="">Ricerca Anagrafica Operatore</dhv:label></a> > 
  <a href="Accounts.do?command=Search"><dhv:label name="accounts.SearchResults">Search Results</dhv:label></a> >
  <a href="Accounts.do?command=Details&orgId=<%=OrgDetails.getOrgId()%>"><dhv:label name="">Scheda Anagrafica Operatore</dhv:label></a> >
