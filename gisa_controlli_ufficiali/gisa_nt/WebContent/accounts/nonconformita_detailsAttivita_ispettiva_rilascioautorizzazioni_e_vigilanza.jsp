...
<body onload="verificaChiusuraNc(<%=request.getAttribute("Chiudi")%>,<%=request.getAttribute("numSottoAttivita")%>,'<%=request.getAttribute("Messaggio2")%>',<%=TicketDetails.getIdControlloUfficiale() %>,'AccountVigilanza')">
...
<dhv:container name="accountsnonconformita" selected="details" object="TicketDetails"
	param="<%= param1 %>"
