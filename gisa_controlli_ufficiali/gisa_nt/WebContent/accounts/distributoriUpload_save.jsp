...
<td width="100%">
  ...
  <dhv:label name="">Distributori Importati</dhv:label>
</td>
</tr>
</table>
<%-- End Trails --%>
...
<%String orgId=(String) request.getAttribute("orgId"); %>
  ...
  <input type="submit" value="<dhv:label name="global.button.c">Chiudi</dhv:label>" onClick="this.form.action='Accounts.do?command=Details&orgId=<%=orgId %>'" /><br/>
  <dhv:formMessage />
  <br />
</form>
</body>