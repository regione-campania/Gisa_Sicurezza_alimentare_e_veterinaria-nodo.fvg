...
<form name="addticket" action="PuntiSbarcoSequestri.do?command=Insert&auto-populate=true" method="post">
<%-- Trails --%>
...
<a href="PuntiSbarcoNonConformita.do?command=TicketDetails&id=<%= request.getAttribute("idNC")%>&orgId=<%=OrgDetails.getOrgId()%>"><dhv:label name="">Non Conformità Rilevata</dhv:label></a> >
...
<input type="button" value="Annulla" onClick="window.location.href='PuntiSbarcoNonConformita.do?command=TicketDetails&id=<%= request.getAttribute("idNC") %>&orgId=<%=OrgDetails.getOrgId()%>';this.form.dosubmit.value='false';" />
<br>
<dhv:formMessage />
...
if(form.tipo_richiesta.value==""){
  ...
  function addNewContact(){
    <dhv:permission name="punti_di_sbarco-contacts-add">
      var acctPermission = true;
    </dhv:permission>
    <dhv:permission name="punti_di_sbarco-contacts-add" none="true">
