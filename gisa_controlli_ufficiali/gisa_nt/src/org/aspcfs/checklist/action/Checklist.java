 ...
 */
public final class Checklist extends CFSModule {
	...
	public String executeCommandList(ActionContext context) {
		...
		String orgId = context.getRequest().getParameter("orgId");  //questo mi da problemi
	...
	*/
	...
	public String executeCommandUpdate(ActionContext context) throws SQLException {
		...
		thisAudit.setIdLastDomanda(context.getRequest().getParameter("idLastDomanda"))						;
			...
			newTic.queryRecord(db, Integer.parseInt(idC));
			thisAudit.setOrgId(Integer.parseInt(context.getRequest().getParameter("orgId")));
			thisAudit.setNote(context.getRequest().getParameter("note"));
	...
	if(!rs_operatore.next())
	{
		...
		*/
		...
		organ.updateCategoriaRischio(db, categoria,date, Integer.parseInt(orgId),Integer.parseInt(idC));
