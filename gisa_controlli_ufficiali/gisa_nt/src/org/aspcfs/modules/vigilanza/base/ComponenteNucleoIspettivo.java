...
public class ComponenteNucleoIspettivo extends GenericBean {
	...
	private String nomeQualifica = null;
	...
	public void setDatiComponente(Connection db) throws SQLException {
		...
		this.nomeQualifica = utente.getRole();
		
		if (idStruttura > 0){
			OiaNodo struttura = null;
			OiaNodo strutturaPadre = null;
			struttura = new OiaNodo(db, idStruttura);
			if (struttura.getId_padre()>0)
				strutturaPadre = new OiaNodo(db, struttura.getId_padre());

			nomeStruttura = strutturaPadre.getDescrizionePadre() + "->"+ strutturaPadre.getDescrizione_lunga() + "->" + struttura.getDescrizione_lunga();
		}
	...
	public void buildRecord(ResultSet rs) throws SQLException
	{
		...
		idStruttura =rs.getInt("id_struttura_componente");
