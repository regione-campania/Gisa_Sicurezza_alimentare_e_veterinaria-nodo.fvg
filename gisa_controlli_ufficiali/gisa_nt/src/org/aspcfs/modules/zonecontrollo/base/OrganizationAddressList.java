...
public class OrganizationAddressList extends AddressList {
  ...
  private static Logger log = Logger.getLogger(org.aspcfs.modules.zonecontrollo.base.OrganizationAddressList.class);
  static {
  ...
  public void buildList(Connection db) throws SQLException {
    ...
    sqlSelect.append(
        ...
        "FROM organization_address a left join lookup_orgaddress_types l on  a.address_type = l.code " +
        " where 1=1 ");
