...
public final class AccountFollowup extends CFSModule {
  ...
  public String executeCommandViewFollowup(ActionContext context) {
	    if (!hasPermission(context, "trasporti-trasporti-followup-view")) {
  ...
  public String executeCommandReopenTicket(ActionContext context) {
    if (!hasPermission(context, "trasporti-trasporti-followup-edit")) {
      return ("PermissionError");
    }
    int resultCount = -1;
    Connection db = null;
  ...
  public String executeCommandConfirmDelete(ActionContext context) {
    if (!hasPermission(context, "trasporti-trasporti-followup-delete")) {
      return ("PermissionError");
    }
    Connection db = null;
    //Parameters
