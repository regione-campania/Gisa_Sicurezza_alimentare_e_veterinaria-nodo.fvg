 ...
 * @created Luglio 2012
 */
public final class EliminaAssociazioneConAziendaZootecnica extends CFSModule {

	Logger logger = Logger.getLogger("MainLogger");
	
	public String executeCommandDelete(ActionContext context) {
		// verifica permessi  
		if (!(hasPermission(context, "osmregistrati-associazioneaziendazootecnica-delete"))) {
		...
		try {
			logger.info("Eliminazione collegamento fra OSM registrato e azienda zootecnica.....");
