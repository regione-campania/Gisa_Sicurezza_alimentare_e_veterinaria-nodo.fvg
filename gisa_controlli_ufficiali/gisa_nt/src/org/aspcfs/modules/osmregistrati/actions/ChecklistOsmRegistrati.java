...
public class ChecklistOsmRegistrati extends CFSModule{
		 ...
		 Connection db = null;
			...
			try 
			{
				...
				if (messaggioAllegatiSanzione!=null && !messaggioAllegatiSanzione.equals("")){
					...
					org.aspcfs.modules.osmregistrati.actions.AccountVigilanza AV = new org.aspcfs.modules.osmregistrati.actions.AccountVigilanza();
