...
public class CheckListRiproduzioneAnimale extends CFSModule{
	 ...
	 public String executeCommandAdd(ActionContext context)
	  {
		...
		finally 
		{
		 ...
		 return "checklistRiproduzioneAnimaleAdd";
	 ...
	 public String executeCommandSave(ActionContext context)
	  {
		...
		finally 
		{
		 ...
		 return "checklistRiproduzioneAnimaleSaveOk";
	  }
	 ...
	 public String executeCommandView(ActionContext context)
	 {
		...
		finally 
		{
		 ...
		 return "checklistRiproduzioneAnimaleView";
	 }
	 ...
	 public String executeCommandModify(ActionContext context)
	 {
		...
		finally 
		{
		 ...
		 return "checklistRiproduzioneAnimaleModify";
	 }
	 ...
	 public String executeCommandUpdate(ActionContext context)
	 {
		...
		finally 
		{
		 ...
		 return "checklistRiproduzioneAnimaleUpdate";
	 }
	 ...
	 public String executeCommandDelete(ActionContext context)
	 {
		...
		finally 
		{
		 ...
		 return ("checklistRiproduzioneAnimaleDelete");
	 }
	 ...
	 public String executeCommandUpdateCategoria(ActionContext context)
	 {
		 ...
		 Connection db = null;
			...
			try 
			{
				...
				if (messaggioAllegatiSanzione!=null && !messaggioAllegatiSanzione.equals("")){
					...
					org.aspcfs.modules.riproduzioneanimale.actions.RiproduzioneAnimaleVigilanza AV = new org.aspcfs.modules.riproduzioneanimale.actions.RiproduzioneAnimaleVigilanza();
		...
		RiproduzioneAnimaleVigilanza AV = new RiproduzioneAnimaleVigilanza();
		return AV.executeCommandChiudiTutto(context);
		//return ("checklistRiproduzioneAnimaleUpdateCategoria");
	 }
