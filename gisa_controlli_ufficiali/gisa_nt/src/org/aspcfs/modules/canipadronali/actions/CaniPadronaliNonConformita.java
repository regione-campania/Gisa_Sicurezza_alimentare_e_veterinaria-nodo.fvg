...
public class CaniPadronaliNonConformita extends CFSModule {
	...
	public String executeCommandTicketDetails(ActionContext context) {
		...
		try {
			...
			Proprietario proprietario = op.dettaglioProprietario(id_prop, Integer.parseInt((String)context.getRequest().getAttribute("idC"))); 
