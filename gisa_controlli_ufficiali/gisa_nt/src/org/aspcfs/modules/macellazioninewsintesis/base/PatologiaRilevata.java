...
public class PatologiaRilevata  extends GenericBean
{
	...
	public static ArrayList<PatologiaRilevata> load( int id, ConfigTipo configTipo,Connection db )
	{
		...
		try
		{
			stat	= db.prepareStatement( "SELECT * FROM m_vpm_patologie_rilevate WHERE "+configTipo.getNomeCampoRifAltreTabelle()+" = ? and trashed_date IS NULL" );
			stat.setInt( 1, id );
