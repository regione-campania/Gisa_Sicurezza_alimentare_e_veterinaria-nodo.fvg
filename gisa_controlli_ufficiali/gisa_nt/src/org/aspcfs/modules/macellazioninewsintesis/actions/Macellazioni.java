...
import org.aspcfs.modules.macellazioninewsintesis.base.BeanAjax;
import org.aspcfs.modules.macellazioninewsintesis.base.Campione;
import org.aspcfs.modules.macellazioninewsintesis.base.Capo;
...
import org.aspcfs.modules.macellazioninewsintesis.base.CategoriaRischio;
import org.aspcfs.modules.macellazioninewsintesis.base.ChiaveModuliMacelli;
import org.aspcfs.modules.macellazioninewsintesis.base.Esito;
...
import org.aspcfs.modules.macellazioninewsintesis.base.PartitaLog;
import org.aspcfs.modules.macellazioninewsintesis.base.PartitaLogDao;
import org.aspcfs.modules.macellazioninewsintesis.base.PartitaSeduta;
import org.aspcfs.modules.macellazioninewsintesis.base.PatologiaRilevata;
import org.aspcfs.modules.macellazioninewsintesis.base.ProvvedimentiCASL;
import org.aspcfs.modules.macellazioninewsintesis.base.RichiestaIstopatologico;
import org.aspcfs.modules.macellazioninewsintesis.base.StampeModuli;
import org.aspcfs.modules.macellazioninewsintesis.base.StampeModuliDao;
import org.aspcfs.modules.macellazioninewsintesis.base.Tampone;
import org.aspcfs.modules.macellazioninewsintesis.base.Tipo;
import org.aspcfs.modules.macellazioninewsintesis.base.TipoRicerca;
...
public class Macellazioni extends CFSModule
{
	...
	public String executeCommandSearch( ActionContext context )
	{
		...
		if (context.getParameter("matricola")!=null && ! "".equals(context.getParameter("matricola")))
		{
			...
			try
			{
				...
				context.getRequest().setAttribute("altId",b.getId_macello()+"" );
				SintesisStabilimento org = new SintesisStabilimento( db, b.getId_macello(), true );
	...
	public String executeCommandToStampeModuli( ActionContext context ) throws NumberFormatException
	{
		...
		try {
			...
			SintesisStabilimento macello = new SintesisStabilimento( db, Integer.parseInt( context.getParameter( "altId" ) ), true );
		...
		try
		{
			...
			if(identificativo!=null && !identificativo.equals(""))
			{
				...
				if(context.getRequest().getParameter("fromModifica")!=null && context.getRequest().getParameter("fromModifica").equals("si"))
					ca = ac.isCapoEsistenteUpdateSintesis(b.getId(),identificativo,b.getCd_codice_azienda_provenienza(),((Partita)b).getCd_num_capi_ovini(),((Partita)b).getCd_num_capi_caprini());
				else 
...
//               ArrayList<Partita> partite = new ArrayList<Partita>();
                 ...
                 if(dataMacellazioneString != null && !dataMacellazioneString.equals(""))
                 {
                         if(!dataMacellazioneString.equals("-1"))
                         {
                                 ...
                                 //capi = Capo.loadByStabilimentoPerDataMacellazione( context.getParameter( "altId" ),dataMacellazioneTimestamp, db );
                                 beans = GenericBean.loadByStabilimentoPerDataMacellazione( context.getParameter( "altId" ),dataMacellazioneTimestamp, db, configTipo );
                         }
                         else
                         {
                                 //capi = Capo.loadByStabilimentoCapiNonMacellati( context.getParameter( "altId" ), db );
                                 beans = GenericBean.loadByStabilimentoCapiNonMacellati( context.getParameter( "altId" ), db, configTipo );
                         }
                 }
                 else
                 {
                         ...
                         {
                                 //capi = Capo.loadByStabilimento( context.getParameter( "altId" ), db );
                                 beans = GenericBean.loadByStabilimento( context.getParameter( "altId" ), db, configTipo );
                         }
                                                	 ...
                                                	 Partita pTemp = null;
                                                	  ...
                                                	  db2 = GestoreConnessioni.getConnection();
                                                	   pTemp = (Partita)Partita.load(id, db2, configTipo);
                                                         ...
                                                         //return "<div style=\"background-color:" + colore + "\"><a href=\"macellazioninew.do?command=Details&id=" + id + "&altId=" + id_mac + "\">" + temp + "</a></div>";
                                                         db2.close();
                                                      }
                                                      catch (Exception e)
                                                      {
                                                      ...
                                                      finally
                                                      {
                                                         ...
                                                         return categoriaPartita+"<br/>"+"<a href=\"MacellazioniNewSintesis.do?command=Details&id=" + id + "&altId=" + id_mac + "\">" + temp + "</a>";
                                                         //return temp;
                         ...
                         cg.getCellRenderer().setCellEditor(
                                         new CellEditor()
                                         {
                                                 public Object getValue(Object item, String property, int rowCount)
                                                 {
                                                         ...
                                                         //return "<div style=\"background-color:" + colore + "\"><a href=\"macellazioninew.do?command=Details&id=" + id + "&altId=" + id_mac + "\">" + temp + "</a></div>";
                                                         return "<center><a href=\"MacellazioniNewSintesis.do?command=NuovoCapo&id=" + id + "&altId=" + id_mac + "&clona=si \"><img src=\"images/icons/clone.png\" height=\"20px\" width=\"20px\" title=\"Clona capo\" /></a></center>";
                                                         //return temp;
...
////                                                             //return "<div style=\"background-color:" + colore + "\"><a href=\"Macellazioni.do?command=Details&id=" + id + "&altId=" + id_mac + "\">" + temp + "</a></div>";
////                                                                             toReturn += "<center><a href=\"MacellazioniNewSintesis.do?command=RichiestaIstopatologico&id=" + id + "&altId=" + id_mac + " \"><img src=\"images/icons/clone.png\" height=\"20px\" width=\"20px\" title=\"Richiedi istopatologico\" /></a></center>";
////                                                                             k++;
////                                                                     }
...
////                                                                             toReturn += "<div>" + "<a onclick=\"window.open('MacellazioniNewSintesis.do?command=VisualizzaEsitoRichiestaIstopatologico&idIstopatologico=" + istopatologico_id + "&popup=true', 'titolo', 'width=600, height=600, resizable, status, scrollbars=1, location');\" href=\"#\" + \">Visualizza esito</a>" + "</div> ";
////                                                                      if (richiesteIstopatologico.getIdEsito() <= 0)
////                                                                             toReturn += "<div>" + "<a onclick=\"window.open('MacellazioniNewSintesis.do?command=PrepareInserisciEsitoRichiestaIstopatologico&idIstopatologico=" + istopatologico_id + "&popup=true', 'titolo', 'width=600, height=600, resizable, status, scrollbars=1, location');\" href=\"#\" + \">Inserisci esito</a>" + "</div> ";
////                                                                      k++;
////                                                                     }
////                                                             }
////                                                             if (("").equals(toReturn) )
...
//                                       //}
                                 ...
                                 cg.getCellRenderer().setCellEditor(
                                                 new CellEditor()
                                                 {
                                                         public Object getValue(Object item, String property, int rowCount)
                                                         {
                                                                 ...
                                                                 if(chiusa.equals("true"))
                                                                         return "<a href=\"MacellazioniNewSintesis.do?command=ListSedute&id=" + id + "&altId=" + id_mac + "\">Lista Sedute</a> <a href=\"javascript:toMostraMotivazioni("+id+","+id_mac+");\">Motivazioni</a>";
                                                                 else
                                                                 {
                                                                         if(numCapiOviniDestMavamPartitaSedute<pTemp.getCd_num_capi_ovini() || numCapiCapriniDestMavamPartitaSedute<pTemp.getCd_num_capi_caprini())
                                                                                 return "<a href=\"MacellazioniNewSintesis.do?command=ToRiprendiPartita&id=" + id + "&altId=" + id_mac + "\">Aggiungi Seduta</a> <a href=\"MacellazioniNewSintesis.do?command=ListSedute&id=" + id + "&altId=" + id_mac + "\">Lista Sedute</a> <a href=\"javascript:toChiudiPartita("+id+","+id_mac+");\">Chiudi</a>";
                                                                         else
                                                                                 return "<a href=\"#\" onclick=\"alert('Impossibile inserire altre sedute di macellazione: tutti i capi risultano gia' macellati.')\" >Aggiungi Seduta</a> <a href=\"MacellazioniNewSintesis.do?command=ListSedute&id=" + id + "&altId=" + id_mac + "\">Lista Sedute</a> <a href=\"javascript:toChiudiPartita("+id+","+id_mac+");\">Chiudi</a>";
						...
						{	
							public Object getValue(Object item, String property, int rowCount)
							{
                              ...
                              finally
                              {
								...
								//return "<div style=\"background-color:" + colore + "\"><a href=\"macellazioninew.do?command=Details&id=" + id + "&altId=" + id_mac + "\">" + temp + "</a></div>";
								return categoriaPartita+"<br/>"+ "<a href=\"MacellazioniNewSintesis.do?command=DetailsSeduta&id=" + id + "&altId=" + id_mac + "\">" + temp + "</a>";
								//return temp;
	...
	public String executeCommandListTipi( ActionContext context )
	{
		...
		try
		{
			...
			SintesisStabilimento org = new SintesisStabilimento( db, Integer.parseInt(context.getRequest().getParameter("altId")), true );
			context.getRequest().setAttribute( "OrgDetails", org );
...
//				return ret2;
	...
	public String executeCommandToChiudiPartita( ActionContext context )
	{
		...
		try
		{
			...
			org = new SintesisStabilimento( db, b.getId_macello(), true );
	...
	public String executeCommandModificaSedutaCampioniSenzaEsito( ActionContext context )
	{
		...
		try
		{
			...
			SintesisStabilimento org = new SintesisStabilimento( db, p_seduta.getId_macello(), true );
...
//			}
	...
	public String executeCommandPrintBRCRilevazioneMacelli(ActionContext context) 
	{
		...
		try {
			...
			SintesisStabilimento org = new SintesisStabilimento(db, orgid, true);
	...
	/*public String executeCommandPrintModelloIdatidosi(ActionContext context) {
		...
		try {
			db = this.getConnection( context );
			Organization org = new Organization( db, Integer.parseInt( context.getParameter( "altId" ) ) );
			context.getRequest().setAttribute( "OrgDetails", org );
		  ...
		  if (bytes != null) {
		    FileDownload fileDownload = new FileDownload();
		    	fileDownload.setDisplayName("Modello_idatidosi_" + org.getAltId() + ".pdf");
		    fileDownload.sendFile(context, bytes, "application/pdf");
		  } else {
		    return ("SystemError");
		  }
	...
	/*public String executeCommandPrintModelloIdatidosi(ActionContext context) throws com.itextpdf.text.DocumentException, IOException {
		...
		try {
			...
			db = this.getConnection(context);
			Organization macello = new Organization( db, Integer.parseInt( context.getParameter( "altId" ) ) );
			context.getRequest().setAttribute( "OrgDetails", macello );
			String data = context.getParameter( "data" );
			...
			stat.setInt( 1, macello.getAltId() );
			stat.setTimestamp( 2, d );
			ResultSet res = stat.executeQuery();
...
//			}
	...
	private String controlloUnivocitaUpdate(ConfigTipo configTipo, ActionContext context, Connection db, String identificativo )
	{
		...
		{
			AjaxCalls ac = new AjaxCalls();
			PartitaAjax  pa = ac.isCapoEsistenteUpdateSintesis(b.getId(),identificativo,b.getCd_codice_azienda_provenienza(),((Partita)b).getCd_num_capi_ovini(),((Partita)b).getCd_num_capi_caprini());
			if( pa.isEsistente() )
			{
				this.freeConnection(context, db);
	...
	private String controlloProgressivoMacellazione(ConfigTipo configTipo, ActionContext context, Connection db, boolean update,GenericBean vb, String identificativo)
	{
			...
			{
				AjaxCalls ac = new AjaxCalls();
				if(!ac.controlloProgressivoMacellazioneSintesis(configTipo,b.getId_macello(), new SimpleDateFormat("dd/MM/yyyy").format( new Date(b.getVpm_data().getTime() ) ), b.getProgressivo_macellazione(), identificativo))
				{
					this.freeConnection(context, db);
		...
		if(context.getSession().getAttribute("configTipo")!=null){
			...
			try {
				...
				context.getSession().setAttribute("configTipo", configTipo);
					...
					org.aspcfs.modules.macellazioninew.utils.ConfigTipo configTipo3 = (org.aspcfs.modules.macellazioninew.utils.ConfigTipo) context.getSession().getAttribute("configTipo");
