...
public class CheckListCanili extends CFSModule{
	 ...
	 public String executeCommandUpdateCategoria(ActionContext context)
	 {
		 ...
		 Connection db = null;
			...
			try 
			{
				...
				if (messaggioAllegatiSanzione!=null && !messaggioAllegatiSanzione.equals("")){
					...
					org.aspcfs.modules.canili.actions.CaniliVigilanza AV = new org.aspcfs.modules.canili.actions.CaniliVigilanza();
		...
		CaniliVigilanza AV = new CaniliVigilanza();
		return AV.executeCommandChiudiTutto(context);
		//return ("checklistCaniliUpdateCategoria");
	 }
