...
public class RegistroRecapiti {

	public static final int ID_TIPOLOGIA = 2;
	...
	private ArrayList<CaricoRecapiti> listaCarico = new ArrayList<CaricoRecapiti>();
	
	public RegistroRecapiti() {
	}
	
	
	public RegistroRecapiti(Connection db, int id) throws SQLException {
		...
		if (rs.next()){
			...
			ArrayList<CaricoRecapiti> carico = CaricoRecapiti.getListaCarico(db, this.id);
			this.listaCarico = carico;
		}
		
	}

	public RegistroRecapiti(Connection db, String numRegistrazioneStab) throws SQLException {
	...
	public ArrayList<CaricoRecapiti> getListaCarico() {
		return listaCarico;
	}

	public void setListaCarico(ArrayList<CaricoRecapiti> listaCarico) {
