...
public class Casl_Non_Conformita_Rilevata  extends GenericBean
{
	private static final long serialVersionUID = -1818715611806660576L;
	...
	private int id_casl_non_conformita;
	...
	public int getId_casl_non_conformita() {
		return id_casl_non_conformita;
	}
	public void setId_casl_non_conformita(int idCaslNonConformita) {
		id_casl_non_conformita = idCaslNonConformita;
	}
		...
		throws SQLException, IllegalArgumentException, IllegalAccessException, InvocationTargetException
	{
		...
		String sql = "INSERT INTO m_casl_non_conformita_rilevate( ";
	...
	public static ArrayList<Casl_Non_Conformita_Rilevata> load( int id, ConfigTipo configTipo, Connection db )
	{
	
		ArrayList<Casl_Non_Conformita_Rilevata>	ret		= new ArrayList<Casl_Non_Conformita_Rilevata>();
		PreparedStatement				stat	= null;
		ResultSet						res		= null;
		
		try
		{
			stat	= db.prepareStatement( "SELECT * FROM m_casl_non_conformita_rilevate WHERE " + configTipo.getNomeCampoRifAltreTabelle() + " = ? and trashed_date IS NULL" );
			stat.setInt( 1, id );
	...
	public static Casl_Non_Conformita_Rilevata load(String id, Connection db )
	{

		Casl_Non_Conformita_Rilevata	ret		= null;
		PreparedStatement	stat	= null;
		ResultSet			res		= null;
		...
		if( (id != null) && (id.trim().length() > 0) )
		{
			try
			{
				...
				stat	= db.prepareStatement( "SELECT * FROM m_casl_non_conformita_rilevate WHERE id = ? and trashed_date IS NULL" );
				stat.setInt( 1, iid );
				res		= stat.executeQuery();
				if( res.next() )
				{
	...
	private static Casl_Non_Conformita_Rilevata loadResultSet( ResultSet res ) 
		throws SQLException, IllegalArgumentException, IllegalAccessException, InvocationTargetException
	{
		Casl_Non_Conformita_Rilevata ret = new Casl_Non_Conformita_Rilevata();
	...
	public void update(Connection db)
		throws SQLException, IllegalArgumentException, IllegalAccessException, InvocationTargetException
	{
		String sql = "UPDATE m_casl_non_conformita_rilevate SET ";
	...
	public static void delete( int id, int user_id, Connection db )
	{
		...
		try
		{
			stat	= db.prepareStatement( 
					"UPDATE m_casl_non_conformita_rilevate SET modified = CURRENT_TIMESTAMP, trashed_date = CURRENT_TIMESTAMP, modified_by = ? " +
	...
	public void setId_seduta(Integer id_seduta) {
