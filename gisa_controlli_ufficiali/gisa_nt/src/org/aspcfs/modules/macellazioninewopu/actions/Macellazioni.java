...
import org.aspcfs.modules.macellazioninewopu.base.BeanAjax;
...
import org.aspcfs.modules.macellazioninewopu.base.CategoriaRischio;
import org.aspcfs.modules.macellazioninewopu.base.ChiaveModuliMacelli;
import org.aspcfs.modules.macellazioninewopu.base.Esito;
...
import org.aspcfs.modules.macellazioninewopu.base.PartitaLog;
import org.aspcfs.modules.macellazioninewopu.base.PartitaLogDao;
import org.aspcfs.modules.macellazioninewopu.base.PartitaSeduta;
import org.aspcfs.modules.macellazioninewopu.base.PatologiaRilevata;
import org.aspcfs.modules.macellazioninewopu.base.ProvvedimentiCASL;
import org.aspcfs.modules.macellazioninewopu.base.RichiestaIstopatologico;
import org.aspcfs.modules.macellazioninewopu.base.StampeModuli;
import org.aspcfs.modules.macellazioninewopu.base.StampeModuliDao;
import org.aspcfs.modules.macellazioninewopu.base.Tampone;
import org.aspcfs.modules.macellazioninewopu.base.Tipo;
import org.aspcfs.modules.macellazioninewopu.base.TipoRicerca;
import org.aspcfs.modules.macellazioninewopu.utils.ConfigTipo;
import org.aspcfs.modules.macellazioninewopu.utils.MacelliUtil;
	...
	public String executeCommandSearch( ActionContext context )
	{
		...
		if (context.getParameter("matricola")!=null && ! "".equals(context.getParameter("matricola")))
		{
			...
			try
			{
				...
				Stabilimento org = new Stabilimento( db, b.getId_macello(), true );
		...
		try
		{
			...
			if(identificativo!=null && !identificativo.equals(""))
			{
				...
				if(context.getRequest().getParameter("fromModifica")!=null && context.getRequest().getParameter("fromModifica").equals("si"))
					ca = ac.isCapoEsistenteUpdateOpu(b.getId(),identificativo,b.getCd_codice_azienda_provenienza(),((Partita)b).getCd_num_capi_ovini(),((Partita)b).getCd_num_capi_caprini());
				else 
                                                 ...
                                                 public Object getValue(Object item, String property, int rowCount)
                                                 {
                                                	 Partita pTemp = null;
                                                      ...
                                                      finally
                                                      {
                                                         ...
                                                         return categoriaPartita+"<br/>"+"<a href=\"MacellazioniNewOpu.do?command=Details&id=" + id + "&altId=" + id_mac + "\">" + temp + "</a>";
                                                         //return temp;
                         ...
                         cg.getCellRenderer().setCellEditor(
                                         new CellEditor()
                                         {
                                                 public Object getValue(Object item, String property, int rowCount)
                                                 {
                                                         ...
                                                         //return "<div style=\"background-color:" + colore + "\"><a href=\"macellazioninew.do?command=Details&id=" + id + "&altId=" + id_mac + "\">" + temp + "</a></div>";
                                                         return "<center><a href=\"MacellazioniNewOpu.do?command=NuovoCapo&id=" + id + "&altId=" + id_mac + "&clona=si \"><img src=\"images/icons/clone.png\" height=\"20px\" width=\"20px\" title=\"Clona capo\" /></a></center>";
                                                         //return temp;
...
////                                                                             toReturn += "<center><a href=\"MacellazioniNewOpu.do?command=RichiestaIstopatologico&id=" + id + "&altId=" + id_mac + " \"><img src=\"images/icons/clone.png\" height=\"20px\" width=\"20px\" title=\"Richiedi istopatologico\" /></a></center>";
////                                                                             k++;
////                                                                     }
...
////                                                                             toReturn += "<div>" + "<a onclick=\"window.open('MacellazioniNewOpu.do?command=VisualizzaEsitoRichiestaIstopatologico&idIstopatologico=" + istopatologico_id + "&popup=true', 'titolo', 'width=600, height=600, resizable, status, scrollbars=1, location');\" href=\"#\" + \">Visualizza esito</a>" + "</div> ";
////                                                                      if (richiesteIstopatologico.getIdEsito() <= 0)
////                                                                             toReturn += "<div>" + "<a onclick=\"window.open('MacellazioniNewOpu.do?command=PrepareInserisciEsitoRichiestaIstopatologico&idIstopatologico=" + istopatologico_id + "&popup=true', 'titolo', 'width=600, height=600, resizable, status, scrollbars=1, location');\" href=\"#\" + \">Inserisci esito</a>" + "</div> ";
////                                                                      k++;
////                                                                     }
////                                                             }
////                                                             if (("").equals(toReturn) )
                                 ...
                                 cg.getCellRenderer().setCellEditor(
                                                 new CellEditor()
                                                 {
                                                         public Object getValue(Object item, String property, int rowCount)
                                                         {
                                                                 ...
                                                                 if(chiusa.equals("true"))
                                                                         return "<a href=\"MacellazioniNewOpu.do?command=ListSedute&id=" + id + "&altId=" + id_mac + "\">Lista Sedute</a> <a href=\"javascript:toMostraMotivazioni("+id+","+id_mac+");\">Motivazioni</a>";
                                                                 else
                                                                 {
                                                                         if(numCapiOviniDestMavamPartitaSedute<pTemp.getCd_num_capi_ovini() || numCapiCapriniDestMavamPartitaSedute<pTemp.getCd_num_capi_caprini())
                                                                                 return "<a href=\"MacellazioniNewOpu.do?command=ToRiprendiPartita&id=" + id + "&altId=" + id_mac + "\">Aggiungi Seduta</a> <a href=\"MacellazioniNewOpu.do?command=ListSedute&id=" + id + "&altId=" + id_mac + "\">Lista Sedute</a> <a href=\"javascript:toChiudiPartita("+id+","+id_mac+");\">Chiudi</a>";
                                                                         else
                                                                                 return "<a href=\"#\" onclick=\"alert('Impossibile inserire altre sedute di macellazione: tutti i capi risultano gia' macellati.')\" >Aggiungi Seduta</a> <a href=\"MacellazioniNewOpu.do?command=ListSedute&id=" + id + "&altId=" + id_mac + "\">Lista Sedute</a> <a href=\"javascript:toChiudiPartita("+id+","+id_mac+");\">Chiudi</a>";
						...
						{	
							public Object getValue(Object item, String property, int rowCount)
							{
                              ...
                              finally
                              {
								...
								//return "<div style=\"background-color:" + colore + "\"><a href=\"macellazioninew.do?command=Details&id=" + id + "&altId=" + id_mac + "\">" + temp + "</a></div>";
								return categoriaPartita+"<br/>"+ "<a href=\"MacellazioniNewOpu.do?command=DetailsSeduta&id=" + id + "&altId=" + id_mac + "\">" + temp + "</a>";
								//return temp;
...
//				return ret2;
	...
	public String executeCommandToChiudiPartita( ActionContext context )
	{
		...
		try
		{
			...
			org = new Stabilimento( db, b.getId_macello(), true );
	...
	public String executeCommandModificaSedutaCampioniSenzaEsito( ActionContext context )
	{
		...
		try
		{
			...
			Stabilimento org = new Stabilimento( db, p_seduta.getId_macello(), true );
...
//			}
	...
	public String executeCommandPrintBRCRilevazioneMacelli(ActionContext context) 
	{
		...
		try {
			...
			Stabilimento org = new Stabilimento(db, orgid, true);
...
//			}
	...
	private String controlloUnivocitaUpdate(ConfigTipo configTipo, ActionContext context, Connection db, String identificativo )
	{
		...
		{
			AjaxCalls ac = new AjaxCalls();
			PartitaAjax  pa = ac.isCapoEsistenteUpdateOpu(b.getId(),identificativo,b.getCd_codice_azienda_provenienza(),((Partita)b).getCd_num_capi_ovini(),((Partita)b).getCd_num_capi_caprini());
			if( pa.isEsistente() )
			{
				this.freeConnection(context, db);
	...
	private String controlloProgressivoMacellazione(ConfigTipo configTipo, ActionContext context, Connection db, boolean update,GenericBean vb, String identificativo)
	{
			...
			{
				AjaxCalls ac = new AjaxCalls();
				if(!ac.controlloProgressivoMacellazioneOpu(configTipo,b.getId_macello(), new SimpleDateFormat("dd/MM/yyyy").format( new Date(b.getVpm_data().getTime() ) ), b.getProgressivo_macellazione(), identificativo))
				{
					this.freeConnection(context, db);
