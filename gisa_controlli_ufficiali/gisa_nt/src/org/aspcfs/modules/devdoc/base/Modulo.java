...
public class Modulo extends GenericBean{
	...
	public final static int MODULO_A = 5;
	public final static int MODULO_B = 1;
	public final static int MODULO_C = 2;
	public final static int MODULO_CH = 4;
	public final static int MODULO_D = 3;
	public final static int MODULO_VCE = 6;
	public final static int MODULO_AL = 7;
