	...
	public String executeCommandInsert(ActionContext context,Connection db) throws SQLException 
	{
		...
		if (context.getParameter("id_tipologia_operatore")!=null && ! "".equals(context.getParameter("id_tipologia_operatore")))
		 ...
		 try {
			...
			cu.setFlagBloccoNonConformitaContoTerzi(db, cu.getId());
			if(cu.isflagBloccoCu()==true && cu.isFlagBloccoNonConformitaContoTerzi()==true)
			{
			...
			{
				if(cu.isflagBloccoCu()==true && cu.isFlagBloccoNonConformitaContoTerzi()==false)
				{
					newTic.setFlag_posticipato(true);
...
//				else
	...
	public String executeCommandUpdateTicket(ActionContext context,Connection db){
		...
		newTic.setNcGraviValutazioni(context.getRequest().getParameter("nonConformitaGraviValutazione"));
		newTic.setIdImpresaSanzionata(context.getRequest().getParameter("id_impresa_sanzionata"));
		newTic.setRagioneSocialeImpresaSanzionata(context.getRequest().getParameter("descrizione_impresa_sanzionata"));
