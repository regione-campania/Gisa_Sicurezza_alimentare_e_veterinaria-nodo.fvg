...
public class NonConformita extends GenericBean
{
	...
	public static ArrayList<NonConformita> load( int id_capo, Connection db )
	{
		...
		try
		{
			stat	= db.prepareStatement( "SELECT * FROM m_capi_non_conformita WHERE id_capo = ? and trashed_date IS NULL" );
