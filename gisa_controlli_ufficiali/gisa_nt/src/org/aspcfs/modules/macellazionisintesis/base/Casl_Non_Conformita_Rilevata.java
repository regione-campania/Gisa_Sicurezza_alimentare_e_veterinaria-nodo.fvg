...
public class Casl_Non_Conformita_Rilevata  extends GenericBean
{
	...
	public static ArrayList<Casl_Non_Conformita_Rilevata> load( int id_capo, Connection db )
	{
		...
		try
		{
			stat	= db.prepareStatement( "SELECT * FROM m_casl_non_conformita_rilevate WHERE id_capo = ? and trashed_date IS NULL" );
