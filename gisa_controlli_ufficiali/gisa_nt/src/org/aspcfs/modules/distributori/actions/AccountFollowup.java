...
public final class AccountFollowup extends CFSModule {
  ...
  public String executeCommandViewFollowup(ActionContext context) {
	    if (!hasPermission(context, "distributori-distributori-followup-view")) {
	    ...
	    ticketListInfo.setLink(
	        "Accounts.do?command=ViewFollowup&orgId=" + passedId);
  ...
  public String executeCommandReopenTicket(ActionContext context) {
    if (!hasPermission(context, "distributori-distributori-followup-edit")) {
      return ("PermissionError");
    }
    int resultCount = -1;
    Connection db = null;
  ...
  public String executeCommandConfirmDelete(ActionContext context) {
    if (!hasPermission(context, "distributori-distributori-followup-delete")) {
      return ("PermissionError");
    }
    Connection db = null;
    //Parameters
    ...
    try {
  	...
  	if (recordDeleted) {
  		...
  		context
  				...
  				.setAttribute(
  						"refreshUrl",
  						"AccountNonConformita.do?command=TicketDetails&id="+id_controllo+"&orgId="
  								+ orgId
  								+ (inline != null
