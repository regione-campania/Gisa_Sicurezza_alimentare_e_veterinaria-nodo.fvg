...
import org.aspcfs.modules.macellazioniopu.base.Art17;
import org.aspcfs.modules.macellazioniopu.base.Art17ErrataCorrige;
...
//	        				}
	...
	public String executeCommandViewModuleErrataCorrigeArt17(ActionContext context) throws IndirizzoNotFoundException{
...
public String executeCommandViewListaModuleErrataCorrigeArt17(ActionContext context) throws IndirizzoNotFoundException{
...
public String executeCommandViewErrataCorrigeArt17(ActionContext context) throws IndirizzoNotFoundException{
	...
	try
	{
		...
		if (c.getDestinatario_1_id()>0 &&c.getDestinatario_1_id()<20000000){
			...
			Stabilimento esercente = new Stabilimento(db, c.getDestinatario_1_id(), true);
			nomeEsercente =esercente.getOperatore().getRagioneSociale();
	    	  indirizzoEsercente = " - "+ esercente.getSedeOperativa().getDescrizioneToponimo() + " " + esercente.getSedeOperativa().getVia()+ " "+esercente.getSedeOperativa().getCivico()+", "+  esercente.getSedeOperativa().getDescrizione_provincia() + " ("+ esercente.getSedeOperativa().getDescrizione_provincia()+")";
		}
		context.getRequest().setAttribute("nomeEsercente", nomeEsercente);
