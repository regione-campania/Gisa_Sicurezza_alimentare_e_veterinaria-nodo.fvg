...
public class CheckListColonie extends CFSModule{
	 ...
	 public String executeCommandUpdateCategoria(ActionContext context)
	 {
		 ...
		 Connection db = null;
			...
			try 
			{
				...
				if (messaggioAllegatiSanzione!=null && !messaggioAllegatiSanzione.equals("")){
					...
					org.aspcfs.modules.colonie.actions.ColonieVigilanza AV = new org.aspcfs.modules.colonie.actions.ColonieVigilanza();
		...
		ColonieVigilanza AV = new ColonieVigilanza();
		return AV.executeCommandChiudiTutto(context);
		//return ("checklistColonieUpdateCategoria");
	 }
