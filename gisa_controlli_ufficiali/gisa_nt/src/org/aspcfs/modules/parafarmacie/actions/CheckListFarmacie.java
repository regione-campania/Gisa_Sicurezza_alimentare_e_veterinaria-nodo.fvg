...
public class CheckListFarmacie extends CFSModule{
		 ...
		 Connection db = null;
			...
			try 
			{
				...
				if (messaggioAllegatiSanzione!=null && !messaggioAllegatiSanzione.equals("")){
					...
					org.aspcfs.modules.parafarmacie.actions.AccountVigilanza AV = new org.aspcfs.modules.parafarmacie.actions.AccountVigilanza();
