 ...
 */
public final class AcqueReteFollowup extends CFSModule {
  ...
  public String executeCommandReopenTicket(ActionContext context) {
    if (!hasPermission(context, "acquedirete-followup-edit")) {
  ...
  public String executeCommandTicketDetails(ActionContext context) {
    if (!hasPermission(context, "acquedirete-followup-view")) {
      return ("PermissionError");
    }
    Connection db = null;
    //Parameters
  ...
  public String executeCommandConfirmDelete(ActionContext context) {
    if (!hasPermission(context, "acquedirete-followup-delete")) {
      return ("PermissionError");
    }
    Connection db = null;
    //Parameters
