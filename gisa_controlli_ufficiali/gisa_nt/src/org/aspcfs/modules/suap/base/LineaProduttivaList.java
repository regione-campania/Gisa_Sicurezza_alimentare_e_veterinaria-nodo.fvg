...
public void setIdRichiesta(int idRichiesta) {
	...
	public ResultSet queryList(Connection db, PreparedStatement pst) throws SQLException {
		...
		String sqlSele = 	"select * from public_functions.suap_get_lista_linee_produttive(?)";
		sqlSelect.append(sqlSele);
		pst = db.prepareStatement(sqlSelect.toString());
		pst.setInt(1, this.idStabilimento);
	...
	public ResultSet queryListSearch(Connection db, PreparedStatement pst) throws SQLException {
		...
		String sqlSele = 	"select  distinct  l.id_tipo_linea_produttiva," +
				...
				"l.codice_attivita as codice,l.id_norma,l.aggregazione as aggregazione,l.id_aggregazione as id_categoria ,l.attivita as attivita ,"+ 
				"l.id_attivita as id_attivita  " ;

		String sqlFrom = " from ml8_linee_attivita_nuove_materializzata l "+ 
				" where 1=1 " ;
