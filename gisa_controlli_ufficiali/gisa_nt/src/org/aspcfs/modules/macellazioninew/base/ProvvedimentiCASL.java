...
public class ProvvedimentiCASL  extends GenericBean
{
	...
	public static ArrayList<ProvvedimentiCASL> load( int id, ConfigTipo configTipo,Connection db )
	{
		...
		try
		{
			stat	= db.prepareStatement( "SELECT * FROM m_casl_provvedimenti WHERE "+ configTipo.getNomeCampoRifAltreTabelle() +" = ? and trashed_date IS NULL" );
			stat.setInt( 1, id );
