...
public class PartitaLog {
	...
	private boolean sedutaSuccessiva;
	...
	public boolean isSedutaSuccessiva() {
		return sedutaSuccessiva;
	}
	public void setSedutaSuccessiva(boolean sedutaSuccessiva) {
		this.sedutaSuccessiva = sedutaSuccessiva;
	}
