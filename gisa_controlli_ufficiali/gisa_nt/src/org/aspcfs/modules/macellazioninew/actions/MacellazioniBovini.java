...
public String executeCommandStampeModuli( ActionContext context )
	{
		...
		try {
			...
			case 1:	
				...
				String select1 = org.aspcfs.modules.macellazioninew.actions.ApplicationProperties.getProperty("GET_IDATIDOSI");
				PreparedStatement stat1 = db.prepareStatement(select1);
				stat1.setInt( 1, macello.getOrgId() );
			...
			case 2:
				document.add(instanceImg);
				String select2 = org.aspcfs.modules.macellazioninew.actions.ApplicationProperties.getProperty("GET_MODELLO_MARCHI");
			...
			case 3:  
				document.add(instanceImg);
				String select3 = org.aspcfs.modules.macellazioninew.actions.ApplicationProperties.getProperty("GET_ANIMALI_INFETTI");
			...
			case 4: 
				document.add(instanceImg);
				String select4 = org.aspcfs.modules.macellazioninew.actions.ApplicationProperties.getProperty("GET_ANIMALI_GRAVIDI");
				...
				break;
			case 5: 
				String select5 = org.aspcfs.modules.macellazioninew.actions.ApplicationProperties.getProperty("GET_TBC_RILEVAZIONE_MACELLO");
				...
				break;
			case 6: 
				String select6 = org.aspcfs.modules.macellazioninew.actions.ApplicationProperties.getProperty("GET_BRC_RILEVAZIONE_MACELLO");
				...
				break;
			case 7:
				String select7 = org.aspcfs.modules.macellazioninew.actions.ApplicationProperties.getProperty("GET_1033_TBC");
			...
			case 8: 
				//document.add(instanceImg);
				String select8 = org.aspcfs.modules.macellazioninew.actions.ApplicationProperties.getProperty("GET_EVIDENZE_VISITA_ANTE_MORTEM");
			...
			case 9: 
				//document.add(instanceImg);
				String select9 = org.aspcfs.modules.macellazioninew.actions.ApplicationProperties.getProperty("GET_MORTE_ANTE_MACELLAZIONE");
				...
				break;
			case 10:
				String select10 = org.aspcfs.modules.macellazioninew.actions.ApplicationProperties.getProperty("GET_ANIMALI_LEB");
			...
			case 11:
				document.add(instanceImg);
				String select11 = org.aspcfs.modules.macellazioninew.actions.ApplicationProperties.getProperty("GET_TRASPORTI_ANIMALI_INFETTI");
