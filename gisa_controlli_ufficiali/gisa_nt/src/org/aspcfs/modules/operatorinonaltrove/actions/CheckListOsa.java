...
import org.aspcfs.modules.osa.actions.AccountVigilanza;
...
public class CheckListOsa extends CFSModule{
		 ...
		 Connection db = null;
			...
			try 
			{
				...
				if (messaggioAllegatiSanzione!=null && !messaggioAllegatiSanzione.equals("")){
					...
					org.aspcfs.modules.operatorinonaltrove.actions.AccountVigilanza AV = new org.aspcfs.modules.operatorinonaltrove.actions.AccountVigilanza();
