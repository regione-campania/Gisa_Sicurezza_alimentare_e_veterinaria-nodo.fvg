...
public class DiarioMacellazione extends GenericBean
{
	...
	public static DiarioMacellazione load( int id, Connection db )
	{
		...
		try
		{
			stat	= db.prepareStatement( 
					"SELECT * FROM stabilimenti_diario_macellazione WHERE trashed_date IS NULL AND enabled AND id = ?" );
			stat.setInt( 1, id );
	...
	public static ArrayList<DiarioMacellazione> loadByStabilimento( int id_stabilimento, Connection db )
	{
		...
		{
			stat	= db.prepareStatement( 
					"SELECT * FROM stabilimenti_diario_macellazione WHERE trashed_date IS NULL AND enabled AND id_stabilimento = ? ORDER BY data DESC" );
	...
	{
		String sql = "INSERT INTO stabilimenti_diario_macellazione( ";
	...
	public static ArrayList<DiarioMacellazione> loadByStabilimento( String id_stabilimento, Connection db )
	{
		return ( id_stabilimento == null ) ? ( null ) : ( loadByStabilimento( Integer.parseInt( id_stabilimento ), db ) );
	}
		...
		throws SQLException, IllegalArgumentException, IllegalAccessException, InvocationTargetException
	{
		...
		String sql = "UPDATE stabilimenti_diario_macellazione SET ";
