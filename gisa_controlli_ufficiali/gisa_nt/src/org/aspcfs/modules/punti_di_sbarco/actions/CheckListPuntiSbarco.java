...
public class CheckListPuntiSbarco extends CFSModule{
	 ...
	 public String executeCommandAdd(ActionContext context)
	  {
		...
		finally 
		{
		 ...
		 return "checklistPuntiSbarcoAdd";
	 ...
	 public String executeCommandSave(ActionContext context)
	  {
		...
		finally 
		{
		 ...
		 return "checklistPuntiSbarcoSaveOk";
	  }
	 ...
	 public String executeCommandView(ActionContext context)
	 {
		...
		finally 
		{
		 ...
		 return "checklistPuntiSbarcoView";
	 }
	 ...
	 public String executeCommandModify(ActionContext context)
	 {
		...
		finally 
		{
		 ...
		 return "checklistPuntiSbarcoModify";
	 }
	 ...
	 public String executeCommandUpdate(ActionContext context)
	 {
		...
		finally 
		{
		 ...
		 return "checklistPuntiSbarcoUpdate";
	 }
	 ...
	 public String executeCommandDelete(ActionContext context)
	 {
		...
		finally 
		{
		 ...
		 return ("checklistPuntiSbarcoDelete");
	 }
	 ...
	 public String executeCommandUpdateCategoria(ActionContext context)
	 {
		 ...
		 Connection db = null;
			...
			try 
			{
				...
				if (messaggioAllegatiSanzione!=null && !messaggioAllegatiSanzione.equals("")){
					...
					org.aspcfs.modules.punti_di_sbarco.actions.PuntiSbarcoVigilanza AV = new org.aspcfs.modules.punti_di_sbarco.actions.PuntiSbarcoVigilanza();
		...
		PuntiSbarcoVigilanza AV = new PuntiSbarcoVigilanza();
		return AV.executeCommandChiudiTutto(context);
		//return ("checklistPuntiSbarcoUpdateCategoria");
	 }
