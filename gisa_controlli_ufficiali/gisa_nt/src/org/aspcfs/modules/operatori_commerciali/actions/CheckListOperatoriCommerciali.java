...
public class CheckListOperatoriCommerciali extends CFSModule{
	 ...
	 public String executeCommandAdd(ActionContext context)
	  {
		...
		finally 
		{
		 ...
		 return "checklistOperatoriCommercialiAdd";
	 ...
	 public String executeCommandSave(ActionContext context)
	  {
		...
		finally 
		{
		 ...
		 return "checklistOperatoriCommercialiSaveOk";
	  }
	 ...
	 public String executeCommandView(ActionContext context)
	 {
		...
		finally 
		{
		 ...
		 return "checklistOperatoriCommercialiView";
	 }
	 ...
	 public String executeCommandModify(ActionContext context)
	 {
		...
		finally 
		{
		 ...
		 return "checklistOperatoriCommercialiModify";
	 }
	 ...
	 public String executeCommandUpdate(ActionContext context)
	 {
		...
		finally 
		{
		 ...
		 return "checklistOperatoriCommercialiUpdate";
	 }
	 ...
	 public String executeCommandDelete(ActionContext context)
	 {
		...
		finally 
		{
		 ...
		 return ("checklistOperatoriCommercialiDelete");
	 }
	 ...
	 public String executeCommandUpdateCategoria(ActionContext context)
	 {
		 ...
		 Connection db = null;
			...
			try 
			{
				...
				if (messaggioAllegatiSanzione!=null && !messaggioAllegatiSanzione.equals("")){
					...
					org.aspcfs.modules.operatori_commerciali.actions.OperatoriCommercialiVigilanza AV = new org.aspcfs.modules.operatori_commerciali.actions.OperatoriCommercialiVigilanza();
		...
		OperatoriCommercialiVigilanza AV = new OperatoriCommercialiVigilanza();
		return AV.executeCommandChiudiTutto(context);
		//return ("checklistOperatoriCommercialiUpdateCategoria");
	 }
