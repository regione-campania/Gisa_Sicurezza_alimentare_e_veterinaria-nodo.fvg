...
public final class AccountFollowup extends CFSModule {
  ...
  public String executeCommandReopenTicket(ActionContext context) {
    if (!hasPermission(context, "operatori-commerciali-followup-edit")) {
  ...
  public String executeCommandTicketDetails(ActionContext context) {
    if (!hasPermission(context, "operatori-commerciali-followup-view")) {
      return ("PermissionError");
    }
    Connection db = null;
    //Parameters
  ...
  public String executeCommandConfirmDelete(ActionContext context) {
    if (!hasPermission(context, "operatori-commerciali-followup-delete")) {
      return ("PermissionError");
    }
    Connection db = null;
    //Parameters
