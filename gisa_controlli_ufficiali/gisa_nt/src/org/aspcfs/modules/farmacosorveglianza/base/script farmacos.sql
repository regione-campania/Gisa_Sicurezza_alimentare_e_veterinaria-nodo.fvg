...
INSERT INTO permission (permission_id, category_id, permission, permission_view, permission_add, permission_edit, permission_delete, description, level, enabled, active, viewpoints) VALUES (362, 50, 'farmacosorveglianza-farmacosorveglianza-history', true, true, true, true, 'Storia Farmacosorveglianza', 151, true, true, false);
INSERT INTO permission (permission_id, category_id, permission, permission_view, permission_add, permission_edit, permission_delete, description, level, enabled, active, viewpoints) VALUES (363, 50, 'farmacosorveglianza', true, true, true, true, 'Accesso Farmacosorveglianza', 15, true, true, false);
INSERT INTO permission (permission_id, category_id, permission, permission_view, permission_add, permission_edit, permission_delete, description, level, enabled, active, viewpoints) VALUES (364, 50, 'farmacosorveglianza-farmacosorveglianza', true, true, true, true, 'Farmacosorveglianza', 15, true, true, false);
