...
//		    }
		...
		numFattrici = context.getRequest().getParameter("numFattrici");
	...
	public void setNumFattrici(String numFattrici) {
		this.numFattrici = numFattrici;
	}
	...
	pst = db.prepareStatement("INSERT INTO public.chk_bns_mod_ist_v6_bovini_bufalini("+
            ...
            "num_bovine_lattazione, num_bovine_asciutta,num_fattrici, prod_latte, num_manze, "+
		...
		pst.setString(++i, this.numFattrici);
	...
	private void queryRecordByIdChkBnsModIst(Connection db) throws SQLException {
		PreparedStatement pst = db.prepareStatement("select * from chk_bns_mod_ist_v6_bovini_bufalini where id_chk_bns_mod_ist = ? and trashed_date is null");
		pst.setInt(1, this.idChkBnsModIst);
		ResultSet rs = pst.executeQuery();
		if (rs.next()){
			buildRecord(rs);
	...
	private void buildRecord(ResultSet rs) throws SQLException {
		...
		this.numFattrici  = rs.getString("num_fattrici");
