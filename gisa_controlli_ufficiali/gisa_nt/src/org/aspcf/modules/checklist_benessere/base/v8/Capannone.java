...
public class Capannone {
	...
	public void insert(Connection db) throws SQLException {
		...
		pst = db.prepareStatement("insert into chk_bns_capannoni_v8 (id_chk_bns_mod_ist, entered_by, indice, numero, capacita, animali, num_totale_box, num_totale_box_attivi, ispezionato) values (?, ?, ?, ?, ?, ?, ?, ?, ?)");
	...
	public static ArrayList<Capannone> queryListByIdChkBnsModIst(Connection db, int idChkBnsModIst) throws SQLException {
		...
		PreparedStatement pst = db.prepareStatement("select * from chk_bns_capannoni_v8 where id_chk_bns_mod_ist = ? and trashed_date is null order by indice asc");
