...
public class VariazioneDetentoreList extends  Vector implements SyncableList {
	...
	public void buildList(Connection db) throws SQLException {
		    ...
		    while (rs.next()) {
		      StabilimentoVariazioneDetentore thisMov = new StabilimentoVariazioneDetentore();
	...
	public ResultSet queryList(Connection db, PreparedStatement pst) throws SQLException {
	    ...
	    sqlCount.append(
	        ...
	        "FROM apicoltura_apiari_variazioni_detentore " +
	        " where 1=1  ");
	    ...
	    if (pagedListInfo != null) {
	      ...
	      sqlOrder.append(" ORDER BY data_assegnazione_detentore ");
	    ...
	    sqlSelect.append(" * FROM apicoltura_apiari_variazioni_detentore where 1=1 ");
