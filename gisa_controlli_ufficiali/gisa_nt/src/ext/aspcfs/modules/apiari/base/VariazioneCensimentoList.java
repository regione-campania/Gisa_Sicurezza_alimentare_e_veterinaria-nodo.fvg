...
public class VariazioneCensimentoList extends  Vector implements SyncableList {
	...
	public void buildList(Connection db) throws SQLException {
		    ...
		    while (rs.next()) {
		      StabilimentoVariazioneCensimento thisMov = new StabilimentoVariazioneCensimento();
	...
	public ResultSet queryList(Connection db, PreparedStatement pst) throws SQLException {
	    ...
	    sqlCount.append(
	        ...
	        "FROM apicoltura_apiari_variazioni_censimenti " +
	        " where 1=1  ");
	    ...
	    if (pagedListInfo != null) {
	      ...
	      sqlOrder.append(" ORDER BY data_assegnazione_censimento ");
	    ...
	    sqlSelect.append(" * FROM apicoltura_apiari_variazioni_censimenti where 1=1 ");
	  ...
	  protected void createFilter(Connection db, StringBuffer sqlFilter) {
	    ...
	    sqlFilter.append(" and trashed_by is null ");
