...
public class GetCapoOvino  implements java.io.Serializable {
    ...
    /**
     * Gets the p_capo_codice value for this GetCapoOvino.
     * 
    ...
    /**
     * Sets the p_capo_codice value for this GetCapoOvino.
     * 
     * @param p_capo_codice
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetCapoOvino)) return false;
        GetCapoOvino other = (GetCapoOvino) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetCapoOvino.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://bdr.izs.it/webservices", ">getCapoOvino"));
