...
public class FindCapoMacellato_STR  implements java.io.Serializable {
    private java.lang.String p_capo_codice;

    public FindCapoMacellato_STR() {
    }
    ...
    /**
     * Gets the p_capo_codice value for this FindCapoMacellato_STR.
     * 
    ...
    /**
     * Sets the p_capo_codice value for this FindCapoMacellato_STR.
     * 
     * @param p_capo_codice
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FindCapoMacellato_STR)) return false;
        FindCapoMacellato_STR other = (FindCapoMacellato_STR) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FindCapoMacellato_STR.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://bdr.izs.it/webservices", ">FindCapoMacellato_STR"));
