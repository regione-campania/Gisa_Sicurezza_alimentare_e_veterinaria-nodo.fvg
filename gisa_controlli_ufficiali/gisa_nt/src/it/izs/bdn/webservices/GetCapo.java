...
public class GetCapo  implements java.io.Serializable {
    ...
    /**
     * Gets the p_capo_codice value for this GetCapo.
     * 
    ...
    /**
     * Sets the p_capo_codice value for this GetCapo.
     * 
     * @param p_capo_codice
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetCapo)) return false;
        GetCapo other = (GetCapo) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetCapo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://bdr.izs.it/webservices", ">getCapo"));
