...
public class GetCapoMacellato_STR  implements java.io.Serializable {
    private java.lang.String p_capo_codice;

    public GetCapoMacellato_STR() {
    }
    ...
    /**
     * Gets the p_capo_codice value for this GetCapoMacellato_STR.
     * 
    ...
    /**
     * Sets the p_capo_codice value for this GetCapoMacellato_STR.
     * 
     * @param p_capo_codice
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetCapoMacellato_STR)) return false;
        GetCapoMacellato_STR other = (GetCapoMacellato_STR) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetCapoMacellato_STR.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://bdr.izs.it/webservices", ">getCapoMacellato_STR"));
