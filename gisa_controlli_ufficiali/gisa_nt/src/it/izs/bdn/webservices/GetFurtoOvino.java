...
public class GetFurtoOvino  implements java.io.Serializable {
    private java.lang.String p_codice_capo;

    public GetFurtoOvino() {
    }
    ...
    /**
     * Gets the p_codice_capo value for this GetFurtoOvino.
     * 
    ...
    /**
     * Sets the p_codice_capo value for this GetFurtoOvino.
     * 
     * @param p_codice_capo
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetFurtoOvino)) return false;
        GetFurtoOvino other = (GetFurtoOvino) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetFurtoOvino.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://bdr.izs.it/webservices", ">getFurtoOvino"));
