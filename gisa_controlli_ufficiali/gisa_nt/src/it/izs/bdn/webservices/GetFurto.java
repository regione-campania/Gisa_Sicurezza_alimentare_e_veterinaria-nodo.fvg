...
public class GetFurto  implements java.io.Serializable {
    ...
    /**
     * Gets the p_codice_capo value for this GetFurto.
     * 
    ...
    /**
     * Sets the p_codice_capo value for this GetFurto.
     * 
     * @param p_codice_capo
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetFurto)) return false;
        GetFurto other = (GetFurto) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetFurto.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://bdr.izs.it/webservices", ">getFurto"));
