...
public class FindCapoMacellato  implements java.io.Serializable {
    private java.lang.String p_capo_codice;

    public FindCapoMacellato() {
    }
    ...
    /**
     * Gets the p_capo_codice value for this FindCapoMacellato.
     * 
    ...
    /**
     * Sets the p_capo_codice value for this FindCapoMacellato.
     * 
     * @param p_capo_codice
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FindCapoMacellato)) return false;
        FindCapoMacellato other = (FindCapoMacellato) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FindCapoMacellato.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://bdr.izs.it/webservices", ">FindCapoMacellato"));
