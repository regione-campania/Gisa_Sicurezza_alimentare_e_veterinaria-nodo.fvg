...
public class GetPersona  implements java.io.Serializable {
    ...
    /**
     * Gets the p_persona_idfiscale value for this GetPersona.
     * 
    ...
    /**
     * Sets the p_persona_idfiscale value for this GetPersona.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetPersona)) return false;
        GetPersona other = (GetPersona) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetPersona.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://bdr.izs.it/webservices", ">getPersona"));
