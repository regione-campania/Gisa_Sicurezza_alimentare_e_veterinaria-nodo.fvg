...
public class GetCapoALibro  implements java.io.Serializable {
    private java.lang.String p_capo_codice;

    public GetCapoALibro() {
    }
    ...
    /**
     * Gets the p_capo_codice value for this GetCapoALibro.
     * 
    ...
    /**
     * Sets the p_capo_codice value for this GetCapoALibro.
     * 
     * @param p_capo_codice
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetCapoALibro)) return false;
        GetCapoALibro other = (GetCapoALibro) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetCapoALibro.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://bdr.izs.it/webservices", ">getCapoALibro"));
