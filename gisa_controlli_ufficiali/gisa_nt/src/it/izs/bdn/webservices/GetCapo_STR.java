...
public class GetCapo_STR  implements java.io.Serializable {
    ...
    /**
     * Gets the p_capo_codice value for this GetCapo_STR.
     * 
    ...
    /**
     * Sets the p_capo_codice value for this GetCapo_STR.
     * 
     * @param p_capo_codice
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetCapo_STR)) return false;
        GetCapo_STR other = (GetCapo_STR) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetCapo_STR.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://bdr.izs.it/webservices", ">getCapo_STR"));
