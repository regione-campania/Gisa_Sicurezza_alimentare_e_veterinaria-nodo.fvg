...
public class GetCapoALibro_STR  implements java.io.Serializable {
    private java.lang.String p_capo_codice;

    public GetCapoALibro_STR() {
    }
    ...
    /**
     * Gets the p_capo_codice value for this GetCapoALibro_STR.
     * 
    ...
    /**
     * Sets the p_capo_codice value for this GetCapoALibro_STR.
     * 
     * @param p_capo_codice
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetCapoALibro_STR)) return false;
        GetCapoALibro_STR other = (GetCapoALibro_STR) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetCapoALibro_STR.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://bdr.izs.it/webservices", ">getCapoALibro_STR"));
