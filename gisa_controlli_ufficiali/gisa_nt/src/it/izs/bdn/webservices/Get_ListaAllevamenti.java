...
public class Get_ListaAllevamenti  implements java.io.Serializable {
    private java.lang.String p_codice_capo;

    public Get_ListaAllevamenti() {
    }
    ...
    /**
     * Gets the p_codice_capo value for this Get_ListaAllevamenti.
     * 
    ...
    /**
     * Sets the p_codice_capo value for this Get_ListaAllevamenti.
     * 
     * @param p_codice_capo
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Get_ListaAllevamenti)) return false;
        Get_ListaAllevamenti other = (Get_ListaAllevamenti) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Get_ListaAllevamenti.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://bdr.izs.it/webservices", ">Get_ListaAllevamenti"));
