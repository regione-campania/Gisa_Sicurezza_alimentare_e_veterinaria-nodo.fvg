...
public class GetCapoMacellato  implements java.io.Serializable {
    private java.lang.String p_capo_codice;

    public GetCapoMacellato() {
    }
    ...
    /**
     * Gets the p_capo_codice value for this GetCapoMacellato.
     * 
    ...
    /**
     * Sets the p_capo_codice value for this GetCapoMacellato.
     * 
     * @param p_capo_codice
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetCapoMacellato)) return false;
        GetCapoMacellato other = (GetCapoMacellato) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetCapoMacellato.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://bdr.izs.it/webservices", ">getCapoMacellato"));
